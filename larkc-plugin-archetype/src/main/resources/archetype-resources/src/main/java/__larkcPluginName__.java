...
/**
 * <p>Generated LarKC plug-in skeleton for <code>${package}.${larkcPluginName}</code>.
 * Use this class as an entry point for your plug-in development.</p>
 */
public class ${larkcPluginName} extends Plugin
{
	 ...
	 */
	public ${larkcPluginName}(URI pluginUri) {
		super(pluginUri);
	...
	protected void initialiseInternal(SetOfStatements workflowDescription) {
		...
		logger.info("${larkcPluginName} initialized. Hello World!");
	}
	...
	protected SetOfStatements invokeInternal(SetOfStatements input) {
		logger.info("${larkcPluginName} working.");
		return null;
	}
