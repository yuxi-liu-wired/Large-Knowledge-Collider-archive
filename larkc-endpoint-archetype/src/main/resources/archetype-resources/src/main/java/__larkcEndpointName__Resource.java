 ...
 * </ul>
 */
public class ${larkcEndpointName}Resource extends ServerResource {

	private static Logger logger = LoggerFactory
			.getLogger(${larkcEndpointName}Resource.class);
	...
	public Representation executeQuery(Representation entity) throws Exception {
		...
		Executor ex = null;
		Endpoint ep = null;
		if (application instanceof ${larkcEndpointName}App) {
			ep = ((${larkcEndpointName}App) application).getEndpoint();
			ex = ep.getExecutor();
		}
		assert (ep != null);
		assert (ex != null);
