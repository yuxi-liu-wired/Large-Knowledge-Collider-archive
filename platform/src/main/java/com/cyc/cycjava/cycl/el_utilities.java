...
public  final class el_utilities extends SubLTranslatedFile {
  ...
  @SubL(source = "cycl/el-utilities.lisp", position = 59155) 
  public static final SubLObject make_ist_sentence(SubLObject mt, SubLObject sentence) {
    return make_binary_formula($const69$ist, mt, sentence);
  }
  

  /** Assumes that FORMULA is a ternary formula.
   returns four values: the operator of FORMULA, its arg1, its arg2, and its arg3. */
  @SubL(source = "cycl/el-utilities.lisp", position = 62557) 
  public static final SubLObject unmake_ternary_formula(SubLObject formula) {
    return Values.values(cycl_utilities.formula_arg0(formula), cycl_utilities.formula_arg1(formula, UNPROVIDED), cycl_utilities.formula_arg2(formula, UNPROVIDED), cycl_utilities.formula_arg3(formula, UNPROVIDED));
  }
  ...
  @SubL(source = "cycl/el-utilities.lisp", position = 115437) 
  public static final SubLObject possibly_formula_with_sequence_variablesP(SubLObject formula) {
    return list_utilities.tree_find_if($sym118$DOTTED_LIST_P, formula, UNPROVIDED);
  }

  
  /** Returns the free variables in SENTENCE that occur as sequence variables. */
  @SubL(source = "cycl/el-utilities.lisp", position = 118519) 
  public static final SubLObject sentence_free_sequence_variables(SubLObject sentence, SubLObject bound_vars, SubLObject varP) {
    ...
    }
    {
      ...
      }
      {
        ...
        if (((NIL != seqvar)
             && (NIL == subl_promotions.memberP(seqvar, bound_vars, UNPROVIDED, UNPROVIDED)))) {
          {
        ...
        if ((NIL != subl_promotions.memberP(sentence, bound_vars, UNPROVIDED, UNPROVIDED))) {
          ...
          {
            SubLObject cdolist_list_var = cycl_utilities.sentence_args(sentence, $kw28$IGNORE);
            SubLObject arg = NIL;
          ...
          return result;
        } else if (((NIL != el_implication_p(sentence))
        ...
        } else if ((NIL != possibly_el_quantified_sentence_p(sentence))) {
          return ConsesLow.append(result, sentence_free_sequence_variables(quantified_sub_sentence(sentence), cons(quantified_var(sentence), bound_vars), varP));
        } else if ((NIL != mt_designating_literalP(sentence))) {
          {
            ...
            if ((NIL == mtP)) {
              result_10 = ConsesLow.append(result_10, naut_free_sequence_variables(mt, bound_vars, varP));
            }
            return result_10;
          }
          ...
          return ConsesLow.append(result, literal_free_sequence_variables(sentence, bound_vars, varP));
             ...
             && (NIL != Functions.funcall(varP, cycl_utilities.sentence_arg0(sentence))))) {
          return ConsesLow.append(result, literal_free_sequence_variables(sentence, bound_vars, varP));
        } else if ((NIL != relation_expressionP(sentence))) {
  ...
  @SubL(source = "cycl/el-utilities.lisp", position = 115102) 
  public static final SubLObject literal_free_sequence_variables(SubLObject literal, SubLObject old_bound_vars, SubLObject varP) {
  ...
  @SubL(source = "cycl/el-utilities.lisp", position = 115645) 
  public static final SubLObject relation_free_sequence_variables(SubLObject relation, SubLObject old_bound_vars, SubLObject varP) {
    if ((old_bound_vars == UNPROVIDED)) {
      old_bound_vars = NIL;
    }
    if ((varP == UNPROVIDED)) {
    ...
    if ((NIL != subl_promotions.memberP(relation, old_bound_vars, UNPROVIDED, UNPROVIDED))) {
    } else if ((NIL != Functions.funcall(varP, relation))) {
      return NIL;
    ...
    } else if ((NIL != el_formula_p(relation))) {
      {
        ...
        SubLObject ans = NIL;
        if (((NIL != sequence_var)
             && (NIL == subl_promotions.memberP(sequence_var, bound_vars, UNPROVIDED, UNPROVIDED)))) {
          {
        ...
        {
          SubLObject terms = cycl_utilities.formula_terms(relation, $kw28$IGNORE);
          ...
          for (v_term = cdolist_list_var.first(); (NIL != cdolist_list_var); cdolist_list_var = cdolist_list_var.rest(), v_term = cdolist_list_var.first()) {
            if ((NIL != subl_promotions.memberP(v_term, bound_vars, UNPROVIDED, UNPROVIDED))) {
            ...
            } else if ((NIL != czer_utilities.leave_variables_at_el_for_argP(reln, psn, UNPROVIDED))) {
              ...
              {
                SubLObject seqvar = sequence_var(conses_high.second(v_term), UNPROVIDED);
                if (((NIL == subl_promotions.memberP(seqvar, bound_vars, UNPROVIDED, UNPROVIDED))
                     && (NIL != Functions.funcall(varP, seqvar)))) {
                  {
                    SubLObject item_var = seqvar;
                    if ((NIL == conses_high.member(item_var, ans, Symbols.symbol_function(EQL), Symbols.symbol_function(IDENTITY)))) {
                      ans = cons(item_var, ans);
  ...
  @SubL(source = "cycl/el-utilities.lisp", position = 115274) 
  public static final SubLObject naut_free_sequence_variables(SubLObject naut, SubLObject old_bound_vars, SubLObject varP) {
    if ((old_bound_vars == UNPROVIDED)) {
      old_bound_vars = NIL;
    }
    if ((varP == UNPROVIDED)) {
  ...
  /** @return el-formula-p or nil; the designated CycL sentence in LITERAL.
   @param LITERAL an @xref mt-designating-literal? */
  @SubL(source = "cycl/el-utilities.lisp", position = 100241) 
  ...
  /** @return integerp or nil; which arg position of LITERAL contains the designated CycL sentence.
   @param LITERAL an @xref mt-designating-literal? */
  @SubL(source = "cycl/el-utilities.lisp", position = 99890) 
  public static final SubLObject sentence_designation_argnum(SubLObject literal) {
    {
      ...
      if (($const69$ist == pred)) {
        ...
        return kb_mapping_utilities.fpred_value_in_any_mt(pred, $const104$sentenceDesignationArgnum, UNPROVIDED, UNPROVIDED, UNPROVIDED);
      }
    }
  }
  ...
  /** @return hlmt-p or nil; the designated microtheory in LITERAL.
   @param LITERAL an @xref mt-designating-literal? */
  @SubL(source = "cycl/el-utilities.lisp", position = 99670) 
 ...
 public static final SubLObject mt_designation_argnum(SubLObject literal) {
   {
     ...
     if (($const69$ist == pred)) {
       ...
       return kb_mapping_utilities.fpred_value_in_any_mt(pred, $const103$microtheoryDesignationArgnum, UNPROVIDED, UNPROVIDED, UNPROVIDED);
     }
   }
 }
  ...
  @SubL(source = "cycl/el-utilities.lisp", position = 121105) 
  public static final SubLObject occurs_as_sequence_variableP(SubLObject var, SubLObject sentence) {
  ...
  @SubL(source = "cycl/el-utilities.lisp", position = 123485) 
  public static final SubLObject sentence_sequence_variables(SubLObject formula, SubLObject varP) {
    if ((varP == UNPROVIDED)) {
      varP = $sym39$CYC_VAR_;
    }
    {
  ...
  @SubL(source = "cycl/el-utilities.lisp", position = 62286) 
  public static final SubLObject unmake_binary_formula(SubLObject formula) {
    return Values.values(cycl_utilities.formula_arg0(formula), cycl_utilities.formula_arg1(formula, UNPROVIDED), cycl_utilities.formula_arg2(formula, UNPROVIDED));
  }



  /** Returns the free variables in FORMULA that occur as term variables (the counterpart of sequence variables). */
  @SubL(source = "cycl/el-utilities.lisp", position = 118251) 
  public static final SubLObject sentence_free_term_variables(SubLObject formula, SubLObject bound_vars, SubLObject varP) {
    if ((bound_vars == UNPROVIDED)) {
      bound_vars = NIL;
    }
    if ((varP == UNPROVIDED)) {
