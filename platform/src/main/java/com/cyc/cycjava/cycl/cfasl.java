...
public final class cfasl extends SubLTranslatedFile {
	...
	public static final class $cfasl_encoding_stream_native extends
			SubLStructNative {
		...
		private static final SubLStructDeclNative structDecl = Structures
				.makeStructDeclNative($cfasl_encoding_stream_native.class,
						$sym0$CFASL_ENCODING_STREAM,
						$sym1$CFASL_ENCODING_STREAM_P, $list2, $list3,
						new String[] { "$internal_stream" }, $list4, $list5,
	...
	@SubL(source = "cycl/cfasl.lisp", position = 2449)
	public static final SubLObject cfasl_encoding_stream_print_function_trampoline(
	...
	public static final SubLObject cfasl_encoding_stream_p(SubLObject object) {
		return ((object.getClass() == $cfasl_encoding_stream_native.class) ? ((SubLObject) T)
				: NIL);
	}

	@SubL(source = "cycl/cfasl.lisp", position = 13555)
	public static final SubLObject cfasl_output_maybe_externalized(
			SubLObject object, SubLObject stream, SubLObject externalizedP) {
		if ((NIL != externalizedP)) {
			return cfasl_output_externalized(object, stream);
		} else {
			return cfasl_output(object, stream);
		}
	}

	public static final class $cfasl_encoding_stream_p$UnaryFunction extends
			UnaryFunction {
	...
	public static final class $cfasl_decoding_stream_native extends
			SubLStructNative {
		public SubLStructDecl getStructDecl() {
			return structDecl;
		}
		...
		public SubLObject $internal_stream = NIL;
		private static final SubLStructDeclNative structDecl = Structures
				.makeStructDeclNative($cfasl_decoding_stream_native.class,
						$sym28$CFASL_DECODING_STREAM,
						$sym29$CFASL_DECODING_STREAM_P, $list2, $list3,
						new String[] { "$internal_stream" }, $list30, $list31,
						$sym6$DEFAULT_STRUCT_PRINT_FUNCTION);
	}
	...
	@SubL(source = "cycl/cfasl.lisp", position = 6745)
	public static final SubLObject cfasl_decoding_stream_print_function_trampoline(
			SubLObject object, SubLObject stream) {
		compatibility.default_struct_print_function(object, stream,
				ZERO_INTEGER);
		return NIL;
	...
	public static final SubLObject cfasl_decoding_stream_p(SubLObject object) {
		return ((object.getClass() == $cfasl_decoding_stream_native.class) ? ((SubLObject) T)
				: NIL);
	}

	public static final class $cfasl_decoding_stream_p$UnaryFunction extends
			UnaryFunction {
	...
	public static final class $cfasl_count_stream_native extends
			SubLStructNative {
		public SubLStructDecl getStructDecl() {
			return structDecl;
		}
		...
		private static final SubLStructDeclNative structDecl = Structures
				.makeStructDeclNative($cfasl_count_stream_native.class,
						$sym43$CFASL_COUNT_STREAM, $sym44$CFASL_COUNT_STREAM_P,
						$list45, $list46, new String[] { "$position" },
						$list47, $list48, $sym6$DEFAULT_STRUCT_PRINT_FUNCTION);
	}
	...
	@SubL(source = "cycl/cfasl.lisp", position = 9427)
	public static final SubLObject cfasl_count_stream_print_function_trampoline(
			SubLObject object, SubLObject stream) {
		compatibility.default_struct_print_function(object, stream,
				ZERO_INTEGER);
		return NIL;
	...
	public static final SubLObject cfasl_count_stream_p(SubLObject object) {
		return ((object.getClass() == $cfasl_count_stream_native.class) ? ((SubLObject) T)
				: NIL);
	}

	public static final class $cfasl_count_stream_p$UnaryFunction extends
			UnaryFunction {
	...
	/**
	 * Output OBJECT to STREAM in the CFASL protocol. The encoding is relevant
	 * to this image only.
	 */
	...
	/**
	 * Output OBJECT to STREAM in the CFASL protocol. The encoding is relevant
	 * to any image, not just this one.
	 */
	...
	public static final SubLObject cfasl_output_object(SubLObject object,
			SubLObject stream) {
		{
			SubLObject method_function = Structures.method_func(object,
					$cfasl_output_object_method_table$.getGlobalValue());
			...
			if ((NIL == Errors
					.handleMissingMethodError("This call was replaced for LarKC purposes. Originally a method was called. Refer to number 31000"))) {
				{
					...
					try {
						{
							SubLObject _prev_bind_0 = Dynamic
									.currentBinding(Errors.$error_handler$);
							try {
								Dynamic.bind(Errors.$error_handler$,
										$sym59$CATCH_ERROR_MESSAGE_HANDLER);
								try {
									cfasl_output_defstruct_recipe(object,
											stream);
								} catch (Throwable catch_var) {
									Errors.handleThrowable(catch_var, NIL);
								}
							} finally {
								Dynamic.rebind(Errors.$error_handler$,
										_prev_bind_0);
							}
						}
					...
					if (msg.isString()) {
						Errors.handleMissingMethodError("This call was replaced for LarKC purposes. Originally a method was called. Refer to number 30984");
						return NIL;
					}
				}
			}
	...
	/**
	 * If non-nil, then structure created during CFASL input is allocated in the
	 * static area.
	 */
	...
	/**
	 * Input an object from STREAM in the CFASL protocol. EOF-ERROR-P indicates
	 * whether an end-of-file is considered an error. EOF-VALUE indicates a
	 * value to return when end-of-file is encountered and eof-error-p is nil.
	 */
	...
	/**
	 * Peek at STREAM to return the opcode for the next object to be read in
	 * CFASL protocol. EOF-ERROR-P indicates whether an end-of-file is
	 * considered an error. EOF-VALUE indicates a value to return when
	 * end-of-file is encountered and eof-error-p is nil.
	 */
			...
			SubLObject eof_error_p, SubLObject eof_value) {
		{
			...
			}
			{
				...
				if (($sym64$CFASL_INPUT_ERROR == cfasl_input_method)) {
					return Errors.error($str65$Undefined_cfasl_opcode__A_in__S,
							opcode, stream);
				} else {
	...
	public static final SubLObject cfasl_opcode_peek_internal(
	...
	public static final SubLObject cfasl_input_method(SubLObject cfasl_opcode) {
		return Vectors.aref($cfasl_input_method_table$.getGlobalValue(),
				cfasl_opcode);
	}

	@SubL(source = "cycl/cfasl.lisp", position = 17567)
	public static final SubLObject register_cfasl_input_function(
			SubLObject cfasl_opcode, SubLObject function) {
		Vectors.set_aref($cfasl_input_method_table$.getGlobalValue(),
				cfasl_opcode, function);
		return function;
	}
	...
	public static final SubLObject cfasl_output_externalization(
			SubLObject object, SubLObject stream) {
		{
			final SubLThread thread = SubLProcess.currentSubLThread();
			cfasl_raw_write_byte(
					$cfasl_opcode_externalization$.getGlobalValue(), stream);
			{
				SubLObject answer = NIL;
				{
					SubLObject _prev_bind_0 = $within_cfasl_externalization$
							.currentBinding(thread);
					try {
						$within_cfasl_externalization$.bind(T, thread);
						answer = cfasl_output(object, stream);
					} finally {
						$within_cfasl_externalization$.rebind(_prev_bind_0,
								thread);
					}
				}
				return answer;
	...
	/**
	 * This method expects to be called by CFASL-OUTPUT in the case where no
	 * implementation is available for a STRUCTURE-P.
	 */
	@SubL(source = "cycl/cfasl.lisp", position = 22969)
	public static final SubLObject cfasl_output_defstruct_recipe(
			SubLObject object, SubLObject stream) {
		{
			final SubLThread thread = SubLProcess.currentSubLThread();
			Errors.handleMissingMethodError("This call was replaced for LarKC purposes. Originally a method was called. Refer to number 30992");
			{
				SubLObject _prev_bind_0 = $current_cfasl_defstruct_output_stream$
						.currentBinding(thread);
				try {
					$current_cfasl_defstruct_output_stream$
							.bind(stream, thread);
					visitation
							.visit_defstruct(
									object,
									Symbols.symbol_function($sym89$CFASL_OUTPUT_DEFSTRUCT_RECIPE_VISITORFN));
				} finally {
					$current_cfasl_defstruct_output_stream$.rebind(
							_prev_bind_0, thread);
				}
			}
			return object;
	...
	public static final SubLObject cfasl_output_defstruct_recipe_visitorfn(
			SubLObject obj, SubLObject phase, SubLObject param_a,
			SubLObject param_b) {
		{
			final SubLThread thread = SubLProcess.currentSubLThread();
			{
				SubLObject stream = $current_cfasl_defstruct_output_stream$
	...
	/**
	 * @note this method is dispatched to by the CFASL-INPUT infrastructure after
	 *       the *CFASL-OPCODE-DEFSTRUCT-RECIPE* has been read.
	 * @return STRUCTURE-P
	 */
	@SubL(source = "cycl/cfasl.lisp", position = 24143)
	public static final SubLObject cfasl_input_defstruct_recipe(
			SubLObject stream) {
		{
			final SubLThread thread = SubLProcess.currentSubLThread();
			{
				SubLObject constructor_fn = cfasl_input(stream, UNPROVIDED,
						UNPROVIDED);
				SubLObject num_of_slots = cfasl_input(stream, UNPROVIDED,
						UNPROVIDED);
				SubLObject plist = NIL;
				SubLObject cursor = NIL;
				if ((NIL == Errors.$ignore_mustsP$.getDynamicValue(thread))) {
					if ((!(constructor_fn.isFunctionSpec()))) {
						Errors.error($str93$Error__expected_constructor_for_d,
								constructor_fn);
					}
				}
				plist = ConsesLow.make_list(
						Numbers.add(num_of_slots, num_of_slots), UNPROVIDED);
				cursor = plist;
				{
					SubLObject i = NIL;
					for (i = ZERO_INTEGER; i.numL(num_of_slots); i = Numbers
							.add(i, ONE_INTEGER)) {
						{
							SubLObject slot_name = cfasl_input(stream,
									UNPROVIDED, UNPROVIDED);
							SubLObject slot_value = cfasl_input(stream,
									UNPROVIDED, UNPROVIDED);
	...
	public static final SubLObject cfasl_immediate_fixnump(SubLObject object) {
		return makeBoolean((object.isFixnum() && object.numGE(ZERO_INTEGER) && object
				.numL($cfasl_immediate_fixnum_cutoff$.getGlobalValue())));
	}

	@SubL(source = "cycl/cfasl.lisp", position = 25990)
	public static final SubLObject cfasl_output_immediate_fixnum(
			SubLObject object, SubLObject stream) {
		cfasl_raw_write_byte(Numbers.add(
				$cfasl_immediate_fixnum_offset$.getGlobalValue(), object),
				stream);
		return object;
	}

	@SubL(source = "cycl/cfasl.lisp", position = 26144)
	public static final SubLObject cfasl_immediate_fixnum_opcode(
			SubLObject opcode) {
		return Numbers.numGE(opcode,
				$cfasl_immediate_fixnum_offset$.getGlobalValue());
	}

	@SubL(source = "cycl/cfasl.lisp", position = 26263)
	public static final SubLObject cfasl_extract_immediate_fixnum(
			SubLObject opcode) {
		return Numbers.subtract(opcode,
				$cfasl_immediate_fixnum_offset$.getGlobalValue());
	}
	...
	public static final SubLObject cfasl_output_object_integer_method(
			SubLObject object, SubLObject stream) {
	...
	public static final SubLObject cfasl_output_integer(SubLObject integer,
		...
		}
		{
			...
			SubLObject value = ((NIL != positive) ? ((SubLObject) integer)
					: Numbers.abs(integer));
			if (value.numL($int66$128)) {
				if ((NIL != positive)) {
					cfasl_raw_write_byte(
							$cfasl_opcode_p_8bit_int$.getGlobalValue(), stream);
				} else {
					cfasl_raw_write_byte(
							$cfasl_opcode_n_8bit_int$.getGlobalValue(), stream);
				}
				cfasl_output_integer_internal(value, ONE_INTEGER, stream);
			} else if (value.numL($int108$32768)) {
				if ((NIL != positive)) {
					cfasl_raw_write_byte(
							$cfasl_opcode_p_16bit_int$.getGlobalValue(), stream);
				} else {
					cfasl_raw_write_byte(
							$cfasl_opcode_n_16bit_int$.getGlobalValue(), stream);
				}
				cfasl_output_integer_internal(value, TWO_INTEGER, stream);
			} else if (value.numL($int109$8388608)) {
				if ((NIL != positive)) {
					cfasl_raw_write_byte(
							$cfasl_opcode_p_24bit_int$.getGlobalValue(), stream);
				} else {
					cfasl_raw_write_byte(
							$cfasl_opcode_n_24bit_int$.getGlobalValue(), stream);
				}
				cfasl_output_integer_internal(value, THREE_INTEGER, stream);
			} else if (value.numL($int110$2147483648)) {
				if ((NIL != positive)) {
					cfasl_raw_write_byte(
							$cfasl_opcode_p_32bit_int$.getGlobalValue(), stream);
				} else {
					cfasl_raw_write_byte(
							$cfasl_opcode_n_32bit_int$.getGlobalValue(), stream);
				}
				cfasl_output_integer_internal(value, FOUR_INTEGER, stream);
			} else {
				{
					SubLObject bignum_spec = Numbers
							.disassemble_integer_to_fixnums(integer);
					...
					current = current.rest();
					{
						...
						if (sign.isNegative()) {
							cfasl_raw_write_byte(
									$cfasl_opcode_n_bignum$.getGlobalValue(),
									stream);
						} else {
							cfasl_raw_write_byte(
									$cfasl_opcode_p_bignum$.getGlobalValue(),
									stream);
						}
						cfasl_output(Sequences.length(fixnums), stream);
						{
							...
							for (fixnum = cdolist_list_var.first(); (NIL != cdolist_list_var); cdolist_list_var = cdolist_list_var
									.rest(), fixnum = cdolist_list_var.first()) {
	...
	public static final SubLObject cfasl_output_integer_internal(
			SubLObject integer, SubLObject bytes, SubLObject stream) {
		if (bytes.numE(ONE_INTEGER)) {
			cfasl_raw_write_byte(integer, stream);
		} else {
			{
				SubLObject low_part = Numbers.mod(integer, $int58$256);
				SubLObject high_part = Numbers.integerDivide(
						Numbers.subtract(integer, low_part), $int58$256);
				cfasl_raw_write_byte(low_part, stream);
				cfasl_output_integer_internal(high_part,
						Numbers.subtract(bytes, ONE_INTEGER), stream);
			}
		}
		return integer;
	}
	...
	public static final class $cfasl_input_n_8bit_int$UnaryFunction extends
			UnaryFunction {
	...
	public static final class $cfasl_input_p_16bit_int$UnaryFunction extends
			UnaryFunction {
	...
	public static final class $cfasl_input_p_24bit_int$UnaryFunction extends
			UnaryFunction {
	...
	public static final class $cfasl_input_n_24bit_int$UnaryFunction extends
			UnaryFunction {
	...
	public static final class $cfasl_input_p_32bit_int$UnaryFunction extends
			UnaryFunction {
	...
	public static final SubLObject assemble_2_fixnums_to_non_negative_integer(
			SubLObject fixnum0, SubLObject fixnum1) {
		return Numbers.add(fixnum0, Numbers.ash(fixnum1, EIGHT_INTEGER));
	}

	@SubL(source = "cycl/cfasl.lisp", position = 30777)
	public static final SubLObject assemble_3_fixnums_to_non_negative_integer(
			SubLObject fixnum0, SubLObject fixnum1, SubLObject fixnum2) {
		return Numbers.add(
				assemble_2_fixnums_to_non_negative_integer(fixnum0, fixnum1),
				Numbers.ash(fixnum2, SIXTEEN_INTEGER));
	}

	@SubL(source = "cycl/cfasl.lisp", position = 31033)
	public static final SubLObject assemble_4_fixnums_to_non_negative_integer(
			SubLObject fixnum0, SubLObject fixnum1, SubLObject fixnum2,
			SubLObject fixnum3) {
		return Numbers.add(
				assemble_3_fixnums_to_non_negative_integer(fixnum0, fixnum1,
						fixnum2), Numbers.ash(fixnum3, $int105$24));
	}
	...
	public static final SubLObject cfasl_input_integer(SubLObject bytes,
			SubLObject stream) {
		if ((NIL == cfasl_decoding_stream_p(stream))) {
			return streams_high.read_byte_sequence_to_positive_integer(bytes,
					stream, UNPROVIDED, UNPROVIDED);
		}
		if (bytes.numG(FOUR_INTEGER)) {
			{
				SubLObject high_recursive = cfasl_input_integer(
						Numbers.subtract(bytes, FOUR_INTEGER), stream);
				SubLObject low_4 = cfasl_input_integer(FOUR_INTEGER, stream);
				return Numbers.add(Numbers.ash(high_recursive, $int112$32),
						low_4);
			}
		}
		{
			...
			if (pcase_var.eql(FOUR_INTEGER)) {
				{
					...
					return assemble_4_fixnums_to_non_negative_integer(fixnum0,
							fixnum1, fixnum2, fixnum3);
				}
			} else if (pcase_var.eql(THREE_INTEGER)) {
				{
					...
					SubLObject fixnum1 = cfasl_raw_read_byte(stream);
					SubLObject fixnum2 = cfasl_raw_read_byte(stream);
					return assemble_3_fixnums_to_non_negative_integer(fixnum0,
							fixnum1, fixnum2);
				}
			} else if (pcase_var.eql(TWO_INTEGER)) {
				{
					SubLObject fixnum0 = cfasl_raw_read_byte(stream);
					SubLObject fixnum1 = cfasl_raw_read_byte(stream);
					return assemble_2_fixnums_to_non_negative_integer(fixnum0,
							fixnum1);
				}
	...
	public static final class $cfasl_input_p_bignum$UnaryFunction extends
			UnaryFunction {
	...
	public static final SubLObject cfasl_output_object_float_method(
			SubLObject object, SubLObject stream) {
		return Errors
				.handleMissingMethodError("This call was replaced for LarKC purposes. Originally a method was called. Refer to number 30985");
	}

	public static final class $cfasl_input_p_float$UnaryFunction extends
			UnaryFunction {
	...
	public static final class $cfasl_input_n_float$UnaryFunction extends
			UnaryFunction {
	...
	public static final SubLObject cfasl_output_object_symbol_method(
			SubLObject object, SubLObject stream) {
		if ((NIL == object)) {
	...
	public static final SubLObject cfasl_input_keyword(SubLObject stream) {
		{
			...
			if (Characters.CHAR_colon.eql(Strings.sublisp_char(name,
					ZERO_INTEGER))) {
	...
	public static final class $cfasl_input_keyword$UnaryFunction extends
			UnaryFunction {
	...
	public static final SubLObject cfasl_output_other_symbol(SubLObject object,
			SubLObject stream) {
		cfasl_raw_write_byte($cfasl_opcode_other_symbol$.getGlobalValue(),
				stream);
	...
	public static final SubLObject cyc_package_symbol_p(SubLObject object) {
		return makeBoolean((object.isSymbol() && (!(object.isKeyword())) && ((control_vars.$cyc_package$
				.getGlobalValue() == Symbols.symbol_package(object)) || (object == Packages
				.find_symbol(Symbols.symbol_name(object),
	...
	public static final class $cfasl_input_other_symbol$UnaryFunction extends
			UnaryFunction {
	...
	public static final class $cfasl_input_nil$UnaryFunction extends
			UnaryFunction {
	...
	/**
	 * A list of commonly used symbols for which is it cost-effective to output
	 * in a terser representation.
	 */
	...
	public static final SubLObject cfasl_set_common_symbols(SubLObject symbols) {
		$cfasl_common_symbols$.setDynamicValue(Functions.apply(
				Symbols.symbol_function($sym123$VECTOR), symbols));
		return NIL;
	}

	/**
	 * Set the currently used list of common symbols for CFASL to be SYMBOLS,
	 * assuming that we're only doing a few cfasl functions and so will
	 * sacrifice time for space and not make a vector
	 */
	@SubL(source = "cycl/cfasl.lisp", position = 37530)
	public static final SubLObject cfasl_set_common_symbols_simple(
			SubLObject symbols) {
	...
	/**
	 * Get the currently active common symbol;s in a form that can be used in
	 * conjunction with CFASL-SET-COMMON-SYMBOLS.
	 * 
	...
	public static final SubLObject cfasl_current_common_symbols() {
		{
			...
			if ($cfasl_common_symbols$.getDynamicValue(thread).isVector()) {
				return vector_utilities.vector_elements(
						$cfasl_common_symbols$.getDynamicValue(thread),
						UNPROVIDED);
			} else {
	...
	public static final SubLObject cfasl_common_symbol_p(SubLObject object) {
		{
			final SubLThread thread = SubLProcess.currentSubLThread();
			return makeBoolean(((NIL != $cfasl_common_symbols$
					.getDynamicValue(thread)) && object.isSymbol() && (NIL != Sequences
					.position(object,
							$cfasl_common_symbols$.getDynamicValue(thread),
	...
	public static final SubLObject cfasl_decode_common_symbol(SubLObject integer) {
		{
			final SubLThread thread = SubLProcess.currentSubLThread();
			return ($cfasl_common_symbols$.getDynamicValue(thread).isVector() ? ((SubLObject) Vectors
					.aref($cfasl_common_symbols$.getDynamicValue(thread),
							integer)) : ConsesLow.nth(integer,
					$cfasl_common_symbols$.getDynamicValue(thread)));
		}
	}
	...
	public static final SubLObject cfasl_input_common_symbol(SubLObject stream) {
		{
			...
			if ((NIL == symbol)) {
				Errors.cerror($str128$Use_NIL_,
						$str129$Common_symbol_at_index__D_was_not, encoding,
	...
	public static final class $cfasl_input_common_symbol$UnaryFunction extends
			UnaryFunction {
	...
	public static final SubLObject cfasl_output_object_cons_method(
			SubLObject object, SubLObject stream) {
	...
	public static final SubLObject cfasl_output_list(SubLObject list,
			SubLObject stream) {
		{
			...
			if ((NIL == length)) {
				Errors.cerror($str134$Output_NIL_instead,
						$str135$Trying_to_output_a_circular_list_);
				return cfasl_output_nil(stream);
			} else if (length.numE(ZERO_INTEGER)) {
				return cfasl_output_nil(stream);
			} else if (((NIL != $cfasl_list_methods$.getGlobalValue()) && (NIL != Errors
					.handleMissingMethodError("This call was replaced for LarKC purposes. Originally a method was called. Refer to number 31001")))) {
			} else {
				cfasl_raw_write_byte($cfasl_opcode_list$.getGlobalValue(),
						stream);
				cfasl_output_integer(length, stream);
				{
					SubLObject cdolist_list_var = list;
					SubLObject item = NIL;
					for (item = cdolist_list_var.first(); (NIL != cdolist_list_var); cdolist_list_var = cdolist_list_var
	...
	public static final class $cfasl_input_list$UnaryFunction extends
			UnaryFunction {
	...
	public static final SubLObject cfasl_output_dotted_list(SubLObject object,
			SubLObject stream) {
		{
			...
			cfasl_raw_write_byte($cfasl_opcode_dotted_list$.getGlobalValue(),
					stream);
			cfasl_output_integer(length, stream);
			{
				SubLObject i = NIL;
				SubLObject cons = NIL;
				for (i = ZERO_INTEGER, cons = object; (!(i.numE(length))); i = Numbers
						.add(i, ONE_INTEGER), cons = cons.rest()) {
	...
	public static final class $cfasl_input_dotted_list$UnaryFunction extends
			UnaryFunction {
	...
	public static final SubLObject cfasl_output_object_vector_method(
			SubLObject object, SubLObject stream) {
		if ((NIL != Errors
	...
	public static final class $cfasl_input_general_vector$UnaryFunction extends
			UnaryFunction {
	...
	public static final SubLObject cfasl_output_object_string_method(
			SubLObject object, SubLObject stream) {
	...
	public static final SubLObject cfasl_output_string(SubLObject string,
		...
		cfasl_raw_write_byte($cfasl_opcode_string$.getGlobalValue(), stream);
		{
			...
			{
				SubLObject i = NIL;
				for (i = ZERO_INTEGER; i.numL(length); i = Numbers.add(i,
						ONE_INTEGER)) {
					cfasl_raw_write_byte(Characters.char_code(Strings
							.sublisp_char(string, i)), stream);
				}
			}
		}
		return string;
	...
	/**
	 * If non-nil, a string that is destructively re-used when loading a string
	 * of the same length.
	 */
	...
	public static final SubLObject cfasl_input_string(SubLObject stream) {
		{
			final SubLThread thread = SubLProcess.currentSubLThread();
			{
				...
				if (($cfasl_input_string_resource$.getDynamicValue(thread)
						.isString() && length.numE(Sequences
						.length($cfasl_input_string_resource$
								.getDynamicValue(thread))))) {
					string = $cfasl_input_string_resource$
							.getDynamicValue(thread);
				} else {
					string = Strings.make_string(length, UNPROVIDED);
				}
				if ((NIL == cfasl_decoding_stream_p(stream))) {
					return streams_high.read_byte_sequence_into_string(string,
							stream, UNPROVIDED, UNPROVIDED);
				}
				{
					SubLObject i = NIL;
					for (i = ZERO_INTEGER; i.numL(length); i = Numbers.add(i,
							ONE_INTEGER)) {
						Strings.set_char(string, i, Characters
								.code_char(cfasl_raw_read_byte(stream)));
					}
				}
				return string;
			}
	...
	public static final class $cfasl_input_string$UnaryFunction extends
			UnaryFunction {
	...
	public static final SubLObject cfasl_output_object_character_method(
			SubLObject object, SubLObject stream) {
		return Errors
				.handleMissingMethodError("This call was replaced for LarKC purposes. Originally a method was called. Refer to number 30982");
	}

	public static final class $cfasl_input_character$UnaryFunction extends
			UnaryFunction {
	...
	public static final SubLObject cfasl_input_hashtable(SubLObject stream) {
		{
			...
			if ((pcase_var.eql(EQ) || pcase_var.eql(EQL)
					|| pcase_var.eql(EQUAL) || pcase_var.eql(EQUALP))) {
				test = Symbols.symbol_function(test);
			}
			hashtable = Hashtables.make_hash_table(size, test, UNPROVIDED);
			{
				SubLObject i = NIL;
				for (i = ZERO_INTEGER; i.numL(size); i = Numbers.add(i,
						ONE_INTEGER)) {
					{
	...
	public static final SubLObject cfasl_output_object_guid_method(
			SubLObject object, SubLObject stream) {
	...
	public static final SubLObject cfasl_output_guid(SubLObject guid,
		...
		{
			final SubLThread thread = SubLProcess.currentSubLThread();
			if ((NIL == $terse_guid_serialization_enabledP$
					.getDynamicValue(thread))) {
				return cfasl_output_legacy_guid(guid, stream);
			}
			cfasl_raw_write_byte($cfasl_opcode_guid$.getGlobalValue(), stream);
			{
				SubLObject byte_vector = Guids.disassemble_guid_to_fixnums(
						guid, UNPROVIDED);
				SubLObject i = NIL;
				for (i = ZERO_INTEGER; i.numL(SIXTEEN_INTEGER); i = Numbers
						.add(i, ONE_INTEGER)) {
	...
	public static final class $cfasl_input_guid$UnaryFunction extends
			UnaryFunction {
	...
	public static final SubLObject cfasl_output_legacy_guid(SubLObject guid,
			SubLObject stream) {
		cfasl_raw_write_byte($cfasl_opcode_legacy_guid$.getGlobalValue(),
				stream);
		{
	...
	public static final SubLObject cfasl_input_guid_string(SubLObject stream) {
		{
			final SubLThread thread = SubLProcess.currentSubLThread();
			{
				SubLObject string = NIL;
				{
					SubLObject _prev_bind_0 = $cfasl_input_string_resource$
							.currentBinding(thread);
					try {
						$cfasl_input_string_resource$.bind(
								$cfasl_input_guid_string_resource$
										.getDynamicValue(thread), thread);
						string = cfasl_input(stream, UNPROVIDED, UNPROVIDED);
					} finally {
						$cfasl_input_string_resource$.rebind(_prev_bind_0,
								thread);
					}
				}
				return string;
	...
	/**
	 * Allocates a new GUID string resource and makes it available to the GUID
	 * loading infrastructure.
	 */
	@SubL(source = "cycl/cfasl.lisp", position = 49962)
	public static final SubLObject with_new_cfasl_input_guid_string_resource(
	...
	public static final SubLObject cfasl_output_object_package_method(
			SubLObject object, SubLObject stream) {
		return Errors
	...
	/**
	 * All wide opcodes have to be more than one byte, so that all narrow
	 * opcodes can be re-encoded as wide opcodes without loss of functionality.
	 */
	...
	public static final SubLObject register_wide_cfasl_opcode_input_function(
			SubLObject wide_opcode, SubLObject function) {
		Hashtables.sethash(wide_opcode,
				$cfasl_wide_opcode_input_method_table$.getGlobalValue(),
				function);
		return function;
	}
	...
	public static final SubLObject register_cfasl_guid_denoted_type_input_function(
			SubLObject cfasl_guid_opcode, SubLObject function) {
		Hashtables.sethash(cfasl_guid_opcode,
				$cfasl_guid_denoted_type_input_method_table$.getGlobalValue(),
				function);
		return function;
	}

	public static final SubLObject declare_cfasl_file() {
		declareFunction(myName, "cfasl_encoding_p", "CFASL-ENCODING-P", 1, 0,
				false);
		declareFunction(myName, "cfasl_encodable_stream_p",
				"CFASL-ENCODABLE-STREAM-P", 1, 0, false);
		declareFunction(myName,
				"cfasl_encoding_stream_print_function_trampoline",
				"CFASL-ENCODING-STREAM-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
		declareFunction(myName, "cfasl_encoding_stream_p",
				"CFASL-ENCODING-STREAM-P", 1, 0, false);
		new $cfasl_encoding_stream_p$UnaryFunction();
		declareFunction(myName, "cfasl_encoding_stream_internal_stream",
				"CFASL-ENCODING-STREAM-INTERNAL-STREAM", 1, 0, false);
		declareFunction(myName, "_csetf_cfasl_encoding_stream_internal_stream",
				"_CSETF-CFASL-ENCODING-STREAM-INTERNAL-STREAM", 2, 0, false);
		declareFunction(myName, "make_cfasl_encoding_stream",
				"MAKE-CFASL-ENCODING-STREAM", 0, 1, false);
		declareMacro(myName, "with_cfasl_output_to_hex_string",
				"WITH-CFASL-OUTPUT-TO-HEX-STRING");
		declareFunction(myName, "cfasl_encoding_string_stream_encoding",
				"CFASL-ENCODING-STRING-STREAM-ENCODING", 1, 0, false);
		declareMacro(myName, "with_cfasl_output_to_byte_vector",
				"WITH-CFASL-OUTPUT-TO-BYTE-VECTOR");
		declareFunction(myName, "new_cfasl_encoding_stream",
				"NEW-CFASL-ENCODING-STREAM", 0, 0, false);
		declareFunction(myName, "cfasl_encoding_stream_write_byte",
				"CFASL-ENCODING-STREAM-WRITE-BYTE", 2, 0, false);
		declareFunction(myName, "cfasl_encoding_stream_encoding",
				"CFASL-ENCODING-STREAM-ENCODING", 1, 0, false);
		declareFunction(myName, "close_cfasl_encoding_stream",
				"CLOSE-CFASL-ENCODING-STREAM", 1, 0, false);
		declareFunction(myName, "cfasl_encode", "CFASL-ENCODE", 1, 0, false);
		declareFunction(myName, "cfasl_encode_externalized",
				"CFASL-ENCODE-EXTERNALIZED", 1, 0, false);
		declareFunction(myName, "cfasl_encode_externalized_terse",
				"CFASL-ENCODE-EXTERNALIZED-TERSE", 1, 0, false);
		declareFunction(myName, "cfasl_decodable_stream_p",
				"CFASL-DECODABLE-STREAM-P", 1, 0, false);
		declareFunction(myName,
				"cfasl_decoding_stream_print_function_trampoline",
				"CFASL-DECODING-STREAM-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
		declareFunction(myName, "cfasl_decoding_stream_p",
				"CFASL-DECODING-STREAM-P", 1, 0, false);
		new $cfasl_decoding_stream_p$UnaryFunction();
		declareFunction(myName, "cfasl_decoding_stream_internal_stream",
				"CFASL-DECODING-STREAM-INTERNAL-STREAM", 1, 0, false);
		declareFunction(myName, "_csetf_cfasl_decoding_stream_internal_stream",
				"_CSETF-CFASL-DECODING-STREAM-INTERNAL-STREAM", 2, 0, false);
		declareFunction(myName, "make_cfasl_decoding_stream",
				"MAKE-CFASL-DECODING-STREAM", 0, 1, false);
		declareMacro(myName, "with_cfasl_input_from_string",
				"WITH-CFASL-INPUT-FROM-STRING");
		declareFunction(myName, "new_cfasl_decoding_stream_from_string",
				"NEW-CFASL-DECODING-STREAM-FROM-STRING", 1, 0, false);
		declareMacro(myName, "with_cfasl_input_from_byte_vector",
				"WITH-CFASL-INPUT-FROM-BYTE-VECTOR");
		declareFunction(myName, "new_cfasl_decoding_stream",
				"NEW-CFASL-DECODING-STREAM", 1, 0, false);
		declareFunction(myName, "cfasl_decoding_stream_read_byte",
				"CFASL-DECODING-STREAM-READ-BYTE", 1, 2, false);
		declareFunction(myName, "close_cfasl_decoding_stream",
				"CLOSE-CFASL-DECODING-STREAM", 1, 0, false);
		declareFunction(myName, "cfasl_decode", "CFASL-DECODE", 1, 0, false);
		declareFunction(myName, "cfasl_count_stream_print_function_trampoline",
				"CFASL-COUNT-STREAM-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
		declareFunction(myName, "cfasl_count_stream_p", "CFASL-COUNT-STREAM-P",
				1, 0, false);
		new $cfasl_count_stream_p$UnaryFunction();
		declareFunction(myName, "cfasl_count_stream_position",
				"CFASL-COUNT-STREAM-POSITION", 1, 0, false);
		declareFunction(myName, "_csetf_cfasl_count_stream_position",
				"_CSETF-CFASL-COUNT-STREAM-POSITION", 2, 0, false);
		declareFunction(myName, "make_cfasl_count_stream",
				"MAKE-CFASL-COUNT-STREAM", 0, 1, false);
		declareMacro(myName, "with_cfasl_output_to_count_stream",
				"WITH-CFASL-OUTPUT-TO-COUNT-STREAM");
		declareFunction(myName, "new_cfasl_count_stream",
				"NEW-CFASL-COUNT-STREAM", 0, 0, false);
		declareFunction(myName, "cfasl_count_stream_write_byte",
				"CFASL-COUNT-STREAM-WRITE-BYTE", 2, 0, false);
		declareFunction(myName, "cfasl_count_stream_size",
				"CFASL-COUNT-STREAM-SIZE", 1, 0, false);
		declareFunction(myName, "close_cfasl_count_stream",
				"CLOSE-CFASL-COUNT-STREAM", 1, 0, false);
		declareFunction(myName, "cfasl_object_size", "CFASL-OBJECT-SIZE", 1, 0,
				false);
		declareFunction(myName, "cfasl_externalized_object_size",
				"CFASL-EXTERNALIZED-OBJECT-SIZE", 1, 0, false);
		declareMacro(myName, "with_cfasl_stream_extensions",
				"WITH-CFASL-STREAM-EXTENSIONS");
		declareFunction(myName, "cfasl_output", "CFASL-OUTPUT", 2, 0, false);
		declareFunction(myName, "cfasl_output_externalized",
				"CFASL-OUTPUT-EXTERNALIZED", 2, 0, false);
		declareFunction(myName, "cfasl_output_maybe_externalized",
				"CFASL-OUTPUT-MAYBE-EXTERNALIZED", 3, 0, false);
		declareFunction(myName, "cfasl_output_object", "CFASL-OUTPUT-OBJECT",
				2, 0, false);
		declareFunction(myName, "cfasl_output_error", "CFASL-OUTPUT-ERROR", 2,
				0, false);
		declareFunction(myName, "cfasl_raw_write_byte", "CFASL-RAW-WRITE-BYTE",
				2, 0, false);
		declareFunction(myName, "cfasl_input", "CFASL-INPUT", 1, 2, false);
		declareFunction(myName, "cfasl_opcode_peek", "CFASL-OPCODE-PEEK", 1, 2,
				false);
		declareFunction(myName, "cfasl_input_object", "CFASL-INPUT-OBJECT", 1,
				0, false);
		declareFunction(myName, "cfasl_input_error", "CFASL-INPUT-ERROR", 1, 0,
				false);
		declareFunction(myName, "cfasl_input_internal", "CFASL-INPUT-INTERNAL",
				3, 0, false);
		declareFunction(myName, "cfasl_opcode_peek_internal",
				"CFASL-OPCODE-PEEK-INTERNAL", 3, 0, false);
		declareFunction(myName, "cfasl_input_method", "CFASL-INPUT-METHOD", 1,
				0, false);
		declareMacro(myName, "declare_cfasl_opcode", "DECLARE-CFASL-OPCODE");
		declareFunction(myName, "register_cfasl_input_function",
				"REGISTER-CFASL-INPUT-FUNCTION", 2, 0, false);
		declareFunction(myName, "cfasl_raw_peek_byte", "CFASL-RAW-PEEK-BYTE",
				1, 0, false);
		declareFunction(myName, "cfasl_raw_read_byte", "CFASL-RAW-READ-BYTE",
				1, 0, false);
		declareMacro(myName, "with_cfasl_area_allocation",
				"WITH-CFASL-AREA-ALLOCATION");
		declareMacro(myName, "within_cfasl_externalization",
				"WITHIN-CFASL-EXTERNALIZATION");
		declareMacro(myName, "without_cfasl_externalization",
				"WITHOUT-CFASL-EXTERNALIZATION");
		declareFunction(myName, "within_cfasl_externalization_p",
				"WITHIN-CFASL-EXTERNALIZATION-P", 0, 0, false);
		declareMacro(myName, "without_cfasl_channel_externalization",
				"WITHOUT-CFASL-CHANNEL-EXTERNALIZATION");
		declareFunction(myName, "cfasl_channel_externalizedP",
				"CFASL-CHANNEL-EXTERNALIZED?", 0, 0, false);
		declareMacro(myName, "declare_cfasl_extension_opcode",
				"DECLARE-CFASL-EXTENSION-OPCODE");
		declareFunction(myName, "register_cfasl_extension",
				"REGISTER-CFASL-EXTENSION", 4, 0, false);
		declareFunction(myName, "handle_cfasl_extensions",
				"HANDLE-CFASL-EXTENSIONS", 2, 0, false);
		declareFunction(myName, "cfasl_output_narrow_opcode",
				"CFASL-OUTPUT-NARROW-OPCODE", 2, 0, false);
		declareFunction(myName, "cfasl_output_opcode", "CFASL-OUTPUT-OPCODE",
				2, 0, false);
		declareFunction(myName, "cfasl_output_externalization",
				"CFASL-OUTPUT-EXTERNALIZATION", 2, 0, false);
		declareFunction(myName, "cfasl_input_externalization",
				"CFASL-INPUT-EXTERNALIZATION", 1, 0, false);
		declareFunction(myName, "cfasl_output_defstruct_recipe",
				"CFASL-OUTPUT-DEFSTRUCT-RECIPE", 2, 0, false);
		declareFunction(myName, "cfasl_output_defstruct_recipe_visitorfn",
				"CFASL-OUTPUT-DEFSTRUCT-RECIPE-VISITORFN", 4, 0, false);
		declareFunction(myName, "cfasl_input_defstruct_recipe",
				"CFASL-INPUT-DEFSTRUCT-RECIPE", 1, 0, false);
		declareFunction(myName, "cfasl_immediate_fixnump",
				"CFASL-IMMEDIATE-FIXNUMP", 1, 0, false);
		declareFunction(myName, "cfasl_output_immediate_fixnum",
				"CFASL-OUTPUT-IMMEDIATE-FIXNUM", 2, 0, false);
		declareFunction(myName, "cfasl_immediate_fixnum_opcode",
				"CFASL-IMMEDIATE-FIXNUM-OPCODE", 1, 0, false);
		declareFunction(myName, "cfasl_extract_immediate_fixnum",
				"CFASL-EXTRACT-IMMEDIATE-FIXNUM", 1, 0, false);
		declareFunction(myName, "cfasl_output_object_integer_method",
				"CFASL-OUTPUT-OBJECT-INTEGER-METHOD", 2, 0, false);
		declareFunction(myName, "cfasl_output_integer", "CFASL-OUTPUT-INTEGER",
				2, 0, false);
		declareFunction(myName, "cfasl_output_integer_internal",
				"CFASL-OUTPUT-INTEGER-INTERNAL", 3, 0, false);
		declareFunction(myName, "cfasl_input_p_8bit_int",
				"CFASL-INPUT-P-8BIT-INT", 1, 0, false);
		declareFunction(myName, "cfasl_input_n_8bit_int",
				"CFASL-INPUT-N-8BIT-INT", 1, 0, false);
		new $cfasl_input_n_8bit_int$UnaryFunction();
		declareFunction(myName, "cfasl_input_p_16bit_int",
				"CFASL-INPUT-P-16BIT-INT", 1, 0, false);
		new $cfasl_input_p_16bit_int$UnaryFunction();
		declareFunction(myName, "cfasl_input_n_16bit_int",
				"CFASL-INPUT-N-16BIT-INT", 1, 0, false);
		declareFunction(myName, "cfasl_input_p_24bit_int",
				"CFASL-INPUT-P-24BIT-INT", 1, 0, false);
		new $cfasl_input_p_24bit_int$UnaryFunction();
		declareFunction(myName, "cfasl_input_n_24bit_int",
				"CFASL-INPUT-N-24BIT-INT", 1, 0, false);
		new $cfasl_input_n_24bit_int$UnaryFunction();
		declareFunction(myName, "cfasl_input_p_32bit_int",
				"CFASL-INPUT-P-32BIT-INT", 1, 0, false);
		new $cfasl_input_p_32bit_int$UnaryFunction();
		declareFunction(myName, "cfasl_input_n_32bit_int",
				"CFASL-INPUT-N-32BIT-INT", 1, 0, false);
		declareFunction(myName, "assemble_2_fixnums_to_non_negative_integer",
				"ASSEMBLE-2-FIXNUMS-TO-NON-NEGATIVE-INTEGER", 2, 0, false);
		declareFunction(myName, "assemble_3_fixnums_to_non_negative_integer",
				"ASSEMBLE-3-FIXNUMS-TO-NON-NEGATIVE-INTEGER", 3, 0, false);
		declareFunction(myName, "assemble_4_fixnums_to_non_negative_integer",
				"ASSEMBLE-4-FIXNUMS-TO-NON-NEGATIVE-INTEGER", 4, 0, false);
		declareFunction(myName, "cfasl_input_integer", "CFASL-INPUT-INTEGER",
				2, 0, false);
		declareFunction(myName, "cfasl_input_p_bignum", "CFASL-INPUT-P-BIGNUM",
				1, 0, false);
		new $cfasl_input_p_bignum$UnaryFunction();
		declareFunction(myName, "cfasl_input_n_bignum", "CFASL-INPUT-N-BIGNUM",
				1, 0, false);
		declareFunction(myName, "cfasl_input_bignum", "CFASL-INPUT-BIGNUM", 2,
				0, false);
		declareFunction(myName, "cfasl_output_object_float_method",
				"CFASL-OUTPUT-OBJECT-FLOAT-METHOD", 2, 0, false);
		declareFunction(myName, "cfasl_output_float", "CFASL-OUTPUT-FLOAT", 2,
				0, false);
		declareFunction(myName, "cfasl_input_p_float", "CFASL-INPUT-P-FLOAT",
				1, 0, false);
		new $cfasl_input_p_float$UnaryFunction();
		declareFunction(myName, "cfasl_input_n_float", "CFASL-INPUT-N-FLOAT",
				1, 0, false);
		new $cfasl_input_n_float$UnaryFunction();
		declareFunction(myName, "cfasl_input_float", "CFASL-INPUT-FLOAT", 1, 0,
				false);
		declareFunction(myName, "cfasl_output_object_symbol_method",
				"CFASL-OUTPUT-OBJECT-SYMBOL-METHOD", 2, 0, false);
		declareFunction(myName, "cfasl_output_keyword", "CFASL-OUTPUT-KEYWORD",
				2, 0, false);
		declareFunction(myName, "cfasl_input_keyword", "CFASL-INPUT-KEYWORD",
				1, 0, false);
		new $cfasl_input_keyword$UnaryFunction();
		declareFunction(myName, "cfasl_output_other_symbol",
				"CFASL-OUTPUT-OTHER-SYMBOL", 2, 0, false);
		declareFunction(myName, "cyc_package_symbol_p", "CYC-PACKAGE-SYMBOL-P",
				1, 0, false);
		declareFunction(myName, "cfasl_input_other_symbol",
				"CFASL-INPUT-OTHER-SYMBOL", 1, 0, false);
		new $cfasl_input_other_symbol$UnaryFunction();
		declareFunction(myName, "cfasl_output_nil", "CFASL-OUTPUT-NIL", 1, 0,
				false);
		declareFunction(myName, "cfasl_input_nil", "CFASL-INPUT-NIL", 1, 0,
				false);
		new $cfasl_input_nil$UnaryFunction();
		declareFunction(myName, "cfasl_set_common_symbols",
				"CFASL-SET-COMMON-SYMBOLS", 1, 0, false);
		declareMacro(myName, "with_cfasl_common_symbols",
				"WITH-CFASL-COMMON-SYMBOLS");
		declareFunction(myName, "cfasl_set_common_symbols_simple",
				"CFASL-SET-COMMON-SYMBOLS-SIMPLE", 1, 0, false);
		declareMacro(myName, "with_cfasl_common_symbols_simple",
				"WITH-CFASL-COMMON-SYMBOLS-SIMPLE");
		declareFunction(myName, "cfasl_current_common_symbols",
				"CFASL-CURRENT-COMMON-SYMBOLS", 0, 0, false);
		declareFunction(myName, "cfasl_common_symbol_p",
				"CFASL-COMMON-SYMBOL-P", 1, 0, false);
		declareFunction(myName, "cfasl_encode_common_symbol",
				"CFASL-ENCODE-COMMON-SYMBOL", 1, 0, false);
		declareFunction(myName, "cfasl_decode_common_symbol",
				"CFASL-DECODE-COMMON-SYMBOL", 1, 0, false);
		declareFunction(myName, "cfasl_output_common_symbol",
				"CFASL-OUTPUT-COMMON-SYMBOL", 2, 0, false);
		declareFunction(myName, "cfasl_input_common_symbol",
				"CFASL-INPUT-COMMON-SYMBOL", 1, 0, false);
		new $cfasl_input_common_symbol$UnaryFunction();
		declareFunction(myName, "cfasl_output_object_cons_method",
				"CFASL-OUTPUT-OBJECT-CONS-METHOD", 2, 0, false);
		declareFunction(myName, "register_cfasl_list_method",
				"REGISTER-CFASL-LIST-METHOD", 3, 0, false);
		declareFunction(myName, "handle_cfasl_list_methods",
				"HANDLE-CFASL-LIST-METHODS", 2, 0, false);
		declareFunction(myName, "cfasl_output_list", "CFASL-OUTPUT-LIST", 2, 0,
				false);
		declareFunction(myName, "cfasl_input_list", "CFASL-INPUT-LIST", 1, 0,
				false);
		new $cfasl_input_list$UnaryFunction();
		declareFunction(myName, "cfasl_output_dotted_list",
				"CFASL-OUTPUT-DOTTED-LIST", 2, 0, false);
		declareFunction(myName, "cfasl_input_dotted_list",
				"CFASL-INPUT-DOTTED-LIST", 1, 0, false);
		new $cfasl_input_dotted_list$UnaryFunction();
		declareFunction(myName, "cfasl_output_object_vector_method",
				"CFASL-OUTPUT-OBJECT-VECTOR-METHOD", 2, 0, false);
		declareFunction(myName, "cfasl_output_general_vector",
				"CFASL-OUTPUT-GENERAL-VECTOR", 2, 0, false);
		declareFunction(myName, "cfasl_input_general_vector",
				"CFASL-INPUT-GENERAL-VECTOR", 1, 0, false);
		new $cfasl_input_general_vector$UnaryFunction();
		declareFunction(myName, "cfasl_output_byte_vector",
				"CFASL-OUTPUT-BYTE-VECTOR", 2, 0, false);
		declareFunction(myName, "cfasl_input_byte_vector",
				"CFASL-INPUT-BYTE-VECTOR", 1, 0, false);
		declareFunction(myName, "cfasl_output_object_string_method",
				"CFASL-OUTPUT-OBJECT-STRING-METHOD", 2, 0, false);
		declareFunction(myName, "cfasl_output_string", "CFASL-OUTPUT-STRING",
				2, 0, false);
		declareFunction(myName, "cfasl_input_string", "CFASL-INPUT-STRING", 1,
				0, false);
		new $cfasl_input_string$UnaryFunction();
		declareFunction(myName, "cfasl_output_object_character_method",
				"CFASL-OUTPUT-OBJECT-CHARACTER-METHOD", 2, 0, false);
		declareFunction(myName, "cfasl_output_character",
				"CFASL-OUTPUT-CHARACTER", 2, 0, false);
		declareFunction(myName, "cfasl_input_character",
				"CFASL-INPUT-CHARACTER", 1, 0, false);
		new $cfasl_input_character$UnaryFunction();
		declareFunction(myName, "cfasl_output_object_hash_table_method",
				"CFASL-OUTPUT-OBJECT-HASH-TABLE-METHOD", 2, 0, false);
		declareFunction(myName, "cfasl_output_hashtable",
				"CFASL-OUTPUT-HASHTABLE", 2, 0, false);
		declareFunction(myName, "cfasl_input_hashtable",
				"CFASL-INPUT-HASHTABLE", 1, 0, false);
		declareFunction(myName, "cfasl_output_object_guid_method",
				"CFASL-OUTPUT-OBJECT-GUID-METHOD", 2, 0, false);
		declareFunction(myName, "cfasl_output_guid", "CFASL-OUTPUT-GUID", 2, 0,
				false);
		declareFunction(myName, "cfasl_input_guid", "CFASL-INPUT-GUID", 1, 0,
				false);
		new $cfasl_input_guid$UnaryFunction();
		declareFunction(myName, "cfasl_input_guid_byte_vector",
				"CFASL-INPUT-GUID-BYTE-VECTOR", 1, 0, false);
		declareFunction(myName, "cfasl_output_legacy_guid",
				"CFASL-OUTPUT-LEGACY-GUID", 2, 0, false);
		declareFunction(myName, "cfasl_input_legacy_guid",
				"CFASL-INPUT-LEGACY-GUID", 1, 0, false);
		declareFunction(myName, "cfasl_input_guid_string",
				"CFASL-INPUT-GUID-STRING", 1, 0, false);
		declareFunction(myName, "get_new_cfasl_input_guid_string_resource",
				"GET-NEW-CFASL-INPUT-GUID-STRING-RESOURCE", 0, 0, false);
		declareMacro(myName, "with_new_cfasl_input_guid_string_resource",
				"WITH-NEW-CFASL-INPUT-GUID-STRING-RESOURCE");
		declareFunction(myName, "cfasl_input_result_set",
				"CFASL-INPUT-RESULT-SET", 1, 0, false);
		declareFunction(myName, "cfasl_output_object_package_method",
				"CFASL-OUTPUT-OBJECT-PACKAGE-METHOD", 2, 0, false);
		declareFunction(myName, "cfasl_output_package", "CFASL-OUTPUT-PACKAGE",
				2, 0, false);
		declareFunction(myName, "cfasl_input_package", "CFASL-INPUT-PACKAGE",
				1, 0, false);
		declareFunction(myName, "cfasl_narrow_opcode_p",
				"CFASL-NARROW-OPCODE-P", 1, 0, false);
		declareFunction(myName, "cfasl_wide_opcode_input_method",
				"CFASL-WIDE-OPCODE-INPUT-METHOD", 1, 0, false);
		declareFunction(myName, "cfasl_input_wide_opcode_encoded",
				"CFASL-INPUT-WIDE-OPCODE-ENCODED", 1, 0, false);
		declareMacro(myName, "declare_wide_cfasl_opcode",
				"DECLARE-WIDE-CFASL-OPCODE");
		declareFunction(myName, "register_wide_cfasl_opcode_input_function",
				"REGISTER-WIDE-CFASL-OPCODE-INPUT-FUNCTION", 2, 0, false);
		declareFunction(myName, "cfasl_output_wide_opcode",
				"CFASL-OUTPUT-WIDE-OPCODE", 2, 0, false);
		declareFunction(myName, "cfasl_input_instance", "CFASL-INPUT-INSTANCE",
				1, 0, false);
		declareMacro(myName, "declare_cfasl_guid_opcode",
				"DECLARE-CFASL-GUID-OPCODE");
		declareMacro(myName, "declare_cfasl_guid_string_opcode",
				"DECLARE-CFASL-GUID-STRING-OPCODE");
		declareFunction(myName,
				"register_cfasl_guid_denoted_type_input_function",
				"REGISTER-CFASL-GUID-DENOTED-TYPE-INPUT-FUNCTION", 2, 0, false);
		declareFunction(myName, "write_cfasl_guid_denoted_type_opcode",
				"WRITE-CFASL-GUID-DENOTED-TYPE-OPCODE", 2, 0, false);
		declareFunction(myName, "cfasl_guid_denoted_type_input_method",
				"CFASL-GUID-DENOTED-TYPE-INPUT-METHOD", 1, 0, false);
		declareFunction(myName, "cfasl_input_guid_denoted_type",
				"CFASL-INPUT-GUID-DENOTED-TYPE", 1, 0, false);
		declareMacro(myName, "with_guid_denoted_type_cfasl_encoding",
				"WITH-GUID-DENOTED-TYPE-CFASL-ENCODING");
		declareFunction(myName, "cfasl_test", "CFASL-TEST", 1, 0, false);
		declareFunction(myName, "show_cfasl_file", "SHOW-CFASL-FILE", 1, 1,
				false);
		return NIL;
	}

	public static final SubLObject init_cfasl_file() {
		$dtp_cfasl_encoding_stream$ = defconstant(
				"*DTP-CFASL-ENCODING-STREAM*", $sym0$CFASL_ENCODING_STREAM);
		$terse_guid_serialization_enabledP$ = defparameter(
				"*TERSE-GUID-SERIALIZATION-ENABLED?*", NIL);
		$terse_guid_serialization_enabled_for_cfasl_encode_externalizedP$ = defparameter(
				"*TERSE-GUID-SERIALIZATION-ENABLED-FOR-CFASL-ENCODE-EXTERNALIZED?*",
				$kw27$UNINITIALIZED);
		$dtp_cfasl_decoding_stream$ = defconstant(
				"*DTP-CFASL-DECODING-STREAM*", $sym28$CFASL_DECODING_STREAM);
		$dtp_cfasl_count_stream$ = defconstant("*DTP-CFASL-COUNT-STREAM*",
				$sym43$CFASL_COUNT_STREAM);
		$cfasl_stream_extensions_enabled$ = defparameter(
				"*CFASL-STREAM-EXTENSIONS-ENABLED*", NIL);
		$cfasl_unread_byte$ = defparameter("*CFASL-UNREAD-BYTE*", NIL);
		$cfasl_output_object_method_table$ = deflexical(
				"*CFASL-OUTPUT-OBJECT-METHOD-TABLE*",
				Vectors.make_vector($int58$256, NIL));
		$cfasl_input_to_static_area$ = defparameter(
				"*CFASL-INPUT-TO-STATIC-AREA*", NIL);
		$cfasl_max_opcode$ = defconstant("*CFASL-MAX-OPCODE*", $int66$128);
		$cfasl_input_method_table$ = deflexical(
				"*CFASL-INPUT-METHOD-TABLE*",
				((NIL != Symbols.boundp($sym67$_CFASL_INPUT_METHOD_TABLE_)) ? ((SubLObject) $cfasl_input_method_table$
						.getGlobalValue()) : Vectors.make_vector(
						$cfasl_max_opcode$.getGlobalValue(),
						$sym64$CFASL_INPUT_ERROR)));
		$within_cfasl_externalization$ = defparameter(
				"*WITHIN-CFASL-EXTERNALIZATION*", NIL);
		$cfasl_channel_externalizedP$ = defparameter(
				"*CFASL-CHANNEL-EXTERNALIZED?*", T);
		$cfasl_extensions$ = deflexical(
				"*CFASL-EXTENSIONS*",
				((NIL != Symbols.boundp($sym81$_CFASL_EXTENSIONS_)) ? ((SubLObject) $cfasl_extensions$
						.getGlobalValue()) : NIL));
		$cfasl_opcode_externalization$ = defconstant(
				"*CFASL-OPCODE-EXTERNALIZATION*", $int85$51);
		$current_cfasl_defstruct_output_stream$ = defparameter(
				"*CURRENT-CFASL-DEFSTRUCT-OUTPUT-STREAM*", NIL);
		$cfasl_opcode_defstruct_recipe$ = defconstant(
				"*CFASL-OPCODE-DEFSTRUCT-RECIPE*", $int87$44);
		$cfasl_immediate_fixnum_cutoff$ = defconstant(
				"*CFASL-IMMEDIATE-FIXNUM-CUTOFF*",
				$cfasl_max_opcode$.getGlobalValue());
		$cfasl_immediate_fixnum_offset$ = defconstant(
				"*CFASL-IMMEDIATE-FIXNUM-OFFSET*",
				Numbers.subtract($int58$256,
						$cfasl_immediate_fixnum_cutoff$.getGlobalValue()));
		$cfasl_opcode_p_8bit_int$ = defconstant("*CFASL-OPCODE-P-8BIT-INT*",
				ZERO_INTEGER);
		$cfasl_opcode_n_8bit_int$ = defconstant("*CFASL-OPCODE-N-8BIT-INT*",
				ONE_INTEGER);
		$cfasl_opcode_p_16bit_int$ = defconstant("*CFASL-OPCODE-P-16BIT-INT*",
				TWO_INTEGER);
		$cfasl_opcode_n_16bit_int$ = defconstant("*CFASL-OPCODE-N-16BIT-INT*",
				THREE_INTEGER);
		$cfasl_opcode_p_24bit_int$ = defconstant("*CFASL-OPCODE-P-24BIT-INT*",
				FOUR_INTEGER);
		$cfasl_opcode_n_24bit_int$ = defconstant("*CFASL-OPCODE-N-24BIT-INT*",
				FIVE_INTEGER);
		$cfasl_opcode_p_32bit_int$ = defconstant("*CFASL-OPCODE-P-32BIT-INT*",
				SIX_INTEGER);
		$cfasl_opcode_n_32bit_int$ = defconstant("*CFASL-OPCODE-N-32BIT-INT*",
				SEVEN_INTEGER);
		$cfasl_opcode_p_bignum$ = defconstant("*CFASL-OPCODE-P-BIGNUM*",
				$int103$23);
		$cfasl_opcode_n_bignum$ = defconstant("*CFASL-OPCODE-N-BIGNUM*",
				$int105$24);
		$cfasl_opcode_p_float$ = defconstant("*CFASL-OPCODE-P-FLOAT*",
				EIGHT_INTEGER);
		$cfasl_opcode_n_float$ = defconstant("*CFASL-OPCODE-N-FLOAT*",
				NINE_INTEGER);
		$cfasl_opcode_keyword$ = defconstant("*CFASL-OPCODE-KEYWORD*",
				TEN_INTEGER);
		$cfasl_opcode_other_symbol$ = defconstant(
				"*CFASL-OPCODE-OTHER-SYMBOL*", ELEVEN_INTEGER);
		$cfasl_opcode_nil$ = defconstant("*CFASL-OPCODE-NIL*", TWELVE_INTEGER);
		$cfasl_opcode_common_symbol$ = defconstant(
				"*CFASL-OPCODE-COMMON-SYMBOL*", $int121$50);
		$cfasl_common_symbols$ = defparameter("*CFASL-COMMON-SYMBOLS*", NIL);
		$cfasl_list_methods$ = deflexical(
				"*CFASL-LIST-METHODS*",
				((NIL != Symbols.boundp($sym132$_CFASL_LIST_METHODS_)) ? ((SubLObject) $cfasl_list_methods$
						.getGlobalValue()) : NIL));
		$cfasl_opcode_list$ = defconstant("*CFASL-OPCODE-LIST*",
				THIRTEEN_INTEGER);
		$cfasl_opcode_dotted_list$ = defconstant("*CFASL-OPCODE-DOTTED-LIST*",
				SEVENTEEN_INTEGER);
		$cfasl_opcode_general_vector$ = defconstant(
				"*CFASL-OPCODE-GENERAL-VECTOR*", FOURTEEN_INTEGER);
		$cfasl_opcode_byte_vector$ = defconstant("*CFASL-OPCODE-BYTE-VECTOR*",
				$int139$26);
		$cfasl_opcode_string$ = defconstant("*CFASL-OPCODE-STRING*",
				FIFTEEN_INTEGER);
		$cfasl_input_string_resource$ = defparameter(
				"*CFASL-INPUT-STRING-RESOURCE*", NIL);
		$cfasl_opcode_character$ = defconstant("*CFASL-OPCODE-CHARACTER*",
				SIXTEEN_INTEGER);
		$cfasl_opcode_hashtable$ = defconstant("*CFASL-OPCODE-HASHTABLE*",
				EIGHTEEN_INTEGER);
		$cfasl_opcode_guid$ = defconstant("*CFASL-OPCODE-GUID*", $int147$43);
		$cfasl_opcode_legacy_guid$ = defconstant("*CFASL-OPCODE-LEGACY-GUID*",
				$int150$25);
		$cfasl_input_guid_string_resource$ = defparameter(
				"*CFASL-INPUT-GUID-STRING-RESOURCE*", NIL);
		$cfasl_opcode_result_set$ = defconstant("*CFASL-OPCODE-RESULT-SET*",
				$int154$27);
		$cfasl_opcode_package$ = defconstant("*CFASL-OPCODE-PACKAGE*",
				$int156$28);
		$cfasl_opcode_wide_cfasl_opcode$ = defconstant(
				"*CFASL-OPCODE-WIDE-CFASL-OPCODE*", $int159$29);
		$cfasl_min_wide_opcode$ = defconstant("*CFASL-MIN-WIDE-OPCODE*",
				$cfasl_max_opcode$.getGlobalValue());
		$cfasl_wide_opcode_input_method_table$ = deflexical(
				"*CFASL-WIDE-OPCODE-INPUT-METHOD-TABLE*",
				((NIL != Symbols
						.boundp($sym161$_CFASL_WIDE_OPCODE_INPUT_METHOD_TABLE_)) ? ((SubLObject) $cfasl_wide_opcode_input_method_table$
						.getGlobalValue()) : Hashtables.make_hash_table(
						$int112$32, Symbols.symbol_function(EQL), UNPROVIDED)));
		$cfasl_opcode_instance$ = defconstant("*CFASL-OPCODE-INSTANCE*",
				$int167$124);
		$cfasl_opcode_guid_denoted_type$ = defconstant(
				"*CFASL-OPCODE-GUID-DENOTED-TYPE*", $int170$126);
		$cfasl_guid_denoted_type_input_method_table$ = deflexical(
				"*CFASL-GUID-DENOTED-TYPE-INPUT-METHOD-TABLE*",
				((NIL != Symbols
						.boundp($sym172$_CFASL_GUID_DENOTED_TYPE_INPUT_METHOD_TABLE_)) ? ((SubLObject) $cfasl_guid_denoted_type_input_method_table$
						.getGlobalValue()) : Hashtables.make_hash_table(
						$int173$100, Symbols.symbol_function(EQUALP),
						UNPROVIDED)));
		return NIL;
	}
	...
	public static final SubLObject setup_cfasl_file() {
		...
		Structures
				.register_method(
						...
						$dtp_cfasl_encoding_stream$.getGlobalValue(),
						Symbols.symbol_function($sym7$CFASL_ENCODING_STREAM_PRINT_FUNCTION_TRAMPOLINE));
		Structures.def_csetf($sym8$CFASL_ENCODING_STREAM_INTERNAL_STREAM,
		...
		access_macros.register_macro_helper($sym24$NEW_CFASL_ENCODING_STREAM,
		...
		access_macros.register_macro_helper(
				...
				$sym25$WITH_CFASL_OUTPUT_TO_BYTE_VECTOR);
		access_macros.register_macro_helper($sym20$CLOSE_CFASL_ENCODING_STREAM,
				$sym25$WITH_CFASL_OUTPUT_TO_BYTE_VECTOR);
		Structures
				.register_method(
						print_high.$print_object_method_table$.getGlobalValue(),
						$dtp_cfasl_decoding_stream$.getGlobalValue(),
						Symbols.symbol_function($sym32$CFASL_DECODING_STREAM_PRINT_FUNCTION_TRAMPOLINE));
		Structures.def_csetf($sym33$CFASL_DECODING_STREAM_INTERNAL_STREAM,
		...
		access_macros.register_macro_helper($sym38$NEW_CFASL_DECODING_STREAM,
				$sym39$WITH_CFASL_INPUT_FROM_BYTE_VECTOR);
		access_macros.register_macro_helper(
				$sym41$CFASL_DECODING_STREAM_READ_BYTE,
				$sym39$WITH_CFASL_INPUT_FROM_BYTE_VECTOR);
		access_macros.register_macro_helper($sym36$CLOSE_CFASL_DECODING_STREAM,
				$sym39$WITH_CFASL_INPUT_FROM_BYTE_VECTOR);
		Structures
				.register_method(
						print_high.$print_object_method_table$.getGlobalValue(),
						$dtp_cfasl_count_stream$.getGlobalValue(),
						Symbols.symbol_function($sym49$CFASL_COUNT_STREAM_PRINT_FUNCTION_TRAMPOLINE));
		Structures.def_csetf($sym50$CFASL_COUNT_STREAM_POSITION,
				$sym51$_CSETF_CFASL_COUNT_STREAM_POSITION);
		Equality.identity($sym43$CFASL_COUNT_STREAM);
		subl_macro_promotions
				.declare_defglobal($sym67$_CFASL_INPUT_METHOD_TABLE_);
		access_macros.register_macro_helper(
		...
		access_macros.register_macro_helper($sym83$REGISTER_CFASL_EXTENSION,
				$sym84$DECLARE_CFASL_EXTENSION_OPCODE);
		register_cfasl_input_function(
				$cfasl_opcode_externalization$.getGlobalValue(),
				$sym86$CFASL_INPUT_EXTERNALIZATION);
		register_cfasl_input_function(
				$cfasl_opcode_defstruct_recipe$.getGlobalValue(),
				$sym88$CFASL_INPUT_DEFSTRUCT_RECIPE);
		register_cfasl_input_function(
				$cfasl_opcode_p_8bit_int$.getGlobalValue(),
				$sym95$CFASL_INPUT_P_8BIT_INT);
		register_cfasl_input_function(
				$cfasl_opcode_n_8bit_int$.getGlobalValue(),
				$sym96$CFASL_INPUT_N_8BIT_INT);
		register_cfasl_input_function(
				$cfasl_opcode_p_16bit_int$.getGlobalValue(),
				$sym97$CFASL_INPUT_P_16BIT_INT);
		register_cfasl_input_function(
				$cfasl_opcode_n_16bit_int$.getGlobalValue(),
				$sym98$CFASL_INPUT_N_16BIT_INT);
		register_cfasl_input_function(
				$cfasl_opcode_p_24bit_int$.getGlobalValue(),
				$sym99$CFASL_INPUT_P_24BIT_INT);
		register_cfasl_input_function(
				$cfasl_opcode_n_24bit_int$.getGlobalValue(),
				$sym100$CFASL_INPUT_N_24BIT_INT);
		register_cfasl_input_function(
				$cfasl_opcode_p_32bit_int$.getGlobalValue(),
				$sym101$CFASL_INPUT_P_32BIT_INT);
		register_cfasl_input_function(
				$cfasl_opcode_n_32bit_int$.getGlobalValue(),
				$sym102$CFASL_INPUT_N_32BIT_INT);
		register_cfasl_input_function($cfasl_opcode_p_bignum$.getGlobalValue(),
				$sym104$CFASL_INPUT_P_BIGNUM);
		register_cfasl_input_function($cfasl_opcode_n_bignum$.getGlobalValue(),
				$sym106$CFASL_INPUT_N_BIGNUM);
		Structures.register_method($cfasl_output_object_method_table$
				.getGlobalValue(), Types.$dtp_bignum$.getGlobalValue(), Symbols
				.symbol_function($sym107$CFASL_OUTPUT_OBJECT_INTEGER_METHOD));
		Structures.register_method($cfasl_output_object_method_table$
				.getGlobalValue(), Types.$dtp_fixnum$.getGlobalValue(), Symbols
				.symbol_function($sym107$CFASL_OUTPUT_OBJECT_INTEGER_METHOD));
		register_cfasl_input_function($cfasl_opcode_p_float$.getGlobalValue(),
				$sym114$CFASL_INPUT_P_FLOAT);
		register_cfasl_input_function($cfasl_opcode_n_float$.getGlobalValue(),
				$sym115$CFASL_INPUT_N_FLOAT);
		Structures.register_method($cfasl_output_object_method_table$
				.getGlobalValue(), Types.$dtp_float$.getGlobalValue(), Symbols
				.symbol_function($sym116$CFASL_OUTPUT_OBJECT_FLOAT_METHOD));
		Structures.register_method($cfasl_output_object_method_table$
				.getGlobalValue(), Types.$dtp_symbol$.getGlobalValue(), Symbols
				.symbol_function($sym117$CFASL_OUTPUT_OBJECT_SYMBOL_METHOD));
		register_cfasl_input_function($cfasl_opcode_keyword$.getGlobalValue(),
				$sym118$CFASL_INPUT_KEYWORD);
		register_cfasl_input_function(
				$cfasl_opcode_other_symbol$.getGlobalValue(),
				$sym119$CFASL_INPUT_OTHER_SYMBOL);
		register_cfasl_input_function($cfasl_opcode_nil$.getGlobalValue(),
				$sym120$CFASL_INPUT_NIL);
		register_cfasl_input_function(
				$cfasl_opcode_common_symbol$.getGlobalValue(),
				$sym122$CFASL_INPUT_COMMON_SYMBOL);
		Structures.register_method($cfasl_output_object_method_table$
				.getGlobalValue(), Types.$dtp_cons$.getGlobalValue(), Symbols
				.symbol_function($sym131$CFASL_OUTPUT_OBJECT_CONS_METHOD));
		subl_macro_promotions.declare_defglobal($sym132$_CFASL_LIST_METHODS_);
		register_cfasl_input_function($cfasl_opcode_list$.getGlobalValue(),
				$sym133$CFASL_INPUT_LIST);
		register_cfasl_input_function(
				$cfasl_opcode_dotted_list$.getGlobalValue(),
				$sym136$CFASL_INPUT_DOTTED_LIST);
		Structures.register_method($cfasl_output_object_method_table$
				.getGlobalValue(), Types.$dtp_vector$.getGlobalValue(), Symbols
				.symbol_function($sym137$CFASL_OUTPUT_OBJECT_VECTOR_METHOD));
		register_cfasl_input_function(
				$cfasl_opcode_general_vector$.getGlobalValue(),
				$sym138$CFASL_INPUT_GENERAL_VECTOR);
		register_cfasl_input_function(
				$cfasl_opcode_byte_vector$.getGlobalValue(),
				$sym140$CFASL_INPUT_BYTE_VECTOR);
		register_cfasl_input_function($cfasl_opcode_string$.getGlobalValue(),
				$sym141$CFASL_INPUT_STRING);
		Structures.register_method($cfasl_output_object_method_table$
				.getGlobalValue(), Types.$dtp_string$.getGlobalValue(), Symbols
				.symbol_function($sym142$CFASL_OUTPUT_OBJECT_STRING_METHOD));
		register_cfasl_input_function(
				$cfasl_opcode_character$.getGlobalValue(),
				$sym143$CFASL_INPUT_CHARACTER);
		Structures
				.register_method(
						$cfasl_output_object_method_table$.getGlobalValue(),
						Types.$dtp_character$.getGlobalValue(),
						Symbols.symbol_function($sym144$CFASL_OUTPUT_OBJECT_CHARACTER_METHOD));
		register_cfasl_input_function(
				$cfasl_opcode_hashtable$.getGlobalValue(),
				$sym145$CFASL_INPUT_HASHTABLE);
		Structures
				.register_method(
						$cfasl_output_object_method_table$.getGlobalValue(),
						Types.$dtp_hash_table$.getGlobalValue(),
						Symbols.symbol_function($sym146$CFASL_OUTPUT_OBJECT_HASH_TABLE_METHOD));
		register_cfasl_input_function($cfasl_opcode_guid$.getGlobalValue(),
				$sym148$CFASL_INPUT_GUID);
		Structures.register_method($cfasl_output_object_method_table$
				.getGlobalValue(), Guids.$dtp_guid$.getGlobalValue(), Symbols
				.symbol_function($sym149$CFASL_OUTPUT_OBJECT_GUID_METHOD));
		register_cfasl_input_function(
				$cfasl_opcode_legacy_guid$.getGlobalValue(),
				$sym151$CFASL_INPUT_LEGACY_GUID);
		register_cfasl_input_function(
				$cfasl_opcode_result_set$.getGlobalValue(),
				$sym155$CFASL_INPUT_RESULT_SET);
		register_cfasl_input_function($cfasl_opcode_package$.getGlobalValue(),
				$sym157$CFASL_INPUT_PACKAGE);
		Structures
				.register_method(
						$cfasl_output_object_method_table$.getGlobalValue(),
						Types.$dtp_package$.getGlobalValue(),
						Symbols.symbol_function($sym158$CFASL_OUTPUT_OBJECT_PACKAGE_METHOD));
		register_cfasl_input_function(
				$cfasl_opcode_wide_cfasl_opcode$.getGlobalValue(),
				$sym160$CFASL_INPUT_WIDE_OPCODE_ENCODED);
		subl_macro_promotions
				.declare_defglobal($sym161$_CFASL_WIDE_OPCODE_INPUT_METHOD_TABLE_);
		access_macros.register_macro_helper(
				$sym165$REGISTER_WIDE_CFASL_OPCODE_INPUT_FUNCTION,
				$sym166$DECLARE_WIDE_CFASL_OPCODE);
		register_cfasl_input_function($cfasl_opcode_instance$.getGlobalValue(),
				$sym168$CFASL_INPUT_INSTANCE);
		register_cfasl_input_function(
				$cfasl_opcode_guid_denoted_type$.getGlobalValue(),
				$sym171$CFASL_INPUT_GUID_DENOTED_TYPE);
		subl_macro_promotions
				.declare_defglobal($sym172$_CFASL_GUID_DENOTED_TYPE_INPUT_METHOD_TABLE_);
		access_macros.register_macro_helper(
	...
	public static final SubLList $list12 = list(
			list(makeSymbol("STREAM"), makeSymbol("STRING")),
	...
	public static final SubLList $list22 = list(
			list(makeSymbol("STREAM"), makeSymbol("BYTE-VECTOR")),
			makeSymbol("&BODY"), makeSymbol("BODY"));
	...
	public static final SubLList $list53 = list(
			list(makeSymbol("STREAM"), makeSymbol("COUNT")),
			makeSymbol("&BODY"), makeSymbol("BODY"));
	...
	public static final SubLList $list57 = list(
			list(makeSymbol("*CFASL-STREAM-EXTENSIONS-ENABLED*"), T),
			list(makeSymbol("*CFASL-UNREAD-BYTE*"), NIL));
	...
	public static final SubLList $list68 = list(makeSymbol("VARIABLE"),
			makeSymbol("CFASL-OPCODE"), makeSymbol("INPUT-FUNCTION"));
	...
	public static final SubLList $list78 = list(list(
			makeSymbol("*WITHIN-CFASL-EXTERNALIZATION*"), T));
	public static final SubLList $list79 = list(list(
			makeSymbol("*WITHIN-CFASL-EXTERNALIZATION*"), NIL));
	public static final SubLList $list80 = list(list(
			makeSymbol("*CFASL-CHANNEL-EXTERNALIZED?*"), NIL));
	public static final SubLSymbol $sym81$_CFASL_EXTENSIONS_ = makeSymbol("*CFASL-EXTENSIONS*");
	public static final SubLList $list82 = list(makeSymbol("VARIABLE"),
			makeSymbol("CFASL-OPCODE"), makeSymbol("PRED-FUNC"),
			makeSymbol("OUTPUT-FUNC"), makeSymbol("INPUT-FUNC"));
	...
	public static final SubLList $list111 = list(makeSymbol("SIGN"),
			makeSymbol("&REST"), makeSymbol("FIXNUMS"));
	...
	public static final SubLList $list124 = list(makeSymbol("SYMBOLS"),
			makeSymbol("&BODY"), makeSymbol("BODY"));
	public static final SubLList $list125 = list(list(
			makeSymbol("*CFASL-COMMON-SYMBOLS*"), NIL));
	...
	public static final SubLList $list153 = list(list(
			makeSymbol("*CFASL-INPUT-GUID-STRING-RESOURCE*"),
			list(makeSymbol("GET-NEW-CFASL-INPUT-GUID-STRING-RESOURCE"))));
	...
	public static final SubLList $list163 = list(makeSymbol("VARIABLE"),
			makeSymbol("WIDE-OPCODE"), makeSymbol("INPUT-FUNCTION"));
	...
	public static final SubLList $list174 = list(makeSymbol("VARIABLE"),
			makeSymbol("CFASL-GUID-OPCODE"), makeSymbol("INPUT-FUNCTION"));
	...
	public static final SubLList $list178 = list(makeSymbol("VARIABLE"),
			makeSymbol("CFASL-GUID-STRING-OPCODE"),
			makeSymbol("INPUT-FUNCTION"));
	...
	public static final SubLList $list182 = list(
			list(makeSymbol("TYPE-DENOTING-GUID"), makeSymbol("STREAM")),
			makeSymbol("&BODY"), makeSymbol("BODY"));
