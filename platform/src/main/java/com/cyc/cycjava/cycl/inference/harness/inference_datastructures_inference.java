...
public final class inference_datastructures_inference extends
		SubLTranslatedFile {
	...
	public static final class $inference_native extends SubLStructNative {
		...
		public SubLObject getField6() {
			return $input_el_query;
		}

		public SubLObject getField7() {
			return $input_non_explanatory_el_query;
		}

		public SubLObject getField8() {
			return $input_query_properties;
		}
		...
		public SubLObject getField16() {
			return $hypothetical_bindings;
		}

		public SubLObject getField17() {
			return $answer_id_index;
		}

		public SubLObject getField18() {
			return $answer_bindings_index;
		}

		public SubLObject getField19() {
			return $new_answer_id_start;
		}

		public SubLObject getField20() {
			return $new_answer_justifications;
		}
		...
		public SubLObject getField29() {
			return $disjunction_free_el_vars_policy;
		}

		public SubLObject getField30() {
			return $result_uniqueness_criterion;
		}

		public SubLObject getField31() {
			return $allow_hl_predicate_transformationP;
		}

		public SubLObject getField32() {
			return $allow_unbound_predicate_transformationP;
		}

		public SubLObject getField33() {
			return $allow_evaluatable_predicate_transformationP;
		}

		public SubLObject getField34() {
			return $allow_indeterminate_resultsP;
		}
		...
		public SubLObject getField38() {
			return $allow_abnormality_checkingP;
		}

		public SubLObject getField39() {
			return $transitive_closure_mode;
		}

		public SubLObject getField40() {
			return $problem_store_privateP;
		}
		...
		public SubLObject getField56() {
			return $start_universal_time;
		}

		public SubLObject getField57() {
			return $start_internal_real_time;
		}

		public SubLObject getField58() {
			return $end_internal_real_time;
		}

		public SubLObject getField59() {
			return $pad_internal_real_time;
		}
		...
		public SubLObject getField66() {
			return $proof_watermark;
		}

		public SubLObject getField67() {
			return $problem_working_time_data;
		}
		...
		public SubLObject setField3(SubLObject value) {
			return $problem_store = value;
		}

		public SubLObject setField4(SubLObject value) {
			return $forward_propagate = value;
		}

		public SubLObject setField5(SubLObject value) {
			return $input_mt = value;
		}

		public SubLObject setField6(SubLObject value) {
			return $input_el_query = value;
		}

		public SubLObject setField7(SubLObject value) {
			return $input_non_explanatory_el_query = value;
		}

		public SubLObject setField8(SubLObject value) {
			return $input_query_properties = value;
		}
		...
		public SubLObject setField51(SubLObject value) {
			return $forward_max_time = value;
		}

		public SubLObject setField52(SubLObject value) {
			return $max_proof_depth = value;
		}
		...
		public SubLObject setField61(SubLObject value) {
			return $step_count = value;
		}

		public SubLObject setField62(SubLObject value) {
			return $cumulative_step_count = value;
		}
		...
		public SubLObject setField66(SubLObject value) {
			return $proof_watermark = value;
		}

		public SubLObject setField67(SubLObject value) {
			return $problem_working_time_data = value;
		}
		...
		private static final SubLStructDeclNative structDecl = Structures
				.makeStructDeclNative(
						$inference_native.class,
						$sym1$INFERENCE,
						$sym2$INFERENCE_P,
						$list3,
						$list4,
						new String[] { "$suid", "$problem_store",
								"$forward_propagate", "$input_mt",
								"$input_el_query",
								"$input_non_explanatory_el_query",
								"$input_query_properties", "$mt", "$el_query",
								"$el_bindings", "$hl_query",
								"$explanatory_subquery",
								"$non_explanatory_subquery", "$free_hl_vars",
								"$hypothetical_bindings", "$answer_id_index",
								"$answer_bindings_index",
								"$new_answer_id_start",
								"$new_answer_justifications", "$status",
								"$suspend_status", "$root_link",
								"$relevant_problems", "$strategy_set",
								"$control_process", "$interrupting_processes",
								"$max_transformation_depth_reached",
								"$disjunction_free_el_vars_policy",
								"$result_uniqueness_criterion",
								"$allow_hl_predicate_transformationP",
								"$allow_unbound_predicate_transformationP",
								"$allow_evaluatable_predicate_transformationP",
								"$allow_indeterminate_resultsP",
								"$allowed_rules", "$forbidden_rules",
								"$allowed_modules",
								"$allow_abnormality_checkingP",
								"$transitive_closure_mode",
								"$problem_store_privateP", "$continuableP",
								"$browsableP", "$return_type",
								"$answer_language", "$cache_resultsP",
								"$blockingP", "$max_number", "$max_time",
								"$max_step", "$mode", "$forward_max_time",
								"$max_proof_depth",
								"$max_transformation_depth",
								"$probably_approximately_done",
								"$metrics_template", "$start_universal_time",
								"$start_internal_real_time",
								"$end_internal_real_time",
								"$pad_internal_real_time", "$cumulative_time",
								"$step_count", "$cumulative_step_count",
								"$events", "$halt_conditions", "$accumulators",
								"$proof_watermark",
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject inference_print_function_trampoline(
			SubLObject object, SubLObject stream) {
		Errors.handleMissingMethodError("This call was replaced for LarKC purposes. Originally a method was called. Refer to number 35787");
		return NIL;
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject inference_p(SubLObject object) {
		return ((object.getClass() == $inference_native.class) ? ((SubLObject) T)
				: NIL);
	}
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject infrnc_input_non_explanatory_el_query(
			SubLObject object) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject infrnc_input_query_properties(
			SubLObject object) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 65000)
	public static final SubLObject inference_has_some_answerP(
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject infrnc_answer_bindings_index(
			SubLObject object) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject infrnc_new_answer_justifications(
			SubLObject object) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject infrnc_interrupting_processes(
			SubLObject object) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject infrnc_max_transformation_depth_reached(
			SubLObject object) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject infrnc_disjunction_free_el_vars_policy(
			SubLObject object) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject infrnc_result_uniqueness_criterion(
			SubLObject object) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject infrnc_allow_hl_predicate_transformationP(
			SubLObject object) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject infrnc_allow_unbound_predicate_transformationP(
			SubLObject object) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject infrnc_allow_evaluatable_predicate_transformationP(
			SubLObject object) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject infrnc_allow_indeterminate_resultsP(
			SubLObject object) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject infrnc_allow_abnormality_checkingP(
			SubLObject object) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject infrnc_transitive_closure_mode(
			SubLObject object) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject infrnc_problem_store_privateP(
			SubLObject object) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject infrnc_max_transformation_depth(
			SubLObject object) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject infrnc_probably_approximately_done(
			SubLObject object) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject infrnc_start_internal_real_time(
			SubLObject object) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject infrnc_end_internal_real_time(
			SubLObject object) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject infrnc_pad_internal_real_time(
			SubLObject object) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject infrnc_cumulative_step_count(
			SubLObject object) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject infrnc_problem_working_time_data(
			SubLObject object) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject _csetf_infrnc_problem_store(
			SubLObject object, SubLObject value) {
		checkType(object, $sym2$INFERENCE_P);
		return object.setField3(value);
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject _csetf_infrnc_forward_propagate(
			SubLObject object, SubLObject value) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject _csetf_infrnc_input_el_query(
			SubLObject object, SubLObject value) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject _csetf_infrnc_input_non_explanatory_el_query(
			SubLObject object, SubLObject value) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject _csetf_infrnc_input_query_properties(
			SubLObject object, SubLObject value) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject _csetf_infrnc_explanatory_subquery(
			SubLObject object, SubLObject value) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject _csetf_infrnc_non_explanatory_subquery(
			SubLObject object, SubLObject value) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject _csetf_infrnc_free_hl_vars(
			SubLObject object, SubLObject value) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject _csetf_infrnc_hypothetical_bindings(
			SubLObject object, SubLObject value) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject _csetf_infrnc_answer_id_index(
			SubLObject object, SubLObject value) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject _csetf_infrnc_answer_bindings_index(
			SubLObject object, SubLObject value) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject _csetf_infrnc_new_answer_id_start(
			SubLObject object, SubLObject value) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject _csetf_infrnc_new_answer_justifications(
			SubLObject object, SubLObject value) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject _csetf_infrnc_suspend_status(
			SubLObject object, SubLObject value) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject _csetf_infrnc_relevant_problems(
			SubLObject object, SubLObject value) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject _csetf_infrnc_strategy_set(
			SubLObject object, SubLObject value) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject _csetf_infrnc_control_process(
			SubLObject object, SubLObject value) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject _csetf_infrnc_interrupting_processes(
			SubLObject object, SubLObject value) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject _csetf_infrnc_max_transformation_depth_reached(
			SubLObject object, SubLObject value) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject _csetf_infrnc_disjunction_free_el_vars_policy(
			SubLObject object, SubLObject value) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject _csetf_infrnc_result_uniqueness_criterion(
			SubLObject object, SubLObject value) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject _csetf_infrnc_allow_hl_predicate_transformationP(
			SubLObject object, SubLObject value) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject _csetf_infrnc_allow_unbound_predicate_transformationP(
			SubLObject object, SubLObject value) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject _csetf_infrnc_allow_evaluatable_predicate_transformationP(
			SubLObject object, SubLObject value) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject _csetf_infrnc_allow_indeterminate_resultsP(
			SubLObject object, SubLObject value) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject _csetf_infrnc_allowed_rules(
			SubLObject object, SubLObject value) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject _csetf_infrnc_forbidden_rules(
			SubLObject object, SubLObject value) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject _csetf_infrnc_allowed_modules(
			SubLObject object, SubLObject value) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject _csetf_infrnc_allow_abnormality_checkingP(
			SubLObject object, SubLObject value) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject _csetf_infrnc_transitive_closure_mode(
			SubLObject object, SubLObject value) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject _csetf_infrnc_problem_store_privateP(
			SubLObject object, SubLObject value) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject _csetf_infrnc_continuableP(
			SubLObject object, SubLObject value) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject _csetf_infrnc_answer_language(
			SubLObject object, SubLObject value) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject _csetf_infrnc_cache_resultsP(
			SubLObject object, SubLObject value) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject _csetf_infrnc_forward_max_time(
			SubLObject object, SubLObject value) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject _csetf_infrnc_max_proof_depth(
			SubLObject object, SubLObject value) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject _csetf_infrnc_max_transformation_depth(
			SubLObject object, SubLObject value) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject _csetf_infrnc_probably_approximately_done(
			SubLObject object, SubLObject value) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject _csetf_infrnc_metrics_template(
			SubLObject object, SubLObject value) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject _csetf_infrnc_start_universal_time(
			SubLObject object, SubLObject value) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject _csetf_infrnc_start_internal_real_time(
			SubLObject object, SubLObject value) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject _csetf_infrnc_end_internal_real_time(
			SubLObject object, SubLObject value) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject _csetf_infrnc_pad_internal_real_time(
			SubLObject object, SubLObject value) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject _csetf_infrnc_cumulative_time(
			SubLObject object, SubLObject value) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject _csetf_infrnc_cumulative_step_count(
			SubLObject object, SubLObject value) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject _csetf_infrnc_halt_conditions(
			SubLObject object, SubLObject value) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject _csetf_infrnc_accumulators(
			SubLObject object, SubLObject value) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject _csetf_infrnc_proof_watermark(
			SubLObject object, SubLObject value) {
		checkType(object, $sym2$INFERENCE_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 3460)
	public static final SubLObject _csetf_infrnc_problem_working_time_data(
			SubLObject object, SubLObject value) {
		checkType(object, $sym2$INFERENCE_P);
			...
			for (next = arglist; (NIL != next); next = conses_high.cddr(next)) {
				{
					...
					if (pcase_var.eql($kw194$SUID)) {
						...
						_csetf_infrnc_input_el_query(v_new, current_value);
							...
							.eql($kw199$INPUT_NON_EXPLANATORY_EL_QUERY)) {
						_csetf_infrnc_input_non_explanatory_el_query(v_new,
								current_value);
					} else if (pcase_var.eql($kw200$INPUT_QUERY_PROPERTIES)) {
						_csetf_infrnc_input_query_properties(v_new,
								current_value);
						...
						_csetf_infrnc_non_explanatory_subquery(v_new,
								current_value);
						...
						_csetf_infrnc_hypothetical_bindings(v_new,
								current_value);
						...
						_csetf_infrnc_answer_bindings_index(v_new,
								current_value);
						...
						_csetf_infrnc_new_answer_justifications(v_new,
								current_value);
						...
						_csetf_infrnc_interrupting_processes(v_new,
								current_value);
					} else if (pcase_var
							.eql($kw220$MAX_TRANSFORMATION_DEPTH_REACHED)) {
						_csetf_infrnc_max_transformation_depth_reached(v_new,
								current_value);
					} else if (pcase_var
							.eql($kw221$DISJUNCTION_FREE_EL_VARS_POLICY)) {
						_csetf_infrnc_disjunction_free_el_vars_policy(v_new,
								current_value);
					} else if (pcase_var
							.eql($kw222$RESULT_UNIQUENESS_CRITERION)) {
						_csetf_infrnc_result_uniqueness_criterion(v_new,
								current_value);
					} else if (pcase_var
							.eql($kw223$ALLOW_HL_PREDICATE_TRANSFORMATION_)) {
						_csetf_infrnc_allow_hl_predicate_transformationP(v_new,
								current_value);
					} else if (pcase_var
							.eql($kw224$ALLOW_UNBOUND_PREDICATE_TRANSFORMATION_)) {
						_csetf_infrnc_allow_unbound_predicate_transformationP(
								v_new, current_value);
					} else if (pcase_var
							.eql($kw225$ALLOW_EVALUATABLE_PREDICATE_TRANSFORMATION_)) {
						_csetf_infrnc_allow_evaluatable_predicate_transformationP(
								v_new, current_value);
					} else if (pcase_var
							.eql($kw226$ALLOW_INDETERMINATE_RESULTS_)) {
						_csetf_infrnc_allow_indeterminate_resultsP(v_new,
								current_value);
						...
						_csetf_infrnc_allowed_modules(v_new, current_value);
							...
							.eql($kw230$ALLOW_ABNORMALITY_CHECKING_)) {
						_csetf_infrnc_allow_abnormality_checkingP(v_new,
								current_value);
					} else if (pcase_var.eql($kw231$TRANSITIVE_CLOSURE_MODE)) {
						_csetf_infrnc_transitive_closure_mode(v_new,
								current_value);
					} else if (pcase_var.eql($kw232$PROBLEM_STORE_PRIVATE_)) {
						_csetf_infrnc_problem_store_privateP(v_new,
								current_value);
						...
						_csetf_infrnc_max_transformation_depth(v_new,
								current_value);
					} else if (pcase_var
							.eql($kw246$PROBABLY_APPROXIMATELY_DONE)) {
						_csetf_infrnc_probably_approximately_done(v_new,
								current_value);
						...
						_csetf_infrnc_start_internal_real_time(v_new,
								current_value);
					} else if (pcase_var.eql($kw250$END_INTERNAL_REAL_TIME)) {
						_csetf_infrnc_end_internal_real_time(v_new,
								current_value);
					} else if (pcase_var.eql($kw251$PAD_INTERNAL_REAL_TIME)) {
						_csetf_infrnc_pad_internal_real_time(v_new,
								current_value);
						...
						_csetf_infrnc_cumulative_step_count(v_new,
								current_value);
						...
						_csetf_infrnc_problem_working_time_data(v_new,
								current_value);
						...
						Errors.error($str262$Invalid_slot__S_for_construction_,
								current_arg);
					}
				}
			}
	...
	public static final SubLObject valid_inference_p(SubLObject object) {
		return makeBoolean(((NIL != inference_p(object)) && (NIL == inference_invalid_p(object))));
	}
	...
	public static final class $sxhash_inference_method$UnaryFunction extends
			UnaryFunction {
	...
	public static final SubLObject new_inference_p(SubLObject object) {
		return makeBoolean(((NIL != inference_p(object)) && ($kw267$NEW == inference_status(object))));
	}
	...
	public static final SubLObject prepared_inference_p(SubLObject object) {
		return makeBoolean(((NIL != inference_p(object)) && ($kw268$PREPARED == inference_status(object))));
	}
	...
	public static final SubLObject running_inference_p(SubLObject object) {
		return makeBoolean(((NIL != inference_p(object)) && ($kw270$RUNNING == inference_status(object))));
	}
		...
		if ((NIL != inference_p(object))) {
			{
				...
				if ((NIL != inference_datastructures_enumerated_types
						.continuable_inference_status_p(status))) {
	...
	public static final SubLObject new_inference(SubLObject store) {
		checkType(store, $sym324$PROBLEM_STORE_P);
		{
			...
			SubLObject suid = inference_datastructures_problem_store
					.problem_store_new_inference_id(store);
			...
			_csetf_infrnc_answer_id_index(inf,
					id_index.new_id_index(TEN_INTEGER, ZERO_INTEGER));
			_csetf_infrnc_answer_bindings_index(inf, dictionary.new_dictionary(
			...
			_csetf_infrnc_relevant_problems(inf,
					set.new_set(Symbols.symbol_function(EQ), UNPROVIDED));
			_csetf_infrnc_strategy_set(inf,
					set.new_set(Symbols.symbol_function(EQ), UNPROVIDED));
			...
			set_inference_metrics_template(
					...
					inference_datastructures_enumerated_types.$default_inference_metrics_template$
							.getGlobalValue());
			_csetf_infrnc_accumulators(inf, dictionary.new_dictionary(
					Symbols.symbol_function(EQ), UNPROVIDED));
			_csetf_infrnc_proof_watermark(inf, ZERO_INTEGER);
			clear_inference_blocking(inf);
			inference_datastructures_problem_store.add_problem_store_inference(
					store, inf);
			return inf;
		}
	}
	...
	/**
	 * Disposes of the INFERENCE datastructure. This gets rid of all pointers to
	 * its referenced substructures so that the GC can collect them all.
	 */
	...
	public static final SubLObject destroy_inference(SubLObject inference) {
		if ((NIL != valid_inference_p(inference))) {
			try {
				...
				{
					SubLObject _prev_bind_0 = Dynamic
							.currentBinding(Threads.$is_thread_performing_cleanupP$);
					try {
						...
						note_inference_invalid(inference);
						{
							...
							SubLObject set_contents_var = set
									.do_set_internal(inference_strategy_set(inference_var));
									...
									.do_set_contents_update_state(state)) {
								{
									...
									if ((NIL != set_contents
										...
										inference_datastructures_strategy
												.destroy_inference_strategy(strategy);
									}
								}
							}
						}
	...
	public static final SubLObject destroy_problem_store_inference(
			SubLObject inference) {
		if ((NIL != valid_inference_p(inference))) {
			inference_strategist.inference_abort_if_running(inference);
			note_inference_invalid(inference);
	...
	public static final SubLObject destroy_inference_int(SubLObject inf) {
		inference_datastructures_forward_propagate
				.destroy_forward_propagate(infrnc_forward_propagate(inf));
		...
		_csetf_infrnc_allow_evaluatable_predicate_transformationP(inf,
				$kw328$FREE);
			...
			if ((NIL != lock)) {
				{
					...
					try {
						...
						_csetf_infrnc_problem_working_time_data(inf,
								$kw328$FREE);
					} finally {
						if ((NIL != release)) {
	...
	public static final SubLObject inference_input_non_explanatory_el_query(
			SubLObject inference) {
		checkType(inference, $sym2$INFERENCE_P);
	...
	public static final SubLObject inference_input_query_properties(
			SubLObject inference) {
		checkType(inference, $sym2$INFERENCE_P);
	...
	/**
	 * Returns bindings which map HL proven query wrt INFERENCE -> EL proven
	 * query wrt INFERENCE
	 */
	...
	public static final SubLObject inference_explanatory_subquery(
			SubLObject inference) {
		checkType(inference, $sym2$INFERENCE_P);
	...
	public static final SubLObject inference_answer_id_index(
			SubLObject inference) {
		checkType(inference, $sym2$INFERENCE_P);
	...
	public static final SubLObject inference_answer_bindings_index(
			SubLObject inference) {
		checkType(inference, $sym2$INFERENCE_P);
	...
	public static final SubLObject inference_new_answer_id_start(
			SubLObject inference) {
		checkType(inference, $sym2$INFERENCE_P);
	...
	public static final SubLObject inference_new_answer_justifications(
			SubLObject inference) {
		checkType(inference, $sym2$INFERENCE_P);
	...
	public static final SubLObject inference_relevant_problems(
			SubLObject inference) {
		checkType(inference, $sym2$INFERENCE_P);
	...
	public static final SubLObject inference_interrupting_processes(
			SubLObject inference) {
		checkType(inference, $sym2$INFERENCE_P);
	...
	public static final SubLObject inference_max_transformation_depth_reached(
			SubLObject inference) {
		checkType(inference, $sym2$INFERENCE_P);
	...
	public static final SubLObject inference_answer_language(
			SubLObject inference) {
		checkType(inference, $sym2$INFERENCE_P);
	...
	public static final SubLObject inference_disjunction_free_el_vars_policy(
			SubLObject inference) {
		checkType(inference, $sym2$INFERENCE_P);
	...
	public static final SubLObject inference_result_uniqueness_criterion(
			SubLObject inference) {
		checkType(inference, $sym2$INFERENCE_P);
	...
	public static final SubLObject inference_allow_hl_predicate_transformationP(
			SubLObject inference) {
		checkType(inference, $sym2$INFERENCE_P);
	...
	public static final SubLObject inference_allow_unbound_predicate_transformationP(
			SubLObject inference) {
		checkType(inference, $sym2$INFERENCE_P);
	...
	public static final SubLObject inference_allow_evaluatable_predicate_transformationP(
			SubLObject inference) {
		checkType(inference, $sym2$INFERENCE_P);
	...
	public static final SubLObject inference_allow_indeterminate_resultsP(
			SubLObject inference) {
		checkType(inference, $sym2$INFERENCE_P);
	...
	public static final SubLObject inference_forbidden_rules(
			SubLObject inference) {
		checkType(inference, $sym2$INFERENCE_P);
	...
	public static final SubLObject inference_allowed_modules(
			SubLObject inference) {
		checkType(inference, $sym2$INFERENCE_P);
	...
	public static final SubLObject inference_allow_abnormality_checkingP(
			SubLObject inference) {
		checkType(inference, $sym2$INFERENCE_P);
	...
	public static final SubLObject inference_transitive_closure_mode(
			SubLObject inference) {
		checkType(inference, $sym2$INFERENCE_P);
	...
	public static final SubLObject inference_problem_store_privateP(
			SubLObject inference) {
		checkType(inference, $sym2$INFERENCE_P);
	...
	/**
	 * @return inference-return-type-p, the return type of inference stored in
	 *         :return.
	 */
	...
	/**
	 * @return nil or universal-time-p NIL indicates there is no time cutoff
	 */
	...
	/**
	 * @return nil or non-negative-integer-p NIL indicates there is no step
	 *         cutoff
	 */
	...
	public static final SubLObject inference_forward_max_time(
			SubLObject inference) {
		checkType(inference, $sym2$INFERENCE_P);
	...
	/**
	 * @return nil or non-negative-integer-p NIL indicates there is no number
	 *         limit
	 */
	...
	/**
	 * @return nil or non-negative-integer-p NIL indicates there is no limit on
	 *         proof depth
	 */
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 37687)
	public static final SubLObject inference_max_proof_depth(
			SubLObject inference) {
		checkType(inference, $sym2$INFERENCE_P);
	...
	public static final SubLObject inference_max_transformation_depth(
			SubLObject inference) {
		checkType(inference, $sym2$INFERENCE_P);
	...
	/**
	 * @return probability-p 1 means we must be 100% sure we are done before
	 *         halting
	 */
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 38073)
	public static final SubLObject inference_probably_approximately_done(
			SubLObject inference) {
		checkType(inference, $sym2$INFERENCE_P);
	...
	public static final SubLObject inference_metrics_template(
			SubLObject inference) {
		checkType(inference, $sym2$INFERENCE_P);
	...
	public static final SubLObject inference_start_internal_real_time(
			SubLObject inference) {
		checkType(inference, $sym2$INFERENCE_P);
	...
	public static final SubLObject inference_end_internal_real_time(
			SubLObject inference) {
		checkType(inference, $sym2$INFERENCE_P);
	...
	public static final SubLObject inference_pad_internal_real_time(
			SubLObject inference) {
		checkType(inference, $sym2$INFERENCE_P);
	...
	/**
	 * This is the total time spent in all of INFERENCE's previous
	 * continuations. Use @xref inference-cumulative-time-so-far if you want to
	 * include the time spent so far in the current continuation.
	 */
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 39066)
	public static final SubLObject inference_cumulative_time(
			SubLObject inference) {
		checkType(inference, $sym2$INFERENCE_P);
	...
	/**
	 * The number of inference steps performed so far for this inference, summed
	 * over all continuations
	 */
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 39619)
	public static final SubLObject inference_cumulative_step_count(
			SubLObject inference) {
		checkType(inference, $sym2$INFERENCE_P);
	...
	public static final SubLObject inference_problem_working_time_data(
			SubLObject inference) {
		checkType(inference, $sym2$INFERENCE_P);
	...
	public static final SubLObject set_inference_input_el_query(
			SubLObject inference, SubLObject el_query) {
		checkType(inference, $sym2$INFERENCE_P);
		if ((NIL != el_query)) {
	...
	public static final SubLObject set_inference_input_non_explanatory_el_query(
			SubLObject inference, SubLObject el_query) {
		checkType(inference, $sym2$INFERENCE_P);
		if ((NIL != el_query)) {
			checkType(el_query, $sym333$POSSIBLY_INFERENCE_SENTENCE_P);
	...
	public static final SubLObject set_inference_input_query_properties(
			SubLObject inference, SubLObject query_properties) {
		checkType(inference, $sym2$INFERENCE_P);
	...
	public static final SubLObject set_inference_el_bindings(
			SubLObject inference, SubLObject el_bindings) {
		checkType(inference, $sym2$INFERENCE_P);
	...
	public static final SubLObject set_inference_explanatory_subquery(
			SubLObject inference, SubLObject explanatory_subquery) {
		checkType(inference, $sym2$INFERENCE_P);
	...
	public static final SubLObject set_inference_non_explanatory_subquery(
			SubLObject inference, SubLObject non_explanatory_subquery) {
		checkType(inference, $sym2$INFERENCE_P);
		checkType(non_explanatory_subquery,
				$sym339$NON_EXPLANATORY_SUBQUERY_SPEC_P);
		_csetf_infrnc_non_explanatory_subquery(inference,
				non_explanatory_subquery);
		return inference;
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 43325)
	public static final SubLObject set_inference_free_hl_vars(
			SubLObject inference, SubLObject free_hl_vars) {
		checkType(inference, $sym2$INFERENCE_P);
	...
	public static final SubLObject set_inference_hypothetical_bindings(
			SubLObject inference, SubLObject hypothetical_bindings) {
		checkType(inference, $sym2$INFERENCE_P);
	...
	public static final SubLObject set_inference_status(SubLObject inference,
		...
		if ((NIL == inference_datastructures_enumerated_types
				.inference_suspend_status_applicableP(status))) {
	...
	public static final SubLObject set_inference_suspend_status(
			SubLObject inference, SubLObject suspend_status) {
		checkType(inference, $sym2$INFERENCE_P);
	...
	public static final SubLObject set_inference_root_link(
			SubLObject inference, SubLObject root_link) {
		checkType(inference, $sym2$INFERENCE_P);
	...
	public static final SubLObject set_inference_control_process(
			SubLObject inference, SubLObject process) {
		checkType(inference, $sym2$INFERENCE_P);
		if ((NIL != process)) {
	...
	public static final SubLObject set_inference_max_transformation_depth_reached(
			SubLObject inference, SubLObject depth) {
		checkType(inference, $sym2$INFERENCE_P);
	...
	public static final SubLObject set_inference_disjunction_free_el_vars_policy(
			SubLObject inference, SubLObject disjunction_free_el_vars_policy) {
		checkType(inference, $sym2$INFERENCE_P);
		checkType(disjunction_free_el_vars_policy,
				$sym346$INFERENCE_DISJUNCTION_FREE_EL_VARS_POLICY_P);
		_csetf_infrnc_disjunction_free_el_vars_policy(inference,
				disjunction_free_el_vars_policy);
		return inference;
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 45541)
	public static final SubLObject set_inference_result_uniqueness_criterion(
			SubLObject inference, SubLObject criterion) {
		checkType(inference, $sym2$INFERENCE_P);
	...
	public static final SubLObject set_inference_allow_hl_predicate_transformation(
			SubLObject inference, SubLObject allowP) {
		checkType(inference, $sym2$INFERENCE_P);
	...
	public static final SubLObject set_inference_allow_unbound_predicate_transformation(
			SubLObject inference, SubLObject allowP) {
		checkType(inference, $sym2$INFERENCE_P);
		checkType(allowP, $sym348$BOOLEANP);
	...
	public static final SubLObject set_inference_allow_evaluatable_predicate_transformation(
			SubLObject inference, SubLObject allowP) {
		checkType(inference, $sym2$INFERENCE_P);
		checkType(allowP, $sym348$BOOLEANP);
		_csetf_infrnc_allow_evaluatable_predicate_transformationP(inference,
				allowP);
		return inference;
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 46556)
	public static final SubLObject set_inference_allow_indeterminate_results(
			SubLObject inference, SubLObject allowP) {
		checkType(inference, $sym2$INFERENCE_P);
		checkType(allowP, $sym348$BOOLEANP);
	...
	public static final SubLObject set_inference_allowed_rules(
			SubLObject inference, SubLObject allowed_rules) {
		checkType(inference, $sym2$INFERENCE_P);
	...
	public static final SubLObject set_inference_forbidden_rules(
			SubLObject inference, SubLObject forbidden_rules) {
		checkType(inference, $sym2$INFERENCE_P);
	...
	public static final SubLObject set_inference_allowed_modules(
			SubLObject inference, SubLObject allowed_modules) {
		checkType(inference, $sym2$INFERENCE_P);
	...
	public static final SubLObject set_inference_allow_abnormality_checking(
			SubLObject inference, SubLObject allowP) {
		checkType(inference, $sym2$INFERENCE_P);
		checkType(allowP, $sym348$BOOLEANP);
	...
	public static final SubLObject set_inference_transitive_closure_mode(
			SubLObject inference, SubLObject transitive_closure_mode) {
		checkType(inference, $sym2$INFERENCE_P);
		checkType(transitive_closure_mode,
				$sym350$INFERENCE_TRANSITIVE_CLOSURE_MODE_P);
		_csetf_infrnc_transitive_closure_mode(inference,
				transitive_closure_mode);
		return inference;
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 48198)
	public static final SubLObject set_inference_problem_store_private(
			SubLObject inference, SubLObject privateP) {
		checkType(inference, $sym2$INFERENCE_P);
	...
	public static final SubLObject set_inference_continuable(
			SubLObject inference, SubLObject continuableP) {
	...
	public static final SubLObject set_inference_browsable(
			SubLObject inference, SubLObject browsableP) {
	...
	public static final SubLObject set_inference_return_type(
			SubLObject inference, SubLObject return_type) {
	...
	public static final SubLObject set_inference_answer_language(
			SubLObject inference, SubLObject answer_language) {
		checkType(inference, $sym2$INFERENCE_P);
	...
	public static final SubLObject set_inference_cache_results(
			SubLObject inference, SubLObject cache_resultsP) {
		checkType(inference, $sym2$INFERENCE_P);
	...
	public static final SubLObject set_inference_max_number(
			SubLObject inference, SubLObject max_number) {
		if ((NIL != max_number)) {
	...
	public static final SubLObject set_inference_forward_max_time(
			SubLObject inference, SubLObject forward_max_time) {
		...
		}
		{
			...
			if ((max_time.isInteger() && forward_max_time.isInteger() && max_time
					.numL(forward_max_time))) {
				Errors.error($str355$Forward_max_time__s_cannot_be_gre,
						forward_max_time, max_time);
			}
		}
	...
	public static final SubLObject set_inference_max_proof_depth(
			SubLObject inference, SubLObject max_proof_depth) {
	...
	public static final SubLObject set_inference_max_transformation_depth(
			SubLObject inference, SubLObject max_transformation_depth) {
		if ((NIL != max_transformation_depth)) {
			checkType(max_transformation_depth, $sym345$NON_NEGATIVE_INTEGER_P);
		}
		_csetf_infrnc_max_transformation_depth(inference,
				max_transformation_depth);
		return inference;
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 51819)
	public static final SubLObject set_inference_probably_approximately_done(
			SubLObject inference, SubLObject probability) {
	...
	public static final SubLObject set_inference_metrics_template(
			SubLObject inference, SubLObject metrics_template) {
		{
			...
			checkType(list_var, $sym357$NON_DOTTED_LIST_P);
			{
				...
				SubLObject elem = NIL;
				for (elem = cdolist_list_var.first(); (NIL != cdolist_list_var); cdolist_list_var = cdolist_list_var
						.rest(), elem = cdolist_list_var.first()) {
	...
	public static final SubLObject set_inference_start_universal_time(
			SubLObject inference, SubLObject universal_time) {
		checkType(inference, $sym2$INFERENCE_P);
	...
	public static final SubLObject set_inference_start_internal_real_time(
			SubLObject inference, SubLObject internal_real_time) {
		checkType(inference, $sym2$INFERENCE_P);
	...
	public static final SubLObject set_inference_end_internal_real_time(
			SubLObject inference, SubLObject end_internal_real_time) {
		checkType(inference, $sym2$INFERENCE_P);
	...
	public static final SubLObject set_inference_pad_internal_real_time(
			SubLObject inference, SubLObject pad_internal_real_time) {
		checkType(inference, $sym2$INFERENCE_P);
		if ((NIL != pad_internal_real_time)) {
			checkType(pad_internal_real_time,
	...
	public static final SubLObject set_inference_cumulative_time(
			SubLObject inference, SubLObject cumulative_time) {
		checkType(inference, $sym2$INFERENCE_P);
	...
	public static final SubLObject set_inference_step_count(
			SubLObject inference, SubLObject step_count) {
	...
	public static final SubLObject increment_inference_step_count(
			SubLObject inference) {
		_csetf_infrnc_step_count(inference,
				Numbers.add(infrnc_step_count(inference), ONE_INTEGER));
		return inference;
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 54046)
	public static final SubLObject set_inference_cumulative_step_count(
			SubLObject inference, SubLObject cumulative_step_count) {
	...
	public static final SubLObject increment_inference_cumulative_step_count(
			SubLObject inference) {
		_csetf_infrnc_cumulative_step_count(inference, Numbers.add(
				infrnc_cumulative_step_count(inference), ONE_INTEGER));
		return inference;
	}
	...
	public static final SubLObject set_inference_halt_conditions(
			SubLObject inference, SubLObject halt_conditions) {
		checkType(inference, $sym2$INFERENCE_P);
		{
	...
	public static final SubLObject inference_ids(SubLObject inference) {
		checkType(inference, $sym2$INFERENCE_P);
		return list(
				Errors.handleMissingMethodError("This call was replaced for LarKC purposes. Originally a method was called. Refer to number 35773"),
				inference_suid(inference));
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 57477)
	public static final SubLObject inference_no_free_hl_varsP(
			SubLObject inference) {
	...
	public static final SubLObject inference_root_mapped_problem(
			SubLObject inference) {
		{
			SubLObject root_link = inference_root_link(inference);
			if ((NIL != root_link)) {
				return inference_worker_answer
						.answer_link_supporting_mapped_problem(root_link);
			}
		}
		return NIL;
	}
	...
	public static final SubLObject inference_unique_wrt_bindingsP(
			SubLObject inference) {
		return Equality.eq($kw390$BINDINGS,
				inference_result_uniqueness_criterion(inference));
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 61653)
	public static final SubLObject inference_compute_answer_justificationsP(
			SubLObject inference) {
		return inference_datastructures_problem_store
				.problem_store_compute_answer_justificationsP(inference_problem_store(inference));
	}

	/**
	 * Return T iff INFERENCE not only has a private problem store, but the
	 * current set of dynamic properties will never be extended.
	 */
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 62065)
	public static final SubLObject inference_problem_store_private_wrt_dynamic_propertiesP(
			SubLObject inference) {
	...
	public static final SubLObject inference_allows_use_of_all_rulesP(
			SubLObject inference) {
		return makeBoolean((($kw383$ALL == inference_allowed_rules(inference)) && ($kw391$NONE == inference_forbidden_rules(inference))));
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 63154)
	public static final SubLObject inference_allows_use_of_ruleP(
			SubLObject inference, SubLObject rule) {
		if ((NIL != inference_allows_use_of_all_rulesP(inference))) {
			...
			return makeBoolean((NIL == set.set_memberP(rule,
					inference_forbidden_rules(inference))));
		}
		return NIL;
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 64501)
	public static final SubLObject inference_allows_use_of_all_modulesP(
			SubLObject inference) {
	...
	public static final SubLObject inference_allows_use_of_moduleP(
			SubLObject inference, SubLObject hl_module) {
		return makeBoolean(((NIL != inference_allows_use_of_all_modulesP(inference)) || (NIL != Errors
	...
	public static final SubLObject inference_forget_extra_resultsP(
			SubLObject inference) {
		return inference_datastructures_enumerated_types
				.inference_properties_forget_extra_resultsP(inference_input_query_properties(inference));
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 65163)
	public static final SubLObject find_inference_answer_by_id(
			SubLObject inference, SubLObject id) {
	...
	public static final SubLObject inference_maintain_term_working_setP(
			SubLObject inference) {
		checkType(inference, $sym2$INFERENCE_P);
		return list_utilities
				.sublisp_boolean(inference_problem_working_time_data(inference));
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 69196)
	public static final SubLObject inference_halt_condition_presentP(
			SubLObject inference, SubLObject halt_condition) {
		checkType(inference, $sym2$INFERENCE_P);
		checkType(halt_condition, $sym363$INFERENCE_HALT_CONDITION_P);
		return list_utilities.member_eqP(halt_condition,
				infrnc_halt_conditions(inference));
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 71135)
	public static final SubLObject compute_inference_pad_internal_real_time(
			SubLObject inference) {
		{
			...
			if ((NIL != number_utilities.positive_infinity_p(pad_seconds))) {
				...
				{
					SubLObject pad_seconds_remaining = Numbers.subtract(
							pad_seconds, inference_cumulative_time(inference));
	...
	public static final SubLObject initialize_pad_table(SubLObject filename) {
		{
			SubLObject scaled_times_to_first_answer = misc_utilities
					.scale_by_bogomips(
							inference_pad_data.$non_tkb_final_times_to_first_answer$
									.getGlobalValue(),
							inference_pad_data.$non_tkb_final_bogomips$
									.getGlobalValue());
			$pad_times_to_first_answer$
					.setGlobalValue(scaled_times_to_first_answer);
		}
		return Sequences.length($pad_times_to_first_answer$.getGlobalValue());
	}

	/**
	 * @return positive-potentially-infinite-number-p (seconds or
	 *         :positive-infinity)
	 */
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 72258)
	public static final SubLObject probably_approximately_done_cutoff_time(
			SubLObject probability) {
		if (((NIL != list_utilities.safe_E(ONE_INTEGER, probability)) || (NIL == Errors
	...
	public static final SubLObject inference_note_transformation_depth(
			SubLObject inference, SubLObject depth) {
		{
			...
			if (depth.numG(max_transformation_depth_reached)) {
				return inference_note_new_transformation_depth_reached(
						inference, depth);
			}
		}
		return NIL;
	...
	public static final SubLObject inference_note_new_transformation_depth_reached(
			SubLObject inference, SubLObject depth) {
		set_inference_max_transformation_depth_reached(inference, depth);
		possibly_signal_inference_new_transformation_depth_reached(inference,
				depth);
		if ((NIL != inference_halt_condition_presentP(inference,
				$kw398$LOOK_NO_DEEPER_FOR_ADDITIONAL_ANSWERS))) {
			if ((NIL != subl_promotions
					.positive_integer_p(inference_answer_count(inference)))) {
				set_inference_suspend_status(inference,
						$kw398$LOOK_NO_DEEPER_FOR_ADDITIONAL_ANSWERS);
	...
	public static final SubLObject find_inference_answer_by_bindings(
			SubLObject inference, SubLObject v_bindings) {
			...
			if ((NIL == id_index.id_index_objects_empty_p(idx, $kw369$SKIP))) {
				{
					...
					if ((NIL == id_index.id_index_old_objects_empty_p(idx_32,
							$kw369$SKIP))) {
						{
							...
							for (v_iteration = ZERO_INTEGER; v_iteration
									...
									v_iteration, ONE_INTEGER)) {
								{
									...
									SubLObject answer = Vectors.aref(
											vector_var, id);
									if ((!(((NIL != id_index
											.id_index_tombstone_p(answer)) && (NIL != id_index
											.id_index_skip_tombstones_p($kw369$SKIP)))))) {
										if ((NIL != id_index
												.id_index_tombstone_p(answer))) {
											answer = $kw369$SKIP;
										}
	...
	public static final SubLObject inference_all_new_answers(
			SubLObject inference) {
		{
			final SubLThread thread = SubLProcess.currentSubLThread();
			{
				...
				SubLObject id = NIL;
				for (id = start_id; (!(id.numGE(end_id))); id = number_utilities
						.f_1X(id)) {
					{
						SubLObject answer = find_inference_answer_by_id(inf, id);
						if ((NIL == Errors.$ignore_mustsP$
								.getDynamicValue(thread))) {
							if ((NIL == answer)) {
								Errors.error($str399$got_a_null_answer_for__s,
										inference);
							}
						}
						answers = cons(answer, answers);
	...
	public static final SubLObject inference_interrupt_signaledP(
			SubLObject inference) {
		return makeBoolean((NIL == queues
				.queue_empty_p(inference_interrupting_processes(inference))));
	}
	...
	public static final SubLObject forward_inference_p(SubLObject inference) {
		return makeBoolean(((NIL != inference_p(inference)) && (NIL != inference_datastructures_problem_store
				.problem_store_forwardP(inference_problem_store(inference)))));
	}
	...
	public static final SubLObject abductive_inference_p(SubLObject inference) {
		return makeBoolean(((NIL != inference_p(inference)) && (NIL != inference_datastructures_problem_store
				.problem_store_abduction_allowedP(inference_problem_store(inference)))));
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 78666)
	public static final SubLObject inference_set_static_properties(
			SubLObject inference, SubLObject static_properties) {
		checkType(static_properties, $sym404$INFERENCE_STATIC_PROPERTIES_P);
		{
			SubLObject disjunction_free_el_vars_policy = inference_datastructures_enumerated_types
					.inference_properties_disjunction_free_el_vars_policy(static_properties);
			set_inference_disjunction_free_el_vars_policy(inference,
					disjunction_free_el_vars_policy);
		}
		{
			SubLObject uniqueness_criterion = inference_datastructures_enumerated_types
					.inference_properties_uniqueness_criterion(static_properties);
			set_inference_result_uniqueness_criterion(inference,
					uniqueness_criterion);
		}
		{
			SubLObject allow_hl_predicate_transformationP = inference_datastructures_enumerated_types
					.inference_properties_allow_hl_predicate_transformationP(static_properties);
			set_inference_allow_hl_predicate_transformation(inference,
					allow_hl_predicate_transformationP);
		}
		{
			SubLObject allow_unbound_predicate_transformationP = inference_datastructures_enumerated_types
					.inference_properties_allow_unbound_predicate_transformationP(static_properties);
			set_inference_allow_unbound_predicate_transformation(inference,
					allow_unbound_predicate_transformationP);
		}
		{
			SubLObject allow_evaluatable_predicate_transformationP = inference_datastructures_enumerated_types
					.inference_properties_allow_evaluatable_predicate_transformationP(static_properties);
			set_inference_allow_evaluatable_predicate_transformation(inference,
					allow_evaluatable_predicate_transformationP);
		}
		{
			SubLObject allow_indeterminate_resultsP = inference_datastructures_enumerated_types
					.inference_properties_allow_indeterminate_resultsP(static_properties);
			set_inference_allow_indeterminate_results(inference,
					allow_indeterminate_resultsP);
		}
		{
			SubLObject allowed_rules = inference_datastructures_enumerated_types
					.inference_properties_allowed_rules(static_properties);
			...
			if (($kw383$ALL == allowed_rules)) {
				...
				set_inference_allowed_rules(inference,
						set_utilities.construct_set_from_list(allowed_rules,
								Symbols.symbol_function(EQ), UNPROVIDED));
			}
		}
		{
			SubLObject forbidden_rules = inference_datastructures_enumerated_types
					.inference_properties_forbidden_rules(static_properties);
			...
			if (($kw391$NONE == forbidden_rules)) {
				...
				set_inference_forbidden_rules(inference,
						set_utilities.construct_set_from_list(forbidden_rules,
								Symbols.symbol_function(EQ), UNPROVIDED));
			}
		}
		{
			SubLObject allowed_modules = inference_datastructures_enumerated_types
					.inference_properties_allowed_modules(static_properties);
			set_inference_allowed_modules(inference, allowed_modules);
		}
		{
			SubLObject allow_abnormality_checkingP = inference_datastructures_enumerated_types
					.inference_properties_allow_abnormality_checkingP(static_properties);
			set_inference_allow_abnormality_checking(inference,
					allow_abnormality_checkingP);
		}
		{
			SubLObject transitive_closure_mode = inference_datastructures_enumerated_types
					.inference_properties_transitive_closure_mode(static_properties);
			set_inference_transitive_closure_mode(inference,
					transitive_closure_mode);
		}
		{
			SubLObject maintain_term_working_setP = inference_datastructures_enumerated_types
					.inference_properties_maintain_term_working_setP(static_properties);
			if ((NIL != maintain_term_working_setP)) {
				Errors.handleMissingMethodError("This call was replaced for LarKC purposes. Originally a method was called. Refer to number 35782");
			}
		}
		{
			SubLObject events = inference_datastructures_enumerated_types
					.inference_properties_events(static_properties);
			set_inference_events(inference, events);
		}
		{
			SubLObject halt_conditions = inference_datastructures_enumerated_types
					.inference_properties_halt_conditions(static_properties);
	...
	public static final SubLObject update_inference_input_query_properties(
			SubLObject inference, SubLObject input_dynamic_properties) {
		checkType(input_dynamic_properties, $sym407$QUERY_DYNAMIC_PROPERTIES_P);
		{
			...
			SubLObject static_mode = inference_datastructures_enumerated_types
					.inference_properties_mode(input_query_properties);
			SubLObject dynamic_mode = inference_datastructures_enumerated_types
					.inference_properties_mode(input_dynamic_properties);
			SubLObject mode_mismatchP = makeBoolean((static_mode != dynamic_mode));
			if ((NIL != mode_mismatchP)) {
				input_query_properties = inference_datastructures_enumerated_types
						.extract_query_static_properties(inference_strategist
								.explicify_inference_mode_defaults(input_query_properties));
				input_query_properties = conses_high.putf(
						input_query_properties, $kw408$INFERENCE_MODE,
						dynamic_mode);
			...
			}
			{
				...
				for (remainder = input_dynamic_properties; (NIL != remainder); remainder = conses_high
						.cddr(remainder)) {
					{
						SubLObject property = remainder.first();
						SubLObject value = conses_high.cadr(remainder);
						input_query_properties = conses_high.putf(
								input_query_properties, property, value);
					}
				}
			}
			set_inference_input_query_properties(inference,
					input_query_properties);
		}
		return NIL;
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 82921)
	public static final SubLObject add_inference_relevant_problem(
	...
	public static final SubLObject remove_inference_relevant_problem(
			SubLObject inference, SubLObject problem) {
		checkType(inference, $sym2$INFERENCE_P);
		checkType(problem, $sym409$PROBLEM_P);
	...
	public static final SubLObject clear_inference_relevant_problems(
			SubLObject inference) {
		checkType(inference, $sym2$INFERENCE_P);
	...
	public static final SubLObject clear_inference_strategy_set(
			SubLObject inference) {
		checkType(inference, $sym2$INFERENCE_P);
	...
	public static final SubLObject reset_inference_new_answer_id(
			SubLObject inference) {
		{
	...
	public static final SubLObject inference_next_new_answer_id(
			SubLObject inference) {
		{
			SubLObject v_id_index = inference_answer_id_index(inference);
	...
	public static final SubLObject add_inference_new_answer_by_id(
			SubLObject inference, SubLObject answer) {
	...
	public static final SubLObject add_inference_new_answer_by_bindings(
			SubLObject inference, SubLObject answer) {
		checkType(answer, $sym411$INFERENCE_ANSWER_P);
		{
	...
	public static final SubLObject reset_inference_new_answer_justifications(
			SubLObject inference) {
	...
	public static final SubLObject add_inference_new_answer_justification(
			SubLObject inference, SubLObject answer_justification) {
		checkType(answer_justification,
				$sym412$INFERENCE_ANSWER_JUSTIFICATION_P);
		queues.enqueue(answer_justification,
				inference_new_answer_justifications(inference));
		return inference;
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 86532)
	public static final SubLObject clear_inference_control_process(
			SubLObject inference) {
	...
	public static final SubLObject set_inference_control_process_to_me(
			SubLObject inference) {
		return set_inference_control_process(inference,
				Threads.current_process());
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 86974)
	public static final SubLObject increment_inference_cumulative_time(
			SubLObject inference, SubLObject time_delta) {
		{
	...
	public static final SubLObject reset_inference_new_answers(
			SubLObject inference) {
	...
	public static final SubLObject add_inference_new_answer(
			SubLObject inference, SubLObject answer) {
		checkType(answer, $sym411$INFERENCE_ANSWER_P);
	...
	public static final SubLObject initialize_inference_time_properties(
			SubLObject inference) {
		{
			...
			set_inference_start_universal_time(inference, now);
			{
				...
				SubLObject end_time = ((NIL != max_time) ? ((SubLObject) Errors
						.handleMissingMethodError("This call was replaced for LarKC purposes. Originally a method was called. Refer to number 23123"))
						: NIL);
	...
	public static final SubLObject finalize_inference_time_properties(
			SubLObject inference) {
		{
	...
	public static final SubLObject inference_elapsed_internal_real_time_since_start(
			SubLObject inference) {
		{
			SubLObject start = inference_start_internal_real_time(inference);
			SubLObject elapsed = numeric_date_utilities
					.elapsed_internal_real_time(start, UNPROVIDED);
			return elapsed;
		}
	}

	/**
	 * @return the time spent so far on the current continuation of this
	 *         INFERENCE.
	 */
			...
			if ((NIL != running_inference_p(inference))) {
				if ((NIL != seconds_granularityP)) {
				...
				} else {
					{
						...
						seconds = numeric_date_utilities
								.elapsed_internal_real_time_to_elapsed_seconds(elapsed);
					}
				}
			}
			return seconds;
	...
	public static final SubLObject simplest_inference_p(SubLObject object) {
		return makeBoolean(((NIL != inference_p(object)) && ($kw416$SIMPLEST == inference_type(object))));
	}
	...
	public static final SubLObject simplest_inference_strategy(
			SubLObject inference) {
	...
	public static final SubLObject set_simplest_inference_strategy(
			SubLObject inference, SubLObject strategy) {
		checkType(inference, $sym417$SIMPLEST_INFERENCE_P);
		checkType(strategy, $sym410$STRATEGY_P);
	...
	public static final SubLObject new_simplest_inference_of_type(
			SubLObject store, SubLObject strategy_type) {
		checkType(store, $sym324$PROBLEM_STORE_P);
		checkType(strategy_type, $sym418$STRATEGY_TYPE_P);
		{
			SubLObject inference = new_simplest_inference(store);
			SubLObject strategy = inference_datastructures_strategy
					.new_strategy(strategy_type, inference);
	...
	public static final class $inference_answer_native extends SubLStructNative {
		...
		public SubLObject setField5(SubLObject value) {
			return $justifications = value;
		}

		public SubLObject setField6(SubLObject value) {
			return $elapsed_creation_time = value;
		}
		...
		public SubLObject $step_count = NIL;
		private static final SubLStructDeclNative structDecl = Structures
				.makeStructDeclNative($inference_answer_native.class,
						$sym419$INFERENCE_ANSWER, $sym411$INFERENCE_ANSWER_P,
						$list420, $list421, new String[] { "$suid",
								"$inference", "$bindings", "$justifications",
								"$elapsed_creation_time", "$step_count" },
						$list422, $list423, $sym424$PRINT_INFERENCE_ANSWER);
	}
	...
	public static final class $inference_answer_p$UnaryFunction extends
			UnaryFunction {
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 94251)
	public static final SubLObject _csetf_inf_answer_inference(
			SubLObject object, SubLObject value) {
		checkType(object, $sym411$INFERENCE_ANSWER_P);
		return object.setField3(value);
	}
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 94251)
	public static final SubLObject _csetf_inf_answer_bindings(
			SubLObject object, SubLObject value) {
		checkType(object, $sym411$INFERENCE_ANSWER_P);
		return object.setField4(value);
	}
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 94251)
	public static final SubLObject _csetf_inf_answer_justifications(
			SubLObject object, SubLObject value) {
		checkType(object, $sym411$INFERENCE_ANSWER_P);
		return object.setField5(value);
	}
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 94251)
	public static final SubLObject _csetf_inf_answer_elapsed_creation_time(
			SubLObject object, SubLObject value) {
		checkType(object, $sym411$INFERENCE_ANSWER_P);
		return object.setField6(value);
	}
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 94251)
	public static final SubLObject _csetf_inf_answer_step_count(
			SubLObject object, SubLObject value) {
		checkType(object, $sym411$INFERENCE_ANSWER_P);
		return object.setField7(value);
	}
			...
			for (next = arglist; (NIL != next); next = conses_high.cddr(next)) {
				{
					...
					if (pcase_var.eql($kw194$SUID)) {
						...
						_csetf_inf_answer_elapsed_creation_time(v_new,
								current_value);
					} else if (pcase_var.eql($kw253$STEP_COUNT)) {
	...
	public static final SubLObject new_inference_answer(SubLObject inference,
		...
		checkType(v_bindings, $sym444$BINDINGS_P);
		{
			...
			if (suid.isZero()) {
				inference_metrics
						.increment_successful_inference_historical_count();
			}
	...
	public static final SubLObject find_or_create_inference_answer(
			SubLObject inference, SubLObject v_bindings) {
		checkType(inference, $sym2$INFERENCE_P);
		{
			SubLObject answer = find_inference_answer_by_bindings(inference,
					v_bindings);
			SubLObject newP = NIL;
			if ((NIL == answer)) {
	...
	public static final SubLObject inference_answer_suid(
	...
	public static final SubLObject inference_answer_inference(
			SubLObject inference_answer) {
		checkType(inference_answer, $sym411$INFERENCE_ANSWER_P);
	...
	public static final SubLObject inference_answer_bindings(
			SubLObject inference_answer) {
		checkType(inference_answer, $sym411$INFERENCE_ANSWER_P);
	...
	public static final SubLObject inference_answer_justifications(
			SubLObject inference_answer) {
		checkType(inference_answer, $sym411$INFERENCE_ANSWER_P);
	...
	public static final SubLObject set_inference_answer_bindings(
			SubLObject inference_answer, SubLObject v_bindings) {
		checkType(v_bindings, $sym444$BINDINGS_P);
	...
	public static final SubLObject set_inference_answer_elapsed_creation_time(
			SubLObject inference_answer, SubLObject elapsed_creation_time) {
		_csetf_inf_answer_elapsed_creation_time(inference_answer,
				elapsed_creation_time);
		return inference_answer;
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 100475)
	public static final SubLObject set_inference_answer_step_count(
			SubLObject inference_answer, SubLObject step_count) {
	...
	public static final SubLObject find_inference_answer_justification(
			SubLObject inference_answer, SubLObject hl_justification) {
		{
			SubLObject existing_justifications = inference_answer_justifications(inference_answer);
			return Sequences.find(hl_justification, existing_justifications,
	...
	public static final SubLObject inference_answer_result_bindings(
			SubLObject answer) {
		{
			...
			if (pcase_var.eql($kw452$HL)) {
				...
				Errors.error($str454$_S_was_not_an_inference_answer_la,
						answer_language);
			}
		}
		return NIL;
	...
	public static final SubLObject add_inference_answer_justification(
			SubLObject inference_answer, SubLObject justification) {
		checkType(justification, $sym412$INFERENCE_ANSWER_JUSTIFICATION_P);
		_csetf_inf_answer_justifications(
				inference_answer,
				cons(justification, inf_answer_justifications(inference_answer)));
		return inference_answer;
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 104507)
	public static final SubLObject initialize_inference_answer_elapsed_creation_time(
			SubLObject inference_answer) {
		{
			...
			SubLObject elapsed = numeric_date_utilities
					.elapsed_internal_real_time(start, UNPROVIDED);
			set_inference_answer_elapsed_creation_time(inference_answer,
					elapsed);
			return inference_answer;
		}
	}

	public static final class $inference_answer_justification_native extends
			SubLStructNative {
		public SubLStructDecl getStructDecl() {
			return structDecl;
		}
		...
		private static final SubLStructDeclNative structDecl = Structures
				.makeStructDeclNative(
						$inference_answer_justification_native.class,
						$sym456$INFERENCE_ANSWER_JUSTIFICATION,
						$sym412$INFERENCE_ANSWER_JUSTIFICATION_P, $list457,
						$list458, new String[] { "$answer", "$supports",
								"$proofs" }, $list459, $list460,
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 105124)
	public static final SubLObject _csetf_inf_ans_just_answer(
			SubLObject object, SubLObject value) {
		checkType(object, $sym412$INFERENCE_ANSWER_JUSTIFICATION_P);
		return object.setField2(value);
	}
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 105124)
	public static final SubLObject _csetf_inf_ans_just_supports(
			SubLObject object, SubLObject value) {
		checkType(object, $sym412$INFERENCE_ANSWER_JUSTIFICATION_P);
		return object.setField3(value);
	}
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 105124)
	public static final SubLObject _csetf_inf_ans_just_proofs(
			SubLObject object, SubLObject value) {
		checkType(object, $sym412$INFERENCE_ANSWER_JUSTIFICATION_P);
		return object.setField4(value);
	}
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 105124)
	public static final SubLObject make_inference_answer_justification(
			SubLObject arglist) {
		if ((arglist == UNPROVIDED)) {
			arglist = NIL;
		}
	...
	public static final SubLObject new_inference_answer_justification(
			SubLObject answer, SubLObject supports) {
		checkType(answer, $sym411$INFERENCE_ANSWER_P);
	...
	public static final SubLObject find_or_create_inference_answer_justification(
			SubLObject inference, SubLObject v_bindings, SubLObject supports) {
		checkType(inference, $sym2$INFERENCE_P);
		{
			SubLObject answer = find_or_create_inference_answer(inference,
					v_bindings);
			SubLObject justification = find_inference_answer_justification(
					answer, supports);
			SubLObject newP = NIL;
			if ((NIL == justification)) {
				justification = new_inference_answer_justification(answer,
						supports);
	...
	public static final SubLObject inference_answer_justification_answer(
	...
	public static final SubLObject inference_answer_justification_supports(
			SubLObject justification) {
		checkType(justification, $sym412$INFERENCE_ANSWER_JUSTIFICATION_P);
	...
	public static final class $inference_answer_justification_supports$UnaryFunction
		...
		public $inference_answer_justification_supports$UnaryFunction() {
			super(
					extractFunctionNamed("INFERENCE-ANSWER-JUSTIFICATION-SUPPORTS"));
		}
	...
	public static final SubLObject add_inference_answer_justification_proof(
			SubLObject justification, SubLObject proof) {
		checkType(proof, $sym496$PROOF_P);
		_csetf_inf_ans_just_proofs(justification,
				cons(proof, inf_ans_just_proofs(justification)));
		return justification;
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 114910)
	public static final SubLObject inference_compute_metrics(
			SubLObject inference) {
		{
			SubLObject template = inference_metrics_template(inference);
			SubLObject metrics = list_utilities.tree_gather(template,
					Symbols.symbol_function($sym500$INFERENCE_QUERY_METRIC_P),
					UNPROVIDED, UNPROVIDED, UNPROVIDED);
			SubLObject answer = conses_high.copy_tree(template);
			SubLObject metrics_bindings = inference_compute_metrics_alist(
					inference, metrics);
			answer = conses_high.nsublis(metrics_bindings, answer,
					Symbols.symbol_function(EQ), UNPROVIDED);
			return answer;
		}
	}
	...
	/**
	 * Return an alist of the form (METRIC . VALUE) where METRIC is a metric in
	 * METRICS and VALUE is the result of that metric when computed on
	 * INFERENCE.
	 */
	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 115757)
	public static final SubLObject inference_compute_metrics_alist(
			SubLObject inference, SubLObject metrics) {
		{
			SubLObject store = inference_problem_store(inference);
			...
			for (metric = cdolist_list_var.first(); (NIL != cdolist_list_var); cdolist_list_var = cdolist_list_var
					.rest(), metric = cdolist_list_var.first()) {
				{
					...
					if ((NIL != metric_object)) {
						{
							...
							metrics_bindings = cons(cons(metric, result),
									metrics_bindings);
						}
					} else {
						{
							...
							if (pcase_var.eql($kw503$NEW_ROOT_TIMES)) {
								{
									...
									if ((NIL != inference_balanced_tactician_datastructures
											.balanced_strategy_p(strategy))) {
										{
											...
											metrics_bindings = cons(
													cons($kw503$NEW_ROOT_TIMES,
															new_root_times),
													metrics_bindings);
										}
									}
							...
							} else if (pcase_var.eql($kw504$NEW_ROOT_COUNT)) {
								{
									...
									.eql($kw505$PROBLEM_CREATION_TIMES)) {
								{
									...
									metrics_bindings = cons(
											cons($kw505$PROBLEM_CREATION_TIMES,
													problem_creation_times),
											metrics_bindings);
								}
							} else if (pcase_var
									.eql($kw506$INFERENCE_ANSWER_QUERY_PROPERTIES)) {
								...
								metrics_bindings = cons(
										cons($kw506$INFERENCE_ANSWER_QUERY_PROPERTIES,
												answer_query_properties),
										metrics_bindings);
							} else if (pcase_var
									.eql($kw507$INFERENCE_STRONGEST_QUERY_PROPERTIES)) {
								if ((NIL == answer_query_properties)) {
									answer_query_properties = Errors
								...
								if ((NIL != answer_query_properties)) {
									metrics_bindings = cons(
											cons($kw507$INFERENCE_STRONGEST_QUERY_PROPERTIES,
													Errors.handleMissingMethodError("This call was replaced for LarKC purposes. Originally a method was called. Refer to number 35129")),
											metrics_bindings);
								}
							} else if (pcase_var
									.eql($kw508$INFERENCE_MOST_EFFICIENT_QUERY_PROPERTIES)) {
								{
									...
									metrics_bindings = cons(
											cons($kw508$INFERENCE_MOST_EFFICIENT_QUERY_PROPERTIES,
													strengthened_properties),
											metrics_bindings);
								}
							} else {
								Errors.sublisp_break(
										$str509$time_to_implement_metric__S,
										new SubLObject[] { metric });
							}
						}
					}
				}
	...
	public static final SubLObject inference_problem_working_time_lock(
			SubLObject inference) {
		{
	...
	public static final SubLObject inference_note_tactic_executed(
			SubLObject inference, SubLObject tactic) {
		{
			...
			if ((NIL != inference_maintain_term_working_setP(inference))) {
				{
					...
					try {
						release = Locks.seize_lock(lock);
						{
							...
							SubLObject already_being_worked_on = Hashtables
									.gethash_without_values(problem, table,
											UNPROVIDED);
	...
	public static final SubLObject inference_note_problem_pending(
			SubLObject inference, SubLObject problem) {
		{
			SubLObject result = NIL;
			if ((NIL != inference_maintain_term_working_setP(inference))) {
	...
	public static final SubLObject possibly_signal_new_inference_answer(
			SubLObject inference, SubLObject new_answer) {
		return NIL;
	}
	...
	public static final SubLObject possibly_signal_inference_status_change(
			SubLObject inference) {
		return NIL;
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-inference.lisp", position = 124447)
	public static final SubLObject possibly_signal_inference_new_transformation_depth_reached(
			SubLObject inference, SubLObject new_depth) {
		return NIL;
	}

	public static final SubLObject declare_inference_datastructures_inference_file() {
		declareFunction(myName, "inference_type_p", "INFERENCE-TYPE-P", 1, 0,
				false);
		declareFunction(myName, "inference_print_function_trampoline",
				"INFERENCE-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
		...
		declareFunction(myName, "infrnc_problem_store", "INFRNC-PROBLEM-STORE",
				1, 0, false);
		declareFunction(myName, "infrnc_forward_propagate",
				"INFRNC-FORWARD-PROPAGATE", 1, 0, false);
		declareFunction(myName, "infrnc_input_mt", "INFRNC-INPUT-MT", 1, 0,
				false);
		declareFunction(myName, "infrnc_input_el_query",
				"INFRNC-INPUT-EL-QUERY", 1, 0, false);
		declareFunction(myName, "infrnc_input_non_explanatory_el_query",
				"INFRNC-INPUT-NON-EXPLANATORY-EL-QUERY", 1, 0, false);
		declareFunction(myName, "infrnc_input_query_properties",
				"INFRNC-INPUT-QUERY-PROPERTIES", 1, 0, false);
		declareFunction(myName, "infrnc_mt", "INFRNC-MT", 1, 0, false);
		declareFunction(myName, "infrnc_el_query", "INFRNC-EL-QUERY", 1, 0,
				false);
		declareFunction(myName, "infrnc_el_bindings", "INFRNC-EL-BINDINGS", 1,
				0, false);
		declareFunction(myName, "infrnc_hl_query", "INFRNC-HL-QUERY", 1, 0,
				false);
		declareFunction(myName, "infrnc_explanatory_subquery",
				"INFRNC-EXPLANATORY-SUBQUERY", 1, 0, false);
		declareFunction(myName, "infrnc_non_explanatory_subquery",
				"INFRNC-NON-EXPLANATORY-SUBQUERY", 1, 0, false);
		declareFunction(myName, "infrnc_free_hl_vars", "INFRNC-FREE-HL-VARS",
				1, 0, false);
		declareFunction(myName, "infrnc_hypothetical_bindings",
				"INFRNC-HYPOTHETICAL-BINDINGS", 1, 0, false);
		declareFunction(myName, "infrnc_answer_id_index",
				"INFRNC-ANSWER-ID-INDEX", 1, 0, false);
		declareFunction(myName, "infrnc_answer_bindings_index",
				"INFRNC-ANSWER-BINDINGS-INDEX", 1, 0, false);
		declareFunction(myName, "infrnc_new_answer_id_start",
				"INFRNC-NEW-ANSWER-ID-START", 1, 0, false);
		declareFunction(myName, "infrnc_new_answer_justifications",
				"INFRNC-NEW-ANSWER-JUSTIFICATIONS", 1, 0, false);
		declareFunction(myName, "infrnc_status", "INFRNC-STATUS", 1, 0, false);
		declareFunction(myName, "infrnc_suspend_status",
				"INFRNC-SUSPEND-STATUS", 1, 0, false);
		declareFunction(myName, "infrnc_root_link", "INFRNC-ROOT-LINK", 1, 0,
				false);
		declareFunction(myName, "infrnc_relevant_problems",
				"INFRNC-RELEVANT-PROBLEMS", 1, 0, false);
		declareFunction(myName, "infrnc_strategy_set", "INFRNC-STRATEGY-SET",
				1, 0, false);
		declareFunction(myName, "infrnc_control_process",
				"INFRNC-CONTROL-PROCESS", 1, 0, false);
		declareFunction(myName, "infrnc_interrupting_processes",
				"INFRNC-INTERRUPTING-PROCESSES", 1, 0, false);
		declareFunction(myName, "infrnc_max_transformation_depth_reached",
				"INFRNC-MAX-TRANSFORMATION-DEPTH-REACHED", 1, 0, false);
		declareFunction(myName, "infrnc_disjunction_free_el_vars_policy",
				"INFRNC-DISJUNCTION-FREE-EL-VARS-POLICY", 1, 0, false);
		declareFunction(myName, "infrnc_result_uniqueness_criterion",
				"INFRNC-RESULT-UNIQUENESS-CRITERION", 1, 0, false);
		declareFunction(myName, "infrnc_allow_hl_predicate_transformationP",
				"INFRNC-ALLOW-HL-PREDICATE-TRANSFORMATION?", 1, 0, false);
		declareFunction(myName,
				"infrnc_allow_unbound_predicate_transformationP",
				"INFRNC-ALLOW-UNBOUND-PREDICATE-TRANSFORMATION?", 1, 0, false);
		declareFunction(myName,
				"infrnc_allow_evaluatable_predicate_transformationP",
				"INFRNC-ALLOW-EVALUATABLE-PREDICATE-TRANSFORMATION?", 1, 0,
				false);
		declareFunction(myName, "infrnc_allow_indeterminate_resultsP",
				"INFRNC-ALLOW-INDETERMINATE-RESULTS?", 1, 0, false);
		declareFunction(myName, "infrnc_allowed_rules", "INFRNC-ALLOWED-RULES",
				1, 0, false);
		declareFunction(myName, "infrnc_forbidden_rules",
				"INFRNC-FORBIDDEN-RULES", 1, 0, false);
		declareFunction(myName, "infrnc_allowed_modules",
				"INFRNC-ALLOWED-MODULES", 1, 0, false);
		declareFunction(myName, "infrnc_allow_abnormality_checkingP",
				"INFRNC-ALLOW-ABNORMALITY-CHECKING?", 1, 0, false);
		declareFunction(myName, "infrnc_transitive_closure_mode",
				"INFRNC-TRANSITIVE-CLOSURE-MODE", 1, 0, false);
		declareFunction(myName, "infrnc_problem_store_privateP",
				"INFRNC-PROBLEM-STORE-PRIVATE?", 1, 0, false);
		declareFunction(myName, "infrnc_continuableP", "INFRNC-CONTINUABLE?",
				1, 0, false);
		declareFunction(myName, "infrnc_browsableP", "INFRNC-BROWSABLE?", 1, 0,
				false);
		declareFunction(myName, "infrnc_return_type", "INFRNC-RETURN-TYPE", 1,
				0, false);
		declareFunction(myName, "infrnc_answer_language",
				"INFRNC-ANSWER-LANGUAGE", 1, 0, false);
		declareFunction(myName, "infrnc_cache_resultsP",
				"INFRNC-CACHE-RESULTS?", 1, 0, false);
		declareFunction(myName, "infrnc_blockingP", "INFRNC-BLOCKING?", 1, 0,
				false);
		declareFunction(myName, "infrnc_max_number", "INFRNC-MAX-NUMBER", 1, 0,
				false);
		declareFunction(myName, "infrnc_max_time", "INFRNC-MAX-TIME", 1, 0,
				false);
		declareFunction(myName, "infrnc_max_step", "INFRNC-MAX-STEP", 1, 0,
				false);
		declareFunction(myName, "infrnc_mode", "INFRNC-MODE", 1, 0, false);
		declareFunction(myName, "infrnc_forward_max_time",
				"INFRNC-FORWARD-MAX-TIME", 1, 0, false);
		declareFunction(myName, "infrnc_max_proof_depth",
				"INFRNC-MAX-PROOF-DEPTH", 1, 0, false);
		declareFunction(myName, "infrnc_max_transformation_depth",
				"INFRNC-MAX-TRANSFORMATION-DEPTH", 1, 0, false);
		declareFunction(myName, "infrnc_probably_approximately_done",
				"INFRNC-PROBABLY-APPROXIMATELY-DONE", 1, 0, false);
		declareFunction(myName, "infrnc_metrics_template",
				"INFRNC-METRICS-TEMPLATE", 1, 0, false);
		declareFunction(myName, "infrnc_start_universal_time",
				"INFRNC-START-UNIVERSAL-TIME", 1, 0, false);
		declareFunction(myName, "infrnc_start_internal_real_time",
				"INFRNC-START-INTERNAL-REAL-TIME", 1, 0, false);
		declareFunction(myName, "infrnc_end_internal_real_time",
				"INFRNC-END-INTERNAL-REAL-TIME", 1, 0, false);
		declareFunction(myName, "infrnc_pad_internal_real_time",
				"INFRNC-PAD-INTERNAL-REAL-TIME", 1, 0, false);
		declareFunction(myName, "infrnc_cumulative_time",
				"INFRNC-CUMULATIVE-TIME", 1, 0, false);
		declareFunction(myName, "infrnc_step_count", "INFRNC-STEP-COUNT", 1, 0,
				false);
		declareFunction(myName, "infrnc_cumulative_step_count",
				"INFRNC-CUMULATIVE-STEP-COUNT", 1, 0, false);
		declareFunction(myName, "infrnc_events", "INFRNC-EVENTS", 1, 0, false);
		declareFunction(myName, "infrnc_halt_conditions",
				"INFRNC-HALT-CONDITIONS", 1, 0, false);
		declareFunction(myName, "infrnc_accumulators", "INFRNC-ACCUMULATORS",
				1, 0, false);
		declareFunction(myName, "infrnc_proof_watermark",
				"INFRNC-PROOF-WATERMARK", 1, 0, false);
		declareFunction(myName, "infrnc_problem_working_time_data",
				"INFRNC-PROBLEM-WORKING-TIME-DATA", 1, 0, false);
		declareFunction(myName, "infrnc_type", "INFRNC-TYPE", 1, 0, false);
		declareFunction(myName, "infrnc_data", "INFRNC-DATA", 1, 0, false);
		declareFunction(myName, "_csetf_infrnc_suid", "_CSETF-INFRNC-SUID", 2,
				0, false);
		declareFunction(myName, "_csetf_infrnc_problem_store",
				"_CSETF-INFRNC-PROBLEM-STORE", 2, 0, false);
		declareFunction(myName, "_csetf_infrnc_forward_propagate",
				"_CSETF-INFRNC-FORWARD-PROPAGATE", 2, 0, false);
		declareFunction(myName, "_csetf_infrnc_input_mt",
				"_CSETF-INFRNC-INPUT-MT", 2, 0, false);
		declareFunction(myName, "_csetf_infrnc_input_el_query",
				"_CSETF-INFRNC-INPUT-EL-QUERY", 2, 0, false);
		declareFunction(myName, "_csetf_infrnc_input_non_explanatory_el_query",
				"_CSETF-INFRNC-INPUT-NON-EXPLANATORY-EL-QUERY", 2, 0, false);
		declareFunction(myName, "_csetf_infrnc_input_query_properties",
				"_CSETF-INFRNC-INPUT-QUERY-PROPERTIES", 2, 0, false);
		declareFunction(myName, "_csetf_infrnc_mt", "_CSETF-INFRNC-MT", 2, 0,
				false);
		declareFunction(myName, "_csetf_infrnc_el_query",
				"_CSETF-INFRNC-EL-QUERY", 2, 0, false);
		declareFunction(myName, "_csetf_infrnc_el_bindings",
				"_CSETF-INFRNC-EL-BINDINGS", 2, 0, false);
		declareFunction(myName, "_csetf_infrnc_hl_query",
				"_CSETF-INFRNC-HL-QUERY", 2, 0, false);
		declareFunction(myName, "_csetf_infrnc_explanatory_subquery",
				"_CSETF-INFRNC-EXPLANATORY-SUBQUERY", 2, 0, false);
		declareFunction(myName, "_csetf_infrnc_non_explanatory_subquery",
				"_CSETF-INFRNC-NON-EXPLANATORY-SUBQUERY", 2, 0, false);
		declareFunction(myName, "_csetf_infrnc_free_hl_vars",
				"_CSETF-INFRNC-FREE-HL-VARS", 2, 0, false);
		declareFunction(myName, "_csetf_infrnc_hypothetical_bindings",
				"_CSETF-INFRNC-HYPOTHETICAL-BINDINGS", 2, 0, false);
		declareFunction(myName, "_csetf_infrnc_answer_id_index",
				"_CSETF-INFRNC-ANSWER-ID-INDEX", 2, 0, false);
		declareFunction(myName, "_csetf_infrnc_answer_bindings_index",
				"_CSETF-INFRNC-ANSWER-BINDINGS-INDEX", 2, 0, false);
		declareFunction(myName, "_csetf_infrnc_new_answer_id_start",
				"_CSETF-INFRNC-NEW-ANSWER-ID-START", 2, 0, false);
		declareFunction(myName, "_csetf_infrnc_new_answer_justifications",
				"_CSETF-INFRNC-NEW-ANSWER-JUSTIFICATIONS", 2, 0, false);
		declareFunction(myName, "_csetf_infrnc_status", "_CSETF-INFRNC-STATUS",
				2, 0, false);
		declareFunction(myName, "_csetf_infrnc_suspend_status",
				"_CSETF-INFRNC-SUSPEND-STATUS", 2, 0, false);
		declareFunction(myName, "_csetf_infrnc_root_link",
				"_CSETF-INFRNC-ROOT-LINK", 2, 0, false);
		declareFunction(myName, "_csetf_infrnc_relevant_problems",
				"_CSETF-INFRNC-RELEVANT-PROBLEMS", 2, 0, false);
		declareFunction(myName, "_csetf_infrnc_strategy_set",
				"_CSETF-INFRNC-STRATEGY-SET", 2, 0, false);
		declareFunction(myName, "_csetf_infrnc_control_process",
				"_CSETF-INFRNC-CONTROL-PROCESS", 2, 0, false);
		declareFunction(myName, "_csetf_infrnc_interrupting_processes",
				"_CSETF-INFRNC-INTERRUPTING-PROCESSES", 2, 0, false);
		declareFunction(myName,
				"_csetf_infrnc_max_transformation_depth_reached",
				"_CSETF-INFRNC-MAX-TRANSFORMATION-DEPTH-REACHED", 2, 0, false);
		declareFunction(myName,
				"_csetf_infrnc_disjunction_free_el_vars_policy",
				"_CSETF-INFRNC-DISJUNCTION-FREE-EL-VARS-POLICY", 2, 0, false);
		declareFunction(myName, "_csetf_infrnc_result_uniqueness_criterion",
				"_CSETF-INFRNC-RESULT-UNIQUENESS-CRITERION", 2, 0, false);
		declareFunction(myName,
				"_csetf_infrnc_allow_hl_predicate_transformationP",
				"_CSETF-INFRNC-ALLOW-HL-PREDICATE-TRANSFORMATION?", 2, 0, false);
		declareFunction(myName,
				"_csetf_infrnc_allow_unbound_predicate_transformationP",
				"_CSETF-INFRNC-ALLOW-UNBOUND-PREDICATE-TRANSFORMATION?", 2, 0,
				false);
		declareFunction(myName,
				"_csetf_infrnc_allow_evaluatable_predicate_transformationP",
				"_CSETF-INFRNC-ALLOW-EVALUATABLE-PREDICATE-TRANSFORMATION?", 2,
				0, false);
		declareFunction(myName, "_csetf_infrnc_allow_indeterminate_resultsP",
				"_CSETF-INFRNC-ALLOW-INDETERMINATE-RESULTS?", 2, 0, false);
		declareFunction(myName, "_csetf_infrnc_allowed_rules",
				"_CSETF-INFRNC-ALLOWED-RULES", 2, 0, false);
		declareFunction(myName, "_csetf_infrnc_forbidden_rules",
				"_CSETF-INFRNC-FORBIDDEN-RULES", 2, 0, false);
		declareFunction(myName, "_csetf_infrnc_allowed_modules",
				"_CSETF-INFRNC-ALLOWED-MODULES", 2, 0, false);
		declareFunction(myName, "_csetf_infrnc_allow_abnormality_checkingP",
				"_CSETF-INFRNC-ALLOW-ABNORMALITY-CHECKING?", 2, 0, false);
		declareFunction(myName, "_csetf_infrnc_transitive_closure_mode",
				"_CSETF-INFRNC-TRANSITIVE-CLOSURE-MODE", 2, 0, false);
		declareFunction(myName, "_csetf_infrnc_problem_store_privateP",
				"_CSETF-INFRNC-PROBLEM-STORE-PRIVATE?", 2, 0, false);
		declareFunction(myName, "_csetf_infrnc_continuableP",
				"_CSETF-INFRNC-CONTINUABLE?", 2, 0, false);
		declareFunction(myName, "_csetf_infrnc_browsableP",
				"_CSETF-INFRNC-BROWSABLE?", 2, 0, false);
		declareFunction(myName, "_csetf_infrnc_return_type",
				"_CSETF-INFRNC-RETURN-TYPE", 2, 0, false);
		declareFunction(myName, "_csetf_infrnc_answer_language",
				"_CSETF-INFRNC-ANSWER-LANGUAGE", 2, 0, false);
		declareFunction(myName, "_csetf_infrnc_cache_resultsP",
				"_CSETF-INFRNC-CACHE-RESULTS?", 2, 0, false);
		declareFunction(myName, "_csetf_infrnc_blockingP",
				"_CSETF-INFRNC-BLOCKING?", 2, 0, false);
		declareFunction(myName, "_csetf_infrnc_max_number",
				"_CSETF-INFRNC-MAX-NUMBER", 2, 0, false);
		declareFunction(myName, "_csetf_infrnc_max_time",
				"_CSETF-INFRNC-MAX-TIME", 2, 0, false);
		declareFunction(myName, "_csetf_infrnc_max_step",
				"_CSETF-INFRNC-MAX-STEP", 2, 0, false);
		declareFunction(myName, "_csetf_infrnc_mode", "_CSETF-INFRNC-MODE", 2,
				0, false);
		declareFunction(myName, "_csetf_infrnc_forward_max_time",
				"_CSETF-INFRNC-FORWARD-MAX-TIME", 2, 0, false);
		declareFunction(myName, "_csetf_infrnc_max_proof_depth",
				"_CSETF-INFRNC-MAX-PROOF-DEPTH", 2, 0, false);
		declareFunction(myName, "_csetf_infrnc_max_transformation_depth",
				"_CSETF-INFRNC-MAX-TRANSFORMATION-DEPTH", 2, 0, false);
		declareFunction(myName, "_csetf_infrnc_probably_approximately_done",
				"_CSETF-INFRNC-PROBABLY-APPROXIMATELY-DONE", 2, 0, false);
		declareFunction(myName, "_csetf_infrnc_metrics_template",
				"_CSETF-INFRNC-METRICS-TEMPLATE", 2, 0, false);
		declareFunction(myName, "_csetf_infrnc_start_universal_time",
				"_CSETF-INFRNC-START-UNIVERSAL-TIME", 2, 0, false);
		declareFunction(myName, "_csetf_infrnc_start_internal_real_time",
				"_CSETF-INFRNC-START-INTERNAL-REAL-TIME", 2, 0, false);
		declareFunction(myName, "_csetf_infrnc_end_internal_real_time",
				"_CSETF-INFRNC-END-INTERNAL-REAL-TIME", 2, 0, false);
		declareFunction(myName, "_csetf_infrnc_pad_internal_real_time",
				"_CSETF-INFRNC-PAD-INTERNAL-REAL-TIME", 2, 0, false);
		declareFunction(myName, "_csetf_infrnc_cumulative_time",
				"_CSETF-INFRNC-CUMULATIVE-TIME", 2, 0, false);
		declareFunction(myName, "_csetf_infrnc_step_count",
				"_CSETF-INFRNC-STEP-COUNT", 2, 0, false);
		declareFunction(myName, "_csetf_infrnc_cumulative_step_count",
				"_CSETF-INFRNC-CUMULATIVE-STEP-COUNT", 2, 0, false);
		declareFunction(myName, "_csetf_infrnc_events", "_CSETF-INFRNC-EVENTS",
				2, 0, false);
		declareFunction(myName, "_csetf_infrnc_halt_conditions",
				"_CSETF-INFRNC-HALT-CONDITIONS", 2, 0, false);
		declareFunction(myName, "_csetf_infrnc_accumulators",
				"_CSETF-INFRNC-ACCUMULATORS", 2, 0, false);
		declareFunction(myName, "_csetf_infrnc_proof_watermark",
				"_CSETF-INFRNC-PROOF-WATERMARK", 2, 0, false);
		declareFunction(myName, "_csetf_infrnc_problem_working_time_data",
				"_CSETF-INFRNC-PROBLEM-WORKING-TIME-DATA", 2, 0, false);
		declareFunction(myName, "_csetf_infrnc_type", "_CSETF-INFRNC-TYPE", 2,
				0, false);
		declareFunction(myName, "_csetf_infrnc_data", "_CSETF-INFRNC-DATA", 2,
				0, false);
		declareFunction(myName, "make_inference", "MAKE-INFERENCE", 0, 1, false);
		declareFunction(myName, "valid_inference_p", "VALID-INFERENCE-P", 1, 0,
				false);
		declareFunction(myName, "invalid_inference_p", "INVALID-INFERENCE-P",
				1, 0, false);
		declareFunction(myName, "inference_invalid_p", "INFERENCE-INVALID-P",
				1, 0, false);
		declareFunction(myName, "print_inference", "PRINT-INFERENCE", 3, 0,
				false);
		declareFunction(myName, "sxhash_inference_method",
				"SXHASH-INFERENCE-METHOD", 1, 0, false);
		new $sxhash_inference_method$UnaryFunction();
		declareFunction(myName, "new_inference_p", "NEW-INFERENCE-P", 1, 0,
				false);
		declareFunction(myName, "prepared_inference_p", "PREPARED-INFERENCE-P",
				1, 0, false);
		declareFunction(myName, "ready_inference_p", "READY-INFERENCE-P", 1, 0,
				false);
		declareFunction(myName, "running_inference_p", "RUNNING-INFERENCE-P",
				1, 0, false);
		declareFunction(myName, "suspended_inference_p",
				"SUSPENDED-INFERENCE-P", 1, 0, false);
		declareFunction(myName, "continuable_inference_p",
				"CONTINUABLE-INFERENCE-P", 1, 0, false);
		declareFunction(myName, "exhausted_inference_p",
				"EXHAUSTED-INFERENCE-P", 1, 0, false);
		declareMacro(myName, "do_inference_relevant_problems",
				"DO-INFERENCE-RELEVANT-PROBLEMS");
		declareMacro(myName, "do_inference_new_answer_justifications",
				"DO-INFERENCE-NEW-ANSWER-JUSTIFICATIONS");
		declareMacro(myName, "do_inference_new_answers",
				"DO-INFERENCE-NEW-ANSWERS");
		declareMacro(myName, "do_inference_answers", "DO-INFERENCE-ANSWERS");
		declareMacro(myName, "do_inference_answers_from_index",
				"DO-INFERENCE-ANSWERS-FROM-INDEX");
		declareMacro(myName, "do_inference_justifications",
				"DO-INFERENCE-JUSTIFICATIONS");
		declareMacro(myName, "do_inference_interrupting_processes",
				"DO-INFERENCE-INTERRUPTING-PROCESSES");
		declareMacro(myName, "do_inference_root_proofs",
				"DO-INFERENCE-ROOT-PROOFS");
		declareMacro(myName, "do_inference_allowed_rules",
				"DO-INFERENCE-ALLOWED-RULES");
		declareMacro(myName, "with_inference_problem_working_time_lock",
				"WITH-INFERENCE-PROBLEM-WORKING-TIME-LOCK");
		declareFunction(myName, "new_inference", "NEW-INFERENCE", 1, 0, false);
		declareFunction(myName, "new_tautological_inference",
				"NEW-TAUTOLOGICAL-INFERENCE", 1, 0, false);
		declareFunction(myName, "destroy_all_inferences",
				"DESTROY-ALL-INFERENCES", 0, 0, false);
		declareFunction(myName, "destroy_inference", "DESTROY-INFERENCE", 1, 0,
				false);
		declareFunction(myName, "destroy_inference_and_problem_store",
				"DESTROY-INFERENCE-AND-PROBLEM-STORE", 1, 0, false);
		declareFunction(myName, "destroy_problem_store_inference",
				"DESTROY-PROBLEM-STORE-INFERENCE", 1, 0, false);
		declareFunction(myName, "destroy_inference_int",
				"DESTROY-INFERENCE-INT", 1, 0, false);
		declareFunction(myName, "note_inference_invalid",
				"NOTE-INFERENCE-INVALID", 1, 0, false);
		declareFunction(myName, "inference_suid", "INFERENCE-SUID", 1, 0, false);
		declareFunction(myName, "inference_problem_store",
				"INFERENCE-PROBLEM-STORE", 1, 0, false);
		declareFunction(myName, "inference_forward_propagate",
				"INFERENCE-FORWARD-PROPAGATE", 1, 0, false);
		declareFunction(myName, "inference_input_mt", "INFERENCE-INPUT-MT", 1,
				0, false);
		declareFunction(myName, "inference_input_el_query",
				"INFERENCE-INPUT-EL-QUERY", 1, 0, false);
		declareFunction(myName, "inference_input_non_explanatory_el_query",
				"INFERENCE-INPUT-NON-EXPLANATORY-EL-QUERY", 1, 0, false);
		declareFunction(myName, "inference_input_query_properties",
				"INFERENCE-INPUT-QUERY-PROPERTIES", 1, 0, false);
		declareFunction(myName, "inference_mt", "INFERENCE-MT", 1, 0, false);
		declareFunction(myName, "inference_el_query", "INFERENCE-EL-QUERY", 1,
				0, false);
		declareFunction(myName, "inference_el_bindings",
				"INFERENCE-EL-BINDINGS", 1, 0, false);
		declareFunction(myName, "inference_hl_query", "INFERENCE-HL-QUERY", 1,
				0, false);
		declareFunction(myName, "inference_explanatory_subquery",
				"INFERENCE-EXPLANATORY-SUBQUERY", 1, 0, false);
		declareFunction(myName, "inference_non_explanatory_subquery",
				"INFERENCE-NON-EXPLANATORY-SUBQUERY", 1, 0, false);
		declareFunction(myName, "inference_free_hl_vars",
				"INFERENCE-FREE-HL-VARS", 1, 0, false);
		declareFunction(myName, "inference_hypothetical_bindings",
				"INFERENCE-HYPOTHETICAL-BINDINGS", 1, 0, false);
		declareFunction(myName, "inference_answer_id_index",
				"INFERENCE-ANSWER-ID-INDEX", 1, 0, false);
		declareFunction(myName, "inference_answer_bindings_index",
				"INFERENCE-ANSWER-BINDINGS-INDEX", 1, 0, false);
		declareFunction(myName, "inference_new_answer_id_start",
				"INFERENCE-NEW-ANSWER-ID-START", 1, 0, false);
		declareFunction(myName, "inference_new_answer_justifications",
				"INFERENCE-NEW-ANSWER-JUSTIFICATIONS", 1, 0, false);
		declareFunction(myName, "inference_status", "INFERENCE-STATUS", 1, 0,
				false);
		declareFunction(myName, "inference_suspend_status",
				"INFERENCE-SUSPEND-STATUS", 1, 0, false);
		declareFunction(myName, "inference_root_link", "INFERENCE-ROOT-LINK",
				1, 0, false);
		declareFunction(myName, "inference_relevant_problems",
				"INFERENCE-RELEVANT-PROBLEMS", 1, 0, false);
		declareFunction(myName, "inference_strategy_set",
				"INFERENCE-STRATEGY-SET", 1, 0, false);
		declareFunction(myName, "inference_control_process",
				"INFERENCE-CONTROL-PROCESS", 1, 0, false);
		declareFunction(myName, "inference_interrupting_processes",
				"INFERENCE-INTERRUPTING-PROCESSES", 1, 0, false);
		declareFunction(myName, "inference_max_transformation_depth_reached",
				"INFERENCE-MAX-TRANSFORMATION-DEPTH-REACHED", 1, 0, false);
		declareFunction(myName, "inference_answer_language",
				"INFERENCE-ANSWER-LANGUAGE", 1, 0, false);
		declareFunction(myName, "inference_cache_resultsP",
				"INFERENCE-CACHE-RESULTS?", 1, 0, false);
		declareFunction(myName, "inference_blockingP", "INFERENCE-BLOCKING?",
				1, 0, false);
		declareFunction(myName, "inference_disjunction_free_el_vars_policy",
				"INFERENCE-DISJUNCTION-FREE-EL-VARS-POLICY", 1, 0, false);
		declareFunction(myName, "inference_result_uniqueness_criterion",
				"INFERENCE-RESULT-UNIQUENESS-CRITERION", 1, 0, false);
		declareFunction(myName, "inference_allow_hl_predicate_transformationP",
				"INFERENCE-ALLOW-HL-PREDICATE-TRANSFORMATION?", 1, 0, false);
		declareFunction(myName,
				"inference_allow_unbound_predicate_transformationP",
				"INFERENCE-ALLOW-UNBOUND-PREDICATE-TRANSFORMATION?", 1, 0,
				false);
		declareFunction(myName,
				"inference_allow_evaluatable_predicate_transformationP",
				"INFERENCE-ALLOW-EVALUATABLE-PREDICATE-TRANSFORMATION?", 1, 0,
				false);
		declareFunction(myName, "inference_allow_indeterminate_resultsP",
				"INFERENCE-ALLOW-INDETERMINATE-RESULTS?", 1, 0, false);
		declareFunction(myName, "inference_allowed_rules",
				"INFERENCE-ALLOWED-RULES", 1, 0, false);
		declareFunction(myName, "inference_forbidden_rules",
				"INFERENCE-FORBIDDEN-RULES", 1, 0, false);
		declareFunction(myName, "inference_allowed_modules",
				"INFERENCE-ALLOWED-MODULES", 1, 0, false);
		declareFunction(myName, "inference_allow_abnormality_checkingP",
				"INFERENCE-ALLOW-ABNORMALITY-CHECKING?", 1, 0, false);
		declareFunction(myName, "inference_transitive_closure_mode",
				"INFERENCE-TRANSITIVE-CLOSURE-MODE", 1, 0, false);
		declareFunction(myName, "inference_problem_store_privateP",
				"INFERENCE-PROBLEM-STORE-PRIVATE?", 1, 0, false);
		declareFunction(myName, "inference_continuableP",
				"INFERENCE-CONTINUABLE?", 1, 0, false);
		declareFunction(myName, "inference_browsableP", "INFERENCE-BROWSABLE?",
				1, 0, false);
		declareFunction(myName, "inference_return_type",
				"INFERENCE-RETURN-TYPE", 1, 0, false);
		declareFunction(myName, "inference_max_time", "INFERENCE-MAX-TIME", 1,
				0, false);
		declareFunction(myName, "inference_max_step", "INFERENCE-MAX-STEP", 1,
				0, false);
		declareFunction(myName, "inference_mode", "INFERENCE-MODE", 1, 0, false);
		declareFunction(myName, "inference_forward_max_time",
				"INFERENCE-FORWARD-MAX-TIME", 1, 0, false);
		declareFunction(myName, "inference_max_number", "INFERENCE-MAX-NUMBER",
				1, 0, false);
		declareFunction(myName, "inference_max_proof_depth",
				"INFERENCE-MAX-PROOF-DEPTH", 1, 0, false);
		declareFunction(myName, "inference_max_transformation_depth",
				"INFERENCE-MAX-TRANSFORMATION-DEPTH", 1, 0, false);
		declareFunction(myName, "inference_probably_approximately_done",
				"INFERENCE-PROBABLY-APPROXIMATELY-DONE", 1, 0, false);
		declareFunction(myName, "inference_metrics_template",
				"INFERENCE-METRICS-TEMPLATE", 1, 0, false);
		declareFunction(myName, "inference_start_universal_time",
				"INFERENCE-START-UNIVERSAL-TIME", 1, 0, false);
		declareFunction(myName, "inference_start_internal_real_time",
				"INFERENCE-START-INTERNAL-REAL-TIME", 1, 0, false);
		declareFunction(myName, "inference_end_internal_real_time",
				"INFERENCE-END-INTERNAL-REAL-TIME", 1, 0, false);
		declareFunction(myName, "inference_pad_internal_real_time",
				"INFERENCE-PAD-INTERNAL-REAL-TIME", 1, 0, false);
		declareFunction(myName, "inference_cumulative_time",
				"INFERENCE-CUMULATIVE-TIME", 1, 0, false);
		declareFunction(myName, "inference_step_count", "INFERENCE-STEP-COUNT",
				1, 0, false);
		declareFunction(myName, "inference_cumulative_step_count",
				"INFERENCE-CUMULATIVE-STEP-COUNT", 1, 0, false);
		declareFunction(myName, "inference_problem_working_time_data",
				"INFERENCE-PROBLEM-WORKING-TIME-DATA", 1, 0, false);
		declareFunction(myName, "inference_events", "INFERENCE-EVENTS", 1, 0,
				false);
		declareFunction(myName, "inference_accumulators",
				"INFERENCE-ACCUMULATORS", 1, 0, false);
		declareFunction(myName, "inference_proof_watermark",
				"INFERENCE-PROOF-WATERMARK", 1, 0, false);
		...
		declareFunction(myName, "set_inference_forward_propagate",
				"SET-INFERENCE-FORWARD-PROPAGATE", 2, 0, false);
		declareFunction(myName, "set_inference_input_mt",
				"SET-INFERENCE-INPUT-MT", 2, 0, false);
		declareFunction(myName, "set_inference_input_el_query",
				"SET-INFERENCE-INPUT-EL-QUERY", 2, 0, false);
		declareFunction(myName, "set_inference_input_non_explanatory_el_query",
				"SET-INFERENCE-INPUT-NON-EXPLANATORY-EL-QUERY", 2, 0, false);
		declareFunction(myName, "set_inference_input_query_properties",
				"SET-INFERENCE-INPUT-QUERY-PROPERTIES", 2, 0, false);
		declareFunction(myName, "set_inference_mt", "SET-INFERENCE-MT", 2, 0,
				false);
		declareFunction(myName, "set_inference_el_query",
				"SET-INFERENCE-EL-QUERY", 2, 0, false);
		declareFunction(myName, "set_inference_el_bindings",
				"SET-INFERENCE-EL-BINDINGS", 2, 0, false);
		declareFunction(myName, "set_inference_hl_query",
				"SET-INFERENCE-HL-QUERY", 2, 0, false);
		declareFunction(myName, "set_inference_explanatory_subquery",
				"SET-INFERENCE-EXPLANATORY-SUBQUERY", 2, 0, false);
		declareFunction(myName, "set_inference_non_explanatory_subquery",
				"SET-INFERENCE-NON-EXPLANATORY-SUBQUERY", 2, 0, false);
		declareFunction(myName, "set_inference_free_hl_vars",
				"SET-INFERENCE-FREE-HL-VARS", 2, 0, false);
		declareFunction(myName, "set_inference_hypothetical_bindings",
				"SET-INFERENCE-HYPOTHETICAL-BINDINGS", 2, 0, false);
		declareFunction(myName, "set_inference_status", "SET-INFERENCE-STATUS",
				2, 0, false);
		declareFunction(myName, "set_inference_suspend_status",
				"SET-INFERENCE-SUSPEND-STATUS", 2, 0, false);
		declareFunction(myName, "set_inference_root_link",
				"SET-INFERENCE-ROOT-LINK", 2, 0, false);
		declareFunction(myName, "set_inference_control_process",
				"SET-INFERENCE-CONTROL-PROCESS", 2, 0, false);
		declareFunction(myName,
				"set_inference_max_transformation_depth_reached",
				"SET-INFERENCE-MAX-TRANSFORMATION-DEPTH-REACHED", 2, 0, false);
		declareFunction(myName,
				"set_inference_disjunction_free_el_vars_policy",
				"SET-INFERENCE-DISJUNCTION-FREE-EL-VARS-POLICY", 2, 0, false);
		declareFunction(myName, "set_inference_result_uniqueness_criterion",
				"SET-INFERENCE-RESULT-UNIQUENESS-CRITERION", 2, 0, false);
		declareFunction(myName,
				"set_inference_allow_hl_predicate_transformation",
				"SET-INFERENCE-ALLOW-HL-PREDICATE-TRANSFORMATION", 2, 0, false);
		declareFunction(myName,
				"set_inference_allow_unbound_predicate_transformation",
				"SET-INFERENCE-ALLOW-UNBOUND-PREDICATE-TRANSFORMATION", 2, 0,
				false);
		declareFunction(myName,
				"set_inference_allow_evaluatable_predicate_transformation",
				"SET-INFERENCE-ALLOW-EVALUATABLE-PREDICATE-TRANSFORMATION", 2,
				0, false);
		declareFunction(myName, "set_inference_allow_indeterminate_results",
				"SET-INFERENCE-ALLOW-INDETERMINATE-RESULTS", 2, 0, false);
		declareFunction(myName, "set_inference_allowed_rules",
				"SET-INFERENCE-ALLOWED-RULES", 2, 0, false);
		declareFunction(myName, "set_inference_forbidden_rules",
				"SET-INFERENCE-FORBIDDEN-RULES", 2, 0, false);
		declareFunction(myName, "set_inference_allowed_modules",
				"SET-INFERENCE-ALLOWED-MODULES", 2, 0, false);
		declareFunction(myName, "set_inference_allow_abnormality_checking",
				"SET-INFERENCE-ALLOW-ABNORMALITY-CHECKING", 2, 0, false);
		declareFunction(myName, "set_inference_transitive_closure_mode",
				"SET-INFERENCE-TRANSITIVE-CLOSURE-MODE", 2, 0, false);
		declareFunction(myName, "set_inference_problem_store_private",
				"SET-INFERENCE-PROBLEM-STORE-PRIVATE", 2, 0, false);
		declareFunction(myName, "set_inference_continuable",
				"SET-INFERENCE-CONTINUABLE", 2, 0, false);
		declareFunction(myName, "set_inference_browsable",
				"SET-INFERENCE-BROWSABLE", 2, 0, false);
		declareFunction(myName, "set_inference_return_type",
				"SET-INFERENCE-RETURN-TYPE", 2, 0, false);
		declareFunction(myName, "set_inference_answer_language",
				"SET-INFERENCE-ANSWER-LANGUAGE", 2, 0, false);
		declareFunction(myName, "set_inference_cache_results",
				"SET-INFERENCE-CACHE-RESULTS", 2, 0, false);
		declareFunction(myName, "note_inference_blocking",
				"NOTE-INFERENCE-BLOCKING", 1, 0, false);
		declareFunction(myName, "clear_inference_blocking",
				"CLEAR-INFERENCE-BLOCKING", 1, 0, false);
		declareFunction(myName, "set_inference_max_number",
				"SET-INFERENCE-MAX-NUMBER", 2, 0, false);
		declareFunction(myName, "set_inference_max_time",
				"SET-INFERENCE-MAX-TIME", 2, 0, false);
		declareFunction(myName, "set_inference_max_step",
				"SET-INFERENCE-MAX-STEP", 2, 0, false);
		declareFunction(myName, "set_inference_mode", "SET-INFERENCE-MODE", 2,
				0, false);
		declareFunction(myName, "set_inference_forward_max_time",
				"SET-INFERENCE-FORWARD-MAX-TIME", 2, 0, false);
		declareFunction(myName, "set_inference_max_proof_depth",
				"SET-INFERENCE-MAX-PROOF-DEPTH", 2, 0, false);
		declareFunction(myName, "set_inference_max_transformation_depth",
				"SET-INFERENCE-MAX-TRANSFORMATION-DEPTH", 2, 0, false);
		declareFunction(myName, "set_inference_probably_approximately_done",
				"SET-INFERENCE-PROBABLY-APPROXIMATELY-DONE", 2, 0, false);
		declareFunction(myName, "set_inference_metrics_template",
				"SET-INFERENCE-METRICS-TEMPLATE", 2, 0, false);
		declareFunction(myName, "set_inference_start_universal_time",
				"SET-INFERENCE-START-UNIVERSAL-TIME", 2, 0, false);
		declareFunction(myName, "set_inference_start_internal_real_time",
				"SET-INFERENCE-START-INTERNAL-REAL-TIME", 2, 0, false);
		declareFunction(myName, "set_inference_end_internal_real_time",
				"SET-INFERENCE-END-INTERNAL-REAL-TIME", 2, 0, false);
		declareFunction(myName, "set_inference_pad_internal_real_time",
				"SET-INFERENCE-PAD-INTERNAL-REAL-TIME", 2, 0, false);
		declareFunction(myName, "set_inference_cumulative_time",
				"SET-INFERENCE-CUMULATIVE-TIME", 2, 0, false);
		declareFunction(myName, "set_inference_step_count",
				"SET-INFERENCE-STEP-COUNT", 2, 0, false);
		declareFunction(myName, "increment_inference_step_count",
				"INCREMENT-INFERENCE-STEP-COUNT", 1, 0, false);
		declareFunction(myName, "set_inference_cumulative_step_count",
				"SET-INFERENCE-CUMULATIVE-STEP-COUNT", 2, 0, false);
		declareFunction(myName, "increment_inference_cumulative_step_count",
				"INCREMENT-INFERENCE-CUMULATIVE-STEP-COUNT", 1, 0, false);
		declareFunction(myName, "set_inference_problem_working_time_data",
				"SET-INFERENCE-PROBLEM-WORKING-TIME-DATA", 2, 0, false);
		declareFunction(myName, "set_inference_events", "SET-INFERENCE-EVENTS",
				2, 0, false);
		declareFunction(myName, "set_inference_halt_conditions",
				"SET-INFERENCE-HALT-CONDITIONS", 2, 0, false);
		declareFunction(myName, "set_inference_type", "SET-INFERENCE-TYPE", 2,
				0, false);
		declareFunction(myName, "set_inference_data", "SET-INFERENCE-DATA", 2,
				0, false);
		declareFunction(myName, "inference_ids", "INFERENCE-IDS", 1, 0, false);
		declareMacro(myName, "with_inference_ids", "WITH-INFERENCE-IDS");
		declareFunction(myName, "inference_problem_store_suid",
				"INFERENCE-PROBLEM-STORE-SUID", 1, 0, false);
		declareFunction(myName, "all_inferences", "ALL-INFERENCES", 0, 0, false);
		declareFunction(myName, "inference_strategies", "INFERENCE-STRATEGIES",
				1, 0, false);
		declareFunction(myName, "inference_hl_mts", "INFERENCE-HL-MTS", 1, 0,
				false);
		declareFunction(myName, "inference_first_hl_query_mt",
				"INFERENCE-FIRST-HL-QUERY-MT", 1, 0, false);
		declareFunction(myName, "inference_no_free_hl_varsP",
				"INFERENCE-NO-FREE-HL-VARS?", 1, 0, false);
		declareFunction(myName, "inference_free_el_vars",
				"INFERENCE-FREE-EL-VARS", 1, 0, false);
		declareFunction(myName, "inference_input_query_property",
				"INFERENCE-INPUT-QUERY-PROPERTY", 2, 1, false);
		declareFunction(myName, "inference_to_new_cyc_query_arguments",
				"INFERENCE-TO-NEW-CYC-QUERY-ARGUMENTS", 1, 0, false);
		declareFunction(myName, "inference_to_new_cyc_query_form",
				"INFERENCE-TO-NEW-CYC-QUERY-FORM", 1, 0, false);
		declareFunction(myName, "inference_to_new_cyc_query_form_string",
				"INFERENCE-TO-NEW-CYC-QUERY-FORM-STRING", 1, 0, false);
		declareFunction(myName, "inference_args_to_new_cyc_query_form_string",
				"INFERENCE-ARGS-TO-NEW-CYC-QUERY-FORM-STRING", 3, 0, false);
		declareFunction(myName, "inference_root_mapped_problem",
				"INFERENCE-ROOT-MAPPED-PROBLEM", 1, 0, false);
		declareFunction(myName, "inference_root_problem",
				"INFERENCE-ROOT-PROBLEM", 1, 0, false);
		declareFunction(myName, "inference_unique_wrt_proofsP",
				"INFERENCE-UNIQUE-WRT-PROOFS?", 1, 0, false);
		declareFunction(myName, "inference_unique_wrt_bindingsP",
				"INFERENCE-UNIQUE-WRT-BINDINGS?", 1, 0, false);
		declareFunction(myName, "inference_compute_answer_justificationsP",
				"INFERENCE-COMPUTE-ANSWER-JUSTIFICATIONS?", 1, 0, false);
		declareFunction(myName, "inference_computes_metricsP",
				"INFERENCE-COMPUTES-METRICS?", 1, 0, false);
		declareFunction(myName, "inference_computes_metricP",
				"INFERENCE-COMPUTES-METRIC?", 2, 0, false);
		declareFunction(myName,
				"inference_problem_store_private_wrt_dynamic_propertiesP",
				"INFERENCE-PROBLEM-STORE-PRIVATE-WRT-DYNAMIC-PROPERTIES?", 1,
				0, false);
		declareFunction(myName, "inference_dynamic_properties_exhaustiveP",
				"INFERENCE-DYNAMIC-PROPERTIES-EXHAUSTIVE?", 1, 0, false);
		declareFunction(myName, "inference_allows_use_of_all_rulesP",
				"INFERENCE-ALLOWS-USE-OF-ALL-RULES?", 1, 0, false);
		declareFunction(myName, "inference_allows_use_of_ruleP",
				"INFERENCE-ALLOWS-USE-OF-RULE?", 2, 0, false);
		declareFunction(myName, "inference_filter_rules",
				"INFERENCE-FILTER-RULES", 2, 0, false);
		declareFunction(myName, "inference_allows_use_of_all_modulesP",
				"INFERENCE-ALLOWS-USE-OF-ALL-MODULES?", 1, 0, false);
		declareFunction(myName, "inference_allows_use_of_moduleP",
				"INFERENCE-ALLOWS-USE-OF-MODULE?", 2, 0, false);
		declareFunction(myName, "inference_forget_extra_resultsP",
				"INFERENCE-FORGET-EXTRA-RESULTS?", 1, 0, false);
		declareFunction(myName, "inference_has_some_answerP",
				"INFERENCE-HAS-SOME-ANSWER?", 1, 0, false);
		declareFunction(myName, "find_inference_answer_by_id",
				"FIND-INFERENCE-ANSWER-BY-ID", 2, 0, false);
		declareFunction(myName, "find_inference_answer_by_ids",
				"FIND-INFERENCE-ANSWER-BY-IDS", 3, 0, false);
		declareFunction(myName, "inference_first_answer",
				"INFERENCE-FIRST-ANSWER", 1, 0, false);
		declareFunction(myName, "inference_last_answer",
				"INFERENCE-LAST-ANSWER", 1, 0, false);
		declareFunction(myName, "inference_first_answer_elapsed_time",
				"INFERENCE-FIRST-ANSWER-ELAPSED-TIME", 1, 0, false);
		declareFunction(myName, "inference_first_answer_step_count",
				"INFERENCE-FIRST-ANSWER-STEP-COUNT", 1, 0, false);
		declareFunction(myName, "inference_last_answer_elapsed_time",
				"INFERENCE-LAST-ANSWER-ELAPSED-TIME", 1, 0, false);
		declareFunction(myName, "inference_last_answer_step_count",
				"INFERENCE-LAST-ANSWER-STEP-COUNT", 1, 0, false);
		declareFunction(myName, "inference_answer_count_at_elapsed_time",
				"INFERENCE-ANSWER-COUNT-AT-ELAPSED-TIME", 2, 0, false);
		declareFunction(myName, "inference_answer_count_at_30_seconds",
				"INFERENCE-ANSWER-COUNT-AT-30-SECONDS", 1, 0, false);
		declareFunction(myName, "inference_answer_count_at_60_seconds",
				"INFERENCE-ANSWER-COUNT-AT-60-SECONDS", 1, 0, false);
		declareFunction(myName, "inference_answer_times",
				"INFERENCE-ANSWER-TIMES", 1, 0, false);
		declareFunction(myName, "inference_answer_step_counts",
				"INFERENCE-ANSWER-STEP-COUNTS", 1, 0, false);
		declareFunction(myName, "inference_end_universal_time",
				"INFERENCE-END-UNIVERSAL-TIME", 1, 0, false);
		declareFunction(myName, "inference_maintain_term_working_setP",
				"INFERENCE-MAINTAIN-TERM-WORKING-SET?", 1, 0, false);
		declareFunction(myName, "inference_halt_condition_presentP",
				"INFERENCE-HALT-CONDITION-PRESENT?", 2, 0, false);
		declareFunction(myName, "add_inference_accumulator",
				"ADD-INFERENCE-ACCUMULATOR", 3, 0, false);
		declareFunction(myName, "inference_accumulator",
				"INFERENCE-ACCUMULATOR", 2, 0, false);
		declareFunction(myName, "inference_accumulator_contents",
				"INFERENCE-ACCUMULATOR-CONTENTS", 2, 0, false);
		declareFunction(myName, "inference_accumulate", "INFERENCE-ACCUMULATE",
				3, 0, false);
		declareFunction(myName, "set_inference_proof_watermark",
				"SET-INFERENCE-PROOF-WATERMARK", 2, 0, false);
		declareFunction(myName, "compute_inference_pad_internal_real_time",
				"COMPUTE-INFERENCE-PAD-INTERNAL-REAL-TIME", 1, 0, false);
		declareFunction(myName, "initialize_pad_table", "INITIALIZE-PAD-TABLE",
				1, 0, false);
		declareFunction(myName, "pad_table_initializedP",
				"PAD-TABLE-INITIALIZED?", 0, 0, false);
		declareFunction(myName, "probably_approximately_done_cutoff_time",
				"PROBABLY-APPROXIMATELY-DONE-CUTOFF-TIME", 1, 0, false);
		declareFunction(myName, "compute_pad_from_time",
				"COMPUTE-PAD-FROM-TIME", 1, 0, false);
		declareFunction(myName, "inference_note_transformation_depth",
				"INFERENCE-NOTE-TRANSFORMATION-DEPTH", 2, 0, false);
		declareFunction(myName,
				"inference_note_new_transformation_depth_reached",
				"INFERENCE-NOTE-NEW-TRANSFORMATION-DEPTH-REACHED", 2, 0, false);
		declareFunction(myName, "find_inference_answer_by_bindings",
				"FIND-INFERENCE-ANSWER-BY-BINDINGS", 2, 0, false);
		declareFunction(myName, "new_inference_answer_id",
				"NEW-INFERENCE-ANSWER-ID", 1, 0, false);
		declareFunction(myName, "inference_all_answers",
				"INFERENCE-ALL-ANSWERS", 1, 0, false);
		declareFunction(myName, "inference_all_new_answers",
				"INFERENCE-ALL-NEW-ANSWERS", 1, 0, false);
		declareFunction(myName, "inference_allowed_rules_list",
				"INFERENCE-ALLOWED-RULES-LIST", 1, 0, false);
		declareFunction(myName, "inference_allowed_rule_count",
				"INFERENCE-ALLOWED-RULE-COUNT", 1, 0, false);
		declareFunction(myName, "inference_forbidden_rules_list",
				"INFERENCE-FORBIDDEN-RULES-LIST", 1, 0, false);
		declareFunction(myName, "inference_forbidden_rule_count",
				"INFERENCE-FORBIDDEN-RULE-COUNT", 1, 0, false);
		declareFunction(myName, "inference_interrupt_signaledP",
				"INFERENCE-INTERRUPT-SIGNALED?", 1, 0, false);
		declareFunction(myName, "inference_no_interrupt_signaledP",
				"INFERENCE-NO-INTERRUPT-SIGNALED?", 1, 0, false);
		declareFunction(myName, "inference_interrupt_handledP",
				"INFERENCE-INTERRUPT-HANDLED?", 1, 0, false);
		declareFunction(myName, "inference_answer_count",
				"INFERENCE-ANSWER-COUNT", 1, 0, false);
		declareFunction(myName, "inference_new_answer_count",
				"INFERENCE-NEW-ANSWER-COUNT", 1, 0, false);
		declareFunction(myName, "inference_new_justification_count",
				"INFERENCE-NEW-JUSTIFICATION-COUNT", 1, 0, false);
		declareFunction(myName, "inference_new_result_count",
				"INFERENCE-NEW-RESULT-COUNT", 1, 0, false);
		declareFunction(myName, "forward_inference_p", "FORWARD-INFERENCE-P",
				1, 0, false);
		declareFunction(myName, "backward_inference_p", "BACKWARD-INFERENCE-P",
				1, 0, false);
		declareFunction(myName, "abductive_inference_p",
				"ABDUCTIVE-INFERENCE-P", 1, 0, false);
		declareFunction(myName, "inference_provability_status",
				"INFERENCE-PROVABILITY-STATUS", 1, 0, false);
		declareFunction(myName, "good_inference_p", "GOOD-INFERENCE-P", 1, 0,
				false);
		declareFunction(myName, "neutral_inference_p", "NEUTRAL-INFERENCE-P",
				1, 0, false);
		declareFunction(myName, "no_good_inference_p", "NO-GOOD-INFERENCE-P",
				1, 0, false);
		declareFunction(myName, "closed_inference_p", "CLOSED-INFERENCE-P", 1,
				0, false);
		declareFunction(myName, "inference_set_static_properties",
				"INFERENCE-SET-STATIC-PROPERTIES", 2, 0, false);
		declareFunction(myName, "update_inference_input_query_properties",
				"UPDATE-INFERENCE-INPUT-QUERY-PROPERTIES", 2, 0, false);
		declareFunction(myName, "add_inference_relevant_problem",
				"ADD-INFERENCE-RELEVANT-PROBLEM", 2, 0, false);
		declareFunction(myName, "remove_inference_relevant_problem",
				"REMOVE-INFERENCE-RELEVANT-PROBLEM", 2, 0, false);
		declareFunction(myName, "clear_inference_relevant_problems",
				"CLEAR-INFERENCE-RELEVANT-PROBLEMS", 1, 0, false);
		declareFunction(myName, "add_inference_strategy",
				"ADD-INFERENCE-STRATEGY", 2, 0, false);
		declareFunction(myName, "remove_inference_strategy",
				"REMOVE-INFERENCE-STRATEGY", 2, 0, false);
		declareFunction(myName, "clear_inference_strategy_set",
				"CLEAR-INFERENCE-STRATEGY-SET", 1, 0, false);
		declareFunction(myName, "reset_inference_new_answer_id",
				"RESET-INFERENCE-NEW-ANSWER-ID", 1, 0, false);
		declareFunction(myName, "inference_next_new_answer_id",
				"INFERENCE-NEXT-NEW-ANSWER-ID", 1, 0, false);
		declareFunction(myName, "add_inference_new_answer_by_id",
				"ADD-INFERENCE-NEW-ANSWER-BY-ID", 2, 0, false);
		declareFunction(myName, "remove_inference_new_answer_by_id",
				"REMOVE-INFERENCE-NEW-ANSWER-BY-ID", 2, 0, false);
		declareFunction(myName, "add_inference_new_answer_by_bindings",
				"ADD-INFERENCE-NEW-ANSWER-BY-BINDINGS", 2, 0, false);
		declareFunction(myName, "remove_inference_new_answer_by_bindings",
				"REMOVE-INFERENCE-NEW-ANSWER-BY-BINDINGS", 2, 0, false);
		declareFunction(myName, "reset_inference_new_answer_justifications",
				"RESET-INFERENCE-NEW-ANSWER-JUSTIFICATIONS", 1, 0, false);
		declareFunction(myName, "add_inference_new_answer_justification",
				"ADD-INFERENCE-NEW-ANSWER-JUSTIFICATION", 2, 0, false);
		declareFunction(myName, "remove_inference_new_answer_justification",
				"REMOVE-INFERENCE-NEW-ANSWER-JUSTIFICATION", 2, 0, false);
		declareFunction(myName, "clear_inference_control_process",
				"CLEAR-INFERENCE-CONTROL-PROCESS", 1, 0, false);
		declareFunction(myName, "set_inference_control_process_to_me",
				"SET-INFERENCE-CONTROL-PROCESS-TO-ME", 1, 0, false);
		declareFunction(myName, "note_inference_interrupt_signaled",
				"NOTE-INFERENCE-INTERRUPT-SIGNALED", 2, 0, false);
		declareFunction(myName, "increment_inference_cumulative_time",
				"INCREMENT-INFERENCE-CUMULATIVE-TIME", 2, 0, false);
		declareFunction(myName, "reorder_inference_free_hl_vars",
				"REORDER-INFERENCE-FREE-HL-VARS", 2, 0, false);
		declareFunction(myName, "reorder_inference_free_el_vars",
				"REORDER-INFERENCE-FREE-EL-VARS", 2, 0, false);
		declareFunction(myName, "reset_inference_new_answers",
				"RESET-INFERENCE-NEW-ANSWERS", 1, 0, false);
		declareFunction(myName, "add_inference_new_answer",
				"ADD-INFERENCE-NEW-ANSWER", 2, 0, false);
		declareFunction(myName, "remove_inference_new_answer",
				"REMOVE-INFERENCE-NEW-ANSWER", 2, 0, false);
		declareFunction(myName, "initialize_inference_time_properties",
				"INITIALIZE-INFERENCE-TIME-PROPERTIES", 1, 0, false);
		declareFunction(myName, "finalize_inference_time_properties",
				"FINALIZE-INFERENCE-TIME-PROPERTIES", 1, 0, false);
		declareFunction(myName,
				"inference_elapsed_internal_real_time_since_start",
				"INFERENCE-ELAPSED-INTERNAL-REAL-TIME-SINCE-START", 1, 0, false);
		declareFunction(myName, "inference_elapsed_universal_time_since_start",
				"INFERENCE-ELAPSED-UNIVERSAL-TIME-SINCE-START", 1, 0, false);
		declareFunction(myName, "inference_time_so_far",
				"INFERENCE-TIME-SO-FAR", 1, 1, false);
		declareFunction(myName, "inference_remaining_time",
				"INFERENCE-REMAINING-TIME", 1, 1, false);
		declareFunction(myName, "inference_cumulative_time_so_far",
				"INFERENCE-CUMULATIVE-TIME-SO-FAR", 1, 1, false);
		declareFunction(myName, "inference_signal_interrupt",
				"INFERENCE-SIGNAL-INTERRUPT", 1, 0, false);
		declareFunction(myName, "inference_handle_interrupts",
				"INFERENCE-HANDLE-INTERRUPTS", 1, 0, false);
		declareFunction(myName, "simplest_inference_p", "SIMPLEST-INFERENCE-P",
				1, 0, false);
		declareFunction(myName, "new_simplest_inference",
				"NEW-SIMPLEST-INFERENCE", 1, 0, false);
		declareFunction(myName, "simplest_inference_strategy",
				"SIMPLEST-INFERENCE-STRATEGY", 1, 0, false);
		declareFunction(myName, "set_simplest_inference_strategy",
				"SET-SIMPLEST-INFERENCE-STRATEGY", 2, 0, false);
		declareFunction(myName, "new_simplest_inference_of_type",
				"NEW-SIMPLEST-INFERENCE-OF-TYPE", 2, 0, false);
		declareFunction(myName, "new_simplest_inference_with_new_store",
				"NEW-SIMPLEST-INFERENCE-WITH-NEW-STORE", 1, 0, false);
		declareFunction(myName, "inference_answer_print_function_trampoline",
				"INFERENCE-ANSWER-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
		declareFunction(myName, "inference_answer_p", "INFERENCE-ANSWER-P", 1,
				0, false);
		new $inference_answer_p$UnaryFunction();
		declareFunction(myName, "inf_answer_suid", "INF-ANSWER-SUID", 1, 0,
				false);
		declareFunction(myName, "inf_answer_inference", "INF-ANSWER-INFERENCE",
				1, 0, false);
		declareFunction(myName, "inf_answer_bindings", "INF-ANSWER-BINDINGS",
				1, 0, false);
		declareFunction(myName, "inf_answer_justifications",
				"INF-ANSWER-JUSTIFICATIONS", 1, 0, false);
		declareFunction(myName, "inf_answer_elapsed_creation_time",
				"INF-ANSWER-ELAPSED-CREATION-TIME", 1, 0, false);
		declareFunction(myName, "inf_answer_step_count",
				"INF-ANSWER-STEP-COUNT", 1, 0, false);
		declareFunction(myName, "_csetf_inf_answer_suid",
				"_CSETF-INF-ANSWER-SUID", 2, 0, false);
		declareFunction(myName, "_csetf_inf_answer_inference",
				"_CSETF-INF-ANSWER-INFERENCE", 2, 0, false);
		declareFunction(myName, "_csetf_inf_answer_bindings",
				"_CSETF-INF-ANSWER-BINDINGS", 2, 0, false);
		declareFunction(myName, "_csetf_inf_answer_justifications",
				"_CSETF-INF-ANSWER-JUSTIFICATIONS", 2, 0, false);
		declareFunction(myName, "_csetf_inf_answer_elapsed_creation_time",
				"_CSETF-INF-ANSWER-ELAPSED-CREATION-TIME", 2, 0, false);
		declareFunction(myName, "_csetf_inf_answer_step_count",
				"_CSETF-INF-ANSWER-STEP-COUNT", 2, 0, false);
		declareFunction(myName, "make_inference_answer",
				"MAKE-INFERENCE-ANSWER", 0, 1, false);
		declareFunction(myName, "valid_inference_answer_p",
				"VALID-INFERENCE-ANSWER-P", 1, 0, false);
		declareFunction(myName, "inference_answer_invalid_p",
				"INFERENCE-ANSWER-INVALID-P", 1, 0, false);
		declareFunction(myName, "print_inference_answer",
				"PRINT-INFERENCE-ANSWER", 3, 0, false);
		declareFunction(myName, "sxhash_inference_answer_method",
				"SXHASH-INFERENCE-ANSWER-METHOD", 1, 0, false);
		declareFunction(myName, "new_inference_answer", "NEW-INFERENCE-ANSWER",
				2, 0, false);
		declareFunction(myName, "find_or_create_inference_answer",
				"FIND-OR-CREATE-INFERENCE-ANSWER", 2, 0, false);
		declareMacro(myName, "do_inference_answer_justifications",
				"DO-INFERENCE-ANSWER-JUSTIFICATIONS");
		declareMacro(myName, "do_inference_answer_justifications_numbered",
				"DO-INFERENCE-ANSWER-JUSTIFICATIONS-NUMBERED");
		declareFunction(myName, "destroy_inference_answer",
				"DESTROY-INFERENCE-ANSWER", 1, 0, false);
		declareFunction(myName, "destroy_inference_answer_int",
				"DESTROY-INFERENCE-ANSWER-INT", 1, 0, false);
		declareFunction(myName, "note_inference_answer_invalid",
				"NOTE-INFERENCE-ANSWER-INVALID", 1, 0, false);
		declareFunction(myName, "inference_answer_suid",
				"INFERENCE-ANSWER-SUID", 1, 0, false);
		declareFunction(myName, "inference_answer_inference",
				"INFERENCE-ANSWER-INFERENCE", 1, 0, false);
		declareFunction(myName, "inference_answer_bindings",
				"INFERENCE-ANSWER-BINDINGS", 1, 0, false);
		declareFunction(myName, "inference_answer_justifications",
				"INFERENCE-ANSWER-JUSTIFICATIONS", 1, 0, false);
		declareFunction(myName, "inference_answer_elapsed_creation_time",
				"INFERENCE-ANSWER-ELAPSED-CREATION-TIME", 1, 0, false);
		declareFunction(myName, "inference_answer_step_count",
				"INFERENCE-ANSWER-STEP-COUNT", 1, 0, false);
		declareFunction(myName, "set_inference_answer_bindings",
				"SET-INFERENCE-ANSWER-BINDINGS", 2, 0, false);
		declareFunction(myName, "set_inference_answer_elapsed_creation_time",
				"SET-INFERENCE-ANSWER-ELAPSED-CREATION-TIME", 2, 0, false);
		declareFunction(myName, "set_inference_answer_step_count",
				"SET-INFERENCE-ANSWER-STEP-COUNT", 2, 0, false);
		declareFunction(myName, "inference_answer_problem_store",
				"INFERENCE-ANSWER-PROBLEM-STORE", 1, 0, false);
		declareFunction(myName, "inference_answer_free_el_vars",
				"INFERENCE-ANSWER-FREE-EL-VARS", 1, 0, false);
		declareFunction(myName, "inference_answer_elapsed_time",
				"INFERENCE-ANSWER-ELAPSED-TIME", 1, 1, false);
		declareFunction(myName, "inference_answer_creation_time",
				"INFERENCE-ANSWER-CREATION-TIME", 1, 0, false);
		declareFunction(myName, "find_inference_answer_justification",
				"FIND-INFERENCE-ANSWER-JUSTIFICATION", 2, 0, false);
		declareFunction(myName, "inference_answer_result_bindings",
				"INFERENCE-ANSWER-RESULT-BINDINGS", 1, 0, false);
		declareFunction(myName, "inference_answer_bindings_equalP",
				"INFERENCE-ANSWER-BINDINGS-EQUAL?", 2, 0, false);
		declareFunction(myName, "inference_answer_newP",
				"INFERENCE-ANSWER-NEW?", 1, 0, false);
		declareFunction(myName, "inference_answer_L", "INFERENCE-ANSWER-<", 2,
				0, false);
		declareFunction(myName, "inference_answer_el_sentence",
				"INFERENCE-ANSWER-EL-SENTENCE", 1, 0, false);
		declareFunction(myName, "add_inference_answer_justification",
				"ADD-INFERENCE-ANSWER-JUSTIFICATION", 2, 0, false);
		declareFunction(myName, "remove_inference_answer_justification",
				"REMOVE-INFERENCE-ANSWER-JUSTIFICATION", 2, 0, false);
		declareFunction(myName,
				"initialize_inference_answer_elapsed_creation_time",
				"INITIALIZE-INFERENCE-ANSWER-ELAPSED-CREATION-TIME", 1, 0,
				false);
		declareFunction(myName,
				"inference_answer_justification_print_function_trampoline",
				"INFERENCE-ANSWER-JUSTIFICATION-PRINT-FUNCTION-TRAMPOLINE", 2,
				0, false);
		declareFunction(myName, "inference_answer_justification_p",
				"INFERENCE-ANSWER-JUSTIFICATION-P", 1, 0, false);
		new $inference_answer_justification_p$UnaryFunction();
		declareFunction(myName, "inf_ans_just_answer", "INF-ANS-JUST-ANSWER",
				1, 0, false);
		declareFunction(myName, "inf_ans_just_supports",
				"INF-ANS-JUST-SUPPORTS", 1, 0, false);
		declareFunction(myName, "inf_ans_just_proofs", "INF-ANS-JUST-PROOFS",
				1, 0, false);
		declareFunction(myName, "_csetf_inf_ans_just_answer",
				"_CSETF-INF-ANS-JUST-ANSWER", 2, 0, false);
		declareFunction(myName, "_csetf_inf_ans_just_supports",
				"_CSETF-INF-ANS-JUST-SUPPORTS", 2, 0, false);
		declareFunction(myName, "_csetf_inf_ans_just_proofs",
				"_CSETF-INF-ANS-JUST-PROOFS", 2, 0, false);
		declareFunction(myName, "make_inference_answer_justification",
				"MAKE-INFERENCE-ANSWER-JUSTIFICATION", 0, 1, false);
		declareFunction(myName, "valid_inference_answer_justification_p",
				"VALID-INFERENCE-ANSWER-JUSTIFICATION-P", 1, 0, false);
		declareFunction(myName, "inference_answer_justification_invalid_p",
				"INFERENCE-ANSWER-JUSTIFICATION-INVALID-P", 1, 0, false);
		declareFunction(myName, "print_inference_answer_justification",
				"PRINT-INFERENCE-ANSWER-JUSTIFICATION", 3, 0, false);
		declareFunction(myName, "sxhash_inference_answer_justification_method",
				"SXHASH-INFERENCE-ANSWER-JUSTIFICATION-METHOD", 1, 0, false);
		declareFunction(myName, "list_of_inference_answer_justification_p",
				"LIST-OF-INFERENCE-ANSWER-JUSTIFICATION-P", 1, 0, false);
		declareFunction(myName, "new_inference_answer_justification",
				"NEW-INFERENCE-ANSWER-JUSTIFICATION", 2, 0, false);
		declareFunction(myName,
				"find_or_create_inference_answer_justification",
				"FIND-OR-CREATE-INFERENCE-ANSWER-JUSTIFICATION", 3, 0, false);
		declareFunction(myName, "destroy_inference_answer_justification",
				"DESTROY-INFERENCE-ANSWER-JUSTIFICATION", 1, 0, false);
		declareFunction(myName, "destroy_inference_answer_justification_int",
				"DESTROY-INFERENCE-ANSWER-JUSTIFICATION-INT", 1, 0, false);
		declareFunction(myName, "note_inference_answer_justification_invalid",
				"NOTE-INFERENCE-ANSWER-JUSTIFICATION-INVALID", 1, 0, false);
		declareFunction(myName, "inference_answer_justification_answer",
				"INFERENCE-ANSWER-JUSTIFICATION-ANSWER", 1, 0, false);
		declareFunction(myName, "inference_answer_justification_supports",
				"INFERENCE-ANSWER-JUSTIFICATION-SUPPORTS", 1, 0, false);
		new $inference_answer_justification_supports$UnaryFunction();
		declareFunction(myName, "inference_answer_justification_proofs",
				"INFERENCE-ANSWER-JUSTIFICATION-PROOFS", 1, 0, false);
		declareMacro(myName, "do_inference_answer_justification_proofs",
				"DO-INFERENCE-ANSWER-JUSTIFICATION-PROOFS");
		declareMacro(myName,
				"do_proof_dependent_inference_answer_justifications",
				"DO-PROOF-DEPENDENT-INFERENCE-ANSWER-JUSTIFICATIONS");
		declareMacro(myName, "do_inference_all_subproofs",
				"DO-INFERENCE-ALL-SUBPROOFS");
		declareFunction(myName, "inference_answer_first_justification",
				"INFERENCE-ANSWER-FIRST-JUSTIFICATION", 1, 0, false);
		declareFunction(myName, "inference_answer_justification_first_proof",
				"INFERENCE-ANSWER-JUSTIFICATION-FIRST-PROOF", 1, 0, false);
		declareFunction(myName, "inference_first_proof",
				"INFERENCE-FIRST-PROOF", 1, 0, false);
		declareFunction(myName, "inference_answer_justification_inference",
				"INFERENCE-ANSWER-JUSTIFICATION-INFERENCE", 1, 0, false);
		declareFunction(myName, "inference_answer_justification_store",
				"INFERENCE-ANSWER-JUSTIFICATION-STORE", 1, 0, false);
		declareFunction(myName, "inference_answer_justification_rules",
				"INFERENCE-ANSWER-JUSTIFICATION-RULES", 1, 0, false);
		declareFunction(myName, "add_inference_answer_justification_proof",
				"ADD-INFERENCE-ANSWER-JUSTIFICATION-PROOF", 2, 0, false);
		declareFunction(myName,
				"new_inference_answer_justification_from_proof",
				"NEW-INFERENCE-ANSWER-JUSTIFICATION-FROM-PROOF", 3, 0, false);
		declareFunction(myName,
				"inference_answer_justification_to_tms_deduction_spec",
				"INFERENCE-ANSWER-JUSTIFICATION-TO-TMS-DEDUCTION-SPEC", 2, 0,
				false);
		declareFunction(myName,
				"inference_answer_justification_to_true_tms_deduction_spec",
				"INFERENCE-ANSWER-JUSTIFICATION-TO-TRUE-TMS-DEDUCTION-SPEC", 1,
				0, false);
		declareFunction(myName,
				"inference_answer_justification_to_false_tms_deduction_spec",
				"INFERENCE-ANSWER-JUSTIFICATION-TO-FALSE-TMS-DEDUCTION-SPEC",
				1, 0, false);
		declareFunction(myName,
				"destroy_proof_inference_answer_justifications",
				"DESTROY-PROOF-INFERENCE-ANSWER-JUSTIFICATIONS", 1, 0, false);
		declareFunction(myName, "inference_time_per_answer",
				"INFERENCE-TIME-PER-ANSWER", 1, 0, false);
		declareFunction(myName, "inference_steps_per_answer",
				"INFERENCE-STEPS-PER-ANSWER", 1, 0, false);
		declareFunction(myName, "inference_wasted_time_after_last_answer",
				"INFERENCE-WASTED-TIME-AFTER-LAST-ANSWER", 1, 0, false);
		declareFunction(myName,
				"inference_latency_improvement_from_iterativity",
				"INFERENCE-LATENCY-IMPROVEMENT-FROM-ITERATIVITY", 1, 0, false);
		declareFunction(myName, "inference_compute_metrics",
				"INFERENCE-COMPUTE-METRICS", 1, 0, false);
		declareFunction(myName, "inference_compute_metrics_plist",
				"INFERENCE-COMPUTE-METRICS-PLIST", 2, 0, false);
		declareFunction(myName, "inference_compute_metrics_alist",
				"INFERENCE-COMPUTE-METRICS-ALIST", 2, 0, false);
		declareFunction(myName, "inference_transformation_rules_in_answers",
				"INFERENCE-TRANSFORMATION-RULES-IN-ANSWERS", 1, 0, false);
		declareFunction(myName, "inference_all_answer_proofs",
				"INFERENCE-ALL-ANSWER-PROOFS", 1, 0, false);
		declareFunction(myName, "inference_all_answer_subproofs",
				"INFERENCE-ALL-ANSWER-SUBPROOFS", 1, 0, false);
		declareFunction(myName, "inference_all_answer_modules",
				"INFERENCE-ALL-ANSWER-MODULES", 1, 0, false);
		declareFunction(myName, "problem_relevant_to_some_strategyP",
				"PROBLEM-RELEVANT-TO-SOME-STRATEGY?", 1, 0, false);
		declareFunction(myName, "first_problem_relevant_strategy",
				"FIRST-PROBLEM-RELEVANT-STRATEGY", 1, 0, false);
		declareFunction(myName, "problem_or_inference_p",
				"PROBLEM-OR-INFERENCE-P", 1, 0, false);
		declareMacro(myName, "with_inference_problem_working_time_table",
				"WITH-INFERENCE-PROBLEM-WORKING-TIME-TABLE");
		declareFunction(myName, "inference_problem_working_time_lock",
				"INFERENCE-PROBLEM-WORKING-TIME-LOCK", 1, 0, false);
		declareFunction(myName, "inference_problem_working_time_table",
				"INFERENCE-PROBLEM-WORKING-TIME-TABLE", 1, 0, false);
		declareFunction(myName,
				"initialize_inference_problem_working_time_data",
				"INITIALIZE-INFERENCE-PROBLEM-WORKING-TIME-DATA", 1, 0, false);
		declareFunction(myName, "inference_note_tactic_executed",
				"INFERENCE-NOTE-TACTIC-EXECUTED", 2, 0, false);
		declareFunction(myName, "inference_note_problem_pending",
				"INFERENCE-NOTE-PROBLEM-PENDING", 2, 0, false);
		declareFunction(myName, "signal_inference_eventP",
				"SIGNAL-INFERENCE-EVENT?", 2, 0, false);
		declareFunction(myName, "possibly_signal_new_inference_answer",
				"POSSIBLY-SIGNAL-NEW-INFERENCE-ANSWER", 2, 0, false);
		declareFunction(myName, "possibly_signal_inference_status_change",
				"POSSIBLY-SIGNAL-INFERENCE-STATUS-CHANGE", 1, 0, false);
		declareFunction(myName,
				"possibly_signal_inference_new_transformation_depth_reached",
				"POSSIBLY-SIGNAL-INFERENCE-NEW-TRANSFORMATION-DEPTH-REACHED",
				2, 0, false);
		declareMacro(myName, "inference_within_sksi_query_execution",
				"INFERENCE-WITHIN-SKSI-QUERY-EXECUTION");
		declareFunction(myName, "possibly_signal_sksi_query_start",
				"POSSIBLY-SIGNAL-SKSI-QUERY-START", 2, 0, false);
		declareFunction(myName, "possibly_signal_sksi_query_end",
				"POSSIBLY-SIGNAL-SKSI-QUERY-END", 2, 0, false);
		declareFunction(myName,
				"possibly_increment_inference_sksi_query_total_time",
				"POSSIBLY-INCREMENT-INFERENCE-SKSI-QUERY-TOTAL-TIME", 2, 0,
				false);
		declareFunction(myName, "possibly_add_inference_sksi_query_start_time",
				"POSSIBLY-ADD-INFERENCE-SKSI-QUERY-START-TIME", 2, 0, false);
		declareFunction(myName, "possibly_signal_sksi_query",
				"POSSIBLY-SIGNAL-SKSI-QUERY", 3, 1, false);
		declareMacro(myName, "inference_within_sparql_query_execution",
				"INFERENCE-WITHIN-SPARQL-QUERY-EXECUTION");
		declareFunction(myName, "possibly_add_inference_sparql_query_profile",
				"POSSIBLY-ADD-INFERENCE-SPARQL-QUERY-PROFILE", 4, 0, false);
		declareFunction(myName, "increment_inference_sksi_query_total_time",
				"INCREMENT-INFERENCE-SKSI-QUERY-TOTAL-TIME", 2, 0, false);
		declareFunction(myName, "add_inference_sksi_query_start_time",
				"ADD-INFERENCE-SKSI-QUERY-START-TIME", 2, 0, false);
		declareFunction(myName, "add_inference_sparql_query_profile",
				"ADD-INFERENCE-SPARQL-QUERY-PROFILE", 2, 0, false);
		return NIL;
	}
	...
	public static final SubLObject init_inference_datastructures_inference_file() {
		...
		$pad_times_to_first_answer$ = deflexical(
				"*PAD-TIMES-TO-FIRST-ANSWER*",
				((NIL != Symbols.boundp($sym394$_PAD_TIMES_TO_FIRST_ANSWER_)) ? ((SubLObject) $pad_times_to_first_answer$
						.getGlobalValue()) : $kw395$UNINITIALIZED));
		$dtp_inference_answer$ = defconstant("*DTP-INFERENCE-ANSWER*",
				$sym419$INFERENCE_ANSWER);
		$dtp_inference_answer_justification$ = defconstant(
				"*DTP-INFERENCE-ANSWER-JUSTIFICATION*",
				$sym456$INFERENCE_ANSWER_JUSTIFICATION);
		return NIL;
	}
	...
	public static final SubLObject setup_inference_datastructures_inference_file() {
		...
		Structures.register_method(print_high.$print_object_method_table$
				.getGlobalValue(), $dtp_inference$.getGlobalValue(), Symbols
				.symbol_function($sym57$INFERENCE_PRINT_FUNCTION_TRAMPOLINE));
		Structures.def_csetf($sym58$INFRNC_SUID, $sym59$_CSETF_INFRNC_SUID);
		Structures.def_csetf($sym60$INFRNC_PROBLEM_STORE,
				$sym61$_CSETF_INFRNC_PROBLEM_STORE);
		Structures.def_csetf($sym62$INFRNC_FORWARD_PROPAGATE,
				$sym63$_CSETF_INFRNC_FORWARD_PROPAGATE);
		Structures.def_csetf($sym64$INFRNC_INPUT_MT,
				$sym65$_CSETF_INFRNC_INPUT_MT);
		Structures.def_csetf($sym66$INFRNC_INPUT_EL_QUERY,
				$sym67$_CSETF_INFRNC_INPUT_EL_QUERY);
		Structures.def_csetf($sym68$INFRNC_INPUT_NON_EXPLANATORY_EL_QUERY,
				$sym69$_CSETF_INFRNC_INPUT_NON_EXPLANATORY_EL_QUERY);
		Structures.def_csetf($sym70$INFRNC_INPUT_QUERY_PROPERTIES,
				$sym71$_CSETF_INFRNC_INPUT_QUERY_PROPERTIES);
		Structures.def_csetf($sym72$INFRNC_MT, $sym73$_CSETF_INFRNC_MT);
		Structures.def_csetf($sym74$INFRNC_EL_QUERY,
				$sym75$_CSETF_INFRNC_EL_QUERY);
		Structures.def_csetf($sym76$INFRNC_EL_BINDINGS,
				$sym77$_CSETF_INFRNC_EL_BINDINGS);
		Structures.def_csetf($sym78$INFRNC_HL_QUERY,
				$sym79$_CSETF_INFRNC_HL_QUERY);
		Structures.def_csetf($sym80$INFRNC_EXPLANATORY_SUBQUERY,
				$sym81$_CSETF_INFRNC_EXPLANATORY_SUBQUERY);
		Structures.def_csetf($sym82$INFRNC_NON_EXPLANATORY_SUBQUERY,
				$sym83$_CSETF_INFRNC_NON_EXPLANATORY_SUBQUERY);
		Structures.def_csetf($sym84$INFRNC_FREE_HL_VARS,
				$sym85$_CSETF_INFRNC_FREE_HL_VARS);
		Structures.def_csetf($sym86$INFRNC_HYPOTHETICAL_BINDINGS,
				$sym87$_CSETF_INFRNC_HYPOTHETICAL_BINDINGS);
		Structures.def_csetf($sym88$INFRNC_ANSWER_ID_INDEX,
				$sym89$_CSETF_INFRNC_ANSWER_ID_INDEX);
		Structures.def_csetf($sym90$INFRNC_ANSWER_BINDINGS_INDEX,
				$sym91$_CSETF_INFRNC_ANSWER_BINDINGS_INDEX);
		Structures.def_csetf($sym92$INFRNC_NEW_ANSWER_ID_START,
				$sym93$_CSETF_INFRNC_NEW_ANSWER_ID_START);
		Structures.def_csetf($sym94$INFRNC_NEW_ANSWER_JUSTIFICATIONS,
				$sym95$_CSETF_INFRNC_NEW_ANSWER_JUSTIFICATIONS);
		Structures.def_csetf($sym96$INFRNC_STATUS, $sym97$_CSETF_INFRNC_STATUS);
		Structures.def_csetf($sym98$INFRNC_SUSPEND_STATUS,
				$sym99$_CSETF_INFRNC_SUSPEND_STATUS);
		Structures.def_csetf($sym100$INFRNC_ROOT_LINK,
				$sym101$_CSETF_INFRNC_ROOT_LINK);
		Structures.def_csetf($sym102$INFRNC_RELEVANT_PROBLEMS,
				$sym103$_CSETF_INFRNC_RELEVANT_PROBLEMS);
		Structures.def_csetf($sym104$INFRNC_STRATEGY_SET,
				$sym105$_CSETF_INFRNC_STRATEGY_SET);
		Structures.def_csetf($sym106$INFRNC_CONTROL_PROCESS,
				$sym107$_CSETF_INFRNC_CONTROL_PROCESS);
		Structures.def_csetf($sym108$INFRNC_INTERRUPTING_PROCESSES,
				$sym109$_CSETF_INFRNC_INTERRUPTING_PROCESSES);
		Structures.def_csetf($sym110$INFRNC_MAX_TRANSFORMATION_DEPTH_REACHED,
				$sym111$_CSETF_INFRNC_MAX_TRANSFORMATION_DEPTH_REACHED);
		Structures.def_csetf($sym112$INFRNC_DISJUNCTION_FREE_EL_VARS_POLICY,
				$sym113$_CSETF_INFRNC_DISJUNCTION_FREE_EL_VARS_POLICY);
		Structures.def_csetf($sym114$INFRNC_RESULT_UNIQUENESS_CRITERION,
				$sym115$_CSETF_INFRNC_RESULT_UNIQUENESS_CRITERION);
		Structures.def_csetf($sym116$INFRNC_ALLOW_HL_PREDICATE_TRANSFORMATION_,
		...
		Structures.def_csetf($sym122$INFRNC_ALLOW_INDETERMINATE_RESULTS_,
				$sym123$_CSETF_INFRNC_ALLOW_INDETERMINATE_RESULTS_);
		Structures.def_csetf($sym124$INFRNC_ALLOWED_RULES,
				$sym125$_CSETF_INFRNC_ALLOWED_RULES);
		Structures.def_csetf($sym126$INFRNC_FORBIDDEN_RULES,
				$sym127$_CSETF_INFRNC_FORBIDDEN_RULES);
		Structures.def_csetf($sym128$INFRNC_ALLOWED_MODULES,
				$sym129$_CSETF_INFRNC_ALLOWED_MODULES);
		Structures.def_csetf($sym130$INFRNC_ALLOW_ABNORMALITY_CHECKING_,
				$sym131$_CSETF_INFRNC_ALLOW_ABNORMALITY_CHECKING_);
		Structures.def_csetf($sym132$INFRNC_TRANSITIVE_CLOSURE_MODE,
				$sym133$_CSETF_INFRNC_TRANSITIVE_CLOSURE_MODE);
		Structures.def_csetf($sym134$INFRNC_PROBLEM_STORE_PRIVATE_,
				$sym135$_CSETF_INFRNC_PROBLEM_STORE_PRIVATE_);
		Structures.def_csetf($sym136$INFRNC_CONTINUABLE_,
				$sym137$_CSETF_INFRNC_CONTINUABLE_);
		Structures.def_csetf($sym138$INFRNC_BROWSABLE_,
				$sym139$_CSETF_INFRNC_BROWSABLE_);
		Structures.def_csetf($sym140$INFRNC_RETURN_TYPE,
				$sym141$_CSETF_INFRNC_RETURN_TYPE);
		Structures.def_csetf($sym142$INFRNC_ANSWER_LANGUAGE,
				$sym143$_CSETF_INFRNC_ANSWER_LANGUAGE);
		Structures.def_csetf($sym144$INFRNC_CACHE_RESULTS_,
				$sym145$_CSETF_INFRNC_CACHE_RESULTS_);
		Structures.def_csetf($sym146$INFRNC_BLOCKING_,
				$sym147$_CSETF_INFRNC_BLOCKING_);
		Structures.def_csetf($sym148$INFRNC_MAX_NUMBER,
				$sym149$_CSETF_INFRNC_MAX_NUMBER);
		Structures.def_csetf($sym150$INFRNC_MAX_TIME,
				$sym151$_CSETF_INFRNC_MAX_TIME);
		Structures.def_csetf($sym152$INFRNC_MAX_STEP,
				$sym153$_CSETF_INFRNC_MAX_STEP);
		Structures.def_csetf($sym154$INFRNC_MODE, $sym155$_CSETF_INFRNC_MODE);
		Structures.def_csetf($sym156$INFRNC_FORWARD_MAX_TIME,
				$sym157$_CSETF_INFRNC_FORWARD_MAX_TIME);
		Structures.def_csetf($sym158$INFRNC_MAX_PROOF_DEPTH,
				$sym159$_CSETF_INFRNC_MAX_PROOF_DEPTH);
		Structures.def_csetf($sym160$INFRNC_MAX_TRANSFORMATION_DEPTH,
				$sym161$_CSETF_INFRNC_MAX_TRANSFORMATION_DEPTH);
		Structures.def_csetf($sym162$INFRNC_PROBABLY_APPROXIMATELY_DONE,
				$sym163$_CSETF_INFRNC_PROBABLY_APPROXIMATELY_DONE);
		Structures.def_csetf($sym164$INFRNC_METRICS_TEMPLATE,
				$sym165$_CSETF_INFRNC_METRICS_TEMPLATE);
		Structures.def_csetf($sym166$INFRNC_START_UNIVERSAL_TIME,
				$sym167$_CSETF_INFRNC_START_UNIVERSAL_TIME);
		Structures.def_csetf($sym168$INFRNC_START_INTERNAL_REAL_TIME,
				$sym169$_CSETF_INFRNC_START_INTERNAL_REAL_TIME);
		Structures.def_csetf($sym170$INFRNC_END_INTERNAL_REAL_TIME,
				$sym171$_CSETF_INFRNC_END_INTERNAL_REAL_TIME);
		Structures.def_csetf($sym172$INFRNC_PAD_INTERNAL_REAL_TIME,
				$sym173$_CSETF_INFRNC_PAD_INTERNAL_REAL_TIME);
		Structures.def_csetf($sym174$INFRNC_CUMULATIVE_TIME,
				$sym175$_CSETF_INFRNC_CUMULATIVE_TIME);
		Structures.def_csetf($sym176$INFRNC_STEP_COUNT,
				$sym177$_CSETF_INFRNC_STEP_COUNT);
		Structures.def_csetf($sym178$INFRNC_CUMULATIVE_STEP_COUNT,
				$sym179$_CSETF_INFRNC_CUMULATIVE_STEP_COUNT);
		Structures.def_csetf($sym180$INFRNC_EVENTS,
				$sym181$_CSETF_INFRNC_EVENTS);
		Structures.def_csetf($sym182$INFRNC_HALT_CONDITIONS,
				$sym183$_CSETF_INFRNC_HALT_CONDITIONS);
		Structures.def_csetf($sym184$INFRNC_ACCUMULATORS,
				$sym185$_CSETF_INFRNC_ACCUMULATORS);
		Structures.def_csetf($sym186$INFRNC_PROOF_WATERMARK,
				$sym187$_CSETF_INFRNC_PROOF_WATERMARK);
		Structures.def_csetf($sym188$INFRNC_PROBLEM_WORKING_TIME_DATA,
		...
		Structures.register_method(
				Sxhash.$sxhash_method_table$.getGlobalValue(),
				$dtp_inference$.getGlobalValue(),
				Symbols.symbol_function($sym266$SXHASH_INFERENCE_METHOD));
		access_macros.register_macro_helper($sym296$INFERENCE_ANSWER_ID_INDEX,
				$sym305$DO_INFERENCE_ANSWERS);
		access_macros.register_macro_helper(
		...
		subl_macro_promotions
				.declare_defglobal($sym394$_PAD_TIMES_TO_FIRST_ANSWER_);
		access_macros.register_macro_helper(
		...
		Structures
				.register_method(
						...
						$dtp_inference_answer$.getGlobalValue(),
						Symbols.symbol_function($sym425$INFERENCE_ANSWER_PRINT_FUNCTION_TRAMPOLINE));
		Structures.def_csetf($sym426$INF_ANSWER_SUID,
				$sym427$_CSETF_INF_ANSWER_SUID);
		Structures.def_csetf($sym428$INF_ANSWER_INFERENCE,
				$sym429$_CSETF_INF_ANSWER_INFERENCE);
		Structures.def_csetf($sym430$INF_ANSWER_BINDINGS,
				$sym431$_CSETF_INF_ANSWER_BINDINGS);
		Structures.def_csetf($sym432$INF_ANSWER_JUSTIFICATIONS,
				$sym433$_CSETF_INF_ANSWER_JUSTIFICATIONS);
		Structures.def_csetf($sym434$INF_ANSWER_ELAPSED_CREATION_TIME,
				$sym435$_CSETF_INF_ANSWER_ELAPSED_CREATION_TIME);
		Structures.def_csetf($sym436$INF_ANSWER_STEP_COUNT,
		...
		// $dtp_inference_answer$.getGlobalValue(),
		// Symbols.symbol_function($sym443$SXHASH_INFERENCE_ANSWER_METHOD));
		access_macros.register_macro_helper(
				$sym447$INFERENCE_ANSWER_JUSTIFICATIONS,
				$sym306$DO_INFERENCE_ANSWER_JUSTIFICATIONS);
		access_macros
				.register_external_symbol($sym455$INFERENCE_ANSWER_EL_SENTENCE);
		Structures
				.register_method(
						print_high.$print_object_method_table$.getGlobalValue(),
						$dtp_inference_answer_justification$.getGlobalValue(),
						Symbols.symbol_function($sym462$INFERENCE_ANSWER_JUSTIFICATION_PRINT_FUNCTION_TRAMPOLINE));
		Structures.def_csetf($sym463$INF_ANS_JUST_ANSWER,
				$sym464$_CSETF_INF_ANS_JUST_ANSWER);
		Structures.def_csetf($sym465$INF_ANS_JUST_SUPPORTS,
				$sym466$_CSETF_INF_ANS_JUST_SUPPORTS);
		Structures.def_csetf($sym467$INF_ANS_JUST_PROOFS,
				$sym468$_CSETF_INF_ANS_JUST_PROOFS);
		Equality.identity($sym456$INFERENCE_ANSWER_JUSTIFICATION);
		// Structures.register_method(Sxhash.$sxhash_method_table$.getGlobalValue(),
		// $dtp_inference_answer_justification$.getGlobalValue(),
		// Symbols.symbol_function($sym476$SXHASH_INFERENCE_ANSWER_JUSTIFICATION_METHOD));
		access_macros.register_macro_helper(
	...
	public static final SubLList $list3 = list(new SubLObject[] {
			makeSymbol("SUID"), makeSymbol("PROBLEM-STORE"),
			makeSymbol("FORWARD-PROPAGATE"), makeSymbol("INPUT-MT"),
			makeSymbol("INPUT-EL-QUERY"),
			makeSymbol("INPUT-NON-EXPLANATORY-EL-QUERY"),
			makeSymbol("INPUT-QUERY-PROPERTIES"), makeSymbol("MT"),
			makeSymbol("EL-QUERY"), makeSymbol("EL-BINDINGS"),
			makeSymbol("HL-QUERY"), makeSymbol("EXPLANATORY-SUBQUERY"),
			makeSymbol("NON-EXPLANATORY-SUBQUERY"), makeSymbol("FREE-HL-VARS"),
			makeSymbol("HYPOTHETICAL-BINDINGS"), makeSymbol("ANSWER-ID-INDEX"),
			makeSymbol("ANSWER-BINDINGS-INDEX"),
			makeSymbol("NEW-ANSWER-ID-START"),
			makeSymbol("NEW-ANSWER-JUSTIFICATIONS"), makeSymbol("STATUS"),
			makeSymbol("SUSPEND-STATUS"), makeSymbol("ROOT-LINK"),
			makeSymbol("RELEVANT-PROBLEMS"), makeSymbol("STRATEGY-SET"),
			makeSymbol("CONTROL-PROCESS"),
			makeSymbol("INTERRUPTING-PROCESSES"),
			makeSymbol("MAX-TRANSFORMATION-DEPTH-REACHED"),
			makeSymbol("DISJUNCTION-FREE-EL-VARS-POLICY"),
			makeSymbol("RESULT-UNIQUENESS-CRITERION"),
			makeSymbol("ALLOW-HL-PREDICATE-TRANSFORMATION?"),
			makeSymbol("ALLOW-UNBOUND-PREDICATE-TRANSFORMATION?"),
			makeSymbol("ALLOW-EVALUATABLE-PREDICATE-TRANSFORMATION?"),
			makeSymbol("ALLOW-INDETERMINATE-RESULTS?"),
			makeSymbol("ALLOWED-RULES"), makeSymbol("FORBIDDEN-RULES"),
			makeSymbol("ALLOWED-MODULES"),
			makeSymbol("ALLOW-ABNORMALITY-CHECKING?"),
			makeSymbol("TRANSITIVE-CLOSURE-MODE"),
			makeSymbol("PROBLEM-STORE-PRIVATE?"), makeSymbol("CONTINUABLE?"),
			makeSymbol("BROWSABLE?"), makeSymbol("RETURN-TYPE"),
			makeSymbol("ANSWER-LANGUAGE"), makeSymbol("CACHE-RESULTS?"),
			makeSymbol("BLOCKING?"), makeSymbol("MAX-NUMBER"),
			makeSymbol("MAX-TIME"), makeSymbol("MAX-STEP"), makeSymbol("MODE"),
			makeSymbol("FORWARD-MAX-TIME"), makeSymbol("MAX-PROOF-DEPTH"),
			makeSymbol("MAX-TRANSFORMATION-DEPTH"),
			makeSymbol("PROBABLY-APPROXIMATELY-DONE"),
			makeSymbol("METRICS-TEMPLATE"), makeSymbol("START-UNIVERSAL-TIME"),
			makeSymbol("START-INTERNAL-REAL-TIME"),
			makeSymbol("END-INTERNAL-REAL-TIME"),
			makeSymbol("PAD-INTERNAL-REAL-TIME"),
			makeSymbol("CUMULATIVE-TIME"), makeSymbol("STEP-COUNT"),
			makeSymbol("CUMULATIVE-STEP-COUNT"), makeSymbol("EVENTS"),
			makeSymbol("HALT-CONDITIONS"), makeSymbol("ACCUMULATORS"),
			makeSymbol("PROOF-WATERMARK"),
			makeSymbol("PROBLEM-WORKING-TIME-DATA"), makeSymbol("TYPE"),
			makeSymbol("DATA") });
	public static final SubLList $list4 = list(new SubLObject[] {
			makeKeyword("SUID"), makeKeyword("PROBLEM-STORE"),
			makeKeyword("FORWARD-PROPAGATE"), makeKeyword("INPUT-MT"),
			makeKeyword("INPUT-EL-QUERY"),
			makeKeyword("INPUT-NON-EXPLANATORY-EL-QUERY"),
			makeKeyword("INPUT-QUERY-PROPERTIES"), makeKeyword("MT"),
			makeKeyword("EL-QUERY"), makeKeyword("EL-BINDINGS"),
			makeKeyword("HL-QUERY"), makeKeyword("EXPLANATORY-SUBQUERY"),
			makeKeyword("NON-EXPLANATORY-SUBQUERY"),
			makeKeyword("FREE-HL-VARS"), makeKeyword("HYPOTHETICAL-BINDINGS"),
			makeKeyword("ANSWER-ID-INDEX"),
			makeKeyword("ANSWER-BINDINGS-INDEX"),
			makeKeyword("NEW-ANSWER-ID-START"),
			makeKeyword("NEW-ANSWER-JUSTIFICATIONS"), makeKeyword("STATUS"),
			makeKeyword("SUSPEND-STATUS"), makeKeyword("ROOT-LINK"),
			makeKeyword("RELEVANT-PROBLEMS"), makeKeyword("STRATEGY-SET"),
			makeKeyword("CONTROL-PROCESS"),
			makeKeyword("INTERRUPTING-PROCESSES"),
			makeKeyword("MAX-TRANSFORMATION-DEPTH-REACHED"),
			makeKeyword("DISJUNCTION-FREE-EL-VARS-POLICY"),
			makeKeyword("RESULT-UNIQUENESS-CRITERION"),
			...
			makeKeyword("PROBLEM-STORE-PRIVATE?"), makeKeyword("CONTINUABLE?"),
			makeKeyword("BROWSABLE?"), makeKeyword("RETURN-TYPE"),
			makeKeyword("ANSWER-LANGUAGE"), makeKeyword("CACHE-RESULTS?"),
			makeKeyword("BLOCKING?"), makeKeyword("MAX-NUMBER"),
			makeKeyword("MAX-TIME"), makeKeyword("MAX-STEP"),
			makeKeyword("MODE"), makeKeyword("FORWARD-MAX-TIME"),
			makeKeyword("MAX-PROOF-DEPTH"),
			makeKeyword("MAX-TRANSFORMATION-DEPTH"),
			makeKeyword("PROBABLY-APPROXIMATELY-DONE"),
			makeKeyword("METRICS-TEMPLATE"),
			makeKeyword("START-UNIVERSAL-TIME"),
			makeKeyword("START-INTERNAL-REAL-TIME"),
			makeKeyword("END-INTERNAL-REAL-TIME"),
			makeKeyword("PAD-INTERNAL-REAL-TIME"),
			makeKeyword("CUMULATIVE-TIME"), makeKeyword("STEP-COUNT"),
			makeKeyword("CUMULATIVE-STEP-COUNT"), makeKeyword("EVENTS"),
			makeKeyword("HALT-CONDITIONS"), makeKeyword("ACCUMULATORS"),
			makeKeyword("PROOF-WATERMARK"),
			makeKeyword("PROBLEM-WORKING-TIME-DATA"), makeKeyword("TYPE"),
			makeKeyword("DATA") });
	public static final SubLList $list5 = list(new SubLObject[] {
			makeSymbol("INFRNC-SUID"), makeSymbol("INFRNC-PROBLEM-STORE"),
			makeSymbol("INFRNC-FORWARD-PROPAGATE"),
			makeSymbol("INFRNC-INPUT-MT"), makeSymbol("INFRNC-INPUT-EL-QUERY"),
			makeSymbol("INFRNC-INPUT-NON-EXPLANATORY-EL-QUERY"),
			makeSymbol("INFRNC-INPUT-QUERY-PROPERTIES"),
			makeSymbol("INFRNC-MT"), makeSymbol("INFRNC-EL-QUERY"),
			makeSymbol("INFRNC-EL-BINDINGS"), makeSymbol("INFRNC-HL-QUERY"),
			makeSymbol("INFRNC-EXPLANATORY-SUBQUERY"),
			makeSymbol("INFRNC-NON-EXPLANATORY-SUBQUERY"),
			makeSymbol("INFRNC-FREE-HL-VARS"),
			makeSymbol("INFRNC-HYPOTHETICAL-BINDINGS"),
			makeSymbol("INFRNC-ANSWER-ID-INDEX"),
			makeSymbol("INFRNC-ANSWER-BINDINGS-INDEX"),
			makeSymbol("INFRNC-NEW-ANSWER-ID-START"),
			makeSymbol("INFRNC-NEW-ANSWER-JUSTIFICATIONS"),
			makeSymbol("INFRNC-STATUS"), makeSymbol("INFRNC-SUSPEND-STATUS"),
			makeSymbol("INFRNC-ROOT-LINK"),
			makeSymbol("INFRNC-RELEVANT-PROBLEMS"),
			makeSymbol("INFRNC-STRATEGY-SET"),
			makeSymbol("INFRNC-CONTROL-PROCESS"),
			makeSymbol("INFRNC-INTERRUPTING-PROCESSES"),
			makeSymbol("INFRNC-MAX-TRANSFORMATION-DEPTH-REACHED"),
			makeSymbol("INFRNC-DISJUNCTION-FREE-EL-VARS-POLICY"),
			makeSymbol("INFRNC-RESULT-UNIQUENESS-CRITERION"),
			makeSymbol("INFRNC-ALLOW-HL-PREDICATE-TRANSFORMATION?"),
			makeSymbol("INFRNC-ALLOW-UNBOUND-PREDICATE-TRANSFORMATION?"),
			makeSymbol("INFRNC-ALLOW-EVALUATABLE-PREDICATE-TRANSFORMATION?"),
			makeSymbol("INFRNC-ALLOW-INDETERMINATE-RESULTS?"),
			makeSymbol("INFRNC-ALLOWED-RULES"),
			makeSymbol("INFRNC-FORBIDDEN-RULES"),
			makeSymbol("INFRNC-ALLOWED-MODULES"),
			makeSymbol("INFRNC-ALLOW-ABNORMALITY-CHECKING?"),
			makeSymbol("INFRNC-TRANSITIVE-CLOSURE-MODE"),
			makeSymbol("INFRNC-PROBLEM-STORE-PRIVATE?"),
			makeSymbol("INFRNC-CONTINUABLE?"), makeSymbol("INFRNC-BROWSABLE?"),
			makeSymbol("INFRNC-RETURN-TYPE"),
			makeSymbol("INFRNC-ANSWER-LANGUAGE"),
			makeSymbol("INFRNC-CACHE-RESULTS?"),
			makeSymbol("INFRNC-BLOCKING?"), makeSymbol("INFRNC-MAX-NUMBER"),
			makeSymbol("INFRNC-MAX-TIME"), makeSymbol("INFRNC-MAX-STEP"),
			makeSymbol("INFRNC-MODE"), makeSymbol("INFRNC-FORWARD-MAX-TIME"),
			makeSymbol("INFRNC-MAX-PROOF-DEPTH"),
			makeSymbol("INFRNC-MAX-TRANSFORMATION-DEPTH"),
			makeSymbol("INFRNC-PROBABLY-APPROXIMATELY-DONE"),
			makeSymbol("INFRNC-METRICS-TEMPLATE"),
			makeSymbol("INFRNC-START-UNIVERSAL-TIME"),
			makeSymbol("INFRNC-START-INTERNAL-REAL-TIME"),
			makeSymbol("INFRNC-END-INTERNAL-REAL-TIME"),
			makeSymbol("INFRNC-PAD-INTERNAL-REAL-TIME"),
			makeSymbol("INFRNC-CUMULATIVE-TIME"),
			makeSymbol("INFRNC-STEP-COUNT"),
			makeSymbol("INFRNC-CUMULATIVE-STEP-COUNT"),
			makeSymbol("INFRNC-EVENTS"), makeSymbol("INFRNC-HALT-CONDITIONS"),
			makeSymbol("INFRNC-ACCUMULATORS"),
			makeSymbol("INFRNC-PROOF-WATERMARK"),
			makeSymbol("INFRNC-PROBLEM-WORKING-TIME-DATA"),
			makeSymbol("INFRNC-TYPE"), makeSymbol("INFRNC-DATA") });
	public static final SubLList $list6 = list(new SubLObject[] {
			makeSymbol("_CSETF-INFRNC-SUID"),
			makeSymbol("_CSETF-INFRNC-PROBLEM-STORE"),
			makeSymbol("_CSETF-INFRNC-FORWARD-PROPAGATE"),
			makeSymbol("_CSETF-INFRNC-INPUT-MT"),
			makeSymbol("_CSETF-INFRNC-INPUT-EL-QUERY"),
			makeSymbol("_CSETF-INFRNC-INPUT-NON-EXPLANATORY-EL-QUERY"),
			makeSymbol("_CSETF-INFRNC-INPUT-QUERY-PROPERTIES"),
			makeSymbol("_CSETF-INFRNC-MT"),
			makeSymbol("_CSETF-INFRNC-EL-QUERY"),
			makeSymbol("_CSETF-INFRNC-EL-BINDINGS"),
			makeSymbol("_CSETF-INFRNC-HL-QUERY"),
			makeSymbol("_CSETF-INFRNC-EXPLANATORY-SUBQUERY"),
			makeSymbol("_CSETF-INFRNC-NON-EXPLANATORY-SUBQUERY"),
			makeSymbol("_CSETF-INFRNC-FREE-HL-VARS"),
			makeSymbol("_CSETF-INFRNC-HYPOTHETICAL-BINDINGS"),
			makeSymbol("_CSETF-INFRNC-ANSWER-ID-INDEX"),
			makeSymbol("_CSETF-INFRNC-ANSWER-BINDINGS-INDEX"),
			makeSymbol("_CSETF-INFRNC-NEW-ANSWER-ID-START"),
			makeSymbol("_CSETF-INFRNC-NEW-ANSWER-JUSTIFICATIONS"),
			makeSymbol("_CSETF-INFRNC-STATUS"),
			makeSymbol("_CSETF-INFRNC-SUSPEND-STATUS"),
			makeSymbol("_CSETF-INFRNC-ROOT-LINK"),
			makeSymbol("_CSETF-INFRNC-RELEVANT-PROBLEMS"),
			makeSymbol("_CSETF-INFRNC-STRATEGY-SET"),
			makeSymbol("_CSETF-INFRNC-CONTROL-PROCESS"),
			makeSymbol("_CSETF-INFRNC-INTERRUPTING-PROCESSES"),
			makeSymbol("_CSETF-INFRNC-MAX-TRANSFORMATION-DEPTH-REACHED"),
			makeSymbol("_CSETF-INFRNC-DISJUNCTION-FREE-EL-VARS-POLICY"),
			makeSymbol("_CSETF-INFRNC-RESULT-UNIQUENESS-CRITERION"),
			makeSymbol("_CSETF-INFRNC-ALLOW-HL-PREDICATE-TRANSFORMATION?"),
			makeSymbol("_CSETF-INFRNC-ALLOW-UNBOUND-PREDICATE-TRANSFORMATION?"),
			makeSymbol("_CSETF-INFRNC-ALLOW-EVALUATABLE-PREDICATE-TRANSFORMATION?"),
			makeSymbol("_CSETF-INFRNC-ALLOW-INDETERMINATE-RESULTS?"),
			makeSymbol("_CSETF-INFRNC-ALLOWED-RULES"),
			makeSymbol("_CSETF-INFRNC-FORBIDDEN-RULES"),
			makeSymbol("_CSETF-INFRNC-ALLOWED-MODULES"),
			makeSymbol("_CSETF-INFRNC-ALLOW-ABNORMALITY-CHECKING?"),
			makeSymbol("_CSETF-INFRNC-TRANSITIVE-CLOSURE-MODE"),
			makeSymbol("_CSETF-INFRNC-PROBLEM-STORE-PRIVATE?"),
			makeSymbol("_CSETF-INFRNC-CONTINUABLE?"),
			makeSymbol("_CSETF-INFRNC-BROWSABLE?"),
			makeSymbol("_CSETF-INFRNC-RETURN-TYPE"),
			makeSymbol("_CSETF-INFRNC-ANSWER-LANGUAGE"),
			makeSymbol("_CSETF-INFRNC-CACHE-RESULTS?"),
			makeSymbol("_CSETF-INFRNC-BLOCKING?"),
			makeSymbol("_CSETF-INFRNC-MAX-NUMBER"),
			makeSymbol("_CSETF-INFRNC-MAX-TIME"),
			makeSymbol("_CSETF-INFRNC-MAX-STEP"),
			makeSymbol("_CSETF-INFRNC-MODE"),
			makeSymbol("_CSETF-INFRNC-FORWARD-MAX-TIME"),
			makeSymbol("_CSETF-INFRNC-MAX-PROOF-DEPTH"),
			makeSymbol("_CSETF-INFRNC-MAX-TRANSFORMATION-DEPTH"),
			makeSymbol("_CSETF-INFRNC-PROBABLY-APPROXIMATELY-DONE"),
			makeSymbol("_CSETF-INFRNC-METRICS-TEMPLATE"),
			makeSymbol("_CSETF-INFRNC-START-UNIVERSAL-TIME"),
			makeSymbol("_CSETF-INFRNC-START-INTERNAL-REAL-TIME"),
			makeSymbol("_CSETF-INFRNC-END-INTERNAL-REAL-TIME"),
			makeSymbol("_CSETF-INFRNC-PAD-INTERNAL-REAL-TIME"),
			makeSymbol("_CSETF-INFRNC-CUMULATIVE-TIME"),
			makeSymbol("_CSETF-INFRNC-STEP-COUNT"),
			makeSymbol("_CSETF-INFRNC-CUMULATIVE-STEP-COUNT"),
			makeSymbol("_CSETF-INFRNC-EVENTS"),
			makeSymbol("_CSETF-INFRNC-HALT-CONDITIONS"),
			makeSymbol("_CSETF-INFRNC-ACCUMULATORS"),
			makeSymbol("_CSETF-INFRNC-PROOF-WATERMARK"),
			makeSymbol("_CSETF-INFRNC-PROBLEM-WORKING-TIME-DATA"),
			makeSymbol("_CSETF-INFRNC-TYPE"), makeSymbol("_CSETF-INFRNC-DATA") });
	...
	public static final SubLList $list272 = list(
			list(makeSymbol("PROBLEM-VAR"), makeSymbol("INFERENCE")),
	...
	public static final SubLList $list275 = list(
			list(makeSymbol("JUST-VAR"), makeSymbol("INFERENCE")),
			makeSymbol("&BODY"), makeSymbol("BODY"));
	...
	public static final SubLList $list278 = list(
			list(makeSymbol("ANSWER-VAR"), makeSymbol("INFERENCE")),
			makeSymbol("&BODY"), makeSymbol("BODY"));
	...
	public static final SubLList $list290 = list(
			list(makeSymbol("ANSWER-VAR"), makeSymbol("INFERENCE"),
					makeSymbol("&KEY"), makeSymbol("ORDERED")),
			makeSymbol("&BODY"), makeSymbol("BODY"));
	...
	public static final SubLList $list298 = list(
			list(makeSymbol("ANSWER-VAR"), makeSymbol("INFERENCE"),
					makeSymbol("START-INDEX")), makeSymbol("&BODY"),
			makeSymbol("BODY"));
	...
	public static final SubLList $list307 = list(
			list(makeSymbol("PROCESS-VAR"), makeSymbol("INFERENCE")),
			makeSymbol("&BODY"), makeSymbol("BODY"));
	...
	public static final SubLList $list310 = list(
			list(makeSymbol("PROOF-VAR"), makeSymbol("INFERENCE"),
					makeSymbol("&KEY"), makeSymbol("PROOF-STATUS")),
			makeSymbol("&BODY"), makeSymbol("BODY"));
	...
	public static final SubLList $list317 = list(
			list(makeSymbol("RULE-VAR"), makeSymbol("INFERENCE"),
					makeSymbol("&KEY"), makeSymbol("DONE")),
			makeSymbol("&BODY"), makeSymbol("BODY"));
	...
	public static final SubLList $list321 = list(list(makeSymbol("INFERENCE")),
			makeSymbol("&BODY"), makeSymbol("BODY"));
	...
	public static final SubLSymbol $sym327$IGNORE_ERRORS_HANDLER = makeSymbol(
			"IGNORE-ERRORS-HANDLER", "SUBLISP");
	...
	public static final SubLList $list365 = list(
			list(makeSymbol("STORE-ID-VAR"), makeSymbol("INFERENCE-ID-VAR"),
					makeSymbol("INFERENCE")), makeSymbol("&BODY"),
			makeSymbol("BODY"));
	...
	public static final SubLList $list371 = list(makeSymbol("MT"),
			makeSymbol("ASENT"));
	...
	public static final SubLList $list374 = list(makeSymbol("HL-MT"),
			makeSymbol("ASENT"));
	...
	public static final SubLList $list420 = list(makeSymbol("SUID"),
			makeSymbol("INFERENCE"), makeSymbol("BINDINGS"),
			makeSymbol("JUSTIFICATIONS"), makeSymbol("ELAPSED-CREATION-TIME"),
			makeSymbol("STEP-COUNT"));
	public static final SubLList $list421 = list(makeKeyword("SUID"),
			makeKeyword("INFERENCE"), makeKeyword("BINDINGS"),
			makeKeyword("JUSTIFICATIONS"),
			makeKeyword("ELAPSED-CREATION-TIME"), makeKeyword("STEP-COUNT"));
	public static final SubLList $list422 = list(makeSymbol("INF-ANSWER-SUID"),
			makeSymbol("INF-ANSWER-INFERENCE"),
			makeSymbol("INF-ANSWER-BINDINGS"),
			makeSymbol("INF-ANSWER-JUSTIFICATIONS"),
			makeSymbol("INF-ANSWER-ELAPSED-CREATION-TIME"),
			makeSymbol("INF-ANSWER-STEP-COUNT"));
	public static final SubLList $list423 = list(
			makeSymbol("_CSETF-INF-ANSWER-SUID"),
			makeSymbol("_CSETF-INF-ANSWER-INFERENCE"),
			makeSymbol("_CSETF-INF-ANSWER-BINDINGS"),
			makeSymbol("_CSETF-INF-ANSWER-JUSTIFICATIONS"),
			makeSymbol("_CSETF-INF-ANSWER-ELAPSED-CREATION-TIME"),
	...
	public static final SubLList $list445 = list(
			list(makeSymbol("JUST-VAR"), makeSymbol("INFERENCE-ANSWER")),
			makeSymbol("&BODY"), makeSymbol("BODY"));
	...
	public static final SubLList $list448 = list(
			list(makeSymbol("JUST-VAR"), makeSymbol("INDEX-VAR"),
					makeSymbol("INFERENCE-ANSWER")), makeSymbol("&BODY"),
			makeSymbol("BODY"));
	...
	public static final SubLList $list457 = list(makeSymbol("ANSWER"),
			makeSymbol("SUPPORTS"), makeSymbol("PROOFS"));
	public static final SubLList $list458 = list(makeKeyword("ANSWER"),
			makeKeyword("SUPPORTS"), makeKeyword("PROOFS"));
	public static final SubLList $list459 = list(
			makeSymbol("INF-ANS-JUST-ANSWER"),
			makeSymbol("INF-ANS-JUST-SUPPORTS"),
			makeSymbol("INF-ANS-JUST-PROOFS"));
	public static final SubLList $list460 = list(
			makeSymbol("_CSETF-INF-ANS-JUST-ANSWER"),
			makeSymbol("_CSETF-INF-ANS-JUST-SUPPORTS"),
			makeSymbol("_CSETF-INF-ANS-JUST-PROOFS"));
	...
	public static final SubLList $list478 = list(
			list(makeSymbol("PROOF-VAR"), makeSymbol("JUSTIFICATION")),
			makeSymbol("&BODY"), makeSymbol("BODY"));
	...
	public static final SubLList $list480 = list(
			list(makeSymbol("JUSTIFICATION-VAR"), makeSymbol("PROOF")),
			makeSymbol("&BODY"), makeSymbol("BODY"));
	...
	public static final SubLList $list487 = list(list(makeSymbol("FUNCTION"),
			EQ));
	public static final SubLList $list488 = list(
			list(makeSymbol("SUBPROOF-VAR"), makeSymbol("INFERENCE")),
			makeSymbol("&BODY"), makeSymbol("BODY"));
	...
	public static final SubLList $list513 = list(
			list(makeSymbol("TABLE-VAR"), makeSymbol("INFERENCE")),
			makeSymbol("&BODY"), makeSymbol("BODY"));
	...
	public static final SubLList $list541 = list(
			list(makeSymbol("&KEY"), makeSymbol("SPARQL"),
					makeSymbol("RESULT-SET")), makeSymbol("&BODY"),
			makeSymbol("BODY"));
	public static final SubLList $list542 = list(makeKeyword("SPARQL"),
			makeKeyword("RESULT-SET"));
