...
public final class inference_datastructures_problem_link extends
		SubLTranslatedFile {
	...
	/**
	 * If T, when a proof is created for a link and subproofs, the proof is also
	...
	public static final class $problem_link_native extends SubLStructNative {
		...
		private static final SubLStructDeclNative structDecl = Structures
				.makeStructDeclNative($problem_link_native.class,
						$sym0$PROBLEM_LINK, $sym1$PROBLEM_LINK_P, $list3,
						$list4, new String[] { "$suid", "$type",
								"$supported_object",
								"$supporting_mapped_problems", "$open_flags",
								"$data", "$proofs" }, $list5, $list6,
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-problem-link.lisp", position = 1395)
	public static final SubLObject problem_link_print_function_trampoline(
			SubLObject object, SubLObject stream) {
		Errors.handleMissingMethodError("This call was replaced for LarKC purposes. Originally a method was called. Refer to number 35657");
		return NIL;
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-problem-link.lisp", position = 1395)
	public static final SubLObject problem_link_p(SubLObject object) {
		return ((object.getClass() == $problem_link_native.class) ? ((SubLObject) T)
				: NIL);
	}

	public static final class $problem_link_p$UnaryFunction extends
			UnaryFunction {
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-problem-link.lisp", position = 17629)
	public static final SubLObject problem_link_close_sole_supporting_mapped_problem(
			SubLObject link) {
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-problem-link.lisp", position = 1395)
	public static final SubLObject prob_link_supporting_mapped_problems(
			SubLObject object) {
		checkType(object, $sym1$PROBLEM_LINK_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-problem-link.lisp", position = 1395)
	public static final SubLObject _csetf_prob_link_supported_object(
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-problem-link.lisp", position = 1395)
	public static final SubLObject _csetf_prob_link_supporting_mapped_problems(
			SubLObject object, SubLObject value) {
		checkType(object, $sym1$PROBLEM_LINK_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-problem-link.lisp", position = 1395)
	public static final SubLObject _csetf_prob_link_open_flags(
			SubLObject object, SubLObject value) {
		checkType(object, $sym1$PROBLEM_LINK_P);
			...
			for (next = arglist; (NIL != next); next = conses_high.cddr(next)) {
				{
					...
					if (pcase_var.eql($kw23$SUID)) {
						...
						_csetf_prob_link_supporting_mapped_problems(v_new,
								current_value);
						...
						Errors.handleMissingMethodError("This call was replaced for LarKC purposes. Originally a method was called. Refer to number 35652");
					} else {
						Errors.error($str30$Invalid_slot__S_for_construction_,
								current_arg);
					}
				}
			}
	...
	public static final SubLObject valid_problem_link_p(SubLObject object) {
		return makeBoolean(((NIL != problem_link_p(object)) && (NIL == problem_link_invalid_p(object))));
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-problem-link.lisp", position = 2566)
	public static final SubLObject problem_link_invalid_p(
			SubLObject problem_link) {
	...
	public static final class $sxhash_problem_link_method$UnaryFunction extends
			UnaryFunction {
	...
	public static final SubLObject new_problem_link(SubLObject type,
			SubLObject supported_problem) {
		{
			...
			checkType(supported_problem, $sym40$PROBLEM_P);
			{
				...
				inference_datastructures_problem.add_problem_argument_link(
						supported_problem, link);
				return link;
			}
		}
	}
	...
	public static final SubLObject new_problem_link_int(
			SubLObject supported_object, SubLObject type) {
		{
			...
			_csetf_prob_link_supported_object(link, supported_object);
			{
				...
				SubLObject suid = inference_datastructures_problem_store
						.problem_store_new_link_id(store);
				inference_metrics
						.increment_problem_link_type_historical_counts(type);
				...
				inference_datastructures_problem_store.add_problem_store_link(
						store, link);
			}
			return link;
		}
		...
		if ((NIL != valid_problem_link_p(link))) {
			{
				...
				note_problem_link_invalid(link);
				{
					...
					if (pcase_var.eql($kw34$ANSWER)) {
						...
						Errors.handleMissingMethodError("This call was replaced for LarKC purposes. Originally a method was called. Refer to number 36224");
					} else if (pcase_var.eql($kw42$TRANSFORMATION)) {
						Errors.handleMissingMethodError("This call was replaced for LarKC purposes. Originally a method was called. Refer to number 36429");
					} else if (pcase_var.eql($kw43$RESIDUAL_TRANSFORMATION)) {
						Errors.handleMissingMethodError("This call was replaced for LarKC purposes. Originally a method was called. Refer to number 35053");
					} else if (pcase_var.eql($kw44$JOIN_ORDERED)) {
						Errors.handleMissingMethodError("This call was replaced for LarKC purposes. Originally a method was called. Refer to number 36361");
					} else if (pcase_var.eql($kw45$JOIN)) {
						Errors.handleMissingMethodError("This call was replaced for LarKC purposes. Originally a method was called. Refer to number 36480");
					} else if (pcase_var.eql($kw46$SPLIT)) {
						Errors.handleMissingMethodError("This call was replaced for LarKC purposes. Originally a method was called. Refer to number 36477");
					} else if (pcase_var.eql($kw47$UNION)) {
						Errors.handleMissingMethodError("This call was replaced for LarKC purposes. Originally a method was called. Refer to number 33006");
					} else if (pcase_var.eql($kw48$RESTRICTION)) {
						Errors.handleMissingMethodError("This call was replaced for LarKC purposes. Originally a method was called. Refer to number 35676");
					}
				}
				if (($kw34$ANSWER != type)) {
					{
						...
						for (proof = cdolist_list_var.first(); (NIL != cdolist_list_var); cdolist_list_var = cdolist_list_var
							...
							if ((NIL != inference_datastructures_proof
									.valid_proof_p(proof))) {
								Errors.handleMissingMethodError("This call was replaced for LarKC purposes. Originally a method was called. Refer to number 35402");
							}
						}
					}
				}
				...
				if (($kw34$ANSWER != type)) {
					{
						...
						if ((NIL != inference_datastructures_problem
								.valid_problem_p(supported_problem))) {
							Errors.handleMissingMethodError("This call was replaced for LarKC purposes. Originally a method was called. Refer to number 35388");
						}
					}
				}
				inference_datastructures_problem_store
						.remove_problem_store_link(store, link);
			}
	...
	public static final SubLObject destroy_problem_link_int(SubLObject link) {
		...
		_csetf_prob_link_open_flags(link, $kw31$FREE);
		{
			...
			for (mapped_problem = cdolist_list_var.first(); (NIL != cdolist_list_var); cdolist_list_var = cdolist_list_var
					.rest(), mapped_problem = cdolist_list_var.first()) {
	...
	public static final SubLObject problem_link_supporting_mapped_problems(
			SubLObject link) {
		checkType(link, $sym1$PROBLEM_LINK_P);
	...
	public static final SubLObject problem_link_store(SubLObject link) {
		if ((NIL != inference_worker_answer.answer_link_p(link))) {
			return inference_datastructures_inference
					.inference_problem_store(problem_link_supported_inference(link));
		} else {
			return inference_datastructures_problem
					.problem_store(problem_link_supported_problem(link));
		}
	}
			...
			SubLObject type) {
		{
			...
			if (pcase_var.eql($kw50$CONTENT)) {
				...
				return makeBoolean(((NIL != inference_worker_split
						.split_link_p(link)) || (NIL != inference_worker_restriction
				...
				return inference_worker_removal
						.conjunctive_removal_link_p(link);
			} else {
	...
	public static final SubLObject problem_link_supported_inference(
			SubLObject link) {
		if ((NIL != inference_worker_answer.answer_link_p(link))) {
	...
	public static final SubLObject problem_link_supported_problem(
			SubLObject link) {
		if ((NIL == inference_worker_answer.answer_link_p(link))) {
			return problem_link_supported_object(link);
		}
	...
	/**
	 * @return boolean; t iff OBJECT is a problem-link with at least one argument
	 *         (child) link.
	 */
	@SubL(source = "cycl/inference/harness/inference-datastructures-problem-link.lisp", position = 10139)
	public static final SubLObject problem_link_with_supporting_problem_p(
			SubLObject object) {
		return makeBoolean(((NIL != problem_link_p(object)) && (NIL != list_utilities
				.sublisp_boolean(problem_link_supporting_mapped_problems(object)))));
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-problem-link.lisp", position = 10587)
	public static final SubLObject problem_link_number_of_supporting_problems(
			SubLObject link) {
	...
	public static final SubLObject problem_link_supporting_mapped_problem_count(
			SubLObject link) {
	...
	public static final SubLObject problem_link_first_supporting_mapped_problem(
			SubLObject link) {
	...
	public static final SubLObject problem_link_sole_supporting_mapped_problem(
			SubLObject link) {
		checkType(link, $sym61$PROBLEM_LINK_WITH_SINGLE_SUPPORTING_PROBLEM_P);
	...
	public static final SubLObject problem_link_sole_supporting_problem(
			SubLObject link) {
	...
	public static final SubLObject problem_link_find_supporting_mapped_problem_by_index(
			SubLObject link, SubLObject index) {
		return ConsesLow.nth(index,
				problem_link_supporting_mapped_problems(link));
	}
	...
	public static final SubLObject problem_link_supporting_mapped_problem_openP(
			SubLObject link, SubLObject supporting_mapped_problem) {
		{
			SubLObject index = Sequences.position(supporting_mapped_problem,
					problem_link_supporting_mapped_problems(link),
					$sym62$MAPPED_PROBLEM_EQUAL, UNPROVIDED, UNPROVIDED,
					UNPROVIDED);
	...
	public static final SubLObject problem_link_sole_supporting_mapped_problem_openP(
			SubLObject link) {
		checkType(link, $sym61$PROBLEM_LINK_WITH_SINGLE_SUPPORTING_PROBLEM_P);
	...
	public static final SubLObject add_problem_link_supporting_mapped_problem(
			SubLObject link, SubLObject supporting_mapped_problem) {
		checkType(link, $sym1$PROBLEM_LINK_P);
		checkType(supporting_mapped_problem, $sym66$MAPPED_PROBLEM_P);
		_csetf_prob_link_supporting_mapped_problems(
				link,
				cons(supporting_mapped_problem,
						prob_link_supporting_mapped_problems(link)));
		return link;
	}
	...
	public static final SubLObject problem_link_open_all(SubLObject link) {
		{
			...
			for (index = ZERO_INTEGER; index
					.numL(supporting_mapped_problem_count); index = Numbers
					.add(index, ONE_INTEGER)) {
	...
	public static final SubLObject problem_link_open_supporting_mapped_problem(
			SubLObject link, SubLObject supporting_mapped_problem) {
		{
			SubLObject index = Sequences.position(supporting_mapped_problem,
					problem_link_supporting_mapped_problems(link),
					$sym62$MAPPED_PROBLEM_EQUAL, UNPROVIDED, UNPROVIDED,
					UNPROVIDED);
			return ((NIL != index) ? ((SubLObject) problem_link_open_index(
					link, index)) : NIL);
		}
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-problem-link.lisp", position = 16863)
	public static final SubLObject problem_link_open_sole_supporting_mapped_problem(
			SubLObject link) {
		checkType(link, $sym61$PROBLEM_LINK_WITH_SINGLE_SUPPORTING_PROBLEM_P);
	...
	public static final SubLObject connect_supporting_mapped_problem_with_dependent_link(
			SubLObject supporting_mapped_problem, SubLObject link) {
		checkType(supporting_mapped_problem, $sym66$MAPPED_PROBLEM_P);
		checkType(link, $sym1$PROBLEM_LINK_P);
		add_problem_link_supporting_mapped_problem(link,
				supporting_mapped_problem);
		inference_datastructures_problem.add_problem_dependent_link(
				mapped_problem_problem(supporting_mapped_problem), link);
		return NIL;
	}

	/**
	 * @return boolean; t iff LINK is a link to goal. The only links (except for
	...
	public static final class $mapped_problem_native extends SubLStructNative {
		...
		private static final SubLStructDeclNative structDecl = Structures
				.makeStructDeclNative($mapped_problem_native.class,
						$sym67$MAPPED_PROBLEM, $sym66$MAPPED_PROBLEM_P,
						$list69, $list70, new String[] { "$problem",
								"$variable_map" }, $list71, $list72,
	...
	public static final SubLObject mapped_problem_p(SubLObject object) {
		return ((object.getClass() == $mapped_problem_native.class) ? ((SubLObject) T)
				: NIL);
	}

	public static final class $mapped_problem_p$UnaryFunction extends
			UnaryFunction {
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-problem-link.lisp", position = 21380)
	public static final SubLObject _csetf_mapped_prob_problem(
			SubLObject object, SubLObject value) {
		checkType(object, $sym66$MAPPED_PROBLEM_P);
		return object.setField2(value);
	}
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-problem-link.lisp", position = 21380)
	public static final SubLObject _csetf_mapped_prob_variable_map(
			SubLObject object, SubLObject value) {
		checkType(object, $sym66$MAPPED_PROBLEM_P);
		return object.setField3(value);
	}
	...
	public static final SubLObject valid_mapped_problem_p(SubLObject object) {
		return makeBoolean(((NIL != mapped_problem_p(object))
				&& ($kw31$FREE != mapped_problem_variable_map(object)) && (NIL != inference_datastructures_problem
				.valid_problem_p(mapped_problem_problem(object)))));
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-problem-link.lisp", position = 22026)
	public static final SubLObject mapped_problem_equal(
			SubLObject mapped_problem1, SubLObject mapped_problem2) {
	...
	public static final class $mapped_problem_equal$BinaryFunction extends
			BinaryFunction {
	...
	public static final SubLObject sxhash_mapped_problem_method(
			SubLObject object) {
		return Numbers.logxor(Sxhash.sxhash(mapped_prob_problem(object)),
				Sxhash.sxhash(mapped_prob_variable_map(object)));
	}
	...
	public static final SubLObject destroy_problem_link_mapped_problem(
	...
	public static final SubLObject destroy_mapped_problem_int(
			SubLObject mapped_problem) {
	...
	public static final SubLObject note_mapped_problem_invalid(
			SubLObject mapped_problem) {
	...
	public static final SubLObject mapped_problem_problem(
			SubLObject mapped_problem) {
	...
	/**
	 * Variable maps go UP, i.e. (<supporting problem's vars> -> <supported
	 * problem's vars>)
	 */
	@SubL(source = "cycl/inference/harness/inference-datastructures-problem-link.lisp", position = 24476)
	public static final SubLObject mapped_problem_variable_map(
			SubLObject mapped_problem) {
		checkType(mapped_problem, $sym66$MAPPED_PROBLEM_P);
	...
	public static final SubLObject find_supporting_mapped_problem_by_index(
			SubLObject link, SubLObject index) {
		{
	...
	public static final SubLObject declare_inference_datastructures_problem_link_file() {
		declareFunction(myName, "problem_link_print_function_trampoline",
				"PROBLEM-LINK-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
		...
		declareFunction(myName, "prob_link_supported_object",
				"PROB-LINK-SUPPORTED-OBJECT", 1, 0, false);
		declareFunction(myName, "prob_link_supporting_mapped_problems",
				"PROB-LINK-SUPPORTING-MAPPED-PROBLEMS", 1, 0, false);
		declareFunction(myName, "prob_link_open_flags", "PROB-LINK-OPEN-FLAGS",
				1, 0, false);
		declareFunction(myName, "prob_link_data", "PROB-LINK-DATA", 1, 0, false);
		declareFunction(myName, "prob_link_proofs", "PROB-LINK-PROOFS", 1, 0,
				false);
		declareFunction(myName, "_csetf_prob_link_suid",
				"_CSETF-PROB-LINK-SUID", 2, 0, false);
		declareFunction(myName, "_csetf_prob_link_type",
				"_CSETF-PROB-LINK-TYPE", 2, 0, false);
		declareFunction(myName, "_csetf_prob_link_supported_object",
				"_CSETF-PROB-LINK-SUPPORTED-OBJECT", 2, 0, false);
		declareFunction(myName, "_csetf_prob_link_supporting_mapped_problems",
				"_CSETF-PROB-LINK-SUPPORTING-MAPPED-PROBLEMS", 2, 0, false);
		declareFunction(myName, "_csetf_prob_link_open_flags",
				"_CSETF-PROB-LINK-OPEN-FLAGS", 2, 0, false);
		declareFunction(myName, "_csetf_prob_link_data",
				"_CSETF-PROB-LINK-DATA", 2, 0, false);
		declareFunction(myName, "_csetf_prob_link_proofs",
				"_CSETF-PROB-LINK-PROOFS", 2, 0, false);
		declareFunction(myName, "make_problem_link", "MAKE-PROBLEM-LINK", 0, 1,
				false);
		declareFunction(myName, "valid_problem_link_p", "VALID-PROBLEM-LINK-P",
				1, 0, false);
		declareFunction(myName, "problem_link_invalid_p",
				"PROBLEM-LINK-INVALID-P", 1, 0, false);
		declareFunction(myName, "print_problem_link", "PRINT-PROBLEM-LINK", 3,
				0, false);
		declareFunction(myName, "sxhash_problem_link_method",
				"SXHASH-PROBLEM-LINK-METHOD", 1, 0, false);
		new $sxhash_problem_link_method$UnaryFunction();
		declareFunction(myName, "new_problem_link", "NEW-PROBLEM-LINK", 2, 0,
				false);
		declareFunction(myName, "new_problem_link_int", "NEW-PROBLEM-LINK-INT",
				2, 0, false);
		declareFunction(myName, "destroy_problem_link", "DESTROY-PROBLEM-LINK",
				1, 0, false);
		declareFunction(myName, "destroy_problem_store_link",
				"DESTROY-PROBLEM-STORE-LINK", 1, 0, false);
		declareFunction(myName, "destroy_problem_link_int",
				"DESTROY-PROBLEM-LINK-INT", 1, 0, false);
		declareFunction(myName, "note_problem_link_invalid",
				"NOTE-PROBLEM-LINK-INVALID", 1, 0, false);
		declareFunction(myName, "problem_link_suid", "PROBLEM-LINK-SUID", 1, 0,
				false);
		declareFunction(myName, "problem_link_type", "PROBLEM-LINK-TYPE", 1, 0,
				false);
		declareFunction(myName, "problem_link_supported_object",
				"PROBLEM-LINK-SUPPORTED-OBJECT", 1, 0, false);
		declareFunction(myName, "problem_link_supporting_mapped_problems",
				"PROBLEM-LINK-SUPPORTING-MAPPED-PROBLEMS", 1, 0, false);
		declareFunction(myName, "problem_link_open_flags",
				"PROBLEM-LINK-OPEN-FLAGS", 1, 0, false);
		declareFunction(myName, "problem_link_data", "PROBLEM-LINK-DATA", 1, 0,
				false);
		declareFunction(myName, "set_problem_link_open_flags",
				"SET-PROBLEM-LINK-OPEN-FLAGS", 2, 0, false);
		declareFunction(myName, "set_problem_link_data",
				"SET-PROBLEM-LINK-DATA", 2, 0, false);
		declareFunction(myName, "add_problem_link_proof",
				"ADD-PROBLEM-LINK-PROOF", 2, 0, false);
		declareFunction(myName, "remove_problem_link_proof",
				"REMOVE-PROBLEM-LINK-PROOF", 2, 0, false);
		declareFunction(myName, "problem_link_supporting_problems",
				"PROBLEM-LINK-SUPPORTING-PROBLEMS", 1, 0, false);
		declareFunction(myName, "problem_link_store", "PROBLEM-LINK-STORE", 1,
				0, false);
		declareFunction(myName, "problem_link_has_typeP",
				"PROBLEM-LINK-HAS-TYPE?", 2, 0, false);
		declareFunction(myName, "problem_link_supported_inference",
				"PROBLEM-LINK-SUPPORTED-INFERENCE", 1, 0, false);
		declareFunction(myName, "problem_link_supported_problem",
				"PROBLEM-LINK-SUPPORTED-PROBLEM", 1, 0, false);
		declareFunction(myName, "problem_link_with_supporting_problem_p",
				"PROBLEM-LINK-WITH-SUPPORTING-PROBLEM-P", 1, 0, false);
		declareFunction(myName,
				"problem_link_with_single_supporting_problem_p",
				"PROBLEM-LINK-WITH-SINGLE-SUPPORTING-PROBLEM-P", 1, 0, false);
		declareFunction(myName, "problem_link_number_of_supporting_problems",
				"PROBLEM-LINK-NUMBER-OF-SUPPORTING-PROBLEMS", 1, 0, false);
		declareFunction(myName, "problem_link_supporting_mapped_problem_count",
				"PROBLEM-LINK-SUPPORTING-MAPPED-PROBLEM-COUNT", 1, 0, false);
		declareFunction(myName, "problem_link_first_supporting_mapped_problem",
				"PROBLEM-LINK-FIRST-SUPPORTING-MAPPED-PROBLEM", 1, 0, false);
		declareFunction(myName, "problem_link_sole_supporting_mapped_problem",
				"PROBLEM-LINK-SOLE-SUPPORTING-MAPPED-PROBLEM", 1, 0, false);
		declareFunction(myName, "problem_link_sole_supporting_variable_map",
				"PROBLEM-LINK-SOLE-SUPPORTING-VARIABLE-MAP", 1, 0, false);
		declareFunction(myName, "problem_link_first_supporting_problem",
				"PROBLEM-LINK-FIRST-SUPPORTING-PROBLEM", 1, 0, false);
		declareFunction(myName, "problem_link_sole_supporting_problem",
				"PROBLEM-LINK-SOLE-SUPPORTING-PROBLEM", 1, 0, false);
		declareFunction(myName,
				"problem_link_find_supporting_mapped_problem_by_index",
				"PROBLEM-LINK-FIND-SUPPORTING-MAPPED-PROBLEM-BY-INDEX", 2, 0,
				false);
		declareFunction(myName, "problem_link_openP", "PROBLEM-LINK-OPEN?", 1,
				0, false);
		declareFunction(myName, "problem_link_closedP", "PROBLEM-LINK-CLOSED?",
				1, 0, false);
		declareFunction(myName, "problem_link_index_openP",
				"PROBLEM-LINK-INDEX-OPEN?", 2, 0, false);
		declareFunction(myName, "problem_link_supporting_mapped_problem_openP",
				"PROBLEM-LINK-SUPPORTING-MAPPED-PROBLEM-OPEN?", 2, 0, false);
		declareFunction(myName,
				"problem_link_sole_supporting_mapped_problem_openP",
				"PROBLEM-LINK-SOLE-SUPPORTING-MAPPED-PROBLEM-OPEN?", 1, 0,
				false);
		declareFunction(myName, "supporting_mapped_problem_open_wrt_linkP",
				"SUPPORTING-MAPPED-PROBLEM-OPEN-WRT-LINK?", 2, 0, false);
		declareFunction(myName, "supporting_problem_open_wrt_linkP",
				"SUPPORTING-PROBLEM-OPEN-WRT-LINK?", 2, 0, false);
		declareFunction(myName, "problem_link_completely_openP",
				"PROBLEM-LINK-COMPLETELY-OPEN?", 1, 0, false);
		declareFunction(myName, "problem_link_has_some_proofP",
				"PROBLEM-LINK-HAS-SOME-PROOF?", 1, 1, false);
		declareFunction(myName, "problem_link_goodP", "PROBLEM-LINK-GOOD?", 1,
				0, false);
		declareFunction(myName, "problem_link_proofs", "PROBLEM-LINK-PROOFS",
				1, 0, false);
		declareFunction(myName, "problem_link_all_proofs_computed",
				"PROBLEM-LINK-ALL-PROOFS-COMPUTED", 1, 0, false);
		declareFunction(myName, "problem_link_all_proofs",
				"PROBLEM-LINK-ALL-PROOFS", 1, 0, false);
		declareFunction(myName, "problem_link_proof_count",
				"PROBLEM-LINK-PROOF-COUNT", 1, 0, false);
		declareFunction(myName, "problem_link_destructibleP",
				"PROBLEM-LINK-DESTRUCTIBLE?", 1, 0, false);
		declareFunction(myName, "problem_link_destructibility_status",
				"PROBLEM-LINK-DESTRUCTIBILITY-STATUS", 1, 0, false);
		declareFunction(myName, "add_problem_link_supporting_mapped_problem",
				"ADD-PROBLEM-LINK-SUPPORTING-MAPPED-PROBLEM", 2, 0, false);
		declareFunction(myName, "problem_link_open_all",
				"PROBLEM-LINK-OPEN-ALL", 1, 0, false);
		declareFunction(myName, "problem_link_open_index",
				"PROBLEM-LINK-OPEN-INDEX", 2, 0, false);
		declareFunction(myName, "problem_link_open_supporting_mapped_problem",
				"PROBLEM-LINK-OPEN-SUPPORTING-MAPPED-PROBLEM", 2, 0, false);
		declareFunction(myName,
				"problem_link_open_sole_supporting_mapped_problem",
				"PROBLEM-LINK-OPEN-SOLE-SUPPORTING-MAPPED-PROBLEM", 1, 0, false);
		declareFunction(myName, "problem_link_close_index",
				"PROBLEM-LINK-CLOSE-INDEX", 2, 0, false);
		declareFunction(myName, "problem_link_close_all",
				"PROBLEM-LINK-CLOSE-ALL", 1, 0, false);
		declareFunction(myName, "problem_link_close_supporting_mapped_problem",
				"PROBLEM-LINK-CLOSE-SUPPORTING-MAPPED-PROBLEM", 2, 0, false);
		declareFunction(myName,
				"problem_link_close_sole_supporting_mapped_problem",
				"PROBLEM-LINK-CLOSE-SOLE-SUPPORTING-MAPPED-PROBLEM", 1, 0,
				false);
		declareFunction(myName,
				"connect_supporting_mapped_problem_with_dependent_link",
				"CONNECT-SUPPORTING-MAPPED-PROBLEM-WITH-DEPENDENT-LINK", 2, 0,
				false);
		declareFunction(myName, "problem_link_to_goal_p",
				"PROBLEM-LINK-TO-GOAL-P", 1, 0, false);
		declareFunction(myName, "find_problem_link_of_type_between",
				"FIND-PROBLEM-LINK-OF-TYPE-BETWEEN", 3, 0, false);
		declareFunction(myName, "link_of_type_betweenP",
				"LINK-OF-TYPE-BETWEEN?", 3, 0, false);
		declareFunction(myName, "find_closed_supporting_problem_by_query",
				"FIND-CLOSED-SUPPORTING-PROBLEM-BY-QUERY", 2, 0, false);
		declareFunction(myName,
				"find_supporting_mapped_problem_by_query_and_variable_map",
				"FIND-SUPPORTING-MAPPED-PROBLEM-BY-QUERY-AND-VARIABLE-MAP", 3,
				0, false);
		declareFunction(myName,
				"problem_link_supporting_mapped_problem_that_isnt",
				"PROBLEM-LINK-SUPPORTING-MAPPED-PROBLEM-THAT-ISNT", 2, 0, false);
		declareFunction(myName, "mapped_problem_print_function_trampoline",
				"MAPPED-PROBLEM-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
		declareFunction(myName, "mapped_problem_p", "MAPPED-PROBLEM-P", 1, 0,
				false);
		new $mapped_problem_p$UnaryFunction();
		declareFunction(myName, "mapped_prob_problem", "MAPPED-PROB-PROBLEM",
				1, 0, false);
		declareFunction(myName, "mapped_prob_variable_map",
				"MAPPED-PROB-VARIABLE-MAP", 1, 0, false);
		declareFunction(myName, "_csetf_mapped_prob_problem",
				"_CSETF-MAPPED-PROB-PROBLEM", 2, 0, false);
		declareFunction(myName, "_csetf_mapped_prob_variable_map",
				"_CSETF-MAPPED-PROB-VARIABLE-MAP", 2, 0, false);
		declareFunction(myName, "make_mapped_problem", "MAKE-MAPPED-PROBLEM",
				0, 1, false);
		declareFunction(myName, "valid_mapped_problem_p",
				"VALID-MAPPED-PROBLEM-P", 1, 0, false);
		declareFunction(myName, "mapped_problem_equal", "MAPPED-PROBLEM-EQUAL",
				2, 0, false);
		new $mapped_problem_equal$BinaryFunction();
		declareFunction(myName, "print_mapped_problem", "PRINT-MAPPED-PROBLEM",
				3, 0, false);
		declareFunction(myName, "sxhash_mapped_problem_method",
				"SXHASH-MAPPED-PROBLEM-METHOD", 1, 0, false);
		declareFunction(myName, "closed_mapped_problem_p",
				"CLOSED-MAPPED-PROBLEM-P", 1, 0, false);
		declareFunction(myName, "new_mapped_problem", "NEW-MAPPED-PROBLEM", 2,
				0, false);
		declareFunction(myName, "new_closed_mapped_problem",
				"NEW-CLOSED-MAPPED-PROBLEM", 1, 0, false);
		declareFunction(myName, "destroy_problem_link_mapped_problem",
				"DESTROY-PROBLEM-LINK-MAPPED-PROBLEM", 1, 0, false);
		declareFunction(myName, "destroy_mapped_problem_int",
				"DESTROY-MAPPED-PROBLEM-INT", 1, 0, false);
		declareFunction(myName, "note_mapped_problem_invalid",
				"NOTE-MAPPED-PROBLEM-INVALID", 1, 0, false);
		declareFunction(myName, "mapped_problem_problem",
				"MAPPED-PROBLEM-PROBLEM", 1, 0, false);
		declareFunction(myName, "mapped_problem_variable_map",
				"MAPPED-PROBLEM-VARIABLE-MAP", 1, 0, false);
		declareFunction(myName, "supporting_mapped_problem_index",
				"SUPPORTING-MAPPED-PROBLEM-INDEX", 2, 0, false);
		declareFunction(myName, "find_supporting_mapped_problem_by_index",
				"FIND-SUPPORTING-MAPPED-PROBLEM-BY-INDEX", 2, 0, false);
		declareFunction(myName, "mapped_problem_query_as_subquery",
				"MAPPED-PROBLEM-QUERY-AS-SUBQUERY", 1, 0, false);
		declareFunction(myName, "mapped_problem_equals_specP",
				"MAPPED-PROBLEM-EQUALS-SPEC?", 3, 0, false);
		declareMacro(myName,
				"do_problem_link_supporting_mapped_problem_interpretations",
				"DO-PROBLEM-LINK-SUPPORTING-MAPPED-PROBLEM-INTERPRETATIONS");
		declareMacro(myName,
				"do_problem_link_supporting_variable_map_interpretations",
				"DO-PROBLEM-LINK-SUPPORTING-VARIABLE-MAP-INTERPRETATIONS");
		declareFunction(myName, "link_has_some_sibling_linkP",
				"LINK-HAS-SOME-SIBLING-LINK?", 1, 0, false);
		return NIL;
	}

	public static final SubLObject init_inference_datastructures_problem_link_file() {
		$problem_link_datastructure_stores_proofsP$ = defparameter(
				"*PROBLEM-LINK-DATASTRUCTURE-STORES-PROOFS?*", NIL);
		$dtp_problem_link$ = defconstant("*DTP-PROBLEM-LINK*",
				$sym0$PROBLEM_LINK);
		$dtp_mapped_problem$ = defconstant("*DTP-MAPPED-PROBLEM*",
	...
	public static final SubLObject setup_inference_datastructures_problem_link_file() {
		...
		Structures.register_method(print_high.$print_object_method_table$
				.getGlobalValue(), $dtp_problem_link$.getGlobalValue(), Symbols
				.symbol_function($sym8$PROBLEM_LINK_PRINT_FUNCTION_TRAMPOLINE));
		Structures
				.def_csetf($sym9$PROB_LINK_SUID, $sym10$_CSETF_PROB_LINK_SUID);
		Structures.def_csetf($sym11$PROB_LINK_TYPE,
				$sym12$_CSETF_PROB_LINK_TYPE);
		Structures.def_csetf($sym13$PROB_LINK_SUPPORTED_OBJECT,
				$sym14$_CSETF_PROB_LINK_SUPPORTED_OBJECT);
		Structures.def_csetf($sym15$PROB_LINK_SUPPORTING_MAPPED_PROBLEMS,
				$sym16$_CSETF_PROB_LINK_SUPPORTING_MAPPED_PROBLEMS);
		Structures.def_csetf($sym17$PROB_LINK_OPEN_FLAGS,
				$sym18$_CSETF_PROB_LINK_OPEN_FLAGS);
		Structures.def_csetf($sym19$PROB_LINK_DATA,
				$sym20$_CSETF_PROB_LINK_DATA);
		Structures.def_csetf($sym21$PROB_LINK_PROOFS,
		...
		Structures.register_method(
				...
				$dtp_problem_link$.getGlobalValue(),
				Symbols.symbol_function($sym37$SXHASH_PROBLEM_LINK_METHOD));
		access_macros.define_obsolete_register(
				$sym59$PROBLEM_LINK_NUMBER_OF_SUPPORTING_PROBLEMS, $list60);
		Structures
				.register_method(
						print_high.$print_object_method_table$.getGlobalValue(),
						$dtp_mapped_problem$.getGlobalValue(),
						Symbols.symbol_function($sym74$MAPPED_PROBLEM_PRINT_FUNCTION_TRAMPOLINE));
		Structures.def_csetf($sym75$MAPPED_PROB_PROBLEM,
				$sym76$_CSETF_MAPPED_PROB_PROBLEM);
		Structures.def_csetf($sym77$MAPPED_PROB_VARIABLE_MAP,
				$sym78$_CSETF_MAPPED_PROB_VARIABLE_MAP);
		Equality.identity($sym67$MAPPED_PROBLEM);
		Structures.register_method(
				Sxhash.$sxhash_method_table$.getGlobalValue(),
				$dtp_mapped_problem$.getGlobalValue(),
				Symbols.symbol_function($sym85$SXHASH_MAPPED_PROBLEM_METHOD));
		return NIL;
	}
	...
	public static final SubLList $list3 = list(makeSymbol("SUID"),
			makeSymbol("TYPE"), makeSymbol("SUPPORTED-OBJECT"),
			makeSymbol("SUPPORTING-MAPPED-PROBLEMS"), makeSymbol("OPEN-FLAGS"),
			makeSymbol("DATA"), makeSymbol("PROOFS"));
	public static final SubLList $list4 = list(makeKeyword("SUID"),
			makeKeyword("TYPE"), makeKeyword("SUPPORTED-OBJECT"),
			makeKeyword("SUPPORTING-MAPPED-PROBLEMS"),
			makeKeyword("OPEN-FLAGS"), makeKeyword("DATA"),
			makeKeyword("PROOFS"));
	public static final SubLList $list5 = list(makeSymbol("PROB-LINK-SUID"),
			makeSymbol("PROB-LINK-TYPE"),
			makeSymbol("PROB-LINK-SUPPORTED-OBJECT"),
			makeSymbol("PROB-LINK-SUPPORTING-MAPPED-PROBLEMS"),
			makeSymbol("PROB-LINK-OPEN-FLAGS"), makeSymbol("PROB-LINK-DATA"),
			makeSymbol("PROB-LINK-PROOFS"));
	public static final SubLList $list6 = list(
			makeSymbol("_CSETF-PROB-LINK-SUID"),
			makeSymbol("_CSETF-PROB-LINK-TYPE"),
			makeSymbol("_CSETF-PROB-LINK-SUPPORTED-OBJECT"),
			makeSymbol("_CSETF-PROB-LINK-SUPPORTING-MAPPED-PROBLEMS"),
			makeSymbol("_CSETF-PROB-LINK-OPEN-FLAGS"),
			makeSymbol("_CSETF-PROB-LINK-DATA"),
			makeSymbol("_CSETF-PROB-LINK-PROOFS"));
	...
	public static final SubLList $list69 = list(makeSymbol("PROBLEM"),
			makeSymbol("VARIABLE-MAP"));
	public static final SubLList $list70 = list(makeKeyword("PROBLEM"),
			makeKeyword("VARIABLE-MAP"));
	public static final SubLList $list71 = list(
			makeSymbol("MAPPED-PROB-PROBLEM"),
			makeSymbol("MAPPED-PROB-VARIABLE-MAP"));
	public static final SubLList $list72 = list(
			makeSymbol("_CSETF-MAPPED-PROB-PROBLEM"),
			makeSymbol("_CSETF-MAPPED-PROB-VARIABLE-MAP"));
	...
	public static final SubLList $list88 = list(
			list(makeSymbol("SUPPORTING-MAPPED-PROBLEM-VAR"),
					makeSymbol("LINK"), makeSymbol("PROBLEM"),
					makeSymbol("&KEY"), makeSymbol("OPEN?"), makeSymbol("DONE")),
			makeSymbol("&BODY"), makeSymbol("BODY"));
	public static final SubLList $list89 = list(makeKeyword("OPEN?"),
			makeKeyword("DONE"));
	...
	public static final SubLList $list98 = list(
			list(makeSymbol("VARIABLE-MAP-VAR"), makeSymbol("LINK"),
					makeSymbol("PROBLEM"), makeSymbol("&KEY"),
					makeSymbol("OPEN?"), makeSymbol("DONE")),
			makeSymbol("&BODY"), makeSymbol("BODY"));
