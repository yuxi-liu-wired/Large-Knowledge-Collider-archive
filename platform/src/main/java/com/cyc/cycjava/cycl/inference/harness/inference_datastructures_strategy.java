...
public final class inference_datastructures_strategy extends SubLTranslatedFile {
	...
	public static final class $strategy_native extends SubLStructNative {
		...
		public SubLObject getField6() {
			return $motivated_problems;
		}

		public SubLObject getField7() {
			return $set_aside_problems;
		}

		public SubLObject getField8() {
			return $should_reconsider_set_asidesP;
		}
		...
		public SubLObject getField10() {
			return $removal_backtracking_productivity_limit;
		}
		...
		public SubLObject getField12() {
			return $problem_proof_spec_index;
		}

		public SubLObject getField13() {
			return $problem_strategic_index;
		}
		...
		public SubLObject setField5(SubLObject value) {
			return $active_problems = value;
		}

		public SubLObject setField6(SubLObject value) {
			return $motivated_problems = value;
		}

		public SubLObject setField7(SubLObject value) {
			return $set_aside_problems = value;
		}

		public SubLObject setField8(SubLObject value) {
			return $should_reconsider_set_asidesP = value;
		}

		public SubLObject setField9(SubLObject value) {
			return $productivity_limit = value;
		}

		public SubLObject setField10(SubLObject value) {
			return $removal_backtracking_productivity_limit = value;
		}

		public SubLObject setField11(SubLObject value) {
			return $proof_spec = value;
		}

		public SubLObject setField12(SubLObject value) {
			return $problem_proof_spec_index = value;
		}

		public SubLObject setField13(SubLObject value) {
			return $problem_strategic_index = value;
		}
		...
		private static final SubLStructDeclNative structDecl = Structures
				.makeStructDeclNative($strategy_native.class, $sym0$STRATEGY,
						$sym1$STRATEGY_P, $list2, $list3, new String[] {
								"$suid", "$inference",
								"$result_uniqueness_criterion",
								"$active_problems", "$motivated_problems",
								"$set_aside_problems",
								"$should_reconsider_set_asidesP",
								"$productivity_limit",
								"$removal_backtracking_productivity_limit",
								"$proof_spec", "$problem_proof_spec_index",
								"$problem_strategic_index",
								"$memoization_state", "$type", "$data" },
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 1838)
	public static final SubLObject strategy_print_function_trampoline(
			SubLObject object, SubLObject stream) {
		Errors.handleMissingMethodError("This call was replaced for LarKC purposes. Originally a method was called. Refer to number 36447");
		return NIL;
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 1838)
	public static final SubLObject strategy_p(SubLObject object) {
		return ((object.getClass() == $strategy_native.class) ? ((SubLObject) T)
				: NIL);
	}
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 1838)
	public static final SubLObject strat_result_uniqueness_criterion(
			SubLObject object) {
		checkType(object, $sym1$STRATEGY_P);
	...
	public static final SubLObject destroy_problem_store_strategy(
			SubLObject strategy) {
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 1838)
	public static final SubLObject strat_should_reconsider_set_asidesP(
			SubLObject object) {
		checkType(object, $sym1$STRATEGY_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 1838)
	public static final SubLObject strat_removal_backtracking_productivity_limit(
			SubLObject object) {
		checkType(object, $sym1$STRATEGY_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 1838)
	public static final SubLObject strat_problem_proof_spec_index(
			SubLObject object) {
		checkType(object, $sym1$STRATEGY_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 1838)
	public static final SubLObject strat_problem_strategic_index(
			SubLObject object) {
		checkType(object, $sym1$STRATEGY_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 1838)
	public static final SubLObject _csetf_strat_result_uniqueness_criterion(
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 1838)
	public static final SubLObject _csetf_strat_active_problems(
			SubLObject object, SubLObject value) {
		checkType(object, $sym1$STRATEGY_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 1838)
	public static final SubLObject _csetf_strat_motivated_problems(
			SubLObject object, SubLObject value) {
		checkType(object, $sym1$STRATEGY_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 1838)
	public static final SubLObject _csetf_strat_set_aside_problems(
			SubLObject object, SubLObject value) {
		checkType(object, $sym1$STRATEGY_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 1838)
	public static final SubLObject _csetf_strat_should_reconsider_set_asidesP(
			SubLObject object, SubLObject value) {
		checkType(object, $sym1$STRATEGY_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 1838)
	public static final SubLObject _csetf_strat_productivity_limit(
			SubLObject object, SubLObject value) {
		checkType(object, $sym1$STRATEGY_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 1838)
	public static final SubLObject _csetf_strat_removal_backtracking_productivity_limit(
			SubLObject object, SubLObject value) {
		checkType(object, $sym1$STRATEGY_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 1838)
	public static final SubLObject _csetf_strat_problem_proof_spec_index(
			SubLObject object, SubLObject value) {
		checkType(object, $sym1$STRATEGY_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 1838)
	public static final SubLObject _csetf_strat_problem_strategic_index(
			SubLObject object, SubLObject value) {
		checkType(object, $sym1$STRATEGY_P);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 1838)
	public static final SubLObject _csetf_strat_memoization_state(
			SubLObject object, SubLObject value) {
		checkType(object, $sym1$STRATEGY_P);
			...
			for (next = arglist; (NIL != next); next = conses_high.cddr(next)) {
				{
					...
					if (pcase_var.eql($kw38$SUID)) {
						...
						_csetf_strat_result_uniqueness_criterion(v_new,
								current_value);
						...
						_csetf_strat_set_aside_problems(v_new, current_value);
							...
							.eql($kw44$SHOULD_RECONSIDER_SET_ASIDES_)) {
						_csetf_strat_should_reconsider_set_asidesP(v_new,
								current_value);
					} else if (pcase_var.eql($kw45$PRODUCTIVITY_LIMIT)) {
						_csetf_strat_productivity_limit(v_new, current_value);
					} else if (pcase_var
							.eql($kw46$REMOVAL_BACKTRACKING_PRODUCTIVITY_LIMIT)) {
						...
						Errors.error($str53$Invalid_slot__S_for_construction_,
								current_arg);
					}
				}
			}
	...
	public static final SubLObject valid_strategy_p(SubLObject object) {
		return makeBoolean(((NIL != strategy_p(object)) && (NIL == strategy_invalid_p(object))));
	}
	...
	public static final class $sxhash_strategy_method$UnaryFunction extends
			UnaryFunction {
	...
	public static final SubLObject new_strategy(SubLObject type,
		...
		checkType(inference, $sym59$INFERENCE_P);
		{
			...
			SubLObject suid = inference_datastructures_problem_store
					.problem_store_new_strategy_id(store);
			...
			_csetf_strat_active_problems(strategy,
					set.new_set(Symbols.symbol_function(EQ), UNPROVIDED));
			_csetf_strat_motivated_problems(
					strategy,
					set_contents.new_set_contents(ZERO_INTEGER,
							Symbols.symbol_function(EQ)));
			_csetf_strat_set_aside_problems(strategy,
					set.new_set(Symbols.symbol_function(EQ), UNPROVIDED));
			_csetf_strat_problem_proof_spec_index(strategy,
					dictionary.new_dictionary(Symbols.symbol_function(EQ),
							UNPROVIDED));
			...
			_csetf_strat_problem_strategic_index(
					strategy,
					Hashtables.make_hash_table(ONE_INTEGER,
							Symbols.symbol_function(EQ), UNPROVIDED));
			_csetf_strat_memoization_state(strategy,
					memoization_state.new_memoization_state(UNPROVIDED,
							UNPROVIDED, UNPROVIDED, UNPROVIDED));
			_csetf_strat_type(strategy, type);
			_csetf_strat_data(strategy, NIL);
			{
				SubLObject subconstructor = strategy_type_property(type,
						$kw60$CONSTRUCTOR);
				Functions.funcall(subconstructor, strategy);
			}
			inference_datastructures_problem_store.add_problem_store_strategy(
					store, strategy);
			inference_datastructures_inference.add_inference_strategy(
					inference, strategy);
			return strategy;
		}
	}
	...
	public static final SubLObject destroy_inference_strategy(
			SubLObject strategy) {
		if ((NIL != valid_strategy_p(strategy))) {
			note_strategy_invalid(strategy);
			inference_datastructures_problem_store
					.remove_problem_store_strategy(
							strategy_problem_store(strategy), strategy);
			return destroy_strategy_int(strategy);
		}
		return NIL;
	}
	...
	public static final SubLObject destroy_strategy_int(SubLObject strategy) {
		...
		memoization_state
				.clear_all_memoization(strategy_memoization_state(strategy));
	...
	public static final SubLObject strategy_local_result_uniqueness_criterion(
			SubLObject strategy) {
		checkType(strategy, $sym1$STRATEGY_P);
	...
	public static final SubLObject strategy_problem_strategic_index(
			SubLObject strategy) {
	...
	public static final SubLObject strategy_motivated_problems(
			SubLObject strategy) {
		checkType(strategy, $sym1$STRATEGY_P);
	...
	public static final SubLObject strategy_set_aside_problems(
			SubLObject strategy) {
		checkType(strategy, $sym1$STRATEGY_P);
	...
	public static final SubLObject strategy_should_reconsider_set_asidesP(
			SubLObject strategy) {
		checkType(strategy, $sym1$STRATEGY_P);
	...
	/**
	 * @return productivity-p If a tactic's productivity meets or exceeds this
	 *         limit, it will be ignored instead of executed.
	 */
	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 10509)
	public static final SubLObject strategy_productivity_limit(
			SubLObject strategy) {
		checkType(strategy, $sym1$STRATEGY_P);
	...
	/**
	 * @return productivity-p If a tactic's productivity meets or exceeds this
	 *         limit, it will not be considered for removal backtracking.
	 */
	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 10770)
	public static final SubLObject strategy_removal_backtracking_productivity_limit(
			SubLObject strategy) {
		checkType(strategy, $sym1$STRATEGY_P);
	...
	/**
	 * @return proof-spec-p The proof spec that this strategy is allowed to
	 *         apply.
	 */
	...
	public static final SubLObject set_strategy_productivity_limit(
			SubLObject strategy, SubLObject productivity_limit) {
		checkType(strategy, $sym1$STRATEGY_P);
	...
	public static final SubLObject strategy_memoization_state(
			SubLObject strategy) {
	...
	public static final SubLObject strategic_context_inference(
			SubLObject strategic_context) {
		return ((NIL != strategy_p(strategic_context)) ? ((SubLObject) strategy_inference(strategic_context))
				: NIL);
	}
	...
	public static final SubLObject strategy_answer_link(SubLObject strategy) {
		return inference_datastructures_inference
				.inference_root_link(strategy_inference(strategy));
	}

	/**
	 * Return T iff the answer-link of the inference of STRATEGY has been
	 * propagated and has not been closed thereafter.
	 */
	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 14541)
	public static final SubLObject strategy_answer_link_propagatedP(
			SubLObject strategy) {
		return inference_worker_answer
				.answer_link_propagatedP(strategy_answer_link(strategy));
	}

	/**
	 * Return T iff the answer-link of the inference of STRATEGY ought to be
	 * propagated.
	 */
	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 14828)
	public static final SubLObject strategy_should_propagate_answer_linkP(
			SubLObject strategy) {
		if ((NIL != strategy_answer_link_propagatedP(strategy))) {
			return NIL;
		} else if (((NIL != inference_worker
				.inference_deems_answer_link_should_be_closedP(
						strategy_inference(strategy),
						strategy_answer_link(strategy))) && (NIL != inference_datastructures_inference
	...
	public static final SubLObject strategy_root_problem(SubLObject strategy) {
		return inference_datastructures_inference
				.inference_root_problem(strategy_inference(strategy));
	}
	...
	public static final SubLObject strategy_continuableP(SubLObject strategy) {
		return inference_datastructures_inference
				.inference_continuableP(strategy_inference(strategy));
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 15948)
	public static final SubLObject problem_active_in_strategyP(
	...
	public static final SubLObject problem_motivatedP(SubLObject problem,
		...
		return set_contents.set_contents_memberP(problem,
				strategy_motivated_problems(strategy),
				Symbols.symbol_function(EQ));
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 16222)
	public static final SubLObject problem_set_aside_in_strategyP(
			SubLObject problem, SubLObject strategy) {
	...
	public static final SubLObject strategy_has_some_set_aside_problemsP(
			SubLObject strategy) {
		return makeBoolean((NIL == set
				.set_emptyP(strategy_set_aside_problems(strategy))));
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 16498)
	public static final SubLObject strategy_all_valid_set_aside_problems(
			SubLObject strategy) {
		return list_utilities.delete_if_not($sym85$VALID_PROBLEM_P,
				set.set_element_list(strategy_set_aside_problems(strategy)),
	...
	public static final SubLObject strategy_problem_store(SubLObject strategy) {
		return inference_datastructures_inference
				.inference_problem_store(strategy_inference(strategy));
	}
	...
	public static final SubLObject strategy_result_uniqueness_criterion(
			SubLObject strategy) {
		{
	...
	public static final SubLObject strategy_unique_wrt_bindingsP(
			SubLObject strategy) {
		return Equality.eq($kw87$BINDINGS,
				strategy_result_uniqueness_criterion(strategy));
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 17467)
	public static final SubLObject strategy_wants_one_answerP(
			SubLObject strategy) {
		return NIL;
	}
	...
	public static final SubLObject set_strategy_property(SubLObject strategy,
			SubLObject property, SubLObject value) {
		checkType(strategy, $sym1$STRATEGY_P);
		checkType(property, $sym90$STRATEGY_PROPERTY_P);
		{
			...
			if (pcase_var.eql($kw45$PRODUCTIVITY_LIMIT)) {
				set_strategy_productivity_limit(strategy, value);
					...
					.eql($kw46$REMOVAL_BACKTRACKING_PRODUCTIVITY_LIMIT)) {
				Errors.handleMissingMethodError("This call was replaced for LarKC purposes. Originally a method was called. Refer to number 36460");
			} else if (pcase_var.eql($kw47$PROOF_SPEC)) {
				Errors.handleMissingMethodError("This call was replaced for LarKC purposes. Originally a method was called. Refer to number 36459");
			} else {
				Errors.error($str91$Unexpected_strategy_property__s_w,
						property, value);
			}
		}
		return strategy;
	...
	public static final SubLObject set_strategy_properties(SubLObject strategy,
		...
		checkType(strategy_properties, $sym92$STRATEGY_PROPERTIES_P);
		{
			...
			for (remainder = strategy_properties; (NIL != remainder); remainder = conses_high
					.cddr(remainder)) {
				{
	...
	public static final SubLObject strategy_note_problem_active(
	...
	public static final SubLObject strategy_note_problem_inactive(
			SubLObject strategy, SubLObject problem) {
	...
	public static final SubLObject strategy_note_problem_motivated(
			SubLObject strategy, SubLObject problem) {
		{
			SubLObject motivated_problems = strategy_motivated_problems(strategy);
			_csetf_strat_motivated_problems(strategy,
					set_contents.set_contents_add(problem, motivated_problems,
							Symbols.symbol_function(EQ)));
		}
		controlling_strategy_callback(strategy,
				$kw93$SUBSTRATEGY_STRATEGEM_MOTIVATED, problem, UNPROVIDED,
				UNPROVIDED, UNPROVIDED);
		return strategy;
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 19914)
	public static final SubLObject strategy_note_problem_set_aside(
			SubLObject strategy, SubLObject problem) {
	...
	public static final SubLObject note_strategy_should_reconsider_set_asides(
			SubLObject strategy) {
	...
	public static final SubLObject clear_strategy_should_reconsider_set_asides(
			SubLObject strategy) {
		_csetf_strat_should_reconsider_set_asidesP(strategy, NIL);
		return strategy;
	}
	...
	public static final SubLObject strategy_dispatch(SubLObject strategy,
			SubLObject method_type, SubLObject arg1, SubLObject arg2,
			SubLObject arg3, SubLObject arg4, SubLObject arg5) {
		...
		{
			SubLObject handler_func = strategy_dispatch_handler(strategy,
					method_type);
			if ((NIL == handler_func)) {
				handler_func = inference_datastructures_enumerated_types
						.strategy_default_method_handler(method_type);
			}
			if (((NIL == handler_func) && (NIL != balancing_tactician
					.balancing_tactician_p(strategy)))) {
				return Errors.error($str101$balancing_tactician_does_not_impl,
						method_type);
			}
	...
	public static final SubLObject strategy_dispatch_handler(
			SubLObject strategy, SubLObject method_type) {
		{
			SubLObject strategy_type = strategy_type(strategy);
			return inference_tactician.strategy_type_dispatch_handler(
					strategy_type, method_type);
		}
	}
	...
	public static final SubLObject strategy_dispatch_funcall_0(SubLObject func,
			SubLObject strategy) {
		{
			...
			if (pcase_var
					.eql($sym102$BALANCED_STRATEGY_DEFAULT_SELECT_BEST_STRATEGEM)) {
				return inference_balanced_tactician_execution
						.balanced_strategy_default_select_best_strategem(strategy);
			} else if (pcase_var.eql($sym103$BALANCED_STRATEGY_DO_ONE_STEP)) {
				return inference_balanced_tactician_execution
						.balanced_strategy_do_one_step(strategy);
			} else if (pcase_var.eql($sym104$BALANCED_STRATEGY_DONE_)) {
				return inference_balanced_tactician_execution
						.balanced_strategy_doneP(strategy);
			} else {
	...
	public static final SubLObject strategy_dispatch_funcall_1(SubLObject func,
			SubLObject strategy, SubLObject arg1) {
		{
			SubLObject pcase_var = func;
			if (pcase_var
					.eql($sym105$BALANCED_STRATEGY_POSSIBLY_ACTIVATE_PROBLEM)) {
				return inference_balanced_tactician_motivation
						.balanced_strategy_possibly_activate_problem(strategy,
								arg1);
			} else {
	...
	public static final SubLObject controlling_strategy_callback(
			SubLObject substrategy, SubLObject method_type, SubLObject arg1,
		...
		{
			SubLObject controlling_strategy = inference_tactician
					.controlling_strategy(substrategy);
			if ((substrategy != controlling_strategy)) {
				if ((NIL != arg4_providedP)) {
					return strategy_dispatch(controlling_strategy, method_type,
							substrategy, arg1, arg2, arg3, arg4);
				} else if ((NIL != arg3_providedP)) {
					return strategy_dispatch(controlling_strategy, method_type,
							substrategy, arg1, arg2, arg3, UNPROVIDED);
				} else if ((NIL != arg2_providedP)) {
					return strategy_dispatch(controlling_strategy, method_type,
							substrategy, arg1, arg2, UNPROVIDED, UNPROVIDED);
				} else if ((NIL != arg1_providedP)) {
					return strategy_dispatch(controlling_strategy, method_type,
							substrategy, arg1, UNPROVIDED, UNPROVIDED,
							UNPROVIDED);
				} else {
					return strategy_dispatch(controlling_strategy, method_type,
							substrategy, UNPROVIDED, UNPROVIDED, UNPROVIDED,
							UNPROVIDED);
				}
			}
		}
	...
	public static final SubLObject new_strategy_type(SubLObject type,
		...
		{
			SubLObject remainder = NIL;
			for (remainder = plist; (NIL != remainder); remainder = conses_high
					.cddr(remainder)) {
				{
					SubLObject property = remainder.first();
					SubLObject value = conses_high.cadr(remainder);
	...
	public static final SubLObject deregister_strategy_type(SubLObject type) {
		return dictionary.dictionary_remove(
				$strategy_type_store$.getGlobalValue(), type);
	}
	...
	public static final SubLObject strategy_type_property(SubLObject type,
			SubLObject property) {
		return dictionary_utilities.dictionary_getf(
				$strategy_type_store$.getGlobalValue(), type, property,
				UNPROVIDED);
	}
	...
	public static final SubLObject set_strategy_type_property(SubLObject type,
		...
		return dictionary_utilities.dictionary_putf(
				$strategy_type_store$.getGlobalValue(), type, property, value);
	}
	...
	public static final SubLObject uninterestingness_cache_thrown_away_wrt_removal_code(
			SubLObject flags) {
		return bytes.ldb($uninterestingness_cache_thrown_away_wrt_removal_byte$
				.getGlobalValue(), flags);
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 30344)
	public static final SubLObject uninterestingness_cache_thrown_away_wrt_transformation_code(
			SubLObject flags) {
		return bytes.ldb(
				$uninterestingness_cache_thrown_away_wrt_transformation_byte$
						.getGlobalValue(), flags);
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 30511)
	public static final SubLObject uninterestingness_cache_thrown_away_wrt_new_root_code(
			SubLObject flags) {
		return bytes.ldb(
				$uninterestingness_cache_thrown_away_wrt_new_root_byte$
						.getGlobalValue(), flags);
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 30666)
	public static final SubLObject uninterestingness_cache_set_aside_wrt_removal_code(
			SubLObject flags) {
		return bytes.ldb($uninterestingness_cache_set_aside_wrt_removal_byte$
				.getGlobalValue(), flags);
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 30815)
	public static final SubLObject uninterestingness_cache_set_aside_wrt_transformation_code(
			SubLObject flags) {
		return bytes.ldb(
				$uninterestingness_cache_set_aside_wrt_transformation_byte$
						.getGlobalValue(), flags);
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 30978)
	public static final SubLObject uninterestingness_cache_set_aside_wrt_new_root_code(
			SubLObject flags) {
		return bytes.ldb($uninterestingness_cache_set_aside_wrt_new_root_byte$
				.getGlobalValue(), flags);
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 31129)
	public static final SubLObject uninterestingness_cache_thrown_away_code(
			SubLObject flags) {
		return bytes.ldb(
				$uninterestingness_cache_thrown_away_byte$.getGlobalValue(),
				flags);
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 31258)
	public static final SubLObject uninterestingness_cache_set_aside_code(
			SubLObject flags) {
		return bytes.ldb(
				$uninterestingness_cache_set_aside_byte$.getGlobalValue(),
				flags);
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 31383)
	public static final SubLObject set_uninterestingness_cache_thrown_away_wrt_removal_code(
			SubLObject flags, SubLObject code) {
		return bytes.dpb(code,
				$uninterestingness_cache_thrown_away_wrt_removal_byte$
						.getGlobalValue(), flags);
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 31571)
	public static final SubLObject set_uninterestingness_cache_thrown_away_wrt_transformation_code(
			SubLObject flags, SubLObject code) {
		return bytes.dpb(code,
				$uninterestingness_cache_thrown_away_wrt_transformation_byte$
						.getGlobalValue(), flags);
	...
	public static final SubLObject set_uninterestingness_cache_thrown_away_wrt_new_root_code(
			SubLObject flags, SubLObject code) {
		return bytes.dpb(code,
				$uninterestingness_cache_thrown_away_wrt_new_root_byte$
						.getGlobalValue(), flags);
	...
	public static final SubLObject set_uninterestingness_cache_set_aside_wrt_removal_code(
			SubLObject flags, SubLObject code) {
		return bytes.dpb(code,
				$uninterestingness_cache_set_aside_wrt_removal_byte$
						.getGlobalValue(), flags);
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 32084)
	public static final SubLObject set_uninterestingness_cache_set_aside_wrt_transformation_code(
			SubLObject flags, SubLObject code) {
		return bytes.dpb(code,
				$uninterestingness_cache_set_aside_wrt_transformation_byte$
						.getGlobalValue(), flags);
	...
	public static final SubLObject set_uninterestingness_cache_set_aside_wrt_new_root_code(
			SubLObject flags, SubLObject code) {
		return bytes.dpb(code,
				$uninterestingness_cache_set_aside_wrt_new_root_byte$
						.getGlobalValue(), flags);
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 32426)
	public static final SubLObject set_uninterestingness_cache_thrown_away_code(
			SubLObject flags, SubLObject code) {
		return bytes.dpb(code,
				$uninterestingness_cache_thrown_away_byte$.getGlobalValue(),
				flags);
	...
	public static final SubLObject set_uninterestingness_cache_set_aside_code(
			SubLObject flags, SubLObject code) {
		return bytes.dpb(code,
				$uninterestingness_cache_set_aside_byte$.getGlobalValue(),
				flags);
	...
	public static final SubLObject decode_uninterestingness_cache_code(
			SubLObject code) {
		{
			...
			if (pcase_var.eql(ZERO_INTEGER)) {
				...
				return Errors.error($str111$invalid_uninterestingness_cache_c,
						code);
			}
		}
	}
	...
	public static final SubLObject encode_uninterestingness_cache_status(
			SubLObject status) {
		if (($kw110$RECOMPUTE == status)) {
			...
			return Errors.error($str112$invalid_uninterestingness_cache_s,
					status);
		}
	}

	public static final class $problem_strategic_properties_native extends
			SubLStructNative {
		public SubLStructDecl getStructDecl() {
			return structDecl;
		}
		...
		private static final SubLStructDeclNative structDecl = Structures
				.makeStructDeclNative(
						$problem_strategic_properties_native.class,
						$sym113$PROBLEM_STRATEGIC_PROPERTIES,
						$sym114$PROBLEM_STRATEGIC_PROPERTIES_P, $list115,
						$list116, new String[] { "$status",
								"$tactic_strategic_property_index",
								"$possible_tactic_count", "$flags" }, $list117,
						$list118, $sym119$DEFAULT_STRUCT_PRINT_FUNCTION);
	}
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 33533)
	public static final SubLObject problem_strategic_properties_p(
			SubLObject object) {
		return ((object.getClass() == $problem_strategic_properties_native.class) ? ((SubLObject) T)
				: NIL);
	}
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 33533)
	public static final SubLObject prob_strategic_properties_status(
			SubLObject object) {
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 33533)
	public static final SubLObject prob_strategic_properties_tactic_strategic_property_index(
			SubLObject object) {
		checkType(object, $sym114$PROBLEM_STRATEGIC_PROPERTIES_P);
		return object.getField3();
	}
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 33533)
	public static final SubLObject prob_strategic_properties_possible_tactic_count(
			SubLObject object) {
		checkType(object, $sym114$PROBLEM_STRATEGIC_PROPERTIES_P);
		return object.getField4();
	}
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 33533)
	public static final SubLObject prob_strategic_properties_flags(
			SubLObject object) {
		checkType(object, $sym114$PROBLEM_STRATEGIC_PROPERTIES_P);
		return object.getField5();
	}
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 33533)
	public static final SubLObject _csetf_prob_strategic_properties_status(
			SubLObject object, SubLObject value) {
		checkType(object, $sym114$PROBLEM_STRATEGIC_PROPERTIES_P);
		return object.setField2(value);
	}
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 33533)
	public static final SubLObject _csetf_prob_strategic_properties_tactic_strategic_property_index(
			SubLObject object, SubLObject value) {
		checkType(object, $sym114$PROBLEM_STRATEGIC_PROPERTIES_P);
		return object.setField3(value);
	}
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 33533)
	public static final SubLObject _csetf_prob_strategic_properties_possible_tactic_count(
			SubLObject object, SubLObject value) {
		checkType(object, $sym114$PROBLEM_STRATEGIC_PROPERTIES_P);
		return object.setField4(value);
	}
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 33533)
	public static final SubLObject _csetf_prob_strategic_properties_flags(
			SubLObject object, SubLObject value) {
		checkType(object, $sym114$PROBLEM_STRATEGIC_PROPERTIES_P);
		return object.setField5(value);
	}
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 33533)
	public static final SubLObject make_problem_strategic_properties(
			SubLObject arglist) {
		if ((arglist == UNPROVIDED)) {
			arglist = NIL;
		}
			...
			for (next = arglist; (NIL != next); next = conses_high.cddr(next)) {
				{
					...
					if (pcase_var.eql($kw129$STATUS)) {
						_csetf_prob_strategic_properties_status(v_new,
								current_value);
					} else if (pcase_var
							.eql($kw130$TACTIC_STRATEGIC_PROPERTY_INDEX)) {
						...
						_csetf_prob_strategic_properties_flags(v_new,
								current_value);
					} else {
						Errors.error($str53$Invalid_slot__S_for_construction_,
								current_arg);
	...
	public static final SubLObject new_problem_strategic_properties() {
		{
			...
			_csetf_prob_strategic_properties_status(
					problem_strategic_properties, $kw133$NEW);
			_csetf_prob_strategic_properties_tactic_strategic_property_index(
					problem_strategic_properties, NIL);
			_csetf_prob_strategic_properties_possible_tactic_count(
					problem_strategic_properties, ZERO_INTEGER);
	...
	public static final SubLObject problem_strategic_properties_int(
			SubLObject problem, SubLObject strategy) {
		checkType(problem, $sym88$PROBLEM_P);
		checkType(strategy, $sym1$STRATEGY_P);
		{
			SubLObject problem_strategic_properties = Hashtables
					.gethash_without_values(problem,
							strategy_problem_strategic_index(strategy),
							UNPROVIDED);
			return problem_strategic_properties;
		}
	}
	...
	public static final SubLObject set_problem_strategic_properties(
			SubLObject problem, SubLObject strategy, SubLObject v_properties) {
		checkType(problem, $sym88$PROBLEM_P);
		checkType(strategy, $sym1$STRATEGY_P);
	...
	public static final SubLObject problem_strategic_properties(
			SubLObject problem, SubLObject strategy) {
		{
			SubLObject problem_strategic_properties = problem_strategic_properties_int(
					problem, strategy);
			if ((NIL == problem_strategic_properties_p(problem_strategic_properties))) {
				...
				set_problem_strategic_properties(problem, strategy,
						problem_strategic_properties);
			}
			return problem_strategic_properties;
		}
	...
	public static final SubLObject problem_strategic_properties_tactic_strategic_property_index(
			SubLObject problem, SubLObject problem_strategic_properties) {
		{
			...
			if ((!(tactic_properties_vector.isVector()))) {
				tactic_properties_vector = Vectors.make_vector(
						inference_datastructures_problem
								.problem_tactic_count(problem), UNPROVIDED);
				_csetf_prob_strategic_properties_tactic_strategic_property_index(
						problem_strategic_properties, tactic_properties_vector);
			}
			if (Sequences.length(tactic_properties_vector).numL(
					inference_datastructures_problem
							.problem_tactic_count(problem))) {
				tactic_properties_vector = vector_utilities.extend_vector_to(
	...
	public static final SubLObject problem_raw_strategic_status(
			SubLObject problem, SubLObject strategy) {
		{
			SubLObject problem_strategic_properties = problem_strategic_properties(
					problem, strategy);
			SubLObject strategic_status = prob_strategic_properties_status(problem_strategic_properties);
			if ((($kw133$NEW == strategic_status) && ($kw133$NEW != inference_datastructures_problem
	...
	public static final SubLObject problem_strategic_provability_status(
			SubLObject problem, SubLObject strategy) {
		{
			SubLObject status = problem_raw_strategic_status(problem, strategy);
			...
			if ((($kw136$NEUTRAL == weak_provability_status) && (NIL != inference_datastructures_problem
					.tactically_good_problem_p(problem)))) {
				return $kw137$GOOD;
			} else if ((($kw136$NEUTRAL == weak_provability_status) && (NIL != inference_datastructures_problem
	...
	public static final SubLObject set_problem_raw_strategic_status(
			SubLObject problem, SubLObject strategy, SubLObject status) {
		{
			SubLObject problem_strategic_properties = problem_strategic_properties(
					problem, strategy);
			_csetf_prob_strategic_properties_status(
					problem_strategic_properties, status);
		}
		return problem;
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 40296)
	public static final SubLObject strategically_unexamined_problem_p(
			SubLObject problem, SubLObject strategy) {
		return Equality.eq($kw134$UNEXAMINED,
				problem_strategic_status(problem, strategy));
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 40453)
	public static final SubLObject strategically_examined_problem_p(
			SubLObject problem, SubLObject strategy) {
		return Equality.eq($kw140$EXAMINED,
				problem_strategic_status(problem, strategy));
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 40592)
	public static final SubLObject strategically_possible_problem_p(
			SubLObject problem, SubLObject strategy) {
		return Equality.eq($kw141$POSSIBLE,
				problem_strategic_status(problem, strategy));
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 40731)
	public static final SubLObject strategically_pending_problem_p(
			SubLObject problem, SubLObject strategy) {
		return Equality.eq($kw142$PENDING,
				problem_strategic_status(problem, strategy));
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 40868)
	public static final SubLObject strategically_finished_problem_p(
			SubLObject problem, SubLObject strategy) {
		return Equality.eq($kw135$FINISHED,
				problem_strategic_status(problem, strategy));
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 41007)
	public static final SubLObject strategically_no_good_problem_p(
			SubLObject problem, SubLObject strategy) {
		return Equality.eq($kw138$NO_GOOD,
				problem_strategic_provability_status(problem, strategy));
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 41156)
	public static final SubLObject strategically_neutral_problem_p(
			SubLObject problem, SubLObject strategy) {
		return Equality.eq($kw136$NEUTRAL,
				problem_strategic_provability_status(problem, strategy));
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 41305)
	public static final SubLObject strategically_good_problem_p(
			SubLObject problem, SubLObject strategy) {
		return Equality.eq($kw137$GOOD,
				problem_strategic_provability_status(problem, strategy));
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 41913)
	public static final SubLObject strategically_totally_no_good_problem_p(
			SubLObject problem, SubLObject strategy) {
		return strategically_no_good_problem_p(problem,
	...
	public static final SubLObject set_problem_strategic_flags(
			SubLObject problem, SubLObject strategy, SubLObject flags) {
		checkType(flags, $sym143$FIXNUMP);
		{
			SubLObject problem_strategic_properties = problem_strategic_properties(
					problem, strategy);
			_csetf_prob_strategic_properties_flags(
					problem_strategic_properties, flags);
		}
		return flags;
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 42619)
	public static final SubLObject problem_thrown_away_cache_status(
			SubLObject problem, SubLObject strategy) {
		return decode_uninterestingness_cache_code(uninterestingness_cache_thrown_away_code(problem_strategic_flags(
				problem, strategy)));
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 42826)
	public static final SubLObject problem_thrown_away_cache_removal_status(
			SubLObject problem, SubLObject strategy) {
		return decode_uninterestingness_cache_code(uninterestingness_cache_thrown_away_wrt_removal_code(problem_strategic_flags(
				problem, strategy)));
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 43051)
	public static final SubLObject problem_thrown_away_cache_transformation_status(
			SubLObject problem, SubLObject strategy) {
		return decode_uninterestingness_cache_code(uninterestingness_cache_thrown_away_wrt_transformation_code(problem_strategic_flags(
				problem, strategy)));
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 43290)
	public static final SubLObject problem_thrown_away_cache_new_root_status(
			SubLObject problem, SubLObject strategy) {
		return decode_uninterestingness_cache_code(uninterestingness_cache_thrown_away_wrt_new_root_code(problem_strategic_flags(
				problem, strategy)));
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 43517)
	public static final SubLObject problem_set_aside_cache_removal_status(
			SubLObject problem, SubLObject strategy) {
		return decode_uninterestingness_cache_code(uninterestingness_cache_set_aside_wrt_removal_code(problem_strategic_flags(
				problem, strategy)));
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 43738)
	public static final SubLObject problem_set_aside_cache_status(
			SubLObject problem, SubLObject strategy) {
		return decode_uninterestingness_cache_code(uninterestingness_cache_set_aside_code(problem_strategic_flags(
				problem, strategy)));
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 43941)
	public static final SubLObject problem_set_aside_cache_transformation_status(
			SubLObject problem, SubLObject strategy) {
		return decode_uninterestingness_cache_code(uninterestingness_cache_set_aside_wrt_transformation_code(problem_strategic_flags(
				problem, strategy)));
	}
	...
	public static final SubLObject set_problem_thrown_away(SubLObject problem,
			SubLObject strategy) {
		{
			...
			SubLObject new_flags = set_uninterestingness_cache_thrown_away_code(
					flags, encode_uninterestingness_cache_status(T));
	...
	public static final SubLObject set_problem_not_thrown_away(
			SubLObject problem, SubLObject strategy) {
		{
			SubLObject flags = problem_strategic_flags(problem, strategy);
			SubLObject new_flags = set_uninterestingness_cache_thrown_away_code(
					flags, encode_uninterestingness_cache_status(NIL));
			return set_problem_strategic_flags(problem, strategy, new_flags);
		}
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 46018)
	public static final SubLObject set_problem_not_thrown_away_wrt_removal(
			SubLObject problem, SubLObject strategy) {
		{
			SubLObject flags = problem_strategic_flags(problem, strategy);
			SubLObject new_flags = set_uninterestingness_cache_thrown_away_wrt_removal_code(
					flags, encode_uninterestingness_cache_status(NIL));
			return set_problem_strategic_flags(problem, strategy, new_flags);
		}
	}
	...
	public static final SubLObject set_problem_recompute_thrown_away_wrt_removal(
			SubLObject problem, SubLObject strategy) {
		{
			SubLObject flags = problem_strategic_flags(problem, strategy);
			SubLObject new_flags = set_uninterestingness_cache_thrown_away_wrt_removal_code(
					flags,
					encode_uninterestingness_cache_status($kw110$RECOMPUTE));
			return set_problem_strategic_flags(problem, strategy, new_flags);
		}
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 47055)
	public static final SubLObject set_problem_thrown_away_wrt_transformation(
			SubLObject problem, SubLObject strategy) {
		{
			SubLObject flags = problem_strategic_flags(problem, strategy);
			SubLObject new_flags = set_uninterestingness_cache_thrown_away_wrt_transformation_code(
					flags, encode_uninterestingness_cache_status(T));
			return set_problem_strategic_flags(problem, strategy, new_flags);
		}
	}
	...
	public static final SubLObject set_problem_not_thrown_away_wrt_transformation(
			SubLObject problem, SubLObject strategy) {
		{
			SubLObject flags = problem_strategic_flags(problem, strategy);
			SubLObject new_flags = set_uninterestingness_cache_thrown_away_wrt_transformation_code(
	...
	public static final SubLObject set_problem_recompute_thrown_away_wrt_transformation(
			SubLObject problem, SubLObject strategy) {
		{
			SubLObject flags = problem_strategic_flags(problem, strategy);
			SubLObject new_flags = set_uninterestingness_cache_thrown_away_wrt_transformation_code(
	...
	public static final SubLObject set_problem_not_thrown_away_wrt_new_root(
			SubLObject problem, SubLObject strategy) {
		{
			SubLObject flags = problem_strategic_flags(problem, strategy);
			SubLObject new_flags = set_uninterestingness_cache_thrown_away_wrt_new_root_code(
					flags, encode_uninterestingness_cache_status(NIL));
			return set_problem_strategic_flags(problem, strategy, new_flags);
		}
	}
	...
	public static final SubLObject set_problem_recompute_thrown_away_wrt_new_root(
			SubLObject problem, SubLObject strategy) {
		{
			SubLObject flags = problem_strategic_flags(problem, strategy);
			SubLObject new_flags = set_uninterestingness_cache_thrown_away_wrt_new_root_code(
	...
	public static final SubLObject set_problem_set_aside(SubLObject problem,
		...
		{
			SubLObject flags = problem_strategic_flags(problem, strategy);
			SubLObject new_flags = set_uninterestingness_cache_set_aside_code(
					flags, encode_uninterestingness_cache_status(T));
			return set_problem_strategic_flags(problem, strategy, new_flags);
		}
	}
	...
	public static final SubLObject set_problem_not_set_aside(
			SubLObject problem, SubLObject strategy) {
		{
			SubLObject flags = problem_strategic_flags(problem, strategy);
			SubLObject new_flags = set_uninterestingness_cache_set_aside_code(
	...
	public static final SubLObject set_problem_not_set_aside_wrt_removal(
			SubLObject problem, SubLObject strategy) {
		{
			SubLObject flags = problem_strategic_flags(problem, strategy);
			SubLObject new_flags = set_uninterestingness_cache_set_aside_wrt_removal_code(
					flags, encode_uninterestingness_cache_status(NIL));
			return set_problem_strategic_flags(problem, strategy, new_flags);
		}
	}
	...
	public static final SubLObject set_problem_recompute_set_aside_wrt_removal(
			SubLObject problem, SubLObject strategy) {
		{
			SubLObject flags = problem_strategic_flags(problem, strategy);
			SubLObject new_flags = set_uninterestingness_cache_set_aside_wrt_removal_code(
	...
	public static final SubLObject set_problem_not_set_aside_wrt_transformation(
			SubLObject problem, SubLObject strategy) {
		{
			SubLObject flags = problem_strategic_flags(problem, strategy);
			SubLObject new_flags = set_uninterestingness_cache_set_aside_wrt_transformation_code(
					flags, encode_uninterestingness_cache_status(NIL));
			return set_problem_strategic_flags(problem, strategy, new_flags);
		}
	}
	...
	public static final SubLObject set_problem_recompute_set_aside_wrt_transformation(
			SubLObject problem, SubLObject strategy) {
		{
			SubLObject flags = problem_strategic_flags(problem, strategy);
			SubLObject new_flags = set_uninterestingness_cache_set_aside_wrt_transformation_code(
	...
	public static final SubLObject set_problem_recompute_set_aside_wrt_new_root(
			SubLObject problem, SubLObject strategy) {
		return NIL;
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 53768)
	public static final SubLObject set_problem_thrown_away_wrt(
			SubLObject problem, SubLObject strategy, SubLObject motivation) {
		{
			...
			if (pcase_var.eql($kw144$REMOVAL)) {
				...
				return set_problem_thrown_away_wrt_transformation(problem,
						strategy);
			} else if (pcase_var.eql($kw146$NEW_ROOT)) {
				return set_problem_thrown_away_wrt_new_root(problem, strategy);
			} else {
				return Errors.error($str147$unexpected_motivation__s,
						motivation);
			}
		}
	}
	...
	public static final SubLObject set_problem_not_thrown_away_wrt(
			SubLObject problem, SubLObject strategy, SubLObject motivation) {
		{
			SubLObject pcase_var = motivation;
			if (pcase_var.eql($kw144$REMOVAL)) {
				return set_problem_not_thrown_away_wrt_removal(problem,
						strategy);
			} else if (pcase_var.eql($kw145$TRANSFORMATION)) {
				return set_problem_not_thrown_away_wrt_transformation(problem,
						strategy);
			} else if (pcase_var.eql($kw146$NEW_ROOT)) {
				return set_problem_not_thrown_away_wrt_new_root(problem,
						strategy);
			} else {
				return Errors.error($str147$unexpected_motivation__s,
						motivation);
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 48296)
	public static final SubLObject set_problem_thrown_away_wrt_new_root(
			SubLObject problem, SubLObject strategy) {
		{
			SubLObject flags = problem_strategic_flags(problem, strategy);
			SubLObject new_flags = set_uninterestingness_cache_thrown_away_wrt_new_root_code(
	...
	public static final SubLObject set_problem_not_set_aside_wrt(
			SubLObject problem, SubLObject strategy, SubLObject motivation) {
		{
			SubLObject pcase_var = motivation;
			if (pcase_var.eql($kw144$REMOVAL)) {
				...
				return set_problem_not_set_aside_wrt_transformation(problem,
						strategy);
			} else if (pcase_var.eql($kw146$NEW_ROOT)) {
				return Errors
	...
	public static final SubLObject problem_thrown_away_cache_status_wrt_motivation(
			SubLObject problem, SubLObject strategy, SubLObject motivation) {
		{
			final SubLThread thread = SubLProcess.currentSubLThread();
			if ((NIL == $uninterestingness_cache_lookup_enabledP$
			...
			}
			{
				SubLObject pcase_var = motivation;
				if (pcase_var.eql($kw144$REMOVAL)) {
					return problem_thrown_away_cache_removal_status(problem,
							strategy);
				} else if (pcase_var.eql($kw145$TRANSFORMATION)) {
					return problem_thrown_away_cache_transformation_status(
							problem, strategy);
				} else if (pcase_var.eql($kw146$NEW_ROOT)) {
					return problem_thrown_away_cache_new_root_status(problem,
							strategy);
				} else {
					return Errors.error($str147$unexpected_motivation__s,
							motivation);
	...
	public static final SubLObject set_problem_recompute_thrown_away_wrt_all_motivations(
			SubLObject problem, SubLObject strategy) {
		if ((NIL != balancing_tactician
				.balancing_tactician_substrategy_p(strategy))) {
			Errors.handleMissingMethodError("This call was replaced for LarKC purposes. Originally a method was called. Refer to number 36452");
		} else {
			set_problem_recompute_thrown_away_wrt_removal(problem, strategy);
			set_problem_recompute_thrown_away_wrt_transformation(problem,
					strategy);
	...
	public static final SubLObject set_problem_recompute_thrown_away_wrt_all_relevant_strategies_and_all_motivations(
			SubLObject problem) {
		{
			...
			if ((NIL == id_index.id_index_objects_empty_p(idx, $kw148$SKIP))) {
				{
					...
					if ((NIL == id_index.id_index_old_objects_empty_p(idx_4,
							$kw148$SKIP))) {
						{
							SubLObject vector_var = id_index
									.id_index_old_objects(idx_4);
							...
							for (v_iteration = ZERO_INTEGER; v_iteration
									...
									v_iteration, ONE_INTEGER)) {
								{
									...
									if ((!(((NIL != id_index
											...
											.id_index_skip_tombstones_p($kw148$SKIP)))))) {
										if ((NIL != id_index
	...
	public static final SubLObject problem_set_aside_cache_status_wrt_motivation(
			SubLObject problem, SubLObject strategy, SubLObject motivation) {
		{
			final SubLThread thread = SubLProcess.currentSubLThread();
			if ((NIL == $uninterestingness_cache_lookup_enabledP$
			...
			}
			{
				SubLObject pcase_var = motivation;
				if (pcase_var.eql($kw144$REMOVAL)) {
					return problem_set_aside_cache_removal_status(problem,
							strategy);
				} else if (pcase_var.eql($kw145$TRANSFORMATION)) {
					return problem_set_aside_cache_transformation_status(
							problem, strategy);
				} else if (pcase_var.eql($kw146$NEW_ROOT)) {
					return NIL;
				} else {
	...
	public static final SubLObject set_problem_recompute_set_aside_wrt_all_motivations(
			SubLObject problem, SubLObject strategy) {
		if ((NIL != balancing_tactician
				.balancing_tactician_substrategy_p(strategy))) {
			Errors.handleMissingMethodError("This call was replaced for LarKC purposes. Originally a method was called. Refer to number 36450");
		} else {
			set_problem_recompute_set_aside_wrt_removal(problem, strategy);
			set_problem_recompute_set_aside_wrt_transformation(problem,
					strategy);
	...
	public static final class $tactic_strategic_properties_native extends
			SubLStructNative {
		public SubLStructDecl getStructDecl() {
			return structDecl;
		}
		...
		private static final SubLStructDeclNative structDecl = Structures
				.makeStructDeclNative(
						$tactic_strategic_properties_native.class,
						$sym149$TACTIC_STRATEGIC_PROPERTIES,
						$sym150$TACTIC_STRATEGIC_PROPERTIES_P, $list151,
						$list152, new String[] { "$preference_level",
								"$preference_level_justification",
								"$productivity", "$flags" }, $list153,
						$list154, $sym119$DEFAULT_STRUCT_PRINT_FUNCTION);
	}
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 59393)
	public static final SubLObject tactic_strategic_properties_p(
			SubLObject object) {
		return ((object.getClass() == $tactic_strategic_properties_native.class) ? ((SubLObject) T)
				: NIL);
	}
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 59393)
	public static final SubLObject tact_strategic_properties_preference_level(
			SubLObject object) {
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 59393)
	public static final SubLObject tact_strategic_properties_productivity(
			SubLObject object) {
		checkType(object, $sym150$TACTIC_STRATEGIC_PROPERTIES_P);
		return object.getField4();
	}
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 59393)
	public static final SubLObject tact_strategic_properties_flags(
			SubLObject object) {
		checkType(object, $sym150$TACTIC_STRATEGIC_PROPERTIES_P);
		return object.getField5();
	}
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 59393)
	public static final SubLObject _csetf_tact_strategic_properties_preference_level(
			SubLObject object, SubLObject value) {
		checkType(object, $sym150$TACTIC_STRATEGIC_PROPERTIES_P);
		return object.setField2(value);
	}
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 59393)
	public static final SubLObject _csetf_tact_strategic_properties_preference_level_justification(
			SubLObject object, SubLObject value) {
		checkType(object, $sym150$TACTIC_STRATEGIC_PROPERTIES_P);
		return object.setField3(value);
	}
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 59393)
	public static final SubLObject _csetf_tact_strategic_properties_productivity(
			SubLObject object, SubLObject value) {
		checkType(object, $sym150$TACTIC_STRATEGIC_PROPERTIES_P);
		return object.setField4(value);
	}
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 59393)
	public static final SubLObject _csetf_tact_strategic_properties_flags(
			SubLObject object, SubLObject value) {
		checkType(object, $sym150$TACTIC_STRATEGIC_PROPERTIES_P);
		return object.setField5(value);
	}
	...
	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 59393)
	public static final SubLObject make_tactic_strategic_properties(
			SubLObject arglist) {
		if ((arglist == UNPROVIDED)) {
			arglist = NIL;
		}
			...
			for (next = arglist; (NIL != next); next = conses_high.cddr(next)) {
				{
					...
					if (pcase_var.eql($kw164$PREFERENCE_LEVEL)) {
						_csetf_tact_strategic_properties_preference_level(
							...
							.eql($kw165$PREFERENCE_LEVEL_JUSTIFICATION)) {
						_csetf_tact_strategic_properties_preference_level_justification(
								v_new, current_value);
					} else if (pcase_var.eql($kw166$PRODUCTIVITY)) {
						_csetf_tact_strategic_properties_productivity(v_new,
								current_value);
					} else if (pcase_var.eql($kw132$FLAGS)) {
						_csetf_tact_strategic_properties_flags(v_new,
								current_value);
					} else {
						Errors.error($str53$Invalid_slot__S_for_construction_,
								current_arg);
	...
	public static final SubLObject new_tactic_strategic_properties() {
		{
			...
			_csetf_tact_strategic_properties_preference_level(
					tactic_strategic_properties, $kw167$DISALLOWED);
			_csetf_tact_strategic_properties_preference_level_justification(
					tactic_strategic_properties, $str168$);
	...
	public static final SubLObject tactic_strategic_properties_int(
			...
			if ((NIL != problem_strategic_properties_p(problem_strategic_properties))) {
				{
					...
					if (tactic_properties_vector.isVector()) {
						{
							SubLObject tactic_suid = inference_datastructures_tactic
									.tactic_suid(tactic);
							return Vectors.aref(tactic_properties_vector,
									tactic_suid);
						}
					}
				}
	...
	public static final SubLObject set_tactic_strategic_properties(
			SubLObject tactic, SubLObject strategy, SubLObject v_properties) {
		checkType(tactic, $sym169$TACTIC_P);
		checkType(strategy, $sym1$STRATEGY_P);
		checkType(v_properties, $sym150$TACTIC_STRATEGIC_PROPERTIES_P);
		{
			...
			SubLObject tactic_suid = inference_datastructures_tactic
					.tactic_suid(tactic);
			Vectors.set_aref(tactic_properties_vector, tactic_suid,
					v_properties);
		}
		return tactic;
	}
	...
	public static final SubLObject tactic_strategic_properties(
			SubLObject tactic, SubLObject strategy) {
		{
			SubLObject tactic_strategic_properties = tactic_strategic_properties_int(
					tactic, strategy);
			if ((NIL == tactic_strategic_properties_p(tactic_strategic_properties))) {
				...
				set_tactic_strategic_properties(tactic, strategy,
						tactic_strategic_properties);
			}
			return tactic_strategic_properties;
		}
	...
	public static final SubLObject tactic_strategic_completeness(
			SubLObject tactic, SubLObject strategic_context) {
		...
		if (($kw170$TACTICAL == strategic_context)) {
			...
			return Errors.error($str171$structural_tactic__s_cannot_have_,
					tactic);
		}
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 62985)
	public static final SubLObject tactic_strategic_preference_level(
			SubLObject tactic, SubLObject strategic_context) {
		checkType(strategic_context, $sym139$STRATEGIC_CONTEXT_P);
		if (($kw170$TACTICAL == strategic_context)) {
			return inference_datastructures_tactic
					.tactic_preference_level(tactic);
		} else if ((NIL != inference_worker
				.generalized_structural_tactic_p(tactic))) {
			{
				SubLObject tactic_strategic_properties = tactic_strategic_properties(
						tactic, strategic_context);
				return tact_strategic_properties_preference_level(tactic_strategic_properties);
			}
		} else {
			return Errors.error($str172$content_tactic__s_cannot_have_a_p,
					tactic);
		}
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 63593)
	public static final SubLObject tactic_strategic_preference_level_justification(
			SubLObject tactic, SubLObject strategic_context) {
		checkType(strategic_context, $sym139$STRATEGIC_CONTEXT_P);
		if (($kw170$TACTICAL == strategic_context)) {
			return inference_datastructures_tactic
					.tactic_preference_level_justification(tactic);
		} else if ((NIL != inference_worker
				.generalized_structural_tactic_p(tactic))) {
			{
				SubLObject tactic_strategic_properties = tactic_strategic_properties(
			...
			return Errors.error($str173$content_tactic__s_cannot_have_a_p,
					tactic);
		}
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 64565)
	public static final SubLObject conjunctive_tactic_strategic_preference_level(
			SubLObject tactic, SubLObject strategic_context) {
		...
		if ((NIL != inference_worker_removal
			...
			return preference_modules
					.completeness_to_preference_level(tactic_strategic_completeness(
							tactic, strategic_context));
		} else {
	...
	public static final SubLObject conjunctive_tactic_strategic_preference_level_justification(
			SubLObject tactic, SubLObject strategic_context) {
		checkType(tactic, $sym174$GENERALIZED_CONJUNCTIVE_TACTIC_P);
		if ((NIL != inference_worker_removal
				.conjunctive_removal_tactic_p(tactic))) {
			return string_utilities.str(tactic_strategic_completeness(tactic,
					strategic_context));
		} else {
			return tactic_strategic_preference_level_justification(tactic,
					strategic_context);
		}
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 65310)
	public static final SubLObject tactic_strategic_productivity(
			SubLObject tactic, SubLObject strategic_context) {
		if (($kw170$TACTICAL == strategic_context)) {
	...
	public static final SubLObject tactic_strategically_preferredP(
			SubLObject tactic, SubLObject strategy) {
		return Equality.eq($kw175$PREFERRED,
				tactic_strategic_preference_level(tactic, strategy));
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 66026)
	public static final SubLObject set_tactic_strategic_preference_level(
			SubLObject tactic, SubLObject strategy,
		...
		checkType(preference_level, $sym176$PREFERENCE_LEVEL_P);
		{
			SubLObject tactic_strategic_properties = tactic_strategic_properties(
					tactic, strategy);
			_csetf_tact_strategic_properties_preference_level(
					tactic_strategic_properties, preference_level);
			_csetf_tact_strategic_properties_preference_level_justification(
	...
	public static final SubLObject set_tactic_strategic_productivity(
			SubLObject tactic, SubLObject strategy, SubLObject productivity) {
		{
			SubLObject tactic_strategic_properties = tactic_strategic_properties(
					tactic, strategy);
			_csetf_tact_strategic_properties_productivity(
					tactic_strategic_properties, productivity);
		}
		return tactic;
	}
	...
	public static final SubLObject set_tactic_strategic_flags(
			SubLObject tactic, SubLObject strategy, SubLObject flags) {
		checkType(flags, $sym143$FIXNUMP);
		{
			SubLObject tactic_strategic_properties = tactic_strategic_properties(
					tactic, strategy);
	...
	public static final SubLObject tactic_thrown_away_cache_status(
			SubLObject tactic, SubLObject strategy) {
		return decode_uninterestingness_cache_code(uninterestingness_cache_thrown_away_code(tactic_strategic_flags(
				tactic, strategy)));
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 68409)
	public static final SubLObject tactic_thrown_away_cache_removal_status(
			SubLObject tactic, SubLObject strategy) {
		return decode_uninterestingness_cache_code(uninterestingness_cache_thrown_away_wrt_removal_code(tactic_strategic_flags(
				tactic, strategy)));
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 68630)
	public static final SubLObject tactic_thrown_away_cache_transformation_status(
			SubLObject tactic, SubLObject strategy) {
		return decode_uninterestingness_cache_code(uninterestingness_cache_thrown_away_wrt_transformation_code(tactic_strategic_flags(
				tactic, strategy)));
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 68865)
	public static final SubLObject tactic_thrown_away_cache_new_root_status(
			SubLObject tactic, SubLObject strategy) {
		return decode_uninterestingness_cache_code(uninterestingness_cache_thrown_away_wrt_new_root_code(tactic_strategic_flags(
				tactic, strategy)));
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 69088)
	public static final SubLObject tactic_set_aside_cache_status(
			SubLObject tactic, SubLObject strategy) {
		return decode_uninterestingness_cache_code(uninterestingness_cache_set_aside_code(tactic_strategic_flags(
				tactic, strategy)));
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 69287)
	public static final SubLObject tactic_set_aside_cache_removal_status(
			SubLObject tactic, SubLObject strategy) {
		return decode_uninterestingness_cache_code(uninterestingness_cache_set_aside_wrt_removal_code(tactic_strategic_flags(
				tactic, strategy)));
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 69504)
	public static final SubLObject tactic_set_aside_cache_transformation_status(
			SubLObject tactic, SubLObject strategy) {
		return decode_uninterestingness_cache_code(uninterestingness_cache_set_aside_wrt_transformation_code(tactic_strategic_flags(
				tactic, strategy)));
	}

	@SubL(source = "cycl/inference/harness/inference-datastructures-strategy.lisp", position = 69735)
	public static final SubLObject tactic_set_aside_cache_new_root_status(
			SubLObject tactic, SubLObject strategy) {
		return decode_uninterestingness_cache_code(uninterestingness_cache_set_aside_wrt_new_root_code(tactic_strategic_flags(
				tactic, strategy)));
	}
	...
	public static final SubLObject set_tactic_not_thrown_away(
			SubLObject tactic, SubLObject strategy) {
		{
			SubLObject flags = tactic_strategic_flags(tactic, strategy);
			SubLObject new_flags = set_uninterestingness_cache_thrown_away_code(
	...
	public static final SubLObject set_tactic_thrown_away_wrt_removal(
			SubLObject tactic, SubLObject strategy) {
		{
			SubLObject flags = tactic_strategic_flags(tactic, strategy);
			SubLObject new_flags = set_uninterestingness_cache_thrown_away_wrt_removal_code(
	...
	public static final SubLObject set_tactic_not_thrown_away_wrt_removal(
			SubLObject tactic, SubLObject strategy) {
		{
			SubLObject flags = tactic_strategic_flags(tactic, strategy);
			SubLObject new_flags = set_uninterestingness_cache_thrown_away_wrt_removal_code(
	...
	public static final SubLObject set_tactic_recompute_thrown_away_wrt_removal(
			SubLObject tactic, SubLObject strategy) {
		{
			SubLObject flags = tactic_strategic_flags(tactic, strategy);
			SubLObject new_flags = set_uninterestingness_cache_thrown_away_wrt_removal_code(
	...
	public static final SubLObject set_tactic_thrown_away_wrt_transformation(
			SubLObject tactic, SubLObject strategy) {
		{
			SubLObject flags = tactic_strategic_flags(tactic, strategy);
			SubLObject new_flags = set_uninterestingness_cache_thrown_away_wrt_transformation_code(
	...
	public static final SubLObject set_tactic_not_thrown_away_wrt_transformation(
			SubLObject tactic, SubLObject strategy) {
		{
			SubLObject flags = tactic_strategic_flags(tactic, strategy);
			SubLObject new_flags = set_uninterestingness_cache_thrown_away_wrt_transformation_code(
	...
	public static final SubLObject set_tactic_recompute_thrown_away_wrt_transformation(
			SubLObject tactic, SubLObject strategy) {
		{
			SubLObject flags = tactic_strategic_flags(tactic, strategy);
			SubLObject new_flags = set_uninterestingness_cache_thrown_away_wrt_transformation_code(
	...
	public static final SubLObject set_tactic_thrown_away_wrt_new_root(
			SubLObject tactic, SubLObject strategy) {
		{
			SubLObject flags = tactic_strategic_flags(tactic, strategy);
			SubLObject new_flags = set_uninterestingness_cache_thrown_away_wrt_new_root_code(
	...
	public static final SubLObject set_tactic_not_thrown_away_wrt_new_root(
			SubLObject tactic, SubLObject strategy) {
		{
			SubLObject flags = tactic_strategic_flags(tactic, strategy);
			SubLObject new_flags = set_uninterestingness_cache_thrown_away_wrt_new_root_code(
	...
	public static final SubLObject set_tactic_recompute_thrown_away_wrt_new_root(
			SubLObject tactic, SubLObject strategy) {
		{
			SubLObject flags = tactic_strategic_flags(tactic, strategy);
			SubLObject new_flags = set_uninterestingness_cache_thrown_away_wrt_new_root_code(
	...
	public static final SubLObject set_tactic_not_set_aside_wrt_removal(
			SubLObject tactic, SubLObject strategy) {
		{
			SubLObject flags = tactic_strategic_flags(tactic, strategy);
			SubLObject new_flags = set_uninterestingness_cache_set_aside_wrt_removal_code(
	...
	public static final SubLObject set_tactic_recompute_set_aside_wrt_removal(
			SubLObject tactic, SubLObject strategy) {
		{
			SubLObject flags = tactic_strategic_flags(tactic, strategy);
			SubLObject new_flags = set_uninterestingness_cache_set_aside_wrt_removal_code(
	...
	public static final SubLObject set_tactic_set_aside_wrt_transformation(
			SubLObject tactic, SubLObject strategy) {
		{
			SubLObject flags = tactic_strategic_flags(tactic, strategy);
			SubLObject new_flags = set_uninterestingness_cache_set_aside_wrt_transformation_code(
	...
	public static final SubLObject set_tactic_not_set_aside_wrt_transformation(
			SubLObject tactic, SubLObject strategy) {
		{
			SubLObject flags = tactic_strategic_flags(tactic, strategy);
			SubLObject new_flags = set_uninterestingness_cache_set_aside_wrt_transformation_code(
	...
	public static final SubLObject set_tactic_recompute_set_aside_wrt_transformation(
			SubLObject tactic, SubLObject strategy) {
		{
			SubLObject flags = tactic_strategic_flags(tactic, strategy);
			SubLObject new_flags = set_uninterestingness_cache_set_aside_wrt_transformation_code(
	...
	public static final SubLObject set_tactic_not_set_aside_wrt_new_root(
			SubLObject tactic, SubLObject strategy) {
		{
			SubLObject flags = tactic_strategic_flags(tactic, strategy);
			SubLObject new_flags = set_uninterestingness_cache_set_aside_wrt_new_root_code(
					flags, encode_uninterestingness_cache_status(NIL));
			return set_tactic_strategic_flags(tactic, strategy, new_flags);
		}
	}
	...
	public static final SubLObject set_tactic_recompute_set_aside_wrt_new_root(
			SubLObject tactic, SubLObject strategy) {
		{
			SubLObject flags = tactic_strategic_flags(tactic, strategy);
			SubLObject new_flags = set_uninterestingness_cache_set_aside_wrt_new_root_code(
	...
	public static final SubLObject set_tactic_thrown_away_wrt(
			SubLObject tactic, SubLObject strategy, SubLObject motivation) {
		{
			SubLObject pcase_var = motivation;
			if (pcase_var.eql($kw144$REMOVAL)) {
				return set_tactic_thrown_away_wrt_removal(tactic, strategy);
			} else if (pcase_var.eql($kw145$TRANSFORMATION)) {
				return set_tactic_thrown_away_wrt_transformation(tactic,
						strategy);
			} else if (pcase_var.eql($kw146$NEW_ROOT)) {
	...
	public static final SubLObject set_tactic_not_thrown_away_wrt(
			SubLObject tactic, SubLObject strategy, SubLObject motivation) {
		{
			SubLObject pcase_var = motivation;
			if (pcase_var.eql($kw144$REMOVAL)) {
				...
				return set_tactic_not_thrown_away_wrt_transformation(tactic,
						strategy);
			} else if (pcase_var.eql($kw146$NEW_ROOT)) {
	...
	public static final SubLObject set_tactic_set_aside_wrt(SubLObject tactic,
			SubLObject strategy, SubLObject motivation) {
		{
			SubLObject pcase_var = motivation;
			if (pcase_var.eql($kw144$REMOVAL)) {
				return Errors
	...
	public static final SubLObject set_tactic_not_set_aside_wrt(
			SubLObject tactic, SubLObject strategy, SubLObject motivation) {
		{
			SubLObject pcase_var = motivation;
			if (pcase_var.eql($kw144$REMOVAL)) {
				...
				return set_tactic_not_set_aside_wrt_transformation(tactic,
						strategy);
			} else if (pcase_var.eql($kw146$NEW_ROOT)) {
	...
	public static final SubLObject tactic_thrown_away_cache_status_wrt_motivation(
			SubLObject tactic, SubLObject strategy, SubLObject motivation) {
		{
			final SubLThread thread = SubLProcess.currentSubLThread();
			if ((NIL == $uninterestingness_cache_lookup_enabledP$
			...
			}
			{
				SubLObject pcase_var = motivation;
				if (pcase_var.eql($kw144$REMOVAL)) {
					return tactic_thrown_away_cache_removal_status(tactic,
							strategy);
				} else if (pcase_var.eql($kw145$TRANSFORMATION)) {
					return tactic_thrown_away_cache_transformation_status(
							tactic, strategy);
				} else if (pcase_var.eql($kw146$NEW_ROOT)) {
					return tactic_thrown_away_cache_new_root_status(tactic,
							strategy);
				} else {
					return Errors.error($str147$unexpected_motivation__s,
							motivation);
	...
	public static final SubLObject set_tactic_recompute_thrown_away_wrt_all_motivations(
			SubLObject tactic, SubLObject strategy) {
		if ((NIL != balancing_tactician
				.balancing_tactician_substrategy_p(strategy))) {
			Errors.handleMissingMethodError("This call was replaced for LarKC purposes. Originally a method was called. Refer to number 36462");
		} else {
			set_tactic_recompute_thrown_away_wrt_removal(tactic, strategy);
			set_tactic_recompute_thrown_away_wrt_transformation(tactic,
					strategy);
	...
	public static final SubLObject set_problem_tactics_recompute_thrown_away_wrt_all_motivations(
			SubLObject problem, SubLObject strategy) {
		{
			...
			for (tactic = cdolist_list_var.first(); (NIL != cdolist_list_var); cdolist_list_var = cdolist_list_var
				...
				set_tactic_recompute_thrown_away_wrt_all_motivations(tactic,
						strategy);
			}
		}
		return NIL;
	...
	public static final SubLObject set_problem_tactics_recompute_thrown_away_wrt_all_relevant_strategies_and_all_motivations(
			SubLObject problem) {
		{
			SubLObject prob = problem;
			SubLObject store = inference_datastructures_problem
			...
			if ((NIL == id_index.id_index_objects_empty_p(idx, $kw148$SKIP))) {
				{
					...
					if ((NIL == id_index.id_index_old_objects_empty_p(idx_8,
							$kw148$SKIP))) {
						{
							SubLObject vector_var = id_index
									.id_index_old_objects(idx_8);
							SubLObject backwardP_var = NIL;
							SubLObject length = Sequences.length(vector_var);
							SubLObject v_iteration = NIL;
							for (v_iteration = ZERO_INTEGER; v_iteration
	...
	public static final SubLObject tactic_set_aside_cache_status_wrt_motivation(
			SubLObject tactic, SubLObject strategy, SubLObject motivation) {
		{
			final SubLThread thread = SubLProcess.currentSubLThread();
			if ((NIL == $uninterestingness_cache_lookup_enabledP$
			...
			}
			{
				SubLObject pcase_var = motivation;
				if (pcase_var.eql($kw144$REMOVAL)) {
					return tactic_set_aside_cache_removal_status(tactic,
							strategy);
				} else if (pcase_var.eql($kw145$TRANSFORMATION)) {
					return tactic_set_aside_cache_transformation_status(tactic,
							strategy);
				} else if (pcase_var.eql($kw146$NEW_ROOT)) {
					return tactic_set_aside_cache_new_root_status(tactic,
							strategy);
				} else {
					return Errors.error($str147$unexpected_motivation__s,
							motivation);
	...
	public static final SubLObject set_tactic_recompute_set_aside_wrt_all_motivations(
			SubLObject tactic, SubLObject strategy) {
		if ((NIL != balancing_tactician
				.balancing_tactician_substrategy_p(strategy))) {
			Errors.handleMissingMethodError("This call was replaced for LarKC purposes. Originally a method was called. Refer to number 36461");
		} else {
	...
	public static final SubLObject set_tactic_recompute_set_aside_wrt_all_relevant_strategies_and_all_motivations(
			SubLObject tactic) {
		{
			SubLObject prob = inference_datastructures_tactic
					.tactic_problem(tactic);
			SubLObject store = inference_datastructures_problem
					.problem_store(prob);
			SubLObject idx = inference_datastructures_problem_store
			...
			if ((NIL == id_index.id_index_objects_empty_p(idx, $kw148$SKIP))) {
				{
					...
					if ((NIL == id_index.id_index_old_objects_empty_p(idx_10,
							$kw148$SKIP))) {
						{
							SubLObject vector_var = id_index
									.id_index_old_objects(idx_10);
							SubLObject backwardP_var = NIL;
							SubLObject length = Sequences.length(vector_var);
							SubLObject v_iteration = NIL;
							for (v_iteration = ZERO_INTEGER; v_iteration
	...
	public static final SubLObject problem_note_tactic_strategically_possible(
			SubLObject problem, SubLObject tactic, SubLObject strategy) {
		checkType(problem, $sym88$PROBLEM_P);
		checkType(tactic, $sym169$TACTIC_P);
		checkType(strategy, $sym1$STRATEGY_P);
		{
	...
	public static final SubLObject problem_note_tactic_not_strategically_possible(
			SubLObject problem, SubLObject tactic, SubLObject strategy) {
		checkType(problem, $sym88$PROBLEM_P);
		checkType(tactic, $sym169$TACTIC_P);
		checkType(strategy, $sym1$STRATEGY_P);
	...
	public static final SubLObject declare_inference_datastructures_strategy_file() {
		declareFunction(myName, "strategy_print_function_trampoline",
				"STRATEGY-PRINT-FUNCTION-TRAMPOLINE", 2, 0, false);
		...
		declareFunction(myName, "strat_inference", "STRAT-INFERENCE", 1, 0,
				false);
		declareFunction(myName, "strat_result_uniqueness_criterion",
				"STRAT-RESULT-UNIQUENESS-CRITERION", 1, 0, false);
		declareFunction(myName, "strat_active_problems",
				"STRAT-ACTIVE-PROBLEMS", 1, 0, false);
		declareFunction(myName, "strat_motivated_problems",
				"STRAT-MOTIVATED-PROBLEMS", 1, 0, false);
		declareFunction(myName, "strat_set_aside_problems",
				"STRAT-SET-ASIDE-PROBLEMS", 1, 0, false);
		declareFunction(myName, "strat_should_reconsider_set_asidesP",
				"STRAT-SHOULD-RECONSIDER-SET-ASIDES?", 1, 0, false);
		declareFunction(myName, "strat_productivity_limit",
				"STRAT-PRODUCTIVITY-LIMIT", 1, 0, false);
		...
		declareFunction(myName, "strat_proof_spec", "STRAT-PROOF-SPEC", 1, 0,
				false);
		declareFunction(myName, "strat_problem_proof_spec_index",
				"STRAT-PROBLEM-PROOF-SPEC-INDEX", 1, 0, false);
		declareFunction(myName, "strat_problem_strategic_index",
				"STRAT-PROBLEM-STRATEGIC-INDEX", 1, 0, false);
		declareFunction(myName, "strat_memoization_state",
				"STRAT-MEMOIZATION-STATE", 1, 0, false);
		declareFunction(myName, "strat_type", "STRAT-TYPE", 1, 0, false);
		declareFunction(myName, "strat_data", "STRAT-DATA", 1, 0, false);
		declareFunction(myName, "_csetf_strat_suid", "_CSETF-STRAT-SUID", 2, 0,
				false);
		declareFunction(myName, "_csetf_strat_inference",
				"_CSETF-STRAT-INFERENCE", 2, 0, false);
		declareFunction(myName, "_csetf_strat_result_uniqueness_criterion",
				"_CSETF-STRAT-RESULT-UNIQUENESS-CRITERION", 2, 0, false);
		declareFunction(myName, "_csetf_strat_active_problems",
				"_CSETF-STRAT-ACTIVE-PROBLEMS", 2, 0, false);
		declareFunction(myName, "_csetf_strat_motivated_problems",
				"_CSETF-STRAT-MOTIVATED-PROBLEMS", 2, 0, false);
		declareFunction(myName, "_csetf_strat_set_aside_problems",
				"_CSETF-STRAT-SET-ASIDE-PROBLEMS", 2, 0, false);
		declareFunction(myName, "_csetf_strat_should_reconsider_set_asidesP",
				"_CSETF-STRAT-SHOULD-RECONSIDER-SET-ASIDES?", 2, 0, false);
		declareFunction(myName, "_csetf_strat_productivity_limit",
				"_CSETF-STRAT-PRODUCTIVITY-LIMIT", 2, 0, false);
		declareFunction(myName,
				"_csetf_strat_removal_backtracking_productivity_limit",
				"_CSETF-STRAT-REMOVAL-BACKTRACKING-PRODUCTIVITY-LIMIT", 2, 0,
				false);
		declareFunction(myName, "_csetf_strat_proof_spec",
				"_CSETF-STRAT-PROOF-SPEC", 2, 0, false);
		declareFunction(myName, "_csetf_strat_problem_proof_spec_index",
				"_CSETF-STRAT-PROBLEM-PROOF-SPEC-INDEX", 2, 0, false);
		declareFunction(myName, "_csetf_strat_problem_strategic_index",
				"_CSETF-STRAT-PROBLEM-STRATEGIC-INDEX", 2, 0, false);
		declareFunction(myName, "_csetf_strat_memoization_state",
				"_CSETF-STRAT-MEMOIZATION-STATE", 2, 0, false);
		declareFunction(myName, "_csetf_strat_type", "_CSETF-STRAT-TYPE", 2, 0,
				false);
		declareFunction(myName, "_csetf_strat_data", "_CSETF-STRAT-DATA", 2, 0,
				false);
		declareFunction(myName, "make_strategy", "MAKE-STRATEGY", 0, 1, false);
		declareFunction(myName, "valid_strategy_p", "VALID-STRATEGY-P", 1, 0,
				false);
		declareFunction(myName, "strategy_invalid_p", "STRATEGY-INVALID-P", 1,
				0, false);
		declareFunction(myName, "print_strategy", "PRINT-STRATEGY", 3, 0, false);
		declareFunction(myName, "sxhash_strategy_method",
				"SXHASH-STRATEGY-METHOD", 1, 0, false);
		new $sxhash_strategy_method$UnaryFunction();
		declareFunction(myName, "new_strategy", "NEW-STRATEGY", 2, 0, false);
		declareFunction(myName, "destroy_strategy", "DESTROY-STRATEGY", 1, 0,
				false);
		declareFunction(myName, "destroy_problem_store_strategy",
				"DESTROY-PROBLEM-STORE-STRATEGY", 1, 0, false);
		declareFunction(myName, "destroy_inference_strategy",
				"DESTROY-INFERENCE-STRATEGY", 1, 0, false);
		declareFunction(myName, "destroy_strategy_int", "DESTROY-STRATEGY-INT",
				1, 0, false);
		declareFunction(myName, "note_strategy_invalid",
				"NOTE-STRATEGY-INVALID", 1, 0, false);
		declareFunction(myName, "remove_strategy_problem",
				"REMOVE-STRATEGY-PROBLEM", 2, 0, false);
		declareFunction(myName, "strategy_suid", "STRATEGY-SUID", 1, 0, false);
		declareFunction(myName, "strategy_inference", "STRATEGY-INFERENCE", 1,
				0, false);
		declareFunction(myName, "strategy_local_result_uniqueness_criterion",
				"STRATEGY-LOCAL-RESULT-UNIQUENESS-CRITERION", 1, 0, false);
		declareFunction(myName, "strategy_problem_strategic_index",
				"STRATEGY-PROBLEM-STRATEGIC-INDEX", 1, 0, false);
		declareFunction(myName, "strategy_type", "STRATEGY-TYPE", 1, 0, false);
		declareFunction(myName, "strategy_data", "STRATEGY-DATA", 1, 0, false);
		declareFunction(myName, "strategy_active_problems",
				"STRATEGY-ACTIVE-PROBLEMS", 1, 0, false);
		declareFunction(myName, "strategy_motivated_problems",
				"STRATEGY-MOTIVATED-PROBLEMS", 1, 0, false);
		declareFunction(myName, "strategy_set_aside_problems",
				"STRATEGY-SET-ASIDE-PROBLEMS", 1, 0, false);
		declareFunction(myName, "strategy_should_reconsider_set_asidesP",
				"STRATEGY-SHOULD-RECONSIDER-SET-ASIDES?", 1, 0, false);
		declareFunction(myName, "strategy_productivity_limit",
				"STRATEGY-PRODUCTIVITY-LIMIT", 1, 0, false);
		declareFunction(myName,
				"strategy_removal_backtracking_productivity_limit",
				"STRATEGY-REMOVAL-BACKTRACKING-PRODUCTIVITY-LIMIT", 1, 0, false);
		declareFunction(myName, "strategy_proof_spec", "STRATEGY-PROOF-SPEC",
				1, 0, false);
		declareFunction(myName, "strategy_problem_proof_spec_index",
				"STRATEGY-PROBLEM-PROOF-SPEC-INDEX", 1, 0, false);
		declareFunction(myName, "set_strategy_result_uniqueness_criterion",
				"SET-STRATEGY-RESULT-UNIQUENESS-CRITERION", 2, 0, false);
		declareFunction(myName, "set_strategy_productivity_limit",
				"SET-STRATEGY-PRODUCTIVITY-LIMIT", 2, 0, false);
		declareFunction(myName,
				"set_strategy_removal_backtracking_productivity_limit",
				"SET-STRATEGY-REMOVAL-BACKTRACKING-PRODUCTIVITY-LIMIT", 2, 0,
				false);
		declareFunction(myName, "set_strategy_proof_spec",
				"SET-STRATEGY-PROOF-SPEC", 2, 0, false);
		declareFunction(myName, "set_strategy_data", "SET-STRATEGY-DATA", 2, 0,
				false);
		declareMacro(myName, "do_strategy_active_problems",
				"DO-STRATEGY-ACTIVE-PROBLEMS");
		declareMacro(myName, "do_strategy_motivated_problems",
				"DO-STRATEGY-MOTIVATED-PROBLEMS");
		declareMacro(myName, "do_strategy_set_aside_problems",
				"DO-STRATEGY-SET-ASIDE-PROBLEMS");
		declareMacro(myName, "with_strategy_memoization_state",
				"WITH-STRATEGY-MEMOIZATION-STATE");
		declareFunction(myName, "strategy_memoization_state",
				"STRATEGY-MEMOIZATION-STATE", 1, 0, false);
		declareFunction(myName, "current_strategy_wrt_memoization",
				"CURRENT-STRATEGY-WRT-MEMOIZATION", 0, 0, false);
		declareFunction(myName, "strategic_context_inference",
				"STRATEGIC-CONTEXT-INFERENCE", 1, 0, false);
		declareFunction(myName, "strategy_answer_link", "STRATEGY-ANSWER-LINK",
				1, 0, false);
		declareFunction(myName, "strategy_answer_link_propagatedP",
				"STRATEGY-ANSWER-LINK-PROPAGATED?", 1, 0, false);
		declareFunction(myName, "strategy_should_propagate_answer_linkP",
				"STRATEGY-SHOULD-PROPAGATE-ANSWER-LINK?", 1, 0, false);
		declareFunction(myName, "strategy_root_problem",
				"STRATEGY-ROOT-PROBLEM", 1, 0, false);
		declareFunction(myName, "strategy_continuableP",
				"STRATEGY-CONTINUABLE?", 1, 0, false);
		declareFunction(myName, "problem_active_in_strategyP",
				"PROBLEM-ACTIVE-IN-STRATEGY?", 2, 0, false);
		declareFunction(myName, "problem_motivatedP", "PROBLEM-MOTIVATED?", 2,
				0, false);
		declareFunction(myName, "problem_set_aside_in_strategyP",
				"PROBLEM-SET-ASIDE-IN-STRATEGY?", 2, 0, false);
		declareFunction(myName, "strategy_has_some_set_aside_problemsP",
				"STRATEGY-HAS-SOME-SET-ASIDE-PROBLEMS?", 1, 0, false);
		declareFunction(myName, "strategy_all_valid_set_aside_problems",
				"STRATEGY-ALL-VALID-SET-ASIDE-PROBLEMS", 1, 0, false);
		declareFunction(myName, "strategy_problem_store",
				"STRATEGY-PROBLEM-STORE", 1, 0, false);
		declareFunction(myName, "strategy_result_uniqueness_criterion",
				"STRATEGY-RESULT-UNIQUENESS-CRITERION", 1, 0, false);
		declareFunction(myName, "strategy_unique_wrt_proofsP",
				"STRATEGY-UNIQUE-WRT-PROOFS?", 1, 0, false);
		declareFunction(myName, "strategy_unique_wrt_bindingsP",
				"STRATEGY-UNIQUE-WRT-BINDINGS?", 1, 0, false);
		declareFunction(myName, "strategy_wants_one_answerP",
				"STRATEGY-WANTS-ONE-ANSWER?", 1, 0, false);
		declareFunction(myName, "strategy_active_problem_count",
				"STRATEGY-ACTIVE-PROBLEM-COUNT", 1, 0, false);
		declareFunction(myName, "strategy_motivated_problem_count",
				"STRATEGY-MOTIVATED-PROBLEM-COUNT", 1, 0, false);
		declareFunction(myName, "strategy_set_aside_problem_count",
				"STRATEGY-SET-ASIDE-PROBLEM-COUNT", 1, 0, false);
		declareFunction(myName, "strategy_problem_proof_spec",
				"STRATEGY-PROBLEM-PROOF-SPEC", 2, 0, false);
		declareFunction(myName, "set_strategy_property",
				"SET-STRATEGY-PROPERTY", 3, 0, false);
		declareFunction(myName, "set_strategy_properties",
				"SET-STRATEGY-PROPERTIES", 2, 0, false);
		declareFunction(myName, "strategy_note_problem_active",
				"STRATEGY-NOTE-PROBLEM-ACTIVE", 2, 0, false);
		declareFunction(myName, "strategy_note_problem_inactive",
				"STRATEGY-NOTE-PROBLEM-INACTIVE", 2, 0, false);
		declareFunction(myName, "strategy_note_problem_motivated",
				"STRATEGY-NOTE-PROBLEM-MOTIVATED", 2, 0, false);
		declareFunction(myName, "strategy_note_problem_unmotivated",
				"STRATEGY-NOTE-PROBLEM-UNMOTIVATED", 2, 0, false);
		declareFunction(myName, "strategy_note_problem_set_aside",
				"STRATEGY-NOTE-PROBLEM-SET-ASIDE", 2, 0, false);
		declareFunction(myName, "strategy_clear_problem_set_aside",
				"STRATEGY-CLEAR-PROBLEM-SET-ASIDE", 2, 0, false);
		declareFunction(myName, "strategy_clear_set_asides",
				"STRATEGY-CLEAR-SET-ASIDES", 1, 0, false);
		declareFunction(myName, "note_strategy_should_reconsider_set_asides",
				"NOTE-STRATEGY-SHOULD-RECONSIDER-SET-ASIDES", 1, 0, false);
		declareFunction(myName, "clear_strategy_should_reconsider_set_asides",
				"CLEAR-STRATEGY-SHOULD-RECONSIDER-SET-ASIDES", 1, 0, false);
		declareMacro(myName, "with_strategically_active_problem",
				"WITH-STRATEGICALLY-ACTIVE-PROBLEM");
		declareFunction(myName, "strategy_note_problem_proof_spec",
				"STRATEGY-NOTE-PROBLEM-PROOF-SPEC", 3, 0, false);
		declareFunction(myName, "strategy_dispatch", "STRATEGY-DISPATCH", 2, 5,
				false);
		declareFunction(myName, "strategy_dispatch_handler",
				"STRATEGY-DISPATCH-HANDLER", 2, 0, false);
		declareFunction(myName, "strategy_dispatch_funcall_0",
				"STRATEGY-DISPATCH-FUNCALL-0", 2, 0, false);
		declareFunction(myName, "strategy_dispatch_funcall_1",
				"STRATEGY-DISPATCH-FUNCALL-1", 3, 0, false);
		declareFunction(myName, "strategy_dispatch_funcall_2",
				"STRATEGY-DISPATCH-FUNCALL-2", 4, 0, false);
		declareFunction(myName, "strategy_dispatch_funcall_3",
				"STRATEGY-DISPATCH-FUNCALL-3", 5, 0, false);
		declareFunction(myName, "strategy_dispatch_funcall_4",
				"STRATEGY-DISPATCH-FUNCALL-4", 6, 0, false);
		declareFunction(myName, "strategy_dispatch_funcall_5",
				"STRATEGY-DISPATCH-FUNCALL-5", 7, 0, false);
		declareFunction(myName,
				"strategy_dispatch_unexpected_strategy_type_error",
				"STRATEGY-DISPATCH-UNEXPECTED-STRATEGY-TYPE-ERROR", 1, 0, false);
		declareFunction(myName, "controlling_strategy_callback",
				"CONTROLLING-STRATEGY-CALLBACK", 2, 4, false);
		declareFunction(myName, "strategy_type_p", "STRATEGY-TYPE-P", 1, 0,
				false);
		declareFunction(myName, "new_strategy_type", "NEW-STRATEGY-TYPE", 2, 0,
				false);
		declareFunction(myName, "deregister_strategy_type",
				"DEREGISTER-STRATEGY-TYPE", 1, 0, false);
		declareFunction(myName, "clear_strategy_type_store",
				"CLEAR-STRATEGY-TYPE-STORE", 0, 0, false);
		declareFunction(myName, "strategy_type_property",
				"STRATEGY-TYPE-PROPERTY", 2, 0, false);
		declareFunction(myName, "set_strategy_type_property",
				"SET-STRATEGY-TYPE-PROPERTY", 3, 0, false);
		declareFunction(myName,
				"uninterestingness_cache_thrown_away_wrt_removal_code",
				"UNINTERESTINGNESS-CACHE-THROWN-AWAY-WRT-REMOVAL-CODE", 1, 0,
				false);
		declareFunction(myName,
		...
		declareFunction(myName,
				...
				"UNINTERESTINGNESS-CACHE-THROWN-AWAY-WRT-NEW-ROOT-CODE", 1, 0,
				false);
		declareFunction(myName,
				"uninterestingness_cache_set_aside_wrt_removal_code",
				"UNINTERESTINGNESS-CACHE-SET-ASIDE-WRT-REMOVAL-CODE", 1, 0,
				false);
		declareFunction(myName,
				"uninterestingness_cache_set_aside_wrt_transformation_code",
				"UNINTERESTINGNESS-CACHE-SET-ASIDE-WRT-TRANSFORMATION-CODE", 1,
				0, false);
		declareFunction(myName,
				"uninterestingness_cache_set_aside_wrt_new_root_code",
				"UNINTERESTINGNESS-CACHE-SET-ASIDE-WRT-NEW-ROOT-CODE", 1, 0,
				false);
		declareFunction(myName, "uninterestingness_cache_thrown_away_code",
				"UNINTERESTINGNESS-CACHE-THROWN-AWAY-CODE", 1, 0, false);
		declareFunction(myName, "uninterestingness_cache_set_aside_code",
				"UNINTERESTINGNESS-CACHE-SET-ASIDE-CODE", 1, 0, false);
		declareFunction(myName,
				"set_uninterestingness_cache_thrown_away_wrt_removal_code",
				"SET-UNINTERESTINGNESS-CACHE-THROWN-AWAY-WRT-REMOVAL-CODE", 2,
				0, false);
		declareFunction(
				myName,
				"set_uninterestingness_cache_thrown_away_wrt_transformation_code",
				"SET-UNINTERESTINGNESS-CACHE-THROWN-AWAY-WRT-TRANSFORMATION-CODE",
				2, 0, false);
		declareFunction(myName,
				"set_uninterestingness_cache_thrown_away_wrt_new_root_code",
				"SET-UNINTERESTINGNESS-CACHE-THROWN-AWAY-WRT-NEW-ROOT-CODE", 2,
				0, false);
		declareFunction(myName,
				"set_uninterestingness_cache_set_aside_wrt_removal_code",
				"SET-UNINTERESTINGNESS-CACHE-SET-ASIDE-WRT-REMOVAL-CODE", 2, 0,
				false);
		declareFunction(
				myName,
				"set_uninterestingness_cache_set_aside_wrt_transformation_code",
				"SET-UNINTERESTINGNESS-CACHE-SET-ASIDE-WRT-TRANSFORMATION-CODE",
				2, 0, false);
		declareFunction(myName,
				"set_uninterestingness_cache_set_aside_wrt_new_root_code",
				"SET-UNINTERESTINGNESS-CACHE-SET-ASIDE-WRT-NEW-ROOT-CODE", 2,
				0, false);
		declareFunction(myName, "set_uninterestingness_cache_thrown_away_code",
				"SET-UNINTERESTINGNESS-CACHE-THROWN-AWAY-CODE", 2, 0, false);
		declareFunction(myName, "set_uninterestingness_cache_set_aside_code",
				"SET-UNINTERESTINGNESS-CACHE-SET-ASIDE-CODE", 2, 0, false);
		declareFunction(myName, "decode_uninterestingness_cache_code",
				"DECODE-UNINTERESTINGNESS-CACHE-CODE", 1, 0, false);
		declareFunction(myName, "encode_uninterestingness_cache_status",
				"ENCODE-UNINTERESTINGNESS-CACHE-STATUS", 1, 0, false);
		declareFunction(myName,
				"problem_strategic_properties_print_function_trampoline",
				"PROBLEM-STRATEGIC-PROPERTIES-PRINT-FUNCTION-TRAMPOLINE", 2, 0,
				false);
		declareFunction(myName, "problem_strategic_properties_p",
				"PROBLEM-STRATEGIC-PROPERTIES-P", 1, 0, false);
		new $problem_strategic_properties_p$UnaryFunction();
		declareFunction(myName, "prob_strategic_properties_status",
				"PROB-STRATEGIC-PROPERTIES-STATUS", 1, 0, false);
		declareFunction(myName,
				"prob_strategic_properties_tactic_strategic_property_index",
				"PROB-STRATEGIC-PROPERTIES-TACTIC-STRATEGIC-PROPERTY-INDEX", 1,
				0, false);
		declareFunction(myName,
				"prob_strategic_properties_possible_tactic_count",
				"PROB-STRATEGIC-PROPERTIES-POSSIBLE-TACTIC-COUNT", 1, 0, false);
		declareFunction(myName, "prob_strategic_properties_flags",
				"PROB-STRATEGIC-PROPERTIES-FLAGS", 1, 0, false);
		declareFunction(myName, "_csetf_prob_strategic_properties_status",
				"_CSETF-PROB-STRATEGIC-PROPERTIES-STATUS", 2, 0, false);
		declareFunction(
				myName,
				"_csetf_prob_strategic_properties_tactic_strategic_property_index",
		...
		declareFunction(myName,
				"_csetf_prob_strategic_properties_possible_tactic_count",
				"_CSETF-PROB-STRATEGIC-PROPERTIES-POSSIBLE-TACTIC-COUNT", 2, 0,
				false);
		declareFunction(myName, "_csetf_prob_strategic_properties_flags",
				"_CSETF-PROB-STRATEGIC-PROPERTIES-FLAGS", 2, 0, false);
		declareFunction(myName, "make_problem_strategic_properties",
				"MAKE-PROBLEM-STRATEGIC-PROPERTIES", 0, 1, false);
		declareFunction(myName, "new_problem_strategic_properties",
				"NEW-PROBLEM-STRATEGIC-PROPERTIES", 0, 0, false);
		declareFunction(myName, "problem_strategic_properties_int",
				"PROBLEM-STRATEGIC-PROPERTIES-INT", 2, 0, false);
		declareFunction(myName, "set_problem_strategic_properties",
				"SET-PROBLEM-STRATEGIC-PROPERTIES", 3, 0, false);
		declareFunction(myName, "remove_problem_strategic_properties",
				"REMOVE-PROBLEM-STRATEGIC-PROPERTIES", 2, 0, false);
		declareFunction(myName, "problem_strategic_properties",
				"PROBLEM-STRATEGIC-PROPERTIES", 2, 0, false);
		declareFunction(myName,
				"problem_strategic_properties_tactic_strategic_property_index",
				"PROBLEM-STRATEGIC-PROPERTIES-TACTIC-STRATEGIC-PROPERTY-INDEX",
				2, 0, false);
		declareFunction(myName, "problem_raw_strategic_status",
				"PROBLEM-RAW-STRATEGIC-STATUS", 2, 0, false);
		declareFunction(myName, "problem_strategic_status",
				"PROBLEM-STRATEGIC-STATUS", 2, 0, false);
		declareFunction(myName, "problem_strategic_provability_status",
				"PROBLEM-STRATEGIC-PROVABILITY-STATUS", 2, 0, false);
		declareFunction(myName, "problem_tactical_or_strategic_status",
				"PROBLEM-TACTICAL-OR-STRATEGIC-STATUS", 2, 0, false);
		declareFunction(myName, "problem_provability_status",
				"PROBLEM-PROVABILITY-STATUS", 2, 0, false);
		declareFunction(myName, "set_problem_raw_strategic_status",
				"SET-PROBLEM-RAW-STRATEGIC-STATUS", 3, 0, false);
		declareFunction(myName, "strategically_unexamined_problem_p",
				"STRATEGICALLY-UNEXAMINED-PROBLEM-P", 2, 0, false);
		declareFunction(myName, "strategically_examined_problem_p",
				"STRATEGICALLY-EXAMINED-PROBLEM-P", 2, 0, false);
		declareFunction(myName, "strategically_possible_problem_p",
				"STRATEGICALLY-POSSIBLE-PROBLEM-P", 2, 0, false);
		declareFunction(myName, "strategically_pending_problem_p",
				"STRATEGICALLY-PENDING-PROBLEM-P", 2, 0, false);
		declareFunction(myName, "strategically_finished_problem_p",
				"STRATEGICALLY-FINISHED-PROBLEM-P", 2, 0, false);
		declareFunction(myName, "strategically_no_good_problem_p",
				"STRATEGICALLY-NO-GOOD-PROBLEM-P", 2, 0, false);
		declareFunction(myName, "strategically_neutral_problem_p",
				"STRATEGICALLY-NEUTRAL-PROBLEM-P", 2, 0, false);
		declareFunction(myName, "strategically_good_problem_p",
				"STRATEGICALLY-GOOD-PROBLEM-P", 2, 0, false);
		declareFunction(myName, "strategically_potentially_possible_problem_p",
				"STRATEGICALLY-POTENTIALLY-POSSIBLE-PROBLEM-P", 2, 0, false);
		declareFunction(myName,
				"strategically_not_potentially_possible_problem_p",
				"STRATEGICALLY-NOT-POTENTIALLY-POSSIBLE-PROBLEM-P", 2, 0, false);
		declareFunction(myName, "strategically_totally_no_good_problem_p",
				"STRATEGICALLY-TOTALLY-NO-GOOD-PROBLEM-P", 2, 0, false);
		declareFunction(myName, "problem_strategic_flags",
				"PROBLEM-STRATEGIC-FLAGS", 2, 0, false);
		declareFunction(myName, "set_problem_strategic_flags",
				"SET-PROBLEM-STRATEGIC-FLAGS", 3, 0, false);
		declareFunction(myName, "problem_thrown_away_cache_status",
				"PROBLEM-THROWN-AWAY-CACHE-STATUS", 2, 0, false);
		declareFunction(myName, "problem_thrown_away_cache_removal_status",
				"PROBLEM-THROWN-AWAY-CACHE-REMOVAL-STATUS", 2, 0, false);
		declareFunction(myName,
				"problem_thrown_away_cache_transformation_status",
				"PROBLEM-THROWN-AWAY-CACHE-TRANSFORMATION-STATUS", 2, 0, false);
		declareFunction(myName, "problem_thrown_away_cache_new_root_status",
				"PROBLEM-THROWN-AWAY-CACHE-NEW-ROOT-STATUS", 2, 0, false);
		declareFunction(myName, "problem_set_aside_cache_removal_status",
				"PROBLEM-SET-ASIDE-CACHE-REMOVAL-STATUS", 2, 0, false);
		declareFunction(myName, "problem_set_aside_cache_status",
				"PROBLEM-SET-ASIDE-CACHE-STATUS", 2, 0, false);
		declareFunction(myName,
				"problem_set_aside_cache_transformation_status",
				"PROBLEM-SET-ASIDE-CACHE-TRANSFORMATION-STATUS", 2, 0, false);
		declareFunction(myName, "problem_set_aside_cache_new_root_status",
				"PROBLEM-SET-ASIDE-CACHE-NEW-ROOT-STATUS", 2, 0, false);
		declareFunction(myName, "set_problem_thrown_away",
				"SET-PROBLEM-THROWN-AWAY", 2, 0, false);
		declareFunction(myName, "set_problem_not_thrown_away",
				"SET-PROBLEM-NOT-THROWN-AWAY", 2, 0, false);
		declareFunction(myName, "set_problem_recompute_thrown_away",
				"SET-PROBLEM-RECOMPUTE-THROWN-AWAY", 2, 0, false);
		declareFunction(myName, "set_problem_thrown_away_wrt_removal",
				"SET-PROBLEM-THROWN-AWAY-WRT-REMOVAL", 2, 0, false);
		declareFunction(myName, "set_problem_not_thrown_away_wrt_removal",
				"SET-PROBLEM-NOT-THROWN-AWAY-WRT-REMOVAL", 2, 0, false);
		declareFunction(myName,
				"set_problem_recompute_thrown_away_wrt_removal",
				"SET-PROBLEM-RECOMPUTE-THROWN-AWAY-WRT-REMOVAL", 2, 0, false);
		declareFunction(myName, "set_problem_thrown_away_wrt_transformation",
				"SET-PROBLEM-THROWN-AWAY-WRT-TRANSFORMATION", 2, 0, false);
		declareFunction(myName,
		...
		declareFunction(myName,
				...
				"SET-PROBLEM-RECOMPUTE-THROWN-AWAY-WRT-TRANSFORMATION", 2, 0,
				false);
		declareFunction(myName, "set_problem_thrown_away_wrt_new_root",
				"SET-PROBLEM-THROWN-AWAY-WRT-NEW-ROOT", 2, 0, false);
		declareFunction(myName, "set_problem_not_thrown_away_wrt_new_root",
				"SET-PROBLEM-NOT-THROWN-AWAY-WRT-NEW-ROOT", 2, 0, false);
		declareFunction(myName,
				"set_problem_recompute_thrown_away_wrt_new_root",
				"SET-PROBLEM-RECOMPUTE-THROWN-AWAY-WRT-NEW-ROOT", 2, 0, false);
		declareFunction(myName, "set_problem_set_aside",
				"SET-PROBLEM-SET-ASIDE", 2, 0, false);
		declareFunction(myName, "set_problem_not_set_aside",
				"SET-PROBLEM-NOT-SET-ASIDE", 2, 0, false);
		declareFunction(myName, "set_problem_recompute_set_aside",
				"SET-PROBLEM-RECOMPUTE-SET-ASIDE", 2, 0, false);
		declareFunction(myName, "set_problem_set_aside_wrt_removal",
				"SET-PROBLEM-SET-ASIDE-WRT-REMOVAL", 2, 0, false);
		declareFunction(myName, "set_problem_not_set_aside_wrt_removal",
				"SET-PROBLEM-NOT-SET-ASIDE-WRT-REMOVAL", 2, 0, false);
		declareFunction(myName, "set_problem_recompute_set_aside_wrt_removal",
				"SET-PROBLEM-RECOMPUTE-SET-ASIDE-WRT-REMOVAL", 2, 0, false);
		declareFunction(myName, "set_problem_set_aside_wrt_transformation",
				"SET-PROBLEM-SET-ASIDE-WRT-TRANSFORMATION", 2, 0, false);
		declareFunction(myName, "set_problem_not_set_aside_wrt_transformation",
				"SET-PROBLEM-NOT-SET-ASIDE-WRT-TRANSFORMATION", 2, 0, false);
		declareFunction(myName,
				"set_problem_recompute_set_aside_wrt_transformation",
				"SET-PROBLEM-RECOMPUTE-SET-ASIDE-WRT-TRANSFORMATION", 2, 0,
				false);
		declareFunction(myName, "set_problem_set_aside_wrt_new_root",
				"SET-PROBLEM-SET-ASIDE-WRT-NEW-ROOT", 2, 0, false);
		declareFunction(myName, "set_problem_not_set_aside_wrt_new_root",
				"SET-PROBLEM-NOT-SET-ASIDE-WRT-NEW-ROOT", 2, 0, false);
		declareFunction(myName, "set_problem_recompute_set_aside_wrt_new_root",
				"SET-PROBLEM-RECOMPUTE-SET-ASIDE-WRT-NEW-ROOT", 2, 0, false);
		declareFunction(myName, "set_problem_thrown_away_wrt",
				"SET-PROBLEM-THROWN-AWAY-WRT", 3, 0, false);
		declareFunction(myName, "set_problem_not_thrown_away_wrt",
				"SET-PROBLEM-NOT-THROWN-AWAY-WRT", 3, 0, false);
		declareFunction(myName, "set_problem_recompute_thrown_away_wrt",
				"SET-PROBLEM-RECOMPUTE-THROWN-AWAY-WRT", 3, 0, false);
		declareFunction(myName, "set_problem_set_aside_wrt",
				"SET-PROBLEM-SET-ASIDE-WRT", 3, 0, false);
		declareFunction(myName, "set_problem_not_set_aside_wrt",
				"SET-PROBLEM-NOT-SET-ASIDE-WRT", 3, 0, false);
		declareFunction(myName, "set_problem_recompute_set_aside_wrt",
				"SET-PROBLEM-RECOMPUTE-SET-ASIDE-WRT", 3, 0, false);
		declareFunction(myName,
				"problem_thrown_away_cache_status_wrt_motivation",
				"PROBLEM-THROWN-AWAY-CACHE-STATUS-WRT-MOTIVATION", 3, 0, false);
		declareFunction(myName,
				"set_problem_recompute_thrown_away_wrt_all_motivations",
				"SET-PROBLEM-RECOMPUTE-THROWN-AWAY-WRT-ALL-MOTIVATIONS", 2, 0,
				false);
		declareFunction(
				myName,
				"set_problem_recompute_thrown_away_wrt_all_relevant_strategies_and_all_motivations",
				"SET-PROBLEM-RECOMPUTE-THROWN-AWAY-WRT-ALL-RELEVANT-STRATEGIES-AND-ALL-MOTIVATIONS",
				1, 0, false);
		declareFunction(myName,
		...
		declareFunction(myName,
				...
				"SET-PROBLEM-RECOMPUTE-SET-ASIDE-WRT-ALL-MOTIVATIONS", 2, 0,
				false);
		declareFunction(
				myName,
				"set_problem_recompute_set_aside_wrt_all_relevant_strategies_and_all_motivations",
				"SET-PROBLEM-RECOMPUTE-SET-ASIDE-WRT-ALL-RELEVANT-STRATEGIES-AND-ALL-MOTIVATIONS",
				1, 0, false);
		declareFunction(myName,
				"tactic_strategic_properties_print_function_trampoline",
				"TACTIC-STRATEGIC-PROPERTIES-PRINT-FUNCTION-TRAMPOLINE", 2, 0,
				false);
		declareFunction(myName, "tactic_strategic_properties_p",
				"TACTIC-STRATEGIC-PROPERTIES-P", 1, 0, false);
		new $tactic_strategic_properties_p$UnaryFunction();
		declareFunction(myName, "tact_strategic_properties_preference_level",
				"TACT-STRATEGIC-PROPERTIES-PREFERENCE-LEVEL", 1, 0, false);
		declareFunction(myName,
				"tact_strategic_properties_preference_level_justification",
				"TACT-STRATEGIC-PROPERTIES-PREFERENCE-LEVEL-JUSTIFICATION", 1,
				0, false);
		declareFunction(myName, "tact_strategic_properties_productivity",
				"TACT-STRATEGIC-PROPERTIES-PRODUCTIVITY", 1, 0, false);
		declareFunction(myName, "tact_strategic_properties_flags",
				"TACT-STRATEGIC-PROPERTIES-FLAGS", 1, 0, false);
		declareFunction(myName,
				"_csetf_tact_strategic_properties_preference_level",
				"_CSETF-TACT-STRATEGIC-PROPERTIES-PREFERENCE-LEVEL", 2, 0,
				false);
		declareFunction(
				myName,
				"_csetf_tact_strategic_properties_preference_level_justification",
		...
		declareFunction(myName, "_csetf_tact_strategic_properties_flags",
				"_CSETF-TACT-STRATEGIC-PROPERTIES-FLAGS", 2, 0, false);
		declareFunction(myName, "make_tactic_strategic_properties",
				"MAKE-TACTIC-STRATEGIC-PROPERTIES", 0, 1, false);
		declareFunction(myName, "new_tactic_strategic_properties",
				"NEW-TACTIC-STRATEGIC-PROPERTIES", 0, 0, false);
		declareFunction(myName, "tactic_strategic_properties_int",
				"TACTIC-STRATEGIC-PROPERTIES-INT", 2, 0, false);
		declareFunction(myName, "set_tactic_strategic_properties",
				"SET-TACTIC-STRATEGIC-PROPERTIES", 3, 0, false);
		declareFunction(myName, "tactic_strategic_properties",
				"TACTIC-STRATEGIC-PROPERTIES", 2, 0, false);
		declareFunction(myName, "tactic_strategic_completeness",
				"TACTIC-STRATEGIC-COMPLETENESS", 2, 0, false);
		declareFunction(myName, "tactic_strategic_preference_level",
				"TACTIC-STRATEGIC-PREFERENCE-LEVEL", 2, 0, false);
		declareFunction(myName,
				"tactic_strategic_preference_level_justification",
				"TACTIC-STRATEGIC-PREFERENCE-LEVEL-JUSTIFICATION", 2, 0, false);
		declareFunction(myName, "tactic_strategic_dwimmed_completeness",
				"TACTIC-STRATEGIC-DWIMMED-COMPLETENESS", 2, 0, false);
		declareFunction(myName,
		...
		declareFunction(myName,
				...
				"CONJUNCTIVE-TACTIC-STRATEGIC-PREFERENCE-LEVEL-JUSTIFICATION",
				2, 0, false);
		declareFunction(myName, "tactic_strategic_productivity",
				"TACTIC-STRATEGIC-PRODUCTIVITY", 2, 0, false);
		declareFunction(myName, "tactic_strategically_preferredP",
				"TACTIC-STRATEGICALLY-PREFERRED?", 2, 0, false);
		declareFunction(myName, "set_tactic_strategic_preference_level",
				"SET-TACTIC-STRATEGIC-PREFERENCE-LEVEL", 4, 0, false);
		declareFunction(myName, "set_tactic_strategic_productivity",
				"SET-TACTIC-STRATEGIC-PRODUCTIVITY", 3, 0, false);
		declareFunction(myName, "tactic_strategic_flags",
				"TACTIC-STRATEGIC-FLAGS", 2, 0, false);
		declareFunction(myName, "set_tactic_strategic_flags",
				"SET-TACTIC-STRATEGIC-FLAGS", 3, 0, false);
		declareFunction(myName, "tactic_thrown_away_cache_status",
				"TACTIC-THROWN-AWAY-CACHE-STATUS", 2, 0, false);
		declareFunction(myName, "tactic_thrown_away_cache_removal_status",
				"TACTIC-THROWN-AWAY-CACHE-REMOVAL-STATUS", 2, 0, false);
		declareFunction(myName,
				"tactic_thrown_away_cache_transformation_status",
				"TACTIC-THROWN-AWAY-CACHE-TRANSFORMATION-STATUS", 2, 0, false);
		declareFunction(myName, "tactic_thrown_away_cache_new_root_status",
				"TACTIC-THROWN-AWAY-CACHE-NEW-ROOT-STATUS", 2, 0, false);
		declareFunction(myName, "tactic_set_aside_cache_status",
				"TACTIC-SET-ASIDE-CACHE-STATUS", 2, 0, false);
		declareFunction(myName, "tactic_set_aside_cache_removal_status",
				"TACTIC-SET-ASIDE-CACHE-REMOVAL-STATUS", 2, 0, false);
		declareFunction(myName, "tactic_set_aside_cache_transformation_status",
				"TACTIC-SET-ASIDE-CACHE-TRANSFORMATION-STATUS", 2, 0, false);
		declareFunction(myName, "tactic_set_aside_cache_new_root_status",
				"TACTIC-SET-ASIDE-CACHE-NEW-ROOT-STATUS", 2, 0, false);
		declareFunction(myName, "set_tactic_thrown_away",
				"SET-TACTIC-THROWN-AWAY", 2, 0, false);
		declareFunction(myName, "set_tactic_not_thrown_away",
				"SET-TACTIC-NOT-THROWN-AWAY", 2, 0, false);
		declareFunction(myName, "set_tactic_recompute_thrown_away",
				"SET-TACTIC-RECOMPUTE-THROWN-AWAY", 2, 0, false);
		declareFunction(myName, "set_tactic_thrown_away_wrt_removal",
				"SET-TACTIC-THROWN-AWAY-WRT-REMOVAL", 2, 0, false);
		declareFunction(myName, "set_tactic_not_thrown_away_wrt_removal",
				"SET-TACTIC-NOT-THROWN-AWAY-WRT-REMOVAL", 2, 0, false);
		declareFunction(myName, "set_tactic_recompute_thrown_away_wrt_removal",
				"SET-TACTIC-RECOMPUTE-THROWN-AWAY-WRT-REMOVAL", 2, 0, false);
		declareFunction(myName, "set_tactic_thrown_away_wrt_transformation",
				"SET-TACTIC-THROWN-AWAY-WRT-TRANSFORMATION", 2, 0, false);
		declareFunction(myName,
		...
		declareFunction(myName,
				...
				"SET-TACTIC-RECOMPUTE-THROWN-AWAY-WRT-TRANSFORMATION", 2, 0,
				false);
		declareFunction(myName, "set_tactic_thrown_away_wrt_new_root",
				"SET-TACTIC-THROWN-AWAY-WRT-NEW-ROOT", 2, 0, false);
		declareFunction(myName, "set_tactic_not_thrown_away_wrt_new_root",
				"SET-TACTIC-NOT-THROWN-AWAY-WRT-NEW-ROOT", 2, 0, false);
		declareFunction(myName,
				"set_tactic_recompute_thrown_away_wrt_new_root",
				"SET-TACTIC-RECOMPUTE-THROWN-AWAY-WRT-NEW-ROOT", 2, 0, false);
		declareFunction(myName, "set_tactic_set_aside", "SET-TACTIC-SET-ASIDE",
				2, 0, false);
		declareFunction(myName, "set_tactic_not_set_aside",
				"SET-TACTIC-NOT-SET-ASIDE", 2, 0, false);
		declareFunction(myName, "set_tactic_recompute_set_aside",
				"SET-TACTIC-RECOMPUTE-SET-ASIDE", 2, 0, false);
		declareFunction(myName, "set_tactic_set_aside_wrt_removal",
				"SET-TACTIC-SET-ASIDE-WRT-REMOVAL", 2, 0, false);
		declareFunction(myName, "set_tactic_not_set_aside_wrt_removal",
				"SET-TACTIC-NOT-SET-ASIDE-WRT-REMOVAL", 2, 0, false);
		declareFunction(myName, "set_tactic_recompute_set_aside_wrt_removal",
				"SET-TACTIC-RECOMPUTE-SET-ASIDE-WRT-REMOVAL", 2, 0, false);
		declareFunction(myName, "set_tactic_set_aside_wrt_transformation",
				"SET-TACTIC-SET-ASIDE-WRT-TRANSFORMATION", 2, 0, false);
		declareFunction(myName, "set_tactic_not_set_aside_wrt_transformation",
				"SET-TACTIC-NOT-SET-ASIDE-WRT-TRANSFORMATION", 2, 0, false);
		declareFunction(myName,
				"set_tactic_recompute_set_aside_wrt_transformation",
				"SET-TACTIC-RECOMPUTE-SET-ASIDE-WRT-TRANSFORMATION", 2, 0,
				false);
		declareFunction(myName, "set_tactic_set_aside_wrt_new_root",
				"SET-TACTIC-SET-ASIDE-WRT-NEW-ROOT", 2, 0, false);
		declareFunction(myName, "set_tactic_not_set_aside_wrt_new_root",
				"SET-TACTIC-NOT-SET-ASIDE-WRT-NEW-ROOT", 2, 0, false);
		declareFunction(myName, "set_tactic_recompute_set_aside_wrt_new_root",
				"SET-TACTIC-RECOMPUTE-SET-ASIDE-WRT-NEW-ROOT", 2, 0, false);
		declareFunction(myName, "set_tactic_thrown_away_wrt",
				"SET-TACTIC-THROWN-AWAY-WRT", 3, 0, false);
		declareFunction(myName, "set_tactic_not_thrown_away_wrt",
				"SET-TACTIC-NOT-THROWN-AWAY-WRT", 3, 0, false);
		declareFunction(myName, "set_tactic_recompute_thrown_away_wrt",
				"SET-TACTIC-RECOMPUTE-THROWN-AWAY-WRT", 3, 0, false);
		declareFunction(myName, "set_tactic_set_aside_wrt",
				"SET-TACTIC-SET-ASIDE-WRT", 3, 0, false);
		declareFunction(myName, "set_tactic_not_set_aside_wrt",
				"SET-TACTIC-NOT-SET-ASIDE-WRT", 3, 0, false);
		declareFunction(myName, "set_tactic_recompute_set_aside_wrt",
				"SET-TACTIC-RECOMPUTE-SET-ASIDE-WRT", 3, 0, false);
		declareFunction(myName,
		...
		declareFunction(myName,
				...
				"SET-TACTIC-RECOMPUTE-THROWN-AWAY-WRT-ALL-MOTIVATIONS", 2, 0,
				false);
		declareFunction(
				myName,
				"set_problem_tactics_recompute_thrown_away_wrt_all_motivations",
		...
		declareFunction(
				...
				1, 0, false);
		declareFunction(myName, "tactic_set_aside_cache_status_wrt_motivation",
				"TACTIC-SET-ASIDE-CACHE-STATUS-WRT-MOTIVATION", 3, 0, false);
		declareFunction(myName,
				"set_tactic_recompute_set_aside_wrt_all_motivations",
				"SET-TACTIC-RECOMPUTE-SET-ASIDE-WRT-ALL-MOTIVATIONS", 2, 0,
				false);
		declareFunction(
				myName,
				"set_tactic_recompute_set_aside_wrt_all_relevant_strategies_and_all_motivations",
				"SET-TACTIC-RECOMPUTE-SET-ASIDE-WRT-ALL-RELEVANT-STRATEGIES-AND-ALL-MOTIVATIONS",
				1, 0, false);
		declareFunction(myName,
				"set_problem_tactics_recompute_set_aside_wrt_all_motivations",
				"SET-PROBLEM-TACTICS-RECOMPUTE-SET-ASIDE-WRT-ALL-MOTIVATIONS",
				2, 0, false);
		declareFunction(
				myName,
				"set_problem_tactics_recompute_set_aside_wrt_all_relevant_strategies_and_all_motivations",
				"SET-PROBLEM-TACTICS-RECOMPUTE-SET-ASIDE-WRT-ALL-RELEVANT-STRATEGIES-AND-ALL-MOTIVATIONS",
				1, 0, false);
		declareFunction(myName, "problem_strategically_possible_tactic_count",
				"PROBLEM-STRATEGICALLY-POSSIBLE-TACTIC-COUNT", 2, 0, false);
		declareFunction(myName, "problem_note_tactic_strategically_possible",
				"PROBLEM-NOTE-TACTIC-STRATEGICALLY-POSSIBLE", 3, 0, false);
		declareFunction(myName,
				"problem_note_tactic_not_strategically_possible",
				"PROBLEM-NOTE-TACTIC-NOT-STRATEGICALLY-POSSIBLE", 3, 0, false);
		declareFunction(myName,
				"problem_note_all_tactics_not_strategically_possible",
				"PROBLEM-NOTE-ALL-TACTICS-NOT-STRATEGICALLY-POSSIBLE", 2, 0,
				false);
		return NIL;
	}
	...
	public static final SubLObject init_inference_datastructures_strategy_file() {
		...
		$current_strategy_wrt_memoization$ = defparameter(
				"*CURRENT-STRATEGY-WRT-MEMOIZATION*", NIL);
		$strategy_type_store$ = deflexical(
				"*STRATEGY-TYPE-STORE*",
				((NIL != Symbols.boundp($sym107$_STRATEGY_TYPE_STORE_)) ? ((SubLObject) $strategy_type_store$
						.getGlobalValue()) : dictionary.new_dictionary(
						Symbols.symbol_function(EQ), FIVE_INTEGER)));
		$uninterestingness_cache_lookup_enabledP$ = defparameter(
				"*UNINTERESTINGNESS-CACHE-LOOKUP-ENABLED?*", T);
		$default_uninterestingness_flags$ = defconstant(
				"*DEFAULT-UNINTERESTINGNESS-FLAGS*", ZERO_INTEGER);
		$uninterestingness_cache_thrown_away_wrt_removal_byte$ = defconstant(
				"*UNINTERESTINGNESS-CACHE-THROWN-AWAY-WRT-REMOVAL-BYTE*",
				bytes.sublisp_byte(TWO_INTEGER, ZERO_INTEGER));
		$uninterestingness_cache_thrown_away_wrt_transformation_byte$ = defconstant(
				"*UNINTERESTINGNESS-CACHE-THROWN-AWAY-WRT-TRANSFORMATION-BYTE*",
				bytes.sublisp_byte(TWO_INTEGER, TWO_INTEGER));
		$uninterestingness_cache_thrown_away_wrt_new_root_byte$ = defconstant(
				"*UNINTERESTINGNESS-CACHE-THROWN-AWAY-WRT-NEW-ROOT-BYTE*",
				bytes.sublisp_byte(TWO_INTEGER, FOUR_INTEGER));
		$uninterestingness_cache_set_aside_wrt_removal_byte$ = defconstant(
				"*UNINTERESTINGNESS-CACHE-SET-ASIDE-WRT-REMOVAL-BYTE*",
				bytes.sublisp_byte(TWO_INTEGER, SIX_INTEGER));
		$uninterestingness_cache_set_aside_wrt_transformation_byte$ = defconstant(
				"*UNINTERESTINGNESS-CACHE-SET-ASIDE-WRT-TRANSFORMATION-BYTE*",
				bytes.sublisp_byte(TWO_INTEGER, EIGHT_INTEGER));
		$uninterestingness_cache_set_aside_wrt_new_root_byte$ = defconstant(
				"*UNINTERESTINGNESS-CACHE-SET-ASIDE-WRT-NEW-ROOT-BYTE*",
				bytes.sublisp_byte(TWO_INTEGER, TEN_INTEGER));
		$uninterestingness_cache_thrown_away_byte$ = defconstant(
				"*UNINTERESTINGNESS-CACHE-THROWN-AWAY-BYTE*",
				bytes.sublisp_byte(TWO_INTEGER, TWELVE_INTEGER));
		$uninterestingness_cache_set_aside_byte$ = defconstant(
				"*UNINTERESTINGNESS-CACHE-SET-ASIDE-BYTE*",
				bytes.sublisp_byte(TWO_INTEGER, FOURTEEN_INTEGER));
		$dtp_problem_strategic_properties$ = defconstant(
				"*DTP-PROBLEM-STRATEGIC-PROPERTIES*",
				$sym113$PROBLEM_STRATEGIC_PROPERTIES);
		$dtp_tactic_strategic_properties$ = defconstant(
				"*DTP-TACTIC-STRATEGIC-PROPERTIES*",
				$sym149$TACTIC_STRATEGIC_PROPERTIES);
		return NIL;
	}
	...
	public static final SubLObject setup_inference_datastructures_strategy_file() {
		...
		Structures.register_method(print_high.$print_object_method_table$
				.getGlobalValue(), $dtp_strategy$.getGlobalValue(), Symbols
				.symbol_function($sym7$STRATEGY_PRINT_FUNCTION_TRAMPOLINE));
		Structures.def_csetf($sym8$STRAT_SUID, $sym9$_CSETF_STRAT_SUID);
		Structures.def_csetf($sym10$STRAT_INFERENCE,
				$sym11$_CSETF_STRAT_INFERENCE);
		Structures.def_csetf($sym12$STRAT_RESULT_UNIQUENESS_CRITERION,
				$sym13$_CSETF_STRAT_RESULT_UNIQUENESS_CRITERION);
		Structures.def_csetf($sym14$STRAT_ACTIVE_PROBLEMS,
				$sym15$_CSETF_STRAT_ACTIVE_PROBLEMS);
		Structures.def_csetf($sym16$STRAT_MOTIVATED_PROBLEMS,
				$sym17$_CSETF_STRAT_MOTIVATED_PROBLEMS);
		Structures.def_csetf($sym18$STRAT_SET_ASIDE_PROBLEMS,
				$sym19$_CSETF_STRAT_SET_ASIDE_PROBLEMS);
		Structures.def_csetf($sym20$STRAT_SHOULD_RECONSIDER_SET_ASIDES_,
				$sym21$_CSETF_STRAT_SHOULD_RECONSIDER_SET_ASIDES_);
		Structures.def_csetf($sym22$STRAT_PRODUCTIVITY_LIMIT,
		...
		Structures.def_csetf($sym26$STRAT_PROOF_SPEC,
				$sym27$_CSETF_STRAT_PROOF_SPEC);
		Structures.def_csetf($sym28$STRAT_PROBLEM_PROOF_SPEC_INDEX,
				$sym29$_CSETF_STRAT_PROBLEM_PROOF_SPEC_INDEX);
		Structures.def_csetf($sym30$STRAT_PROBLEM_STRATEGIC_INDEX,
				$sym31$_CSETF_STRAT_PROBLEM_STRATEGIC_INDEX);
		Structures.def_csetf($sym32$STRAT_MEMOIZATION_STATE,
		...
		Structures.register_method(
				...
				$dtp_strategy$.getGlobalValue(),
				Symbols.symbol_function($sym57$SXHASH_STRATEGY_METHOD));
		access_macros.register_macro_helper($sym61$STRATEGY_ACTIVE_PROBLEMS,
				$sym62$DO_STRATEGY_ACTIVE_PROBLEMS);
		access_macros.register_macro_helper($sym63$STRATEGY_MOTIVATED_PROBLEMS,
				$sym64$DO_STRATEGY_MOTIVATED_PROBLEMS);
		access_macros.register_macro_helper($sym65$STRATEGY_SET_ASIDE_PROBLEMS,
				$sym66$DO_STRATEGY_SET_ASIDE_PROBLEMS);
		access_macros.register_macro_helper($sym80$STRATEGY_MEMOIZATION_STATE,
		...
		Structures
				.register_method(
						...
						Symbols.symbol_function($sym120$PROBLEM_STRATEGIC_PROPERTIES_PRINT_FUNCTION_TRAMPOLINE));
		Structures.def_csetf($sym121$PROB_STRATEGIC_PROPERTIES_STATUS,
		...
		Structures.def_csetf($sym127$PROB_STRATEGIC_PROPERTIES_FLAGS,
		...
		Structures
				.register_method(
						...
						Symbols.symbol_function($sym155$TACTIC_STRATEGIC_PROPERTIES_PRINT_FUNCTION_TRAMPOLINE));
		Structures.def_csetf(
		...
		Structures.def_csetf($sym160$TACT_STRATEGIC_PROPERTIES_PRODUCTIVITY,
				$sym161$_CSETF_TACT_STRATEGIC_PROPERTIES_PRODUCTIVITY);
		Structures.def_csetf($sym162$TACT_STRATEGIC_PROPERTIES_FLAGS,
	...
	public static final SubLList $list2 = list(new SubLObject[] {
			makeSymbol("SUID"), makeSymbol("INFERENCE"),
			makeSymbol("RESULT-UNIQUENESS-CRITERION"),
			makeSymbol("ACTIVE-PROBLEMS"), makeSymbol("MOTIVATED-PROBLEMS"),
			makeSymbol("SET-ASIDE-PROBLEMS"),
			makeSymbol("SHOULD-RECONSIDER-SET-ASIDES?"),
			makeSymbol("PRODUCTIVITY-LIMIT"),
			makeSymbol("REMOVAL-BACKTRACKING-PRODUCTIVITY-LIMIT"),
			makeSymbol("PROOF-SPEC"), makeSymbol("PROBLEM-PROOF-SPEC-INDEX"),
			makeSymbol("PROBLEM-STRATEGIC-INDEX"),
			makeSymbol("MEMOIZATION-STATE"), makeSymbol("TYPE"),
			makeSymbol("DATA") });
	public static final SubLList $list3 = list(new SubLObject[] {
			makeKeyword("SUID"), makeKeyword("INFERENCE"),
			makeKeyword("RESULT-UNIQUENESS-CRITERION"),
			makeKeyword("ACTIVE-PROBLEMS"), makeKeyword("MOTIVATED-PROBLEMS"),
			makeKeyword("SET-ASIDE-PROBLEMS"),
			makeKeyword("SHOULD-RECONSIDER-SET-ASIDES?"),
			makeKeyword("PRODUCTIVITY-LIMIT"),
			makeKeyword("REMOVAL-BACKTRACKING-PRODUCTIVITY-LIMIT"),
			makeKeyword("PROOF-SPEC"), makeKeyword("PROBLEM-PROOF-SPEC-INDEX"),
			makeKeyword("PROBLEM-STRATEGIC-INDEX"),
			makeKeyword("MEMOIZATION-STATE"), makeKeyword("TYPE"),
			makeKeyword("DATA") });
	public static final SubLList $list4 = list(new SubLObject[] {
			makeSymbol("STRAT-SUID"), makeSymbol("STRAT-INFERENCE"),
			makeSymbol("STRAT-RESULT-UNIQUENESS-CRITERION"),
			makeSymbol("STRAT-ACTIVE-PROBLEMS"),
			makeSymbol("STRAT-MOTIVATED-PROBLEMS"),
			makeSymbol("STRAT-SET-ASIDE-PROBLEMS"),
			makeSymbol("STRAT-SHOULD-RECONSIDER-SET-ASIDES?"),
			makeSymbol("STRAT-PRODUCTIVITY-LIMIT"),
			makeSymbol("STRAT-REMOVAL-BACKTRACKING-PRODUCTIVITY-LIMIT"),
			makeSymbol("STRAT-PROOF-SPEC"),
			makeSymbol("STRAT-PROBLEM-PROOF-SPEC-INDEX"),
			makeSymbol("STRAT-PROBLEM-STRATEGIC-INDEX"),
			makeSymbol("STRAT-MEMOIZATION-STATE"), makeSymbol("STRAT-TYPE"),
			makeSymbol("STRAT-DATA") });
	public static final SubLList $list5 = list(new SubLObject[] {
			makeSymbol("_CSETF-STRAT-SUID"),
			makeSymbol("_CSETF-STRAT-INFERENCE"),
			makeSymbol("_CSETF-STRAT-RESULT-UNIQUENESS-CRITERION"),
			makeSymbol("_CSETF-STRAT-ACTIVE-PROBLEMS"),
			makeSymbol("_CSETF-STRAT-MOTIVATED-PROBLEMS"),
			makeSymbol("_CSETF-STRAT-SET-ASIDE-PROBLEMS"),
			makeSymbol("_CSETF-STRAT-SHOULD-RECONSIDER-SET-ASIDES?"),
			makeSymbol("_CSETF-STRAT-PRODUCTIVITY-LIMIT"),
			makeSymbol("_CSETF-STRAT-REMOVAL-BACKTRACKING-PRODUCTIVITY-LIMIT"),
			makeSymbol("_CSETF-STRAT-PROOF-SPEC"),
			makeSymbol("_CSETF-STRAT-PROBLEM-PROOF-SPEC-INDEX"),
			makeSymbol("_CSETF-STRAT-PROBLEM-STRATEGIC-INDEX"),
			makeSymbol("_CSETF-STRAT-MEMOIZATION-STATE"),
	...
	public static final SubLList $list70 = list(
			list(makeSymbol("PROBLEM-VAR"), makeSymbol("STRATEGY"),
	...
	public static final SubLList $list76 = list(makeSymbol("STRATEGY"),
			makeSymbol("&BODY"), makeSymbol("BODY"));
	...
	public static final SubLList $list94 = list(
			list(makeSymbol("STRATEGY"), makeSymbol("PROBLEM")),
			makeSymbol("&BODY"), makeSymbol("BODY"));
	...
	public static final SubLList $list115 = list(makeSymbol("STATUS"),
			makeSymbol("TACTIC-STRATEGIC-PROPERTY-INDEX"),
			makeSymbol("POSSIBLE-TACTIC-COUNT"), makeSymbol("FLAGS"));
	public static final SubLList $list116 = list(makeKeyword("STATUS"),
			makeKeyword("TACTIC-STRATEGIC-PROPERTY-INDEX"),
			makeKeyword("POSSIBLE-TACTIC-COUNT"), makeKeyword("FLAGS"));
	public static final SubLList $list117 = list(
			makeSymbol("PROB-STRATEGIC-PROPERTIES-STATUS"),
	...
	public static final SubLList $list118 = list(
			makeSymbol("_CSETF-PROB-STRATEGIC-PROPERTIES-STATUS"),
	...
	public static final SubLList $list151 = list(
			makeSymbol("PREFERENCE-LEVEL"),
			makeSymbol("PREFERENCE-LEVEL-JUSTIFICATION"),
			makeSymbol("PRODUCTIVITY"), makeSymbol("FLAGS"));
	public static final SubLList $list152 = list(
			makeKeyword("PREFERENCE-LEVEL"),
			makeKeyword("PREFERENCE-LEVEL-JUSTIFICATION"),
			makeKeyword("PRODUCTIVITY"), makeKeyword("FLAGS"));
	public static final SubLList $list153 = list(
			makeSymbol("TACT-STRATEGIC-PROPERTIES-PREFERENCE-LEVEL"),
			makeSymbol("TACT-STRATEGIC-PROPERTIES-PREFERENCE-LEVEL-JUSTIFICATION"),
			makeSymbol("TACT-STRATEGIC-PROPERTIES-PRODUCTIVITY"),
			makeSymbol("TACT-STRATEGIC-PROPERTIES-FLAGS"));
	public static final SubLList $list154 = list(
			makeSymbol("_CSETF-TACT-STRATEGIC-PROPERTIES-PREFERENCE-LEVEL"),
