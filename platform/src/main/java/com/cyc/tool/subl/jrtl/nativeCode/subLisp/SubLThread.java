...
public class SubLThread extends Thread implements CommonSymbols {
	...
	public void run() {
		try {
			...
			// Handle every Exception since this is the last possibility of
			// doing so
			ex.printStackTrace();
			try {
				Larkc.stop();
			} catch (EndpointShutdownException e) {
				// Try again in 5 seconds. There is not much we can do about
				// that.
				try {
					Thread.sleep(5000);
					Larkc.stop();
					...
					// Do nothing
				} catch (EndpointShutdownException ese) {
					// Nothing we can do if it fails again, print stack trace
					ese.printStackTrace();
				}
				if (Larkc.isInitialized()) {
					// Platform is still initialized - 2nd shutdown did not
					// work. Print stack trace.
					e.printStackTrace();
				}
			}
		} finally {
	...
	public final SubLObject values(final SubLObject value1,
			final SubLObject value2, final SubLObject value3) {
		valuesCount = 3;
		this.value3 = value3;
		this.value2 = value2;
		return this.value1 = value1;
	...
	public final SubLObject values(final SubLObject value1,
			final SubLObject value2, final SubLObject value3,
			final SubLObject value4, final SubLObject value5) {
		valuesCount = 5;
		this.value5 = value5;
		this.value4 = value4;
		this.value3 = value3;
	...
	public final SubLObject values(final SubLObject value1,
			final SubLObject value2, final SubLObject value3,
			final SubLObject value4, final SubLObject value5,
			final SubLObject value6, final SubLObject value7) {
		valuesCount = 7;
		this.value7 = value7;
		this.value6 = value6;
		this.value5 = value5;
	...
	/* helper method for NTH-VALUE */
	public final SubLObject nth_value_step_2(final SubLObject num,
	...
	public final SubLObject first_value_helper(final SubLObject arg1,
			final SubLObject result) {
		resetMultipleValues();
		return result;
	}

	public final SubLObject second_value_helper(final SubLObject arg1,
			final SubLObject result) {
	...
	public final SubLObject third_value_helper(final SubLObject arg1,
			final SubLObject result) {
	...
	public final SubLObject fourth_value_helper(final SubLObject arg1,
			final SubLObject result) {
	...
	public final SubLObject fifth_value_helper(final SubLObject arg1,
			final SubLObject result) {
	...
	public final SubLObject sixth_value_helper(final SubLObject arg1,
			final SubLObject result) {
	...
	public final SubLObject seventh_value_helper(final SubLObject arg1,
			final SubLObject result) {
	...
	public final SubLObject eighth_value_helper(final SubLObject arg1,
			final SubLObject result) {
	...
	public static final ComparatorGenericKey genericSortComparator = new ComparatorGenericKey(
			null, null);
	public static final ComparatorIdentityKey identitySortComparator = new ComparatorIdentityKey(
			null);
	public final byte[] byteBuffer = new byte[256];

	public final ArrayList<SubLObject> valuesArray = new ArrayList<SubLObject>(
			128);
