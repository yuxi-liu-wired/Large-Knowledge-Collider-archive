...
public class ManagementInterfaceMain {
	...
	public static void main(String[] args) throws Exception {
		...
		server.getContext().getParameters().set("maxTotalConnections", "1024");
		server.getContext().getParameters().set("maxThreads", "1024");
		server.getContext().getParameters().set("socketTimeout", "600000");
