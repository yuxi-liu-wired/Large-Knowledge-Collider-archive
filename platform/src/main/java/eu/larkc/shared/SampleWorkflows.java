...
public class SampleWorkflows {
	...
	public static SetOfStatements getWorkflowDescriptionWithSPARQLEndpoint() {
		...
		URI endpointType = new URIImpl(
				"urn:eu.larkc.endpoint.sparql.SparqlEndpoint");
	...
	public static SetOfStatements getWorkflowDescriptionWithMultipleEndpoints() {
		...
		URI sparqlEndpointType = new URIImpl(
				"urn:eu.larkc.endpoint.sparql.SparqlEndpoint");
		URI testEndpointUrn = new URIImpl("urn:eu.larkc.endpoint.test.ep1");
		URI testEndpointType = new URIImpl(
				"urn:eu.larkc.endpoint.test.TestEndpoint");
	...
	/**
	 * Constructs a workflow with incorrect plugin types.
	 * 
	 * @return the workflow as a set of RDF statements
	 */
	public static SetOfStatements getWorkflowDescriptionWithIncorrectPluginTypes() {
		URI deciderURI = new URIImpl(
				"urn:eu.larkc.plugin.decide.IncorrectDecider");
		URI transformerURI = new URIImpl(
				"urn:eu.larkc.plugin.transform.IncorrectTransformer");
		URI identifierURI = new URIImpl(
				"urn:eu.larkc.plugin.identify.IncorrectIdentifier");
	...
	/**
	 * Constructs a workflow with incorrect endpoint types.
	 * 
	 * @return the workflow as a set of RDF statements
	 */
	public static SetOfStatements getWorkflowDescriptionWithIncorrectEndpointTypes() {
		URI deciderURI = new URIImpl("urn:eu.larkc.plugin.decide.TestDecider");
		URI transformerURI = new URIImpl(
				"urn:eu.larkc.plugin.transform.TestTransformer");
		URI identifierURI = new URIImpl(
		...
		URI endpointUrn = new URIImpl("urn:eu.larkc.endpoint.incorrect.ep1");
		URI testEndpointType = new URIImpl(
				"urn:eu.larkc.endpoint.incorrect.IncorrectEndpoint");
