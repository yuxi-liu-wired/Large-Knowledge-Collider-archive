...
public class SampleN3Workflows {
	...
	public static String getMinimalN3WorkflowFromD533() {
		return "@prefix rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#> . \n"
				...
				+ "<urn:eu.larkc.endpoint.test.ep1> a <urn:eu.larkc.endpoint.test.TestEndpoint> ."
	...
	public static String getMinimalN3WorkflowFromD533WithoutPrefixes() {
		return "# Define two plug-ins  \n"
				...
				+ "# Connect an endpoint to the path \n"
				+ "<urn:eu.larkc.endpoint.test.ep1> <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <urn:eu.larkc.endpoint.test.TestEndpoint> ."
	...
	public static String getSplitMergeWorkflowFromD533() {
		return "@prefix rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#> . \n"
				...
				+ "# Connect an endpoint to the path \n"
				+ "<urn:eu.larkc.endpoint.sparql.ep1> a <urn:eu.larkc.endpoint.sparql.SparqlEndpoint> . \n"
				+ "<urn:eu.larkc.endpoint.sparql.ep1> larkc:links _:path . \n";
	}

	/**
	 * More complex split&merge workflow in N3 with test endpoint.
	 * 
	 * @return the workflow as a string in N3 format
	 */
	public static String getSplitMergeWorkflowWithTestendpoint() {
		return "@prefix rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#> . \n"
				+ "@prefix larkc: <http://larkc.eu/schema#> . \n"
	...
	public static String getWorkflowWithMultipleTestEndpoints() {
		return "@prefix rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#> . \n"
				...
				+ "# Connect an endpoint to the path \n"
				+ "<urn:eu.larkc.endpoint.test.ep2> a <urn:eu.larkc.endpoint.test.TestEndpoint> . \n"
