...
public class Resources {
	 ...
	 */
	public static final String MGMT_HTML_ROOT = "mgmt/";
	...
	/**
	 * Base URL to get all plug-ins from the mgmt interface
	 */
	public static final String MGMT_PLUGINS_URL = "http://localhost:8182/registry?getAllPlugins";

	/**
	 * Base URL to get all endpoints from the mgmt interface
	 */
	public static final String MGMT_ENDPOINTS_URL = "http://localhost:8182/registry?getAllEndpoints";
