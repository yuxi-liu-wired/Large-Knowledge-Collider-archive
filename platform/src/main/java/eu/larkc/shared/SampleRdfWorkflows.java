...
public class SampleRdfWorkflows {
	...
	public static String getWorkflowWithTestEndpoint() {
		return "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
				...
				+ "<endpointType xmlns=\"larkc:\" rdf:resource=\"urn:eu.larkc.endpoint.test.TestEndpoint\"/>"
	...
	public static String getWorkflowWithPushEndpoint() {
		return "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
				...
				+ "<endpointType xmlns=\"larkc:\" rdf:resource=\"urn:eu.larkc.endpoint.push.PushEndpoint\"/>"
				+ "<links xmlns=\"larkc:\" rdf:nodeID=\"TestPath\"/>"
				+ "</rdf:Description>" +
	...
	public static String getWorkflowWithSparqlEndpoint() {
		return "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
				...
				+ "<endpointType xmlns=\"larkc:\" rdf:resource=\"urn:eu.larkc.endpoint.sparql.SparqlEndpoint\"/>"
				+ "<links xmlns=\"larkc:\" rdf:nodeID=\"TestPath\"/>"
				+ "</rdf:Description>" +
	...
	public static String getMinimalRDFWorkflowFromD533WithoutPrefixes() {
		return "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
				...
				"<rdf:Description rdf:about=\"urn:eu.larkc.endpoint.test.ep1\">"
				+ "<endpointType xmlns=\"http://larkc.eu/schema#\" rdf:resource=\"urn:eu.larkc.endpoint.test.TestEndpoint\"/>"
	 ...
	 * 
	 * @return the workflow with sparql endpoint and test sparql endpoint plugin
	 */
	public static String getWorkflowWithSparqlTestPlugin() {
		return "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
				+ "<rdf:RDF xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\"\n"
				+ "xmlns:larkc=\"http://larkc.eu/schema#\">"
				+
				...
				"<rdf:Description rdf:nodeID=\"TestPath\">"
				+ "<hasInput xmlns=\"larkc:\" rdf:nodeID=\"TestPlugin1\"/>"
				+ "<hasOutput xmlns=\"larkc:\" rdf:nodeID=\"TestPlugin1\"/>"
				+ "</rdf:Description>"
				+

				"<rdf:Description rdf:nodeID=\"TestPlugin1\">"
				+ "<pluginType xmlns=\"larkc:\" rdf:resource=\"urn:eu.larkc.plugin.SPARQLEndpointTestPlugin\"/>"
				+ "</rdf:Description>"
				+
