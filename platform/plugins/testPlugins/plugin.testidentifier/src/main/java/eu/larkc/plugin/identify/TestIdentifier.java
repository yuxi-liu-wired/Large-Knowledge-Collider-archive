 ...
 * <code>eu.larkc.plugin.identify.TestIdentifier</code>. Use this class as an
 * entry point for your plug-in development.
 * </p>
 */
public class TestIdentifier extends Plugin {
	 ...
	 */
	public TestIdentifier(URI pluginUri) {
		super(pluginUri);
	}
	...
	protected void initialiseInternal(SetOfStatements workflowDescription) {
		logger.info("TestIdentifier initialized.");
	}
	...
	protected SetOfStatements invokeInternal(SetOfStatements input) {
		logger.info("TestIdentifier invokeInternal called ...");
		return input;
	}
