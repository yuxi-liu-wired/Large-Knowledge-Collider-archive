 ...
 * <code>eu.larkc.plugin.identify.TestRemoteIdentifier</code>. Use this class as
 * an entry point for your plug-in development.
 * </p>
 */
public class TestRemoteIdentifier extends Plugin {

	/**
	 * Default Constructor.
	 */
	public TestRemoteIdentifier() {
		super(new URIImpl("urn:TestRemoteIdentifier"));
	}
	 ...
	 */
	public TestRemoteIdentifier(URI pluginUri) {
		super(pluginUri);
	}
	...
	protected void initialiseInternal(SetOfStatements workflowDescription) {
		logger.info("TestRemoteIdentifier initialized.");
	}
	...
	protected SetOfStatements invokeInternal(SetOfStatements input) {
		logger.info("TestRemoteIdentifier invokeInternal called ...");
		return input;
	}
