 ...
 * <code>eu.larkc.plugin.decide.TestDecider</code>. Use this class as an entry
 * point for your plug-in development.
 * </p>
 */
public class TestDecider extends Plugin {
	 ...
	 */
	public TestDecider(URI pluginUri) {
		super(pluginUri);
	}
	...
	protected void initialiseInternal(SetOfStatements workflowDescription) {
		logger.info("TestDecider initialized.");
	}
	...
	protected SetOfStatements invokeInternal(SetOfStatements input) {
		logger.info("TestDecider invokeInternal called ...");
		return input;
	}
