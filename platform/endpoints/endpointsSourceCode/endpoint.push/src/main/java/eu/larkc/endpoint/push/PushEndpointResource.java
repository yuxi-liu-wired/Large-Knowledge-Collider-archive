 ...
 * </ul>
 */
public class PushEndpointResource extends ServerResource {

	private static Logger logger = LoggerFactory
			.getLogger(PushEndpointResource.class);
	...
	public Representation executeQuery(Representation entity) throws Exception {
		...
		Executor ex = null;
		Endpoint ep = null;
		if (application instanceof PushEndpointApp) {
			ep = ((PushEndpointApp) application).getEndpoint();
			ex = ep.getExecutor();
		}
		assert (ep != null);
		assert (ex != null);
