...
/**
 * This class represents the main class of the endpoint. (No changes are needed in this class)
 */
public class QueryEndpoint extends Endpoint {

	private static Logger logger = LoggerFactory
			.getLogger(QueryEndpoint.class);
	 ...
	 *            the executor
	 */
	public QueryEndpoint(Executor ex) {
		super(ex, "/endpoint");
	}
