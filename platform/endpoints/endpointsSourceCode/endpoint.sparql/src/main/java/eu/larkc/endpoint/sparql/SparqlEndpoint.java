...
public class SparqlEndpoint extends Endpoint {
	...
	private static Logger logger = LoggerFactory
			.getLogger(SparqlEndpoint.class);
	 ...
	 *            the executor
	 */
	public SparqlEndpoint(Executor ex) {
		super(ex, SPARQL_PATH);
	}
	...
	public void start(int port) throws EndpointException {
		...
		component.getDefaultHost().attach(SPARQL_PATH,
				new SparqlEndpointApp(this));
