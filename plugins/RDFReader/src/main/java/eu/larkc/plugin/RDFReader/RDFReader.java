 ...
 * File path can be as well specified as a parameter. If no file paths specified in the INPUT, it will read file specified in the parameters.
 * 
 * 
 * PARAMETERS- _: larkc:defaultoutputname <label uri> (optional), _:larkc:filePath <literal pointing to a file>
 ...
 *
 */
public class RDFReader extends GenericHadoopPlugin {
	 ...
	 * @param pluginName
	 */
	public RDFReader(URI pluginName) {
		super(pluginName);
	}
	...
	protected void initialiseInternal(SetOfStatements params) {
		...
		// Get the default files to be read
		defaultPaths=DataFactory.INSTANCE.extractObjectsForPredicate(params, Constants.FILEPATH);
	}
	...
	public static void main(String[] args) {
		...
		RDFReader r=new RDFReader(new URIImpl("http://boo"));
